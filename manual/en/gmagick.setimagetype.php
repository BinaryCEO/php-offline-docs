...
<head>
  ...
  <title>PHP: Gmagick::setimagetype - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagetype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagetype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagetype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagescene.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimageunits.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagetype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagetype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagetype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagetype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagetype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagetype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagetype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagetype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagetype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagetype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagetype.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagetype - Manual" />
<meta name="twitter:description" content="Sets the image type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagetype - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.setimageunits.php">
          Gmagick::setimageunits &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagescene.php">
          &laquo; Gmagick::setimagescene        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagetype.php' selected="selected">English</option>
            <option value='de/gmagick.setimagetype.php'>German</option>
            <option value='es/gmagick.setimagetype.php'>Spanish</option>
            <option value='fr/gmagick.setimagetype.php'>French</option>
            <option value='it/gmagick.setimagetype.php'>Italian</option>
            <option value='ja/gmagick.setimagetype.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagetype.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagetype.php'>Russian</option>
            <option value='tr/gmagick.setimagetype.php'>Turkish</option>
            <option value='uk/gmagick.setimagetype.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagetype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagetype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagetype</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagetype</span> &mdash; <span class="dc-title">Sets the image type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagetype-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagetype</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$imgType</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagetype-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">imgType</code></dt>
     <dd>
      <p class="para">
       One of the <a href="gmagick.constants.php#gmagick.constants.imagetype" class="link">Image type</a> constant
       (<code class="literal">Gmagick::IMGTYPE_*</code>).
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagetype-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagetype-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagetype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagetype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagetype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagetype.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="110091">  <div class="votes">
    <div id="Vu110091">
    <a href="/manual/vote-note.php?id=110091&amp;page=gmagick.setimagetype&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd110091">
    <a href="/manual/vote-note.php?id=110091&amp;page=gmagick.setimagetype&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V110091" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#110091" class="name">
  <strong class="user"><em>Jrg Wagner</em></strong></a><a class="genanchor" href="#110091"> &para;</a><div class="date" title="2012-09-18 11:52"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom110091">
<div class="phpcode"><code><span class="html">The predefined constant values listed here are wrong. The correct values can be found at:
<br />www.php.net/manual/de/gmagick.constants.php
<br />
<br />They are:
<br />Gmagick::IMGTYPE_UNDEFINED (integer)
<br />Gmagick::IMGTYPE_BILEVEL (integer)
<br />Gmagick::IMGTYPE_GRAYSCALE (integer)
<br />Gmagick::IMGTYPE_GRAYSCALEMATTE (integer)
<br />Gmagick::IMGTYPE_PALETTE (integer)
<br />Gmagick::IMGTYPE_PALETTEMATTE (integer)
<br />Gmagick::IMGTYPE_TRUECOLOR (integer)
<br />Gmagick::IMGTYPE_TRUECOLORMATTE (integer)
<br />Gmagick::IMGTYPE_COLORSEPARATION (integer)
<br />Gmagick::IMGTYPE_COLORSEPARATIONMATTE (integer)
<br />Gmagick::IMGTYPE_OPTIMIZE (integer)
<br />
<br />The $image_Type parameter can be one of these constants:
<br />
<br />imagick::IMGTYPE_UNDEFINED (integer)
<br />imagick::IMGTYPE_BILEVEL (integer)
<br />imagick::IMGTYPE_GRAYSCALE (integer)
<br />imagick::IMGTYPE_GRAYSCALEMATTE (integer)
<br />imagick::IMGTYPE_PALETTE (integer)
<br />imagick::IMGTYPE_PALETTEMATTE (integer)
<br />imagick::IMGTYPE_TRUECOLOR (integer)
<br />imagick::IMGTYPE_TRUECOLORMATTE (integer)
<br />imagick::IMGTYPE_COLORSEPARATION (integer)
<br />imagick::IMGTYPE_COLORSEPARATIONMATTE (integer)
<br />imagick::IMGTYPE_OPTIMIZE (integer)
<br />
<br />See section "IMGTYPE constants" at <a href="http://www.php.net/manual/en/imagick.constants.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/imagick.constants.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=gmagick.setimagetype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagetype.php">＋<small>add a note</small></a></div>
