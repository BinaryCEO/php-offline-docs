...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-wrapper-restore.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-wrapper-register.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-wrapper-unregister.php">
...
<meta name="Description" content="Restores a previously unregistered built-in wrapper" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_wrapper_restore - Manual" />
<meta name="twitter:description" content="Restores a previously unregistered built-in wrapper" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_wrapper_restore - Manual" />
<meta itemprop="description" content="Restores a previously unregistered built-in wrapper" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Restores a previously unregistered built-in wrapper" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-wrapper-restore.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.stream-wrapper-restore.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.1.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_wrapper_restore</span> &mdash; <span class="dc-title">Restores a previously unregistered built-in wrapper</span></p>
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-wrapper-restore.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-wrapper-restore%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-wrapper-restore&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-wrapper-restore.php">＋<small>add a note</small></a></span>
