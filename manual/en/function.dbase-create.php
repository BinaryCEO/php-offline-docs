...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dbase-create.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.dbase-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dbase-delete-record.php">
...
<meta name="Description" content="Creates a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dbase_create - Manual" />
<meta name="twitter:description" content="Creates a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dbase_create - Manual" />
<meta itemprop="description" content="Creates a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a database" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dbase-create.php' selected="selected">English</option>
            <option value='de/function.dbase-create.php'>German</option>
            <option value='es/function.dbase-create.php'>Spanish</option>
            <option value='fr/function.dbase-create.php'>French</option>
 ...
 <div class="refsect1 description" id="refsect1-function.dbase-create-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.dbase-pack.php" class="function">dbase_pack()</a></span> can be called to force truncation.
  </p>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <strong><code><a href="dbase.constants.php#constant.dbase-type-dbase">DBASE_TYPE_DBASE</a></code></strong> or
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.dbase-create-returnvalues">
  ...
  <p class="para">
   ...
   or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if an error occurred.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.dbase-close.php" class="function" rel="rdfs-seeAlso">dbase_close()</a> - Closes a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dbase/functions/dbase-create.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dbase-create%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dbase-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-create.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">There is no third param in this function.<br />According to latest pecl package "dbase-pecl-php7", there are only 2 params.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.dbase-create&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dbase-create.php">＋<small>add a note</small></a></div>
