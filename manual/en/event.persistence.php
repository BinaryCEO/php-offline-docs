...
<head>
  ...
  <title>PHP: About event persistence - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/event.persistence.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/event.persistence.php">
 <link rel="alternate" href="https://www.php.net/manual/en/event.persistence.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.event.php">
 <link rel="prev" href="https://www.php.net/manual/en/event.flags.php">
 <link rel="next" href="https://www.php.net/manual/en/event.callbacks.php">

 <link rel="alternate" href="https://www.php.net/manual/en/event.persistence.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/event.persistence.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/event.persistence.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/event.persistence.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/event.persistence.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/event.persistence.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/event.persistence.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/event.persistence.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/event.persistence.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/event.persistence.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/event.persistence.php" hreflang="zh">
...
<meta name="Description" content="About event persistence" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: About event persistence - Manual" />
<meta name="twitter:description" content="About event persistence" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: About event persistence - Manual" />
<meta itemprop="description" content="About event persistence" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="About event persistence" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/event.persistence.php' selected="selected">English</option>
            <option value='de/event.persistence.php'>German</option>
            <option value='es/event.persistence.php'>Spanish</option>
            <option value='fr/event.persistence.php'>French</option>
            <option value='it/event.persistence.php'>Italian</option>
            <option value='ja/event.persistence.php'>Japanese</option>
            <option value='pt_BR/event.persistence.php'>Brazilian Portuguese</option>
            <option value='ru/event.persistence.php'>Russian</option>
            <option value='tr/event.persistence.php'>Turkish</option>
            <option value='uk/event.persistence.php'>Ukrainian</option>
            <option value='zh/event.persistence.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="event.persistence" class="chapter">
 ...
 Persistence</a>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/event.persistence.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fevent.persistence%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=event.persistence&amp;repo=en&amp;redirect=https://www.php.net/manual/en/event.persistence.php">＋<small>add a note</small></a></span>
