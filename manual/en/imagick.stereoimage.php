...
<head>
  ...
  <title>PHP: Imagick::stereoImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.stereoimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.stereoimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.stereoimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.steganoimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.stripimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.stereoimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.stereoimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.stereoimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.stereoimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.stereoimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.stereoimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.stereoimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.stereoimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.stereoimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.stereoimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.stereoimage.php" hreflang="zh">
...
<meta name="Description" content="Composites two images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::stereoImage - Manual" />
<meta name="twitter:description" content="Composites two images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::stereoImage - Manual" />
<meta itemprop="description" content="Composites two images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Composites two images" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.stripimage.php">
          Imagick::stripImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.steganoimage.php">
          &laquo; Imagick::steganoImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.stereoimage.php' selected="selected">English</option>
            <option value='de/imagick.stereoimage.php'>German</option>
            <option value='es/imagick.stereoimage.php'>Spanish</option>
            <option value='fr/imagick.stereoimage.php'>French</option>
            <option value='it/imagick.stereoimage.php'>Italian</option>
            <option value='ja/imagick.stereoimage.php'>Japanese</option>
            <option value='pt_BR/imagick.stereoimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.stereoimage.php'>Russian</option>
            <option value='tr/imagick.stereoimage.php'>Turkish</option>
            <option value='uk/imagick.stereoimage.php'>Ukrainian</option>
            <option value='zh/imagick.stereoimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.stereoimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::stereoImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::stereoImage</span> &mdash; <span class="dc-title">Composites two images</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.stereoimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::stereoImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span> <code class="parameter">$offset_wand</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.stereoimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">offset_wand</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.stereoimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.stereoimage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/stereoimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.stereoimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.stereoimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.stereoimage.php">＋<small>add a note</small></a></span>
