...
<head>
  ...
  <title>PHP: socket_getsockname - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-getsockname.php">
 <link rel="shorturl" href="https://www.php.net/socket-getsockname">
 <link rel="alternate" href="https://www.php.net/socket-getsockname" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-getpeername.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-import-stream.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-getsockname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-getsockname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-getsockname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-getsockname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-getsockname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-getsockname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-getsockname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-getsockname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-getsockname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-getsockname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-getsockname.php" hreflang="zh">
...
<meta name="Description" content="Queries the local side of the given socket which may either result in host/port or in a Unix filesystem path, dependent on its type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_getsockname - Manual" />
<meta name="twitter:description" content="Queries the local side of the given socket which may either result in host/port or in a Unix filesystem path, dependent on its type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_getsockname - Manual" />
<meta itemprop="description" content="Queries the local side of the given socket which may either result in host/port or in a Unix filesystem path, dependent on its type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Queries the local side of the given socket which may either result in host/port or in a Unix filesystem path, dependent on its type" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-import-stream.php">
          socket_import_stream &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-getpeername.php">
          &laquo; socket_getpeername        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-getsockname.php' selected="selected">English</option>
            <option value='de/function.socket-getsockname.php'>German</option>
            <option value='es/function.socket-getsockname.php'>Spanish</option>
            <option value='fr/function.socket-getsockname.php'>French</option>
            <option value='it/function.socket-getsockname.php'>Italian</option>
            <option value='ja/function.socket-getsockname.php'>Japanese</option>
            <option value='pt_BR/function.socket-getsockname.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-getsockname.php'>Russian</option>
            <option value='tr/function.socket-getsockname.php'>Turkish</option>
            <option value='uk/function.socket-getsockname.php'>Ukrainian</option>
            <option value='zh/function.socket-getsockname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-getsockname" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.socket-getsockname-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure. <span class="function"><strong>socket_getsockname()</strong></span> may also return
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-strerror.php" class="function" rel="rdfs-seeAlso">socket_strerror()</a> - Return a string describing a socket error</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-getsockname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-getsockname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-getsockname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-getsockname.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115751">  <div class="votes">
    <div id="Vu115751">
    <a href="/manual/vote-note.php?id=115751&amp;page=function.socket-getsockname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115751">
    <a href="/manual/vote-note.php?id=115751&amp;page=function.socket-getsockname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115751" title="66% like this...">
    1
    </div>
  </div>
  <a href="#115751" class="name">
  <strong class="user"><em>CXJ</em></strong></a><a class="genanchor" href="#115751"> &para;</a><div class="date" title="2014-09-17 07:28"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115751">
<div class="phpcode"><code><span class="html">Curiously, getsockname() works for socket_create() and socket_create_pair() Unix-domain (AF_UNIX) sockets if one calls socket_bind() after creation to name the formerly anonymous socket(s).  <br /><br />Using a socket_bind() call also results in a file system "file" (socket, first character 's' in an "ls -l" listing) being created with the given name.  Such a "file" will need to be removed explicitly, as closing the socket will not remove it.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-getsockname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-getsockname.php">＋<small>add a note</small></a></div>
