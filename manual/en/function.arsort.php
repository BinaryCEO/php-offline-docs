...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.arsort.php">
 <link rel="shorturl" href="https://www.php.net/arsort">
 <link rel="alternate" href="https://www.php.net/arsort" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.array-walk-recursive.php">
 <link rel="next" href="https://www.php.net/manual/en/function.asort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.arsort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.arsort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.arsort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.arsort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.arsort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.arsort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.arsort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.arsort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.arsort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.arsort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.arsort.php" hreflang="zh">
...
<meta name="Description" content="Sort an array in descending order and maintain index association" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: arsort - Manual" />
<meta name="twitter:description" content="Sort an array in descending order and maintain index association" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: arsort - Manual" />
<meta itemprop="description" content="Sort an array in descending order and maintain index association" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sort an array in descending order and maintain index association" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.arsort.php' selected="selected">English</option>
            <option value='de/function.arsort.php'>German</option>
            <option value='es/function.arsort.php'>Spanish</option>
            <option value='fr/function.arsort.php'>French</option>
            <option value='it/function.arsort.php'>Italian</option>
            <option value='ja/function.arsort.php'>Japanese</option>
            <option value='pt_BR/function.arsort.php'>Brazilian Portuguese</option>
            <option value='ru/function.arsort.php'>Russian</option>
            <option value='tr/function.arsort.php'>Turkish</option>
            <option value='uk/function.arsort.php'>Ukrainian</option>
            <option value='zh/function.arsort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.arsort" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">arsort</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">arsort</span> &mdash; <span class="dc-title">Sort an array in descending order and maintain index association</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.arsort-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>arsort</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter reference">&$array</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = <strong><code><a href="array.constants.php#constant.sort-regular">SORT_REGULAR</a></code></strong></span></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>

  <p class="para rdfs-comment">
   Sorts <code class="parameter">array</code> in place in descending order,
 ...
 <div class="refsect1 changelog" id="refsect1-function.arsort-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.arsort-examples">
  ...
  <p class="para">
   <div class="example" id="example-5294">
    <p><strong>Example #1 <span class="function"><strong>arsort()</strong></span> example</strong></p>
...
c = apple</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.arsort-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.asort.php" class="function" rel="rdfs-seeAlso">asort()</a> - Sort an array in ascending order and maintain index association</span></li>
   <li>The <a href="array.sorting.php" class="link">comparison of array sorting functions</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/arsort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.arsort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.arsort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.arsort.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="2421">  <div class="votes">
    <div id="Vu2421">
    <a href="/manual/vote-note.php?id=2421&amp;page=function.arsort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd2421">
    <a href="/manual/vote-note.php?id=2421&amp;page=function.arsort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V2421" title="56% like this...">
    14
    </div>
  </div>
  <a href="#2421" class="name">
  <strong class="user"><em>morgan at anomalyinc dot com</em></strong></a><a class="genanchor" href="#2421"> &para;</a><div class="date" title="1999-11-24 07:30"><strong>25 years ago</strong></div>
  <div class="text" id="Hcom2421">
<div class="phpcode"><code><span class="html">If you need to sort a multi-demension array, for example, an array such as 
<br />
...
<br />-mo</span></code></div>
  ...
  <div class="note" id="121205">  <div class="votes">
    <div id="Vu121205">
    <a href="/manual/vote-note.php?id=121205&amp;page=function.arsort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121205">
    <a href="/manual/vote-note.php?id=121205&amp;page=function.arsort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121205" title="57% like this...">
    11
    </div>
  </div>
  <a href="#121205" class="name">
  <strong class="user"><em>stephenakins at gmail dot com</em></strong></a><a class="genanchor" href="#121205"> &para;</a><div class="date" title="2017-06-09 01:25"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121205">
<div class="phpcode"><code><span class="html">I have two servers; one running 5.6 and another that is running 7.  Using this function on the two servers gets me different results when all of the values are the same.  <br /><br /><span class="default">&lt;?php<br /><br />$list </span><span class="keyword">= </span><span class="default">json_decode</span><span class="keyword">(</span><span class="string">'{"706":2,"703":2,"702":2,"696":2,"658":2}'</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$list</span><span class="keyword">);<br /><br /></span><span class="default">arsort</span><span class="keyword">(</span><span class="default">$list</span><span class="keyword">);<br />echo </span><span class="string">"&lt;br&gt;"</span><span class="keyword">;<br /><br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$list</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />PHP 5.6 results:<br />Array ( [706] =&gt; 2 [703] =&gt; 2 [702] =&gt; 2 [696] =&gt; 2 [658] =&gt; 2 ) <br />Array ( [658] =&gt; 2 [696] =&gt; 2 [702] =&gt; 2 [703] =&gt; 2 [706] =&gt; 2 )<br /><br />PHP 7 results:<br />Array ( [706] =&gt; 2 [703] =&gt; 2 [702] =&gt; 2 [696] =&gt; 2 [658] =&gt; 2 ) <br />Array ( [706] =&gt; 2 [703] =&gt; 2 [702] =&gt; 2 [696] =&gt; 2 [658] =&gt; 2 )</span></code></div>
  </div>
 </div>
  <div class="note" id="106144">  <div class="votes">
    <div id="Vu106144">
    <a href="/manual/vote-note.php?id=106144&amp;page=function.arsort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106144">
    <a href="/manual/vote-note.php?id=106144&amp;page=function.arsort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106144" title="46% like this...">
    -3
    </div>
  </div>
  <a href="#106144" class="name">
  <strong class="user"><em>FatBat</em></strong></a><a class="genanchor" href="#106144"> &para;</a><div class="date" title="2011-10-13 01:40"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106144">
<div class="phpcode"><code><span class="html">Needed to get the index of the max/highest value in an assoc array.
<br />max() only returned the value, no index, so I did this instead.
<br />
<br /><span class="default">&lt;?php
<br />reset</span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">);   </span><span class="comment">// optional.
<br /></span><span class="default">arsort</span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">);
<br /></span><span class="default">$key_of_max </span><span class="keyword">= </span><span class="default">key</span><span class="keyword">(</span><span class="default">$x</span><span class="keyword">);   </span><span class="comment">// returns the index.
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.arsort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.arsort.php">＋<small>add a note</small></a></div>
