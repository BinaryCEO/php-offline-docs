...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagemattecolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagemattecolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagemattecolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagematte.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageopacity.php">
...
<meta name="Description" content="Sets the image matte color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageMatteColor - Manual" />
<meta name="twitter:description" content="Sets the image matte color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageMatteColor - Manual" />
<meta itemprop="description" content="Sets the image matte color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image matte color" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagemattecolor.php' selected="selected">English</option>
            ...
            <option value='tr/imagick.setimagemattecolor.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageMatteColor</span> &mdash; <span class="dc-title">Sets the image matte color</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.setimagemattecolor-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageMatteColor</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$matte</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagemattecolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagemattecolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagemattecolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagemattecolor.php">＋<small>add a note</small></a></span>
