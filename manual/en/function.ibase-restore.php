...
<head>
  ...
  <title>PHP: ibase_restore - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-restore.php">
 <link rel="shorturl" href="https://www.php.net/ibase-restore">
 <link rel="alternate" href="https://www.php.net/ibase-restore" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-query.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-rollback.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-restore.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-restore.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-restore.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-restore.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-restore.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-restore.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-restore.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-restore.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-restore.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-restore.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-restore.php" hreflang="zh">
...
<meta name="Description" content="Initiates a restore task in the service manager and returns immediately" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_restore - Manual" />
<meta name="twitter:description" content="Initiates a restore task in the service manager and returns immediately" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_restore - Manual" />
<meta itemprop="description" content="Initiates a restore task in the service manager and returns immediately" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initiates a restore task in the service manager and returns immediately" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-rollback.php">
          ibase_rollback &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-query.php">
          &laquo; ibase_query        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-restore.php' selected="selected">English</option>
            <option value='de/function.ibase-restore.php'>German</option>
            <option value='es/function.ibase-restore.php'>Spanish</option>
            <option value='fr/function.ibase-restore.php'>French</option>
            <option value='it/function.ibase-restore.php'>Italian</option>
            <option value='ja/function.ibase-restore.php'>Japanese</option>
            <option value='pt_BR/function.ibase-restore.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-restore.php'>Russian</option>
            <option value='tr/function.ibase-restore.php'>Turkish</option>
            <option value='uk/function.ibase-restore.php'>Ukrainian</option>
            <option value='zh/function.ibase-restore.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-restore" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_restore</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_restore</span> &mdash; <span class="dc-title">Initiates a restore task in the service manager and returns immediately</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-restore-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_restore</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$service_handle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$source_file</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$dest_db</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$verbose</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span><br>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-restore-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">source_file</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">dest_db</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-restore-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.ibase-restore-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1332">
    <p><strong>Example #1 <span class="function"><strong>ibase_restore()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Attach to database server by ip address and port<br /></span><span style="color: #0000BB">$service </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_service_attach </span><span style="color: #007700">(</span><span style="color: #DD0000">'10.1.11.200/3050'</span><span style="color: #007700">, </span><span style="color: #DD0000">'sysdba'</span><span style="color: #007700">, </span><span style="color: #DD0000">'masterkey'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Start the restore process on database server<br />// Restore employee backup to the new emps.fdb database<br />// Don't use any special arguments<br /></span><span style="color: #0000BB">ibase_restore</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #DD0000">'/srv/backup/employees.fbk'</span><span style="color: #007700">, </span><span style="color: #DD0000">'/srv/firebird/emps.fdb'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Free the attached connection<br /></span><span style="color: #0000BB">ibase_service_detach </span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
  ...
  <p class="para">
   <div class="example" id="example-1333">
    <p><strong>Example #2 <span class="function"><strong>ibase_restore()</strong></span> example with arguments</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Attach to database server by name and default port<br /></span><span style="color: #0000BB">$service </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_service_attach </span><span style="color: #007700">(</span><span style="color: #DD0000">'fb-server.contoso.local'</span><span style="color: #007700">, </span><span style="color: #DD0000">'sysdba'</span><span style="color: #007700">, </span><span style="color: #DD0000">'masterkey'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Start the restore process on database server<br />// Restore to employee database using alias.<br />// Restore without indixes. Replace existing database.<br /></span><span style="color: #0000BB">ibase_restore</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #DD0000">'/srv/backup/employees.fbk'</span><span style="color: #007700">, </span><span style="color: #DD0000">'employees.fdb'</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_RES_DEACTIVATE_IDX </span><span style="color: #007700">| </span><span style="color: #0000BB">IBASE_RES_REPLACE</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Free the attached connection<br /></span><span style="color: #0000BB">ibase_service_detach </span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-restore-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-backup.php" class="function" rel="rdfs-seeAlso">ibase_backup()</a> - Initiates a backup task in the service manager and returns immediately</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-restore.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-restore%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-restore&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-restore.php">＋<small>add a note</small></a></span>
