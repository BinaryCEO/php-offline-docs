...
<head>
  ...
  <title>PHP: pg_last_oid - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-last-oid.php">
 <link rel="shorturl" href="https://www.php.net/pg-last-oid">
 <link rel="alternate" href="https://www.php.net/pg-last-oid" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-last-notice.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-lo-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-last-oid.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-last-oid.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-last-oid.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-last-oid.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-last-oid.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-last-oid.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-last-oid.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-last-oid.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-last-oid.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-last-oid.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-last-oid.php" hreflang="zh">
...
<meta name="Description" content="Returns the last row's OID" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_last_oid - Manual" />
<meta name="twitter:description" content="Returns the last row's OID" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_last_oid - Manual" />
<meta itemprop="description" content="Returns the last row's OID" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the last row's OID" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-lo-close.php">
          pg_lo_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-last-notice.php">
          &laquo; pg_last_notice        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-last-oid.php' selected="selected">English</option>
            <option value='de/function.pg-last-oid.php'>German</option>
            <option value='es/function.pg-last-oid.php'>Spanish</option>
            <option value='fr/function.pg-last-oid.php'>French</option>
            <option value='it/function.pg-last-oid.php'>Italian</option>
            <option value='ja/function.pg-last-oid.php'>Japanese</option>
            <option value='pt_BR/function.pg-last-oid.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-last-oid.php'>Russian</option>
            <option value='tr/function.pg-last-oid.php'>Turkish</option>
            <option value='uk/function.pg-last-oid.php'>Ukrainian</option>
            <option value='zh/function.pg-last-oid.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-last-oid" class="refentry">
...
<span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> or <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>(among others).</p>
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-last-oid-examples">
  ...
  <p class="para">
   <div class="example" id="example-2080">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-result-status.php" class="function" rel="rdfs-seeAlso">pg_result_status()</a> - Get status of query result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-last-oid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-last-oid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-last-oid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-last-oid.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">6 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="35270">  <div class="votes">
    <div id="Vu35270">
    <a href="/manual/vote-note.php?id=35270&amp;page=function.pg-last-oid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd35270">
    <a href="/manual/vote-note.php?id=35270&amp;page=function.pg-last-oid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V35270" title="no votes...">
    0
    </div>
  </div>
  <a href="#35270" class="name">
  <strong class="user"><em>julian at e2-media dot co dot nz</em></strong></a><a class="genanchor" href="#35270"> &para;</a><div class="date" title="2003-08-25 11:21"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom35270">
<div class="phpcode"><code><span class="html">The way I nuderstand it, each value is emitted by a sequence only ONCE. If you retrieve a number (say 12) from a sequence using nextval(), the sequence will advance and subsequent calls to nextval() will return further numbers (after 12) in the sequence.<br /><br />This means that if you use nextval() to retrieve a value to use as a primary key, you can be guaranteed that no other calls to nextval() on that sequence will return the same value. No race conditions, no transactions required.<br /><br />That's what sequences are *for* afaik :^)</span></code></div>
  </div>
 </div>
  <div class="note" id="32076">  <div class="votes">
    <div id="Vu32076">
    <a href="/manual/vote-note.php?id=32076&amp;page=function.pg-last-oid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd32076">
    <a href="/manual/vote-note.php?id=32076&amp;page=function.pg-last-oid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V32076" title="50% like this...">
    0
    </div>
  </div>
  <a href="#32076" class="name">
  <strong class="user"><em>a dot bardsley at lancs dot ac dot uk</em></strong></a><a class="genanchor" href="#32076"> &para;</a><div class="date" title="2003-05-15 11:23"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom32076">
<div class="phpcode"><code><span class="html">As pointed out on a busy site some of the above methods might actually give you an incorrect answer as another record is inserted inbetween your insert  and the select. To combat this put it into a transaction and dont commit till you have done all the work</span></code></div>
  </div>
 </div>
  <div class="note" id="31570">  <div class="votes">
    <div id="Vu31570">
    <a href="/manual/vote-note.php?id=31570&amp;page=function.pg-last-oid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd31570">
    <a href="/manual/vote-note.php?id=31570&amp;page=function.pg-last-oid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V31570" title="50% like this...">
    0
    </div>
  </div>
  <a href="#31570" class="name">
  <strong class="user"><em>dtutar at yore dot com dot tr</em></strong></a><a class="genanchor" href="#31570"> &para;</a><div class="date" title="2003-04-26 07:15"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom31570">
<div class="phpcode"><code><span class="html">This is very useful function :)<br /><br />function sql_last_inserted_id($connection, $result, $table_name, $column_name) {<br />   $oid = pg_last_oid ( $result);<br />       $query_for_id = "SELECT $column_name FROM $table_name WHERE oid=$oid";<br />   $result_for_id = pg_query($connection,$query_for_id);<br />   if(pg_num_rows($result_for_id))<br />      $id=pg_fetch_array($result_for_id,0,PGSQL_ASSOC);<br />   return $id[$column_name];<br />}<br /><br />Call after insert, simply ;)</span></code></div>
  </div>
 </div>
  <div class="note" id="29988">  <div class="votes">
    <div id="Vu29988">
    <a href="/manual/vote-note.php?id=29988&amp;page=function.pg-last-oid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd29988">
    <a href="/manual/vote-note.php?id=29988&amp;page=function.pg-last-oid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V29988" title="no votes...">
    0
    </div>
  </div>
  <a href="#29988" class="name">
  <strong class="user"><em>webmaster at gamecrash dot net</em></strong></a><a class="genanchor" href="#29988"> &para;</a><div class="date" title="2003-03-03 06:29"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom29988">
<div class="phpcode"><code><span class="html">You could use this to get the last insert id...<br /><br />CREATE TABLE test (<br />  id serial,<br />  something int not null<br />);<br /><br />This creates the sequence test_id_seq. Now do the following after inserting something into table test:<br /><br />INSERT INTO test (something) VALUES (123);<br />SELECT currval('test_id_seq') AS lastinsertid;<br /><br />lastinsertid should contain your last insert id.</span></code></div>
  </div>
 </div>
  <div class="note" id="53374">  <div class="votes">
    <div id="Vu53374">
    <a href="/manual/vote-note.php?id=53374&amp;page=function.pg-last-oid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd53374">
    <a href="/manual/vote-note.php?id=53374&amp;page=function.pg-last-oid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V53374" title="33% like this...">
    -2
    </div>
  </div>
  <a href="#53374" class="name">
  <strong class="user"><em>Jonathan Bond-Caron</em></strong></a><a class="genanchor" href="#53374"> &para;</a><div class="date" title="2005-05-30 08:21"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom53374">
<div class="phpcode"><code><span class="html">I'm sharing an elegant solution I found on the web (Vadim Passynkov): <br /><br />CREATE RULE get_pkey_on_insert AS ON INSERT TO Customers DO SELECT currval('customers_customers_id_seq') AS id;<br /><br />Every time you insert to the Customers table, postgreSQL will return a table with the id you just inserted. No need to worry about concurrency, the ressource is locked when the rule gets executed.<br /><br />Note that in cases of multiple inserts: <br />INSERT INTO C1 ( ... ) ( SELECT * FROM C2); <br /><br />we would return the id of the last inserted row. <br /><br />For more info about PostgreSQL rules:<br /><a href="http://www.postgresql.org/docs/7.4/interactive/sql-createrule.html" rel="nofollow" target="_blank">http://www.postgresql.org/docs/7.4/interactive/sql-createrule.html</a></span></code></div>
  </div>
 </div>
  <div class="note" id="109549">  <div class="votes">
    <div id="Vu109549">
    <a href="/manual/vote-note.php?id=109549&amp;page=function.pg-last-oid&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109549">
    <a href="/manual/vote-note.php?id=109549&amp;page=function.pg-last-oid&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109549" title="30% like this...">
    -5
    </div>
  </div>
  <a href="#109549" class="name">
  <strong class="user"><em>qeremy [atta] gmail [dotta] com</em></strong></a><a class="genanchor" href="#109549"> &para;</a><div class="date" title="2012-07-27 02:11"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109549">
<div class="phpcode"><code><span class="html">Simply getting LAST_INSERT_ID;<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Note: waiting for "select" part from pg_query below.<br />// Note: separating the query parts using semicolons (;).<br /><br /></span><span class="default">$qry </span><span class="keyword">= </span><span class="default">pg_query</span><span class="keyword">(</span><span class="string">"<br />    INSERT INTO users (id,uname,upass,rep) VALUES (DEFAULT,'bubu','a981v',0.19);<br />    SELECT Currval('users_id_seq') LIMIT 1<br />"</span><span class="keyword">);<br /><br /></span><span class="comment">// or<br /></span><span class="default">$qry </span><span class="keyword">= </span><span class="default">pg_query</span><span class="keyword">(</span><span class="string">"<br />    INSERT INTO users (id,uname,upass,rep) VALUES (DEFAULT,'bubu','a981v',0.19) RETURNING Currval('users_id_seq')"</span><span class="keyword">);<br /><br /></span><span class="default">$fch </span><span class="keyword">= </span><span class="default">pg_fetch_row</span><span class="keyword">(</span><span class="default">$qry</span><span class="keyword">);<br /></span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$fch</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Array<br />(<br />    [0] =&gt; 3 -&gt; Gotcha!<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-last-oid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-last-oid.php">＋<small>add a note</small></a></div>
