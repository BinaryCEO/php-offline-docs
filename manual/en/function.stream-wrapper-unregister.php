...
<head>
  ...
  <title>PHP: stream_wrapper_unregister - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-wrapper-unregister.php">
 <link rel="shorturl" href="https://www.php.net/stream-wrapper-unregister">
 <link rel="alternate" href="https://www.php.net/stream-wrapper-unregister" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-wrapper-restore.php">
 <link rel="next" href="https://www.php.net/manual/en/book.swoole.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-wrapper-unregister.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-wrapper-unregister.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-wrapper-unregister.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-wrapper-unregister.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-wrapper-unregister.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-wrapper-unregister.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-wrapper-unregister.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-wrapper-unregister.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-wrapper-unregister.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-wrapper-unregister.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-wrapper-unregister.php" hreflang="zh">
...
<meta name="Description" content="Unregister a URL wrapper" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_wrapper_unregister - Manual" />
<meta name="twitter:description" content="Unregister a URL wrapper" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_wrapper_unregister - Manual" />
<meta itemprop="description" content="Unregister a URL wrapper" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Unregister a URL wrapper" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.swoole.php">
          Swoole &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-wrapper-restore.php">
          &laquo; stream_wrapper_restore        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-wrapper-unregister.php' selected="selected">English</option>
            <option value='de/function.stream-wrapper-unregister.php'>German</option>
            <option value='es/function.stream-wrapper-unregister.php'>Spanish</option>
            <option value='fr/function.stream-wrapper-unregister.php'>French</option>
            <option value='it/function.stream-wrapper-unregister.php'>Italian</option>
            <option value='ja/function.stream-wrapper-unregister.php'>Japanese</option>
            <option value='pt_BR/function.stream-wrapper-unregister.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-wrapper-unregister.php'>Russian</option>
            <option value='tr/function.stream-wrapper-unregister.php'>Turkish</option>
            <option value='uk/function.stream-wrapper-unregister.php'>Ukrainian</option>
            <option value='zh/function.stream-wrapper-unregister.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-wrapper-unregister" class="refentry">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-wrapper-unregister.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-wrapper-unregister%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-wrapper-unregister&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-wrapper-unregister.php">＋<small>add a note</small></a></span>
