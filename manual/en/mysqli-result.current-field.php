...
<head>
  ...
  <title>PHP: mysqli_result::$current_field - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-result.current-field.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-result.current-field.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.current-field.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-result.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-result.construct.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-result.data-seek.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.current-field.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-result.current-field.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-result.current-field.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-result.current-field.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-result.current-field.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-result.current-field.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-result.current-field.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-result.current-field.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-result.current-field.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-result.current-field.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-result.current-field.php" hreflang="zh">
...
<meta name="Description" content="Get current field offset of a result pointer" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_result::$current_field - Manual" />
<meta name="twitter:description" content="Get current field offset of a result pointer" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_result::$current_field - Manual" />
<meta itemprop="description" content="Get current field offset of a result pointer" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get current field offset of a result pointer" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli-result.data-seek.php">
          mysqli_result::data_seek &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-result.construct.php">
          &laquo; mysqli_result::__construct        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-result.current-field.php' selected="selected">English</option>
            <option value='de/mysqli-result.current-field.php'>German</option>
            <option value='es/mysqli-result.current-field.php'>Spanish</option>
            <option value='fr/mysqli-result.current-field.php'>French</option>
            <option value='it/mysqli-result.current-field.php'>Italian</option>
            <option value='ja/mysqli-result.current-field.php'>Japanese</option>
            <option value='pt_BR/mysqli-result.current-field.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-result.current-field.php'>Russian</option>
            <option value='tr/mysqli-result.current-field.php'>Turkish</option>
            <option value='uk/mysqli-result.current-field.php'>Ukrainian</option>
            <option value='zh/mysqli-result.current-field.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-result.current-field" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli_result::$current_field</h1>
  <h1 class="refname">mysqli_field_tell</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli_result::$current_field</span> -- <span class="refname">mysqli_field_tell</span> &mdash; <span class="dc-title">Get current field offset of a result pointer</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli-result.current-field-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="fieldsynopsis">
   <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <var class="varname"><a href="mysqli-result.current-field.php">$mysqli_result-&gt;current_field</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_field_tell</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli-result.php" class="type mysqli_result">mysqli_result</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   Returns the position of the field cursor used for the last
   <span class="function"><a href="mysqli-result.fetch-field.php" class="function">mysqli_fetch_field()</a></span> call. This value can
   be used as an argument to <span class="function"><a href="mysqli-result.field-seek.php" class="function">mysqli_field_seek()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-mysqli-result.current-field-parameters">
...
<span class="function"><a href="mysqli.use-result.php" class="function">mysqli_use_result()</a></span> or <span class="function"><a href="mysqli-stmt.get-result.php" class="function">mysqli_stmt_get_result()</a></span>.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli-result.current-field-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-mysqli-result.current-field-examples">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$mysqli </span><span style="color: #007700">= new </span><span style="color: #0000BB">mysqli</span><span style="color: #007700">(</span><span style="color: #DD0000">"localhost"</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_user"</span><span style="color: #007700">, </span><span style="color: #DD0000">"my_password"</span><span style="color: #007700">, </span><span style="color: #DD0000">"world"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* check connection */<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">mysqli_connect_errno</span><span style="color: #007700">()) {<br />    </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Connect failed: %s\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">mysqli_connect_error</span><span style="color: #007700">());<br />    exit();<br />}<br /><br /></span><span style="color: #0000BB">$query </span><span style="color: #007700">= </span><span style="color: #DD0000">"SELECT Name, SurfaceArea from Country ORDER BY Code LIMIT 5"</span><span style="color: #007700">;<br /><br />if (</span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">query</span><span style="color: #007700">(</span><span style="color: #0000BB">$query</span><span style="color: #007700">)) {<br /><br />    </span><span style="color: #FF8000">/* Get field information for all columns */<br />    </span><span style="color: #007700">while (</span><span style="color: #0000BB">$finfo </span><span style="color: #007700">= </span><span style="color: #0000BB">$result</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">fetch_field</span><span style="color: #007700">()) {<br /><br />        </span><span style="color: #FF8000">/* get fieldpointer offset */<br />        </span><span style="color: #0000BB">$currentfield </span><span style="color: #007700">= </span><span style="color: #0000BB">$result</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">current_field</span><span style="color: #007700">;<br /><br />        </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Column %d:\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$currentfield</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Name:     %s\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$finfo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">name</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Table:    %s\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$finfo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">table</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"max. Len: %d\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$finfo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">max_length</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Flags:    %d\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$finfo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">flags</span><span style="color: #007700">);<br />        </span><span style="color: #0000BB">printf</span><span style="color: #007700">(</span><span style="color: #DD0000">"Type:     %d\n\n"</span><span style="color: #007700">, </span><span style="color: #0000BB">$finfo</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">type</span><span style="color: #007700">);<br />    }<br />    </span><span style="color: #0000BB">$result</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br />}<br /><br /></span><span style="color: #FF8000">/* close connection */<br /></span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">close</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
  ...
  <div class="example" id="example-1654">
...
<div class="examplescode"><pre class="examplescode">Column 1:
Name:     Name
Table:    Country
max. Len: 11
Flags:    1
...
Type:     4</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli-result.current-field-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli-result.field-seek.php" class="function" rel="rdfs-seeAlso">mysqli_field_seek()</a> - Set result pointer to a specified field offset</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_result/current-field.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-result.current-field%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-result.current-field&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-result.current-field.php">＋<small>add a note</small></a></span>
