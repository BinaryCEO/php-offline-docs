...
<head>
  ...
  <title>PHP: ReflectionClass::getTraitAliases - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.gettraitaliases.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.gettraitaliases.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.gettraitaliases.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.getstaticpropertyvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.gettraitnames.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.gettraitaliases.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.gettraitaliases.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.gettraitaliases.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.gettraitaliases.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.gettraitaliases.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.gettraitaliases.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.gettraitaliases.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.gettraitaliases.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.gettraitaliases.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.gettraitaliases.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.gettraitaliases.php" hreflang="zh">
...
<meta name="Description" content="Returns an array of trait aliases" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getTraitAliases - Manual" />
<meta name="twitter:description" content="Returns an array of trait aliases" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getTraitAliases - Manual" />
<meta itemprop="description" content="Returns an array of trait aliases" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array of trait aliases" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="reflectionclass.gettraitnames.php">
          ReflectionClass::getTraitNames &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.getstaticpropertyvalue.php">
          &laquo; ReflectionClass::getStaticPropertyValue        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.gettraitaliases.php' selected="selected">English</option>
            <option value='de/reflectionclass.gettraitaliases.php'>German</option>
            <option value='es/reflectionclass.gettraitaliases.php'>Spanish</option>
            <option value='fr/reflectionclass.gettraitaliases.php'>French</option>
            <option value='it/reflectionclass.gettraitaliases.php'>Italian</option>
            <option value='ja/reflectionclass.gettraitaliases.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.gettraitaliases.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.gettraitaliases.php'>Russian</option>
            <option value='tr/reflectionclass.gettraitaliases.php'>Turkish</option>
            <option value='uk/reflectionclass.gettraitaliases.php'>Ukrainian</option>
            <option value='zh/reflectionclass.gettraitaliases.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.gettraitaliases" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getTraitAliases</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getTraitAliases</span> &mdash; <span class="dc-title">Returns an array of trait aliases</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.gettraitaliases-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getTraitAliases</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.gettraitaliases-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.gettraitaliases-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an array with new method names in keys and original names (in the
   format <code class="literal">&quot;TraitName::original&quot;</code>) in values.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/gettraitaliases.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.gettraitaliases%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.gettraitaliases&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.gettraitaliases.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118813">  <div class="votes">
    <div id="Vu118813">
    <a href="/manual/vote-note.php?id=118813&amp;page=reflectionclass.gettraitaliases&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118813">
    <a href="/manual/vote-note.php?id=118813&amp;page=reflectionclass.gettraitaliases&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118813" title="100% like this...">
    1
    </div>
  </div>
  <a href="#118813" class="name">
  <strong class="user"><em>dhairya dot coder at gmail dot com</em></strong></a><a class="genanchor" href="#118813"> &para;</a><div class="date" title="2016-02-10 11:43"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118813">
<div class="phpcode"><code><span class="html">trait A {<br />    public function smallTalk() {<br />        echo 'a';<br />    }<br />    public function bigTalk() {<br />        echo 'A';<br />    }<br />}<br /><br />class Apple{<br />    <br />    use A {<br />        A::bigTalk as talk;<br />    }<br />}<br /><br />$obj=new ReflectionClass('Apple');<br />echo "&lt;pre&gt;";<br />var_dump($obj-&gt;getTraitAliases());  <br />echo "&lt;/pre&gt;";</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.gettraitaliases&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.gettraitaliases.php">＋<small>add a note</small></a></div>
