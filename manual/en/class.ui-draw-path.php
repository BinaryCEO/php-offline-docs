...
<head>
  ...
  <title>PHP: UI\Draw\Path - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.ui-draw-path.php">
 <link rel="shorturl" href="https://www.php.net/ui-draw-path">
 <link rel="alternate" href="https://www.php.net/ui-draw-path" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ui.php">
 <link rel="prev" href="https://www.php.net/manual/en/ui-draw-pen.write.php">
 <link rel="next" href="https://www.php.net/manual/en/ui-draw-path.addrectangle.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.ui-draw-path.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.ui-draw-path.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.ui-draw-path.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.ui-draw-path.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.ui-draw-path.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.ui-draw-path.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.ui-draw-path.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.ui-draw-path.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.ui-draw-path.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.ui-draw-path.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.ui-draw-path.php" hreflang="zh">
...
<meta name="Description" content="Draw Path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: UI\Draw\Path - Manual" />
<meta name="twitter:description" content="Draw Path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: UI\Draw\Path - Manual" />
<meta itemprop="description" content="Draw Path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Draw Path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ui-draw-path.addrectangle.php">
          UI\Draw\Path::addRectangle &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ui-draw-pen.write.php">
          &laquo; UI\Draw\Pen::write        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.ui-draw-path.php' selected="selected">English</option>
            <option value='de/class.ui-draw-path.php'>German</option>
            <option value='es/class.ui-draw-path.php'>Spanish</option>
            <option value='fr/class.ui-draw-path.php'>French</option>
            <option value='it/class.ui-draw-path.php'>Italian</option>
            <option value='ja/class.ui-draw-path.php'>Japanese</option>
            <option value='pt_BR/class.ui-draw-path.php'>Brazilian Portuguese</option>
            <option value='ru/class.ui-draw-path.php'>Russian</option>
            <option value='tr/class.ui-draw-path.php'>Turkish</option>
            <option value='uk/class.ui-draw-path.php'>Ukrainian</option>
            <option value='zh/class.ui-draw-path.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.ui-draw-path" class="reference">
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="ui-draw-path.addrectangle.php">UI\Draw\Path::addRectangle</a> — Draw a Rectangle</li><li><a href="ui-draw-path.arcto.php">UI\Draw\Path::arcTo</a> — Draw an Arc</li><li><a href="ui-draw-path.bezierto.php">UI\Draw\Path::bezierTo</a> — Draw Bezier Curve</li><li><a href="ui-draw-path.closefigure.php">UI\Draw\Path::closeFigure</a> — Close Figure</li><li><a href="ui-draw-path.construct.php">UI\Draw\Path::__construct</a> — Construct a new Path</li><li><a href="ui-draw-path.end.php">UI\Draw\Path::end</a> — Finalize Path</li><li><a href="ui-draw-path.lineto.php">UI\Draw\Path::lineTo</a> — Draw a Line</li><li><a href="ui-draw-path.newfigure.php">UI\Draw\Path::newFigure</a> — Draw Figure</li><li><a href="ui-draw-path.newfigurewitharc.php">UI\Draw\Path::newFigureWithArc</a> — Draw Figure with Arc</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ui/ui.draw.path.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.ui-draw-path%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.ui-draw-path&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.ui-draw-path.php">＋<small>add a note</small></a></span>
