...
<head>
  ...
  <title>PHP: imagelayereffect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagelayereffect.php">
 <link rel="shorturl" href="https://www.php.net/imagelayereffect">
 <link rel="alternate" href="https://www.php.net/imagelayereffect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagejpeg.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imageline.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagelayereffect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagelayereffect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagelayereffect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagelayereffect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagelayereffect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagelayereffect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagelayereffect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagelayereffect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagelayereffect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagelayereffect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagelayereffect.php" hreflang="zh">
...
<meta name="Description" content="Set the alpha blending flag to use layering effects" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagelayereffect - Manual" />
<meta name="twitter:description" content="Set the alpha blending flag to use layering effects" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagelayereffect - Manual" />
<meta itemprop="description" content="Set the alpha blending flag to use layering effects" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the alpha blending flag to use layering effects" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imageline.php">
          imageline &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagejpeg.php">
          &laquo; imagejpeg        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagelayereffect.php' selected="selected">English</option>
            <option value='de/function.imagelayereffect.php'>German</option>
            <option value='es/function.imagelayereffect.php'>Spanish</option>
            <option value='fr/function.imagelayereffect.php'>French</option>
            <option value='it/function.imagelayereffect.php'>Italian</option>
            <option value='ja/function.imagelayereffect.php'>Japanese</option>
            <option value='pt_BR/function.imagelayereffect.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagelayereffect.php'>Russian</option>
            <option value='tr/function.imagelayereffect.php'>Turkish</option>
            <option value='uk/function.imagelayereffect.php'>Ukrainian</option>
            <option value='zh/function.imagelayereffect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagelayereffect" class="refentry">
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagelayereffect-examples">
  ...
  <div class="example" id="example-2918">
   <p><strong>Example #1 <span class="function"><strong>imagelayereffect()</strong></span> example</strong></p>
    ...
    <div class="mediaobject">
     ...
     <div class="imageobject">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagelayereffect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagelayereffect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagelayereffect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagelayereffect.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115787">  <div class="votes">
    <div id="Vu115787">
    <a href="/manual/vote-note.php?id=115787&amp;page=function.imagelayereffect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115787">
    <a href="/manual/vote-note.php?id=115787&amp;page=function.imagelayereffect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115787" title="50% like this...">
    0
    </div>
  </div>
  <a href="#115787" class="name">
  <strong class="user"><em>rx</em></strong></a><a class="genanchor" href="#115787"> &para;</a><div class="date" title="2014-09-23 12:15"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115787">
<div class="phpcode"><code><span class="html">IMG_EFFECT_OVERLAY doesn't work in PHP 5.6.0 with GD version: 2.1.0-alpha.</span></code></div>
  </div>
 </div>
  <div class="note" id="81349">  <div class="votes">
    <div id="Vu81349">
    <a href="/manual/vote-note.php?id=81349&amp;page=function.imagelayereffect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd81349">
    <a href="/manual/vote-note.php?id=81349&amp;page=function.imagelayereffect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V81349" title="50% like this...">
    0
    </div>
  </div>
  <a href="#81349" class="name">
  <strong class="user"><em>[myname] at mac dot com</em></strong></a><a class="genanchor" href="#81349"> &para;</a><div class="date" title="2008-02-23 11:45"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom81349">
<div class="phpcode"><code><span class="html">^^ my name is coreyward ^^<br /><br />imagelayereffect needs to be applied to the destination image, not the source image. As noted, the only useful "effect" as of this time is IMG_EFFECT_OVERLAY since the others are merely another way of setting the alpha blending flag. <br /><br />You can also use imagecopymerge with a lower pct argument to blend two images with more control over the opacity at which the top image is blended. <br /><br />&lt;?<br /><br />// overlays $im_src onto $im_dst properly (assuming same dims)<br /><br />imagelayereffect($im_dst, IMG_EFFECT_OVERLAY);<br />imagecopy($im_dst, $im_src, 0, 0, 0, 0, $im_dst_x, $im_dst_y);<br /><br />?&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="80871">  <div class="votes">
    <div id="Vu80871">
    <a href="/manual/vote-note.php?id=80871&amp;page=function.imagelayereffect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd80871">
    <a href="/manual/vote-note.php?id=80871&amp;page=function.imagelayereffect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V80871" title="50% like this...">
    0
    </div>
  </div>
  <a href="#80871" class="name">
  <strong class="user"><em>Remon</em></strong></a><a class="genanchor" href="#80871"> &para;</a><div class="date" title="2008-02-05 01:12"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80871">
<div class="phpcode"><code><span class="html">I found the following example on a Chinese site and translated and adjusted it. It creates a portrait from the sample picture.<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// Portrait image<br /></span><span class="default">$im </span><span class="keyword">= </span><span class="default">imagecreatefromjpeg</span><span class="keyword">( </span><span class="string">"sample.jpg"</span><span class="keyword">);<br /><br /></span><span class="comment">// Get width and height<br /></span><span class="default">$w </span><span class="keyword">= </span><span class="default">imagesx</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">); <br /></span><span class="default">$h </span><span class="keyword">= </span><span class="default">imagesy</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">);<br /><br /></span><span class="comment">// Non-through<br /></span><span class="default">$c_visible </span><span class="keyword">= </span><span class="default">0x007F7F7F</span><span class="keyword">;<br /></span><span class="comment">// Background (black) <br /></span><span class="default">$c_bg </span><span class="keyword">= </span><span class="default">0x00000000</span><span class="keyword">; <br /><br /></span><span class="comment">// Create mask<br /></span><span class="default">$im_mask </span><span class="keyword">= </span><span class="default">imagecreatetruecolor</span><span class="keyword">(</span><span class="default">$w</span><span class="keyword">,</span><span class="default">$h</span><span class="keyword">);<br /></span><span class="default">imageFilledRectangle</span><span class="keyword">(</span><span class="default">$im_mask</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">$w</span><span class="keyword">,</span><span class="default">$h</span><span class="keyword">, </span><span class="default">$c_bg</span><span class="keyword">); <br /></span><span class="default">imageFilledEllipse </span><span class="keyword">(</span><span class="default">$im_mask</span><span class="keyword">, </span><span class="default">$w</span><span class="keyword">/</span><span class="default">2</span><span class="keyword">,</span><span class="default">$h</span><span class="keyword">/</span><span class="default">2</span><span class="keyword">, </span><span class="default">$w</span><span class="keyword">*</span><span class="default">.9</span><span class="keyword">,</span><span class="default">$h</span><span class="keyword">*</span><span class="default">.9</span><span class="keyword">, </span><span class="default">$c_visible</span><span class="keyword">);<br /><br /></span><span class="comment">// Only overlay seems to something useful<br /></span><span class="default">imagelayereffect</span><span class="keyword">(</span><span class="default">$im_mask</span><span class="keyword">, </span><span class="default">IMG_EFFECT_OVERLAY</span><span class="keyword">);<br /><br /></span><span class="default">imagecopy</span><span class="keyword">(</span><span class="default">$im_mask</span><span class="keyword">, </span><span class="default">$im</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">$w</span><span class="keyword">,</span><span class="default">$h</span><span class="keyword">); <br /></span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">);<br /><br /></span><span class="default">imagepng</span><span class="keyword">(</span><span class="default">$im_mask</span><span class="keyword">);<br /></span><span class="default">imagedestroy</span><span class="keyword">(</span><span class="default">$im_mask</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />Try removing the 'create mask' code and just add another image with 'createimagefromjpeg' to see 'normal' overlay. It blends the colors like different layers in Photoshop.</span></code></div>
  </div>
 </div>
  <div class="note" id="86185">  <div class="votes">
    <div id="Vu86185">
    <a href="/manual/vote-note.php?id=86185&amp;page=function.imagelayereffect&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd86185">
    <a href="/manual/vote-note.php?id=86185&amp;page=function.imagelayereffect&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V86185" title="20% like this...">
    -3
    </div>
  </div>
  <a href="#86185" class="name">
  <strong class="user"><em>andrew at iwebsolutions dot co dot uk</em></strong></a><a class="genanchor" href="#86185"> &para;</a><div class="date" title="2008-10-07 03:38"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom86185">
<div class="phpcode"><code><span class="html">I have been getting a fatal error:<br /><br />Fatal error: Call to undefined function imagelayereffect()<br /><br />This doesn't work with Ubuntu server (8.04 lts) and the php5-gd package.  If you need this you will have to recompile PHP with GD built-in.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagelayereffect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagelayereffect.php">＋<small>add a note</small></a></div>
