...
<head>
  ...
  <title>PHP: DateObjectError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dateobjecterror.php">
 <link rel="shorturl" href="https://www.php.net/dateobjecterror">
 <link rel="alternate" href="https://www.php.net/dateobjecterror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.datetime.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dateerror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.daterangeerror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dateobjecterror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dateobjecterror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dateobjecterror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dateobjecterror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dateobjecterror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dateobjecterror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dateobjecterror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dateobjecterror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dateobjecterror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dateobjecterror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dateobjecterror.php" hreflang="zh">
...
<meta name="Description" content="The DateObjectError class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateObjectError - Manual" />
<meta name="twitter:description" content="The DateObjectError class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateObjectError - Manual" />
<meta itemprop="description" content="The DateObjectError class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateObjectError class" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dateobjecterror.php' selected="selected">English</option>
            <option value='de/class.dateobjecterror.php'>German</option>
            <option value='es/class.dateobjecterror.php'>Spanish</option>
            <option value='fr/class.dateobjecterror.php'>French</option>
            <option value='it/class.dateobjecterror.php'>Italian</option>
            <option value='ja/class.dateobjecterror.php'>Japanese</option>
            <option value='pt_BR/class.dateobjecterror.php'>Brazilian Portuguese</option>
            <option value='ru/class.dateobjecterror.php'>Russian</option>
            <option value='tr/class.dateobjecterror.php'>Turkish</option>
            <option value='uk/class.dateobjecterror.php'>Ukrainian</option>
            <option value='zh/class.dateobjecterror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dateobjecterror" class="reference">
 <h1 class="title">The DateObjectError class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.3.0)</p>


  <div class="section" id="dateobjecterror.intro">
  ...
  <div class="section" id="dateobjecterror.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">DateObjectError</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
  ...
  <div class="section">
   ...
   <ul class="simplelist">
    ...
    <li><span class="exceptionname"><a href="class.daterangeerror.php" class="exceptionname">DateRangeError</a></span></li>
   </ul>
  </div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/dateobjecterror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dateobjecterror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dateobjecterror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dateobjecterror.php">＋<small>add a note</small></a></span>
