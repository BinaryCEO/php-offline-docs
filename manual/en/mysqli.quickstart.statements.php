...
<head>
  ...
  <title>PHP: Executing statements - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.quickstart.statements.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.quickstart.statements.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.quickstart.statements.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mysqli.quickstart.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.quickstart.connections.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.quickstart.prepared-statements.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.quickstart.statements.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.quickstart.statements.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.quickstart.statements.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.quickstart.statements.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.quickstart.statements.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.quickstart.statements.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.quickstart.statements.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.quickstart.statements.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.quickstart.statements.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.quickstart.statements.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.quickstart.statements.php" hreflang="zh">
...
<meta name="Description" content="Executing statements" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Executing statements - Manual" />
<meta name="twitter:description" content="Executing statements" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Executing statements - Manual" />
<meta itemprop="description" content="Executing statements" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Executing statements" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.quickstart.statements.php' selected="selected">English</option>
            <option value='de/mysqli.quickstart.statements.php'>German</option>
            <option value='es/mysqli.quickstart.statements.php'>Spanish</option>
            <option value='fr/mysqli.quickstart.statements.php'>French</option>
            <option value='it/mysqli.quickstart.statements.php'>Italian</option>
            <option value='ja/mysqli.quickstart.statements.php'>Japanese</option>
            <option value='pt_BR/mysqli.quickstart.statements.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.quickstart.statements.php'>Russian</option>
            <option value='tr/mysqli.quickstart.statements.php'>Turkish</option>
            <option value='uk/mysqli.quickstart.statements.php'>Ukrainian</option>
            <option value='zh/mysqli.quickstart.statements.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.quickstart.statements" class="section">
  <h2 class="title">Executing statements</h2>
  <p class="para">
   Statements can be executed with the
   <span class="methodname"><a href="mysqli.query.php" class="methodname">mysqli::query()</a></span>, <span class="methodname"><a href="mysqli.real-query.php" class="methodname">mysqli::real_query()</a></span>
   and <span class="methodname"><a href="mysqli.multi-query.php" class="methodname">mysqli::multi_query()</a></span>.
   The <span class="methodname"><a href="mysqli.query.php" class="methodname">mysqli::query()</a></span> function is the most
   common, and combines the executing statement with a
   buffered fetch of its result set, if any, in one call.
   Calling <span class="methodname"><a href="mysqli.query.php" class="methodname">mysqli::query()</a></span> is identical to
   calling <span class="methodname"><a href="mysqli.real-query.php" class="methodname">mysqli::real_query()</a></span>
   followed by <span class="methodname"><a href="mysqli.store-result.php" class="methodname">mysqli::store_result()</a></span>.
  </p>
  <p class="para">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />mysqli_report</span><span style="color: #007700">(</span><span style="color: #0000BB">MYSQLI_REPORT_ERROR </span><span style="color: #007700">| </span><span style="color: #0000BB">MYSQLI_REPORT_STRICT</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$mysqli </span><span style="color: #007700">= new </span><span style="color: #0000BB">mysqli</span><span style="color: #007700">(</span><span style="color: #DD0000">"example.com"</span><span style="color: #007700">, </span><span style="color: #DD0000">"user"</span><span style="color: #007700">, </span><span style="color: #DD0000">"password"</span><span style="color: #007700">, </span><span style="color: #DD0000">"database"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">query</span><span style="color: #007700">(</span><span style="color: #DD0000">"DROP TABLE IF EXISTS test"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">query</span><span style="color: #007700">(</span><span style="color: #DD0000">"CREATE TABLE test(id INT)"</span><span style="color: #007700">);</span></span></code></div>
  ...
  <p class="para">
   ...
   result sets. <span class="methodname"><a href="mysqli.query.php" class="methodname">mysqli::query()</a></span> combines statement
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">real_query</span><span style="color: #007700">(</span><span style="color: #DD0000">"SELECT id FROM test ORDER BY id ASC"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">$mysqli</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">use_result</span><span style="color: #007700">();<br /><br />echo </span><span style="color: #DD0000">"Result set order...\n"</span><span style="color: #007700">;<br />foreach (</span><span style="color: #0000BB">$result </span><span style="color: #007700">as </span><span style="color: #0000BB">$row</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">" id = " </span><span style="color: #007700">. </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #DD0000">'id'</span><span style="color: #007700">] . </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">;<br />}</span></span></code></div>
  ...
  <p class="para">
   The <span class="methodname"><a href="mysqli.query.php" class="methodname">mysqli::query()</a></span>, <span class="methodname"><a href="mysqli.real-query.php" class="methodname">mysqli::real_query()</a></span>
   and <span class="methodname"><a href="mysqli.multi-query.php" class="methodname">mysqli::multi_query()</a></span> functions are used to execute
...
label = a (string)
  ...
  <p class="para">
   ...
   <strong><code><a href="mysqli.constants.php#constant.mysqli-opt-int-and-float-native">MYSQLI_OPT_INT_AND_FLOAT_NATIVE</a></code></strong> connection option,
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="mysqli.store-result.php" class="methodname">mysqli::store_result()</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.quickstart.statements%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.quickstart.statements&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.quickstart.statements.php">＋<small>add a note</small></a></span>
