...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-train.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-test-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-train-epoch.php">
...
<meta name="Description" content="Train one iteration with a set of inputs, and a set of desired outputs" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_train - Manual" />
<meta name="twitter:description" content="Train one iteration with a set of inputs, and a set of desired outputs" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_train - Manual" />
<meta itemprop="description" content="Train one iteration with a set of inputs, and a set of desired outputs" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Train one iteration with a set of inputs, and a set of desired outputs" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-train.php' selected="selected">English</option>
            <option value='de/function.fann-train.php'>German</option>
            <option value='es/function.fann-train.php'>Spanish</option>
            <option value='fr/function.fann-train.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_train</span> &mdash; <span class="dc-title">Train one iteration with a set of inputs, and a set of desired outputs</span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-get-num-output.php" class="function" rel="rdfs-seeAlso">fann_get_num_output()</a> - Get the number of output neurons</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-train.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-train%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-train&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-train.php">＋<small>add a note</small></a></span>
