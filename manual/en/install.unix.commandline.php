...
<head>
  ...
  <title>PHP: CGI and command line setups - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/install.unix.commandline.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/install.unix.commandline.php">
 <link rel="alternate" href="https://www.php.net/manual/en/install.unix.commandline.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/install.unix.php">
 <link rel="prev" href="https://www.php.net/manual/en/install.unix.source.php">
 <link rel="next" href="https://www.php.net/manual/en/install.unix.apache2.php">

 <link rel="alternate" href="https://www.php.net/manual/en/install.unix.commandline.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/install.unix.commandline.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/install.unix.commandline.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/install.unix.commandline.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/install.unix.commandline.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/install.unix.commandline.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/install.unix.commandline.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/install.unix.commandline.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/install.unix.commandline.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/install.unix.commandline.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/install.unix.commandline.php" hreflang="zh">
...
<meta name="Description" content="CGI and command line setups" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CGI and command line setups - Manual" />
<meta name="twitter:description" content="CGI and command line setups" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CGI and command line setups - Manual" />
<meta itemprop="description" content="CGI and command line setups" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="CGI and command line setups" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="install.unix.apache2.php">
          Apache 2.x on Unix systems &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="install.unix.source.php">
          &laquo; Installing from source on Unix and macOS systems        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/install.unix.commandline.php' selected="selected">English</option>
            <option value='de/install.unix.commandline.php'>German</option>
            <option value='es/install.unix.commandline.php'>Spanish</option>
            <option value='fr/install.unix.commandline.php'>French</option>
            <option value='it/install.unix.commandline.php'>Italian</option>
            <option value='ja/install.unix.commandline.php'>Japanese</option>
            <option value='pt_BR/install.unix.commandline.php'>Brazilian Portuguese</option>
            <option value='ru/install.unix.commandline.php'>Russian</option>
            <option value='tr/install.unix.commandline.php'>Turkish</option>
            <option value='uk/install.unix.commandline.php'>Ukrainian</option>
            <option value='zh/install.unix.commandline.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="install.unix.commandline" class="sect1">
   ...
   <div class="sect2" id="install.unix.commandline.using-variables">
    ...
    <p class="simpara">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/install/unix/commandline.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Finstall.unix.commandline%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=install.unix.commandline&amp;repo=en&amp;redirect=https://www.php.net/manual/en/install.unix.commandline.php">＋<small>add a note</small></a></span>
