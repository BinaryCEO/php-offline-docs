...
<head>
  ...
  <title>PHP: stream_bucket_new - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-bucket-new.php">
 <link rel="shorturl" href="https://www.php.net/stream-bucket-new">
 <link rel="alternate" href="https://www.php.net/stream-bucket-new" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-bucket-make-writeable.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-bucket-prepend.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-bucket-new.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-bucket-new.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-bucket-new.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-bucket-new.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-bucket-new.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-bucket-new.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-bucket-new.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-bucket-new.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-bucket-new.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-bucket-new.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-bucket-new.php" hreflang="zh">
...
<meta name="Description" content="Create a new bucket for use on the current stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_bucket_new - Manual" />
<meta name="twitter:description" content="Create a new bucket for use on the current stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_bucket_new - Manual" />
<meta itemprop="description" content="Create a new bucket for use on the current stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create a new bucket for use on the current stream" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-bucket-prepend.php">
          stream_bucket_prepend &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-bucket-make-writeable.php">
          &laquo; stream_bucket_make_writeable        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-bucket-new.php' selected="selected">English</option>
            <option value='de/function.stream-bucket-new.php'>German</option>
            <option value='es/function.stream-bucket-new.php'>Spanish</option>
            <option value='fr/function.stream-bucket-new.php'>French</option>
            <option value='it/function.stream-bucket-new.php'>Italian</option>
            <option value='ja/function.stream-bucket-new.php'>Japanese</option>
            <option value='pt_BR/function.stream-bucket-new.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-bucket-new.php'>Russian</option>
            <option value='tr/function.stream-bucket-new.php'>Turkish</option>
            <option value='uk/function.stream-bucket-new.php'>Ukrainian</option>
            <option value='zh/function.stream-bucket-new.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-bucket-new" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_bucket_new</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_bucket_new</span> &mdash; <span class="dc-title">
   Create a new bucket for use on the current stream
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stream-bucket-new-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_bucket_new</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stream</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$buffer</code></span>): <span class="type">StreamBucket</span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 changelog" id="refsect1-function.stream-bucket-new-changelog">
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-bucket-new.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-bucket-new%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-bucket-new&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-bucket-new.php">＋<small>add a note</small></a></span>
