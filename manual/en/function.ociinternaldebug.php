...
<head>
  ...
  <title>PHP: ociinternaldebug - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ociinternaldebug.php">
 <link rel="shorturl" href="https://www.php.net/ociinternaldebug">
 <link rel="alternate" href="https://www.php.net/ociinternaldebug" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocifreestatement.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ociloadlob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ociinternaldebug.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ociinternaldebug.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ociinternaldebug.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ociinternaldebug.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ociinternaldebug.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ociinternaldebug.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ociinternaldebug.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ociinternaldebug.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ociinternaldebug.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ociinternaldebug.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ociinternaldebug.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_internal_debug" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ociinternaldebug - Manual" />
<meta name="twitter:description" content="Alias of oci_internal_debug" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ociinternaldebug - Manual" />
<meta itemprop="description" content="Alias of oci_internal_debug" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_internal_debug" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ociloadlob.php">
          ociloadlob &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ocifreestatement.php">
          &laquo; ocifreestatement        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ociinternaldebug.php' selected="selected">English</option>
            <option value='de/function.ociinternaldebug.php'>German</option>
            <option value='es/function.ociinternaldebug.php'>Spanish</option>
            <option value='fr/function.ociinternaldebug.php'>French</option>
            <option value='it/function.ociinternaldebug.php'>Italian</option>
            <option value='ja/function.ociinternaldebug.php'>Japanese</option>
            <option value='pt_BR/function.ociinternaldebug.php'>Brazilian Portuguese</option>
            <option value='ru/function.ociinternaldebug.php'>Russian</option>
            <option value='tr/function.ociinternaldebug.php'>Turkish</option>
            <option value='uk/function.ociinternaldebug.php'>Ukrainian</option>
            <option value='zh/function.ociinternaldebug.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ociinternaldebug" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ociinternaldebug</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PECL OCI8 &gt;= 1.0.0, PECL OCI8 &lt;= 2.2.0)</p><p class="refpurpose"><span class="refname">ociinternaldebug</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-internal-debug.php" class="function">oci_internal_debug()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ociinternaldebug-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-internal-debug.php" class="function">oci_internal_debug()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ociinternaldebug.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ociinternaldebug%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ociinternaldebug&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ociinternaldebug.php">＋<small>add a note</small></a></span>
