...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.types.resource.php">
 <link rel="shorturl" href="https://www.php.net/types.resource">
 <link rel="alternate" href="https://www.php.net/types.resource" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.types.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.types.enumerations.php">
 <link rel="next" href="https://www.php.net/manual/en/language.types.callable.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.types.resource.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.types.resource.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.types.resource.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.types.resource.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.types.resource.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.types.resource.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.types.resource.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.types.resource.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.types.resource.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.types.resource.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.types.resource.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Resources - Manual" />
<meta name="twitter:description" content="Resources" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Resources - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.types.resource.php' selected="selected">English</option>
            ...
            <option value='it/language.types.resource.php'>Italian</option>
            ...
            <option value='uk/language.types.resource.php'>Ukrainian</option>
  ...
  </div><div id="language.types.resource" class="sect1">
 ...
 <div class="sect2" id="language.types.resource.casting">
  ...
  <p class="para">
   As <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> variables hold special handles to opened files,
 ...
 <div class="sect2" id="language.types.resource.self-destruct">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <span class="simpara">
    ...
    <em>not</em> destroyed by the garbage collector. See the
    ...
    connections</a> section for more information.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/types/resource.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.types.resource%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types.resource&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.types.resource.php">＋<small>add a note</small></a></span>
