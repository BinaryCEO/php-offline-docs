...
<head>
  ...
  <title>PHP: Imagick::vignetteImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.vignetteimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.vignetteimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.vignetteimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.waveimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.vignetteimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.vignetteimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.vignetteimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.vignetteimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.vignetteimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.vignetteimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.vignetteimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.vignetteimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.vignetteimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.vignetteimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.vignetteimage.php" hreflang="zh">
...
<meta name="Description" content="Adds vignette filter to the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::vignetteImage - Manual" />
<meta name="twitter:description" content="Adds vignette filter to the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::vignetteImage - Manual" />
<meta itemprop="description" content="Adds vignette filter to the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds vignette filter to the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.waveimage.php">
          Imagick::waveImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.valid.php">
          &laquo; Imagick::valid        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.vignetteimage.php' selected="selected">English</option>
            <option value='de/imagick.vignetteimage.php'>German</option>
            <option value='es/imagick.vignetteimage.php'>Spanish</option>
            <option value='fr/imagick.vignetteimage.php'>French</option>
            <option value='it/imagick.vignetteimage.php'>Italian</option>
            <option value='ja/imagick.vignetteimage.php'>Japanese</option>
            <option value='pt_BR/imagick.vignetteimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.vignetteimage.php'>Russian</option>
            <option value='tr/imagick.vignetteimage.php'>Turkish</option>
            <option value='uk/imagick.vignetteimage.php'>Ukrainian</option>
            <option value='zh/imagick.vignetteimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.vignetteimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::vignetteImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::vignetteImage</span> &mdash; <span class="dc-title">Adds vignette filter to the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.vignetteimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::vignetteImage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$blackPoint</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$whitePoint</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.vignetteimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.vignetteimage-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.vignetteimage-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-3142">
      <p><strong>Example #1  <span class="function"><strong>Imagick::vignetteImage()</strong></span></strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.vignetteimage-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.waveimage.php" class="function" rel="rdfs-seeAlso">Imagick::waveImage()</a> - Applies wave filter to the image</span></li>
    <li><span class="function"><a href="imagick.swirlimage.php" class="function" rel="rdfs-seeAlso">Imagick::swirlImage()</a> - Swirls the pixels about the center of the image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/vignetteimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.vignetteimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.vignetteimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.vignetteimage.php">＋<small>add a note</small></a></span>
