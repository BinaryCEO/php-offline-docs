...
<head>
  ...
  <title>PHP: svn_revert - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-revert.php">
 <link rel="shorturl" href="https://www.php.net/svn-revert">
 <link rel="alternate" href="https://www.php.net/svn-revert" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-repos-recover.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-status.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-revert.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-revert.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-revert.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-revert.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-revert.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-revert.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-revert.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-revert.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-revert.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-revert.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-revert.php" hreflang="zh">
...
<meta name="Description" content="Revert changes to the working copy" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_revert - Manual" />
<meta name="twitter:description" content="Revert changes to the working copy" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_revert - Manual" />
<meta itemprop="description" content="Revert changes to the working copy" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Revert changes to the working copy" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-revert.php' selected="selected">English</option>
            <option value='de/function.svn-revert.php'>German</option>
            <option value='es/function.svn-revert.php'>Spanish</option>
            <option value='fr/function.svn-revert.php'>French</option>
            <option value='it/function.svn-revert.php'>Italian</option>
            <option value='ja/function.svn-revert.php'>Japanese</option>
            <option value='pt_BR/function.svn-revert.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-revert.php'>Russian</option>
            <option value='tr/function.svn-revert.php'>Turkish</option>
            <option value='uk/function.svn-revert.php'>Ukrainian</option>
            <option value='zh/function.svn-revert.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-revert" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.svn-export.php" class="function" rel="rdfs-seeAlso">svn_export()</a> - Export the contents of a SVN directory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-revert.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-revert%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-revert&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-revert.php">＋<small>add a note</small></a></span>
