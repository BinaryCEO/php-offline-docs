...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagebordercolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagebordercolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagebordercolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageblueprimary.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagechanneldepth.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagebordercolor.php' selected="selected">English</option>
            ...
            <option value='pt_BR/gmagick.getimagebordercolor.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagebordercolor</span> &mdash; <span class="dc-title">Returns the image border color</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagebordercolor-returnvalues">
  ...
  <p class="para">
   <span class="classname"><a href="class.gmagickpixel.php" class="classname">GmagickPixel</a></span> object representing the color of the border.
  </p>
 </div>
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagebordercolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagebordercolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagebordercolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagebordercolor.php">＋<small>add a note</small></a></span>
