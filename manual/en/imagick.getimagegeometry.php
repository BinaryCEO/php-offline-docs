...
(
 ...
 <div class="head">
  ...
  <strong class="user"><em>tim at provu dot co dot uk</em></strong></a><a class="genanchor" href="#87128"> &para;</a><div class="date" title="2008-11-20 07:05"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87128">
<div class="phpcode"><code><span class="html">Example code:
<br />
<br /><span class="default">&lt;?php
<br />$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">(</span><span class="default">$filename</span><span class="keyword">);
<br />
<br /></span><span class="default">$geo</span><span class="keyword">=</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageGeometry</span><span class="keyword">();
<br /> 
<br /></span><span class="default">$sizex</span><span class="keyword">=</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'width'</span><span class="keyword">];
<br /></span><span class="default">$sizey</span><span class="keyword">=</span><span class="default">$geo</span><span class="keyword">[</span><span class="string">'height'</span><span class="keyword">];
