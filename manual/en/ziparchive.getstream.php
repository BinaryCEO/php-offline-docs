...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.getstream.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.getstream.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getstream.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.getstatusstring.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.getstreamindex.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.getstream.php' selected="selected">English</option>
            <option value='de/ziparchive.getstream.php'>German</option>
            <option value='es/ziparchive.getstream.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8, PECL zip &gt;= 1.1.0)</p><p class="refpurpose"><span class="refname">ZipArchive::getStream</span> &mdash; <span class="dc-title">Get a file handler to the entry defined by its name (read only)</span></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$contents </span><span style="color: #007700">= </span><span style="color: #DD0000">''</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$z </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">();<br />if (</span><span style="color: #0000BB">$z</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #DD0000">'test.zip'</span><span style="color: #007700">)) {<br />    </span><span style="color: #0000BB">$fp </span><span style="color: #007700">= </span><span style="color: #0000BB">$z</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getStream</span><span style="color: #007700">(</span><span style="color: #DD0000">'test'</span><span style="color: #007700">);<br />    if(!</span><span style="color: #0000BB">$fp</span><span style="color: #007700">) exit(</span><span style="color: #DD0000">"failed\n"</span><span style="color: #007700">);<br /><br />    while (!</span><span style="color: #0000BB">feof</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">)) {<br />        </span><span style="color: #0000BB">$contents </span><span style="color: #007700">.= </span><span style="color: #0000BB">fread</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">, </span><span style="color: #0000BB">2</span><span style="color: #007700">);<br />    }<br /><br />    </span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$fp</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">file_put_contents</span><span style="color: #007700">(</span><span style="color: #DD0000">'t'</span><span style="color: #007700">,</span><span style="color: #0000BB">$contents</span><span style="color: #007700">);<br />    echo </span><span style="color: #DD0000">"done.\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example" id="example-933">
     <p><strong>Example #2 Same as the previous example but with <span class="function"><a href="function.fopen.php" class="function">fopen()</a></span> and the zip
 ...
 <div class="refsect1 seealso" id="refsect1-ziparchive.getstream-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><a href="wrappers.compression.php" class="link">Compression Streams</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/getstream.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.getstream%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.getstream&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getstream.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Here a way to handle specific files from a zip archive without full extract :<br /><br /><span class="default">&lt;?php<br /><br />$zip_file </span><span class="keyword">= </span><span class="string">'/path/to/file.zip'</span><span class="keyword">; </span><span class="comment">// I wan to get stream a CSV files<br /><br /></span><span class="default">$zip </span><span class="keyword">= new </span><span class="default">ZipArchive</span><span class="keyword">();<br /></span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">open</span><span class="keyword">(</span><span class="default">$zip_file</span><span class="keyword">);<br />for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">numFiles</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) { </span><span class="comment">// Check file by file<br />    </span><span class="default">$name </span><span class="keyword">= </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">getNameIndex</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">); </span><span class="comment">// Retrieve entry name<br />    </span><span class="default">$extension </span><span class="keyword">= </span><span class="default">pathinfo</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">PATHINFO_EXTENSION</span><span class="keyword">);<br />    if (</span><span class="default">$extension </span><span class="keyword">=== </span><span class="string">'csv'</span><span class="keyword">) { </span><span class="comment">// I want to handle csv files<br />        </span><span class="default">$stream </span><span class="keyword">= </span><span class="default">$zip</span><span class="keyword">-&gt;</span><span class="default">getStream</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">); </span><span class="comment">// No stream index access before PHP 8.2<br />        // Starting PHP 8.2 $zip-&gt;getStreamIndex() or $zip-&gt;getStreamName()<br />        // Do stuff with $stream<br />        // ...<br />    </span><span class="keyword">}<br />}</span></span></code></div>
  </div>
 </div>
  <div class="note" id="126872">  <div class="votes">
    ...
    <div class="tally" id="V126872" title="no votes...">
    0
    </div>
  </div>
...
<div class="phpcode"><code><span class="html">Keep in mind that this stream is not rewindable/seekable.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ziparchive.getstream&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getstream.php">＋<small>add a note</small></a></div>
