...
<head>
  ...
  <title>PHP: imagecolorallocatealpha - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagecolorallocatealpha.php">
 <link rel="shorturl" href="https://www.php.net/imagecolorallocatealpha">
 <link rel="alternate" href="https://www.php.net/imagecolorallocatealpha" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagecolorallocate.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagecolorat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagecolorallocatealpha.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagecolorallocatealpha.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagecolorallocatealpha.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagecolorallocatealpha.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagecolorallocatealpha.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagecolorallocatealpha.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagecolorallocatealpha.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagecolorallocatealpha.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagecolorallocatealpha.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagecolorallocatealpha.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagecolorallocatealpha.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: imagecolorallocatealpha - Manual" />
<meta name="twitter:description" content="Allocate a color for an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagecolorallocatealpha - Manual" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imagecolorat.php">
          imagecolorat &raquo;
              ...
              <div class="prev">
        <a href="function.imagecolorallocate.php">
          &laquo; imagecolorallocate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagecolorallocatealpha.php' selected="selected">English</option>
            <option value='de/function.imagecolorallocatealpha.php'>German</option>
            <option value='es/function.imagecolorallocatealpha.php'>Spanish</option>
            <option value='fr/function.imagecolorallocatealpha.php'>French</option>
            <option value='it/function.imagecolorallocatealpha.php'>Italian</option>
            <option value='ja/function.imagecolorallocatealpha.php'>Japanese</option>
            <option value='pt_BR/function.imagecolorallocatealpha.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagecolorallocatealpha.php'>Russian</option>
            <option value='tr/function.imagecolorallocatealpha.php'>Turkish</option>
            <option value='uk/function.imagecolorallocatealpha.php'>Ukrainian</option>
            <option value='zh/function.imagecolorallocatealpha.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagecolorallocatealpha" class="refentry">
...
function.</p></div>
 ...
 <div class="refsect1 examples" id="refsect1-function.imagecolorallocatealpha-examples">
  ...
  <div class="example" id="example-2838">
   <p><strong>Example #1 Example of using <span class="function"><strong>imagecolorallocatealpha()</strong></span></strong></p>
...
something similar to:</p></div>
  ...
  <div class="example" id="imagecolorallocatealpha.example.convert">
   <p><strong>Example #2 Convert typical alpha values for use with <span class="function"><strong>imagecolorallocatealpha()</strong></span></strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.imagecolordeallocate.php" class="function" rel="rdfs-seeAlso">imagecolordeallocate()</a> - De-allocate a color for an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagecolorallocatealpha.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagecolorallocatealpha%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagecolorallocatealpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorallocatealpha.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="61081">  <div class="votes">
    <div id="Vu61081">
    <a href="/manual/vote-note.php?id=61081&amp;page=function.imagecolorallocatealpha&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd61081">
    <a href="/manual/vote-note.php?id=61081&amp;page=function.imagecolorallocatealpha&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V61081" title="71% like this...">
    6
    </div>
  </div>
  <a href="#61081" class="name">
  <strong class="user"><em>eric (at) junioronline.us</em></strong></a><a class="genanchor" href="#61081"> &para;</a><div class="date" title="2006-01-25 01:41"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom61081">
<div class="phpcode"><code><span class="html">If you only wish to extract the alpha value for a color, you can simply extract it like so:<br /><br /><span class="default">&lt;?php<br /><br />    $color </span><span class="keyword">= </span><span class="default">imagecolorat</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">, </span><span class="default">50</span><span class="keyword">, </span><span class="default">50</span><span class="keyword">);<br />    </span><span class="default">$alpha </span><span class="keyword">= </span><span class="default">$color </span><span class="keyword">&gt;&gt; </span><span class="default">24</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;<br /></span><br />It actually shifts off the first 24 bits (where 8x3 are used for each color), and returns the remaining 7 allocated bits (commonly used for alpha)</span></code></div>
  </div>
 </div>
  <div class="note" id="118038">  <div class="votes">
    <div id="Vu118038">
    <a href="/manual/vote-note.php?id=118038&amp;page=function.imagecolorallocatealpha&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118038">
    <a href="/manual/vote-note.php?id=118038&amp;page=function.imagecolorallocatealpha&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118038" title="75% like this...">
    4
    </div>
  </div>
  <a href="#118038" class="name">
  <strong class="user"><em>Brett G</em></strong></a><a class="genanchor" href="#118038"> &para;</a><div class="date" title="2015-09-22 10:30"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom118038">
<div class="phpcode"><code><span class="html">When working with transparency, avoid imagecreate() and use imagecreatetruecolor() instead. Transparency effects may not work as expected within a palette-based image.</span></code></div>
  </div>
 </div>
  <div class="note" id="79486">  <div class="votes">
    <div id="Vu79486">
    <a href="/manual/vote-note.php?id=79486&amp;page=function.imagecolorallocatealpha&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79486">
    <a href="/manual/vote-note.php?id=79486&amp;page=function.imagecolorallocatealpha&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79486" title="60% like this...">
    2
    </div>
  </div>
  <a href="#79486" class="name">
  <strong class="user"><em>fjoggen at gmail dot com</em></strong></a><a class="genanchor" href="#79486"> &para;</a><div class="date" title="2007-11-29 07:19"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79486">
<div class="phpcode"><code><span class="html">If you need to calculate the integer representation of a color with an alpha channel, without initialising an image and using the imagecolorallocatealpha function. Then this function might be of some help:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">alphaColor</span><span class="keyword">(</span><span class="default">$hexColor</span><span class="keyword">,</span><span class="default">$alpha</span><span class="keyword">)<br />{<br />        return </span><span class="default">bindec</span><span class="keyword">(</span><span class="default">decbin</span><span class="keyword">(</span><span class="default">$alpha</span><span class="keyword">).</span><span class="default">decbin</span><span class="keyword">(</span><span class="default">hexdec</span><span class="keyword">(</span><span class="default">$hexColor</span><span class="keyword">));<br />}<br /><br />echo </span><span class="default">alphaColor</span><span class="keyword">(</span><span class="string">"FFFFFF"</span><span class="keyword">,</span><span class="default">127</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagecolorallocatealpha&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagecolorallocatealpha.php">＋<small>add a note</small></a></div>
