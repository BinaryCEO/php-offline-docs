...
<head>
  ...
  <title>PHP: FFI::string - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ffi.string.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ffi.string.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ffi.string.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ffi.php">
 <link rel="prev" href="https://www.php.net/manual/en/ffi.sizeof.php">
 <link rel="next" href="https://www.php.net/manual/en/ffi.type.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ffi.string.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ffi.string.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ffi.string.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ffi.string.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ffi.string.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ffi.string.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ffi.string.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ffi.string.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ffi.string.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ffi.string.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ffi.string.php" hreflang="zh">
...
<meta name="Description" content="Creates a PHP string from a memory area" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: FFI::string - Manual" />
<meta name="twitter:description" content="Creates a PHP string from a memory area" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: FFI::string - Manual" />
<meta itemprop="description" content="Creates a PHP string from a memory area" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creates a PHP string from a memory area" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ffi.string.php' selected="selected">English</option>
            <option value='de/ffi.string.php'>German</option>
            <option value='es/ffi.string.php'>Spanish</option>
            <option value='fr/ffi.string.php'>French</option>
            <option value='it/ffi.string.php'>Italian</option>
            <option value='ja/ffi.string.php'>Japanese</option>
            <option value='pt_BR/ffi.string.php'>Brazilian Portuguese</option>
            <option value='ru/ffi.string.php'>Russian</option>
            <option value='tr/ffi.string.php'>Turkish</option>
            <option value='uk/ffi.string.php'>Ukrainian</option>
            <option value='zh/ffi.string.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ffi.string" class="refentry">
    ...
    <tbody class="tbody">
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ffi/ffi/string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fffi.string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ffi.string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ffi.string.php">＋<small>add a note</small></a></span>
