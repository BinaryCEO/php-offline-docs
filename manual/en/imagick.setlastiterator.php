...
<head>
  ...
  <title>PHP: Imagick::setLastIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setlastiterator.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setlastiterator.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setlastiterator.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setiteratorindex.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setoption.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setlastiterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setlastiterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setlastiterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setlastiterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setlastiterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setlastiterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setlastiterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setlastiterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setlastiterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setlastiterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setlastiterator.php" hreflang="zh">
...
<meta name="Description" content="Sets the Imagick iterator to the last image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setLastIterator - Manual" />
<meta name="twitter:description" content="Sets the Imagick iterator to the last image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setLastIterator - Manual" />
<meta itemprop="description" content="Sets the Imagick iterator to the last image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the Imagick iterator to the last image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setoption.php">
          Imagick::setOption &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setiteratorindex.php">
          &laquo; Imagick::setIteratorIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setlastiterator.php' selected="selected">English</option>
            <option value='de/imagick.setlastiterator.php'>German</option>
            <option value='es/imagick.setlastiterator.php'>Spanish</option>
            <option value='fr/imagick.setlastiterator.php'>French</option>
            <option value='it/imagick.setlastiterator.php'>Italian</option>
            <option value='ja/imagick.setlastiterator.php'>Japanese</option>
            <option value='pt_BR/imagick.setlastiterator.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setlastiterator.php'>Russian</option>
            <option value='tr/imagick.setlastiterator.php'>Turkish</option>
            <option value='uk/imagick.setlastiterator.php'>Ukrainian</option>
            <option value='zh/imagick.setlastiterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setlastiterator" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setLastIterator</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.0.1, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setLastIterator</span> &mdash; <span class="dc-title">Sets the Imagick iterator to the last image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setlastiterator-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setLastIterator</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setlastiterator-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.setlastiterator-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setlastiterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setlastiterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setlastiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setlastiterator.php">＋<small>add a note</small></a></span>
