...
<head>
  ...
  <title>PHP: Installing from source on Unix and macOS systems - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/install.unix.source.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/install.unix.source.php">
 <link rel="alternate" href="https://www.php.net/manual/en/install.unix.source.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/install.unix.php">
 <link rel="prev" href="https://www.php.net/manual/en/install.unix.openbsd.php">
 <link rel="next" href="https://www.php.net/manual/en/install.unix.commandline.php">

 <link rel="alternate" href="https://www.php.net/manual/en/install.unix.source.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/install.unix.source.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/install.unix.source.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/install.unix.source.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/install.unix.source.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/install.unix.source.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/install.unix.source.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/install.unix.source.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/install.unix.source.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/install.unix.source.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/install.unix.source.php" hreflang="zh">
...
<meta name="Description" content="Installing from source on Unix and macOS systems" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Installing from source on Unix and macOS systems - Manual" />
<meta name="twitter:description" content="Installing from source on Unix and macOS systems" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Installing from source on Unix and macOS systems - Manual" />
<meta itemprop="description" content="Installing from source on Unix and macOS systems" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Installing from source on Unix and macOS systems" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="install.unix.commandline.php">
          CGI and command line setups &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="install.unix.openbsd.php">
          &laquo; Installing from packages or ports on OpenBSD        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/install.unix.source.php' selected="selected">English</option>
            <option value='de/install.unix.source.php'>German</option>
            <option value='es/install.unix.source.php'>Spanish</option>
            <option value='fr/install.unix.source.php'>French</option>
            <option value='it/install.unix.source.php'>Italian</option>
            <option value='ja/install.unix.source.php'>Japanese</option>
            <option value='pt_BR/install.unix.source.php'>Brazilian Portuguese</option>
            <option value='ru/install.unix.source.php'>Russian</option>
            <option value='tr/install.unix.source.php'>Turkish</option>
            <option value='uk/install.unix.source.php'>Ukrainian</option>
            <option value='zh/install.unix.source.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="install.unix.source" class="sect1">
  ...
  <span class="simpara">
   Cross-compiling for ARM with the Android toolchain is currently not supported.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/install/unix/source.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Finstall.unix.source%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=install.unix.source&amp;repo=en&amp;redirect=https://www.php.net/manual/en/install.unix.source.php">＋<small>add a note</small></a></span>
