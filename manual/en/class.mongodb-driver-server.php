...
<head>
  ...
  <title>PHP: MongoDB\Driver\Server - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-driver-server.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-driver-server">
 <link rel="alternate" href="https://www.php.net/mongodb-driver-server" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.mongodb.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-driver-cursorinterface.toarray.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-driver-server.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-driver-server.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-driver-server.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-driver-server.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-driver-server.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-driver-server.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-driver-server.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-driver-server.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-driver-server.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-driver-server.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-driver-server.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-driver-server.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\Driver\Server class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\Driver\Server - Manual" />
<meta name="twitter:description" content="The MongoDB\Driver\Server class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\Driver\Server - Manual" />
<meta itemprop="description" content="The MongoDB\Driver\Server class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\Driver\Server class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="mongodb-driver-server.construct.php">
          MongoDB\Driver\Server::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-driver-cursorinterface.toarray.php">
          &laquo; MongoDB\Driver\CursorInterface::toArray        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-driver-server.php' selected="selected">English</option>
            <option value='de/class.mongodb-driver-server.php'>German</option>
            <option value='es/class.mongodb-driver-server.php'>Spanish</option>
            <option value='fr/class.mongodb-driver-server.php'>French</option>
            <option value='it/class.mongodb-driver-server.php'>Italian</option>
            <option value='ja/class.mongodb-driver-server.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-driver-server.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-driver-server.php'>Russian</option>
            <option value='tr/class.mongodb-driver-server.php'>Turkish</option>
            <option value='uk/class.mongodb-driver-server.php'>Ukrainian</option>
            <option value='zh/class.mongodb-driver-server.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-driver-server" class="reference">
...
<div class="methodsynopsis dc-description"><span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><a href="mongodb-driver-server.issecondary.php" class="methodname">isSecondary</a></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <div class="section" id="mongodb-driver-server.constants">
   ...
   <dl>
     ...
     <dd>
      <p class="para">Unknown server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Standalone server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Mongos server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Replica set possible primary server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     ...
     <dd>
      <p class="para">Replica set primary server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Replica set secondary server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Replica set arbiter server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     </dd>
     ...
     <dd>
      <p class="para">Replica set other server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     ...
     <dd>
      <p class="para">Replica set ghost server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     ...
     <dd>
      <p class="para">Load balancer server type, returned by <span class="methodname"><a href="mongodb-driver-server.gettype.php" class="methodname">MongoDB\Driver\Server::getType()</a></span>.</p>
     </dd>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-driver-server.construct.php">MongoDB\Driver\Server::__construct</a> — Create a new Server (not used)</li><li><a href="mongodb-driver-server.executebulkwrite.php">MongoDB\Driver\Server::executeBulkWrite</a> — Execute one or more write operations on this server</li><li><a href="mongodb-driver-server.executebulkwritecommand.php">MongoDB\Driver\Server::executeBulkWriteCommand</a> — Execute write operations on this server using the bulkWrite command</li><li><a href="mongodb-driver-server.executecommand.php">MongoDB\Driver\Server::executeCommand</a> — Execute a database command on this server</li><li><a href="mongodb-driver-server.executequery.php">MongoDB\Driver\Server::executeQuery</a> — Execute a database query on this server</li><li><a href="mongodb-driver-server.executereadcommand.php">MongoDB\Driver\Server::executeReadCommand</a> — Execute a database command that reads on this server</li><li><a href="mongodb-driver-server.executereadwritecommand.php">MongoDB\Driver\Server::executeReadWriteCommand</a> — Execute a database command that reads and writes on this server</li><li><a href="mongodb-driver-server.executewritecommand.php">MongoDB\Driver\Server::executeWriteCommand</a> — Execute a database command that writes on this server</li><li><a href="mongodb-driver-server.gethost.php">MongoDB\Driver\Server::getHost</a> — Returns the hostname of this server</li><li><a href="mongodb-driver-server.getinfo.php">MongoDB\Driver\Server::getInfo</a> — Returns an array of information describing this server</li><li><a href="mongodb-driver-server.getlatency.php">MongoDB\Driver\Server::getLatency</a> — Returns the latency of this server in milliseconds</li><li><a href="mongodb-driver-server.getport.php">MongoDB\Driver\Server::getPort</a> — Returns the port on which this server is listening</li><li><a href="mongodb-driver-server.getserverdescription.php">MongoDB\Driver\Server::getServerDescription</a> — Returns a ServerDescription for this server</li><li><a href="mongodb-driver-server.gettags.php">MongoDB\Driver\Server::getTags</a> — Returns an array of tags describing this server in a replica set</li><li><a href="mongodb-driver-server.gettype.php">MongoDB\Driver\Server::getType</a> — Returns an integer denoting the type of this server</li><li><a href="mongodb-driver-server.isarbiter.php">MongoDB\Driver\Server::isArbiter</a> — Checks if this server is an arbiter member of a replica set</li><li><a href="mongodb-driver-server.ishidden.php">MongoDB\Driver\Server::isHidden</a> — Checks if this server is a hidden member of a replica set</li><li><a href="mongodb-driver-server.ispassive.php">MongoDB\Driver\Server::isPassive</a> — Checks if this server is a passive member of a replica set</li><li><a href="mongodb-driver-server.isprimary.php">MongoDB\Driver\Server::isPrimary</a> — Checks if this server is a primary member of a replica set</li><li><a href="mongodb-driver-server.issecondary.php">MongoDB\Driver\Server::isSecondary</a> — Checks if this server is a secondary member of a replica set</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/mongodb/driver/server.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-driver-server%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-driver-server&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-driver-server.php">＋<small>add a note</small></a></span>
