...
<head>
  ...
  <title>PHP: odbc_close_all - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-close-all.php">
 <link rel="shorturl" href="https://www.php.net/odbc-close-all">
 <link rel="alternate" href="https://www.php.net/odbc-close-all" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-columnprivileges.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-close-all.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-close-all.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-close-all.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-close-all.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-close-all.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-close-all.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-close-all.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-close-all.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-close-all.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-close-all.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-close-all.php" hreflang="zh">
...
<meta name="Description" content="Close all ODBC connections" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_close_all - Manual" />
<meta name="twitter:description" content="Close all ODBC connections" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_close_all - Manual" />
<meta itemprop="description" content="Close all ODBC connections" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close all ODBC connections" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-close-all.php' selected="selected">English</option>
            <option value='de/function.odbc-close-all.php'>German</option>
            <option value='es/function.odbc-close-all.php'>Spanish</option>
            <option value='fr/function.odbc-close-all.php'>French</option>
            <option value='it/function.odbc-close-all.php'>Italian</option>
            <option value='ja/function.odbc-close-all.php'>Japanese</option>
            <option value='pt_BR/function.odbc-close-all.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-close-all.php'>Russian</option>
            <option value='tr/function.odbc-close-all.php'>Turkish</option>
            <option value='uk/function.odbc-close-all.php'>Ukrainian</option>
            <option value='zh/function.odbc-close-all.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-close-all" class="refentry">
   ...
   <p class="para">
    ...
    This connection will remain open in this case.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-close-all.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-close-all%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-close-all&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-close-all.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="85826">  <div class="votes">
    <div id="Vu85826">
    <a href="/manual/vote-note.php?id=85826&amp;page=function.odbc-close-all&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd85826">
    <a href="/manual/vote-note.php?id=85826&amp;page=function.odbc-close-all&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V85826" title="0% like this...">
    -5
    </div>
  </div>
  <a href="#85826" class="name">
  <strong class="user"><em>alvaro at demogracia dot com</em></strong></a><a class="genanchor" href="#85826"> &para;</a><div class="date" title="2008-09-19 02:08"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom85826">
<div class="phpcode"><code><span class="html">Apparently, it doesn't really close *all* connections; just those used by the current script.<br /><br />If you are using persistent connections, every time a script does an odbc_pconnect() and all open connections are in use you'll get a new connection with the same credentials. You won't close them all with odbc_close_all().</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.odbc-close-all&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-close-all.php">＋<small>add a note</small></a></div>
