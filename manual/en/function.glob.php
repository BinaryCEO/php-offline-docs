...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.glob.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.fwrite.php">
 <link rel="next" href="https://www.php.net/manual/en/function.is-dir.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.glob.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.glob.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.glob.php" hreflang="uk">
...
<meta name="Description" content="Find pathnames matching a pattern" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: glob - Manual" />
<meta name="twitter:description" content="Find pathnames matching a pattern" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: glob - Manual" />
<meta itemprop="description" content="Find pathnames matching a pattern" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Find pathnames matching a pattern" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/function.glob.php'>Italian</option>
            ...
            <option value='uk/function.glob.php'>Ukrainian</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fnmatch.php" class="function" rel="rdfs-seeAlso">fnmatch()</a> - Match filename against a pattern</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/filesystem/functions/glob.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.glob%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.glob&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.glob.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125723">  <div class="votes">
    <div id="Vu125723">
    <a href="/manual/vote-note.php?id=125723&amp;page=function.glob&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125723">
    <a href="/manual/vote-note.php?id=125723&amp;page=function.glob&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125723" title="58% like this...">
    6
    </div>
  </div>
  <a href="#125723" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#125723"> &para;</a><div class="date" title="2021-01-25 12:25"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125723">
<div class="phpcode"><code><span class="html">Include dotfiles excluding . and .. special dirs with .[!.]*<br /><br /><span class="default">&lt;?php<br />$all_files </span><span class="keyword">= </span><span class="default">array_merge</span><span class="keyword">(</span><span class="default">glob</span><span class="keyword">(</span><span class="string">'.[!.]*'</span><span class="keyword">), </span><span class="default">glob</span><span class="keyword">(</span><span class="string">'*'</span><span class="keyword">));<br /></span><span class="comment">// or<br /></span><span class="default">$all_files </span><span class="keyword">= </span><span class="default">glob</span><span class="keyword">(</span><span class="string">'{.[!.],}*'</span><span class="keyword">, </span><span class="default">GLOB_BRACE</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.glob&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.glob.php">＋<small>add a note</small></a></div>
