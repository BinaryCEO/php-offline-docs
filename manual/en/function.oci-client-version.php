...
<head>
  ...
  <title>PHP: oci_client_version - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-client-version.php">
 <link rel="shorturl" href="https://www.php.net/oci-client-version">
 <link rel="alternate" href="https://www.php.net/oci-client-version" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-cancel.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-client-version.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-client-version.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-client-version.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-client-version.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-client-version.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-client-version.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-client-version.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-client-version.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-client-version.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-client-version.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-client-version.php" hreflang="zh">
...
<meta name="Description" content="Returns the Oracle client library version" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_client_version - Manual" />
<meta name="twitter:description" content="Returns the Oracle client library version" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_client_version - Manual" />
<meta itemprop="description" content="Returns the Oracle client library version" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the Oracle client library version" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-client-version.php' selected="selected">English</option>
            <option value='de/function.oci-client-version.php'>German</option>
            <option value='es/function.oci-client-version.php'>Spanish</option>
            <option value='fr/function.oci-client-version.php'>French</option>
            <option value='it/function.oci-client-version.php'>Italian</option>
            <option value='ja/function.oci-client-version.php'>Japanese</option>
            <option value='pt_BR/function.oci-client-version.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-client-version.php'>Russian</option>
            <option value='tr/function.oci-client-version.php'>Turkish</option>
            <option value='uk/function.oci-client-version.php'>Ukrainian</option>
            <option value='zh/function.oci-client-version.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-client-version" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">oci_client_version</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.7, PHP 7, PHP 8, PECL OCI8 &gt;= 1.4.6)</p><p class="refpurpose"><span class="refname">oci_client_version</span> &mdash; <span class="dc-title">Returns the Oracle client library version</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.oci-client-version-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_client_version</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.oci-client-version-returnvalues">
  ...
  <p class="para">
   Returns the version number as a <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    </span><span style="color: #007700">echo </span><span style="color: #DD0000">"Client Version: " </span><span style="color: #007700">. </span><span style="color: #0000BB">oci_client_version</span><span style="color: #007700">(); </span><span style="color: #FF8000">// Client version: 19.9.0.0.0<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 notes" id="refsect1-function.oci-client-version-notes">
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    Oracle libraries before 10<em>g</em>R2 do not have the underlying
 ...
 <div class="refsect1 seealso" id="refsect1-function.oci-client-version-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.oci-server-version.php" class="function" rel="rdfs-seeAlso">oci_server_version()</a> - Returns the Oracle Database version</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-client-version.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-client-version%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-client-version&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-client-version.php">＋<small>add a note</small></a></span>
