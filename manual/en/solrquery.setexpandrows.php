...
<head>
  ...
  <title>PHP: SolrQuery::setExpandRows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setexpandrows.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setexpandrows.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setexpandrows.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setexpandquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setexplainother.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setexpandrows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setexpandrows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setexpandrows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setexpandrows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setexpandrows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setexpandrows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setexpandrows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setexpandrows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setexpandrows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setexpandrows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setexpandrows.php" hreflang="zh">
...
<meta name="Description" content="Sets the number of rows to display in each group (expand.rows). Server Default 5" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setExpandRows - Manual" />
<meta name="twitter:description" content="Sets the number of rows to display in each group (expand.rows). Server Default 5" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setExpandRows - Manual" />
<meta itemprop="description" content="Sets the number of rows to display in each group (expand.rows). Server Default 5" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the number of rows to display in each group (expand.rows). Server Default 5" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setexplainother.php">
          SolrQuery::setExplainOther &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setexpandquery.php">
          &laquo; SolrQuery::setExpandQuery        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setexpandrows.php' selected="selected">English</option>
            <option value='de/solrquery.setexpandrows.php'>German</option>
            <option value='es/solrquery.setexpandrows.php'>Spanish</option>
            <option value='fr/solrquery.setexpandrows.php'>French</option>
            <option value='it/solrquery.setexpandrows.php'>Italian</option>
            <option value='ja/solrquery.setexpandrows.php'>Japanese</option>
            <option value='pt_BR/solrquery.setexpandrows.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setexpandrows.php'>Russian</option>
            <option value='tr/solrquery.setexpandrows.php'>Turkish</option>
            <option value='uk/solrquery.setexpandrows.php'>Ukrainian</option>
            <option value='zh/solrquery.setexpandrows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setexpandrows" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setExpandRows</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::setExpandRows</span> &mdash; <span class="dc-title">Sets the number of rows to display in each group (expand.rows). Server Default 5</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setexpandrows-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setExpandRows</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setexpandrows-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setexpandrows-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.setexpandrows-seealso">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="solrquery.removeexpandfilterquery.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::removeExpandFilterQuery()</a> - Removes an expand filter query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setexpandrows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setexpandrows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setexpandrows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setexpandrows.php">＋<small>add a note</small></a></span>
