...
<head>
  ...
  <title>PHP: fann_test - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-test.php">
 <link rel="shorturl" href="https://www.php.net/fann-test">
 <link rel="alternate" href="https://www.php.net/fann-test" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-subset-train-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-test-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-test.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-test.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-test.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-test.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-test.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-test.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-test.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-test.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-test.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-test.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-test.php" hreflang="zh">
...
<meta name="Description" content="Test with a set of inputs, and a set of desired outputs" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_test - Manual" />
<meta name="twitter:description" content="Test with a set of inputs, and a set of desired outputs" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_test - Manual" />
<meta itemprop="description" content="Test with a set of inputs, and a set of desired outputs" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Test with a set of inputs, and a set of desired outputs" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-test-data.php">
          fann_test_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-subset-train-data.php">
          &laquo; fann_subset_train_data        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-test.php' selected="selected">English</option>
            <option value='de/function.fann-test.php'>German</option>
            <option value='es/function.fann-test.php'>Spanish</option>
            <option value='fr/function.fann-test.php'>French</option>
            <option value='it/function.fann-test.php'>Italian</option>
            <option value='ja/function.fann-test.php'>Japanese</option>
            <option value='pt_BR/function.fann-test.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-test.php'>Russian</option>
            <option value='tr/function.fann-test.php'>Turkish</option>
            <option value='uk/function.fann-test.php'>Ukrainian</option>
            <option value='zh/function.fann-test.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-test" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-get-num-output.php" class="function" rel="rdfs-seeAlso">fann_get_num_output()</a> - Get the number of output neurons</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-test.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-test%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-test&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-test.php">＋<small>add a note</small></a></span>
