...
<head>
  ...
  <title>PHP: SolrQuery::addStatsField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addstatsfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addstatsfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addstatsfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addstatsfacet.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.collapse.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addstatsfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addstatsfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addstatsfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addstatsfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addstatsfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addstatsfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addstatsfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addstatsfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addstatsfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addstatsfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addstatsfield.php" hreflang="zh">
...
<meta name="Description" content="Maps to stats.field parameter" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addStatsField - Manual" />
<meta name="twitter:description" content="Maps to stats.field parameter" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addStatsField - Manual" />
<meta itemprop="description" content="Maps to stats.field parameter" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to stats.field parameter" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.collapse.php">
          SolrQuery::collapse &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addstatsfacet.php">
          &laquo; SolrQuery::addStatsFacet        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addstatsfield.php' selected="selected">English</option>
            <option value='de/solrquery.addstatsfield.php'>German</option>
            <option value='es/solrquery.addstatsfield.php'>Spanish</option>
            <option value='fr/solrquery.addstatsfield.php'>French</option>
            <option value='it/solrquery.addstatsfield.php'>Italian</option>
            <option value='ja/solrquery.addstatsfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.addstatsfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addstatsfield.php'>Russian</option>
            <option value='tr/solrquery.addstatsfield.php'>Turkish</option>
            <option value='uk/solrquery.addstatsfield.php'>Ukrainian</option>
            <option value='zh/solrquery.addstatsfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addstatsfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addStatsField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addStatsField</span> &mdash; <span class="dc-title">Maps to stats.field parameter</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addstatsfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addStatsField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addstatsfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addstatsfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addstatsfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addstatsfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addstatsfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addstatsfield.php">＋<small>add a note</small></a></span>
