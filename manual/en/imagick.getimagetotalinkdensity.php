...
<head>
  ...
  <title>PHP: Imagick::getImageTotalInkDensity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagetotalinkdensity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagetotalinkdensity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagetotalinkdensity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagetickspersecond.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagetype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagetotalinkdensity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagetotalinkdensity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagetotalinkdensity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagetotalinkdensity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagetotalinkdensity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagetotalinkdensity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagetotalinkdensity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagetotalinkdensity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagetotalinkdensity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagetotalinkdensity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagetotalinkdensity.php" hreflang="zh">
...
<meta name="Description" content="Gets the image total ink density" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageTotalInkDensity - Manual" />
<meta name="twitter:description" content="Gets the image total ink density" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageTotalInkDensity - Manual" />
<meta itemprop="description" content="Gets the image total ink density" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image total ink density" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimagetype.php">
          Imagick::getImageType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagetickspersecond.php">
          &laquo; Imagick::getImageTicksPerSecond        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagetotalinkdensity.php' selected="selected">English</option>
            <option value='de/imagick.getimagetotalinkdensity.php'>German</option>
            <option value='es/imagick.getimagetotalinkdensity.php'>Spanish</option>
            <option value='fr/imagick.getimagetotalinkdensity.php'>French</option>
            <option value='it/imagick.getimagetotalinkdensity.php'>Italian</option>
            <option value='ja/imagick.getimagetotalinkdensity.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagetotalinkdensity.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagetotalinkdensity.php'>Russian</option>
            <option value='tr/imagick.getimagetotalinkdensity.php'>Turkish</option>
            <option value='uk/imagick.getimagetotalinkdensity.php'>Ukrainian</option>
            <option value='zh/imagick.getimagetotalinkdensity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagetotalinkdensity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageTotalInkDensity</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageTotalInkDensity</span> &mdash; <span class="dc-title">Gets the image total ink density</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagetotalinkdensity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageTotalInkDensity</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagetotalinkdensity-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagetotalinkdensity-returnvalues">
...
<span class="classname"><strong class="classname">ImagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagetotalinkdensity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagetotalinkdensity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagetotalinkdensity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagetotalinkdensity.php">＋<small>add a note</small></a></span>
