...
<head>
  ...
  <title>PHP: fbird_commit_ret - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-commit-ret.php">
 <link rel="shorturl" href="https://www.php.net/fbird-commit-ret">
 <link rel="alternate" href="https://www.php.net/fbird-commit-ret" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-commit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-connect.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-commit-ret.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-commit-ret.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-commit-ret.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-commit-ret.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-commit-ret.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-commit-ret.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-commit-ret.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-commit-ret.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-commit-ret.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-commit-ret.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-commit-ret.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_commit_ret" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_commit_ret - Manual" />
<meta name="twitter:description" content="Alias of ibase_commit_ret" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_commit_ret - Manual" />
<meta itemprop="description" content="Alias of ibase_commit_ret" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_commit_ret" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fbird-connect.php">
          fbird_connect &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fbird-commit.php">
          &laquo; fbird_commit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-commit-ret.php' selected="selected">English</option>
            <option value='de/function.fbird-commit-ret.php'>German</option>
            <option value='es/function.fbird-commit-ret.php'>Spanish</option>
            <option value='fr/function.fbird-commit-ret.php'>French</option>
            <option value='it/function.fbird-commit-ret.php'>Italian</option>
            <option value='ja/function.fbird-commit-ret.php'>Japanese</option>
            <option value='pt_BR/function.fbird-commit-ret.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-commit-ret.php'>Russian</option>
            <option value='tr/function.fbird-commit-ret.php'>Turkish</option>
            <option value='uk/function.fbird-commit-ret.php'>Ukrainian</option>
            <option value='zh/function.fbird-commit-ret.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-commit-ret" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_commit_ret</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_commit_ret</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-commit-ret.php" class="function">ibase_commit_ret()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-commit-ret-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-commit-ret.php" class="function">ibase_commit_ret()</a></span>.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-commit-ret.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-commit-ret%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-commit-ret&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-commit-ret.php">＋<small>add a note</small></a></span>
