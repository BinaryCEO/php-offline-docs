...
<head>
  ...
  <title>PHP: ImagickDraw::pathClose - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathclose.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathclose.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathclose.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.matte.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathcurvetoabsolute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathclose.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathclose.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathclose.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathclose.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathclose.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathclose.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathclose.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathclose.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathclose.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathclose.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathclose.php" hreflang="zh">
...
<meta name="Description" content="Adds a path element to the current path" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::pathClose - Manual" />
<meta name="twitter:description" content="Adds a path element to the current path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathClose - Manual" />
<meta itemprop="description" content="Adds a path element to the current path" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds a path element to the current path" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathcurvetoabsolute.php">
          ImagickDraw::pathCurveToAbsolute &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.matte.php">
          &laquo; ImagickDraw::matte        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathclose.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathclose.php'>German</option>
            <option value='es/imagickdraw.pathclose.php'>Spanish</option>
            <option value='fr/imagickdraw.pathclose.php'>French</option>
            <option value='it/imagickdraw.pathclose.php'>Italian</option>
            <option value='ja/imagickdraw.pathclose.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathclose.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathclose.php'>Russian</option>
            <option value='tr/imagickdraw.pathclose.php'>Turkish</option>
            <option value='uk/imagickdraw.pathclose.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathclose.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathclose" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathClose</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathClose</span> &mdash; <span class="dc-title">Adds a path element to the current path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathclose-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::pathClose</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathclose-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathclose.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathclose%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathclose&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathclose.php">＋<small>add a note</small></a></span>
