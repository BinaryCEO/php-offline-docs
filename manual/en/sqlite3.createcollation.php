...
<head>
  ...
  <title>PHP: SQLite3::createCollation - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/sqlite3.createcollation.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/sqlite3.createcollation.php">
 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.createcollation.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.sqlite3.php">
 <link rel="prev" href="https://www.php.net/manual/en/sqlite3.createaggregate.php">
 <link rel="next" href="https://www.php.net/manual/en/sqlite3.createfunction.php">

 <link rel="alternate" href="https://www.php.net/manual/en/sqlite3.createcollation.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/sqlite3.createcollation.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/sqlite3.createcollation.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/sqlite3.createcollation.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/sqlite3.createcollation.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/sqlite3.createcollation.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/sqlite3.createcollation.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/sqlite3.createcollation.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/sqlite3.createcollation.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/sqlite3.createcollation.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/sqlite3.createcollation.php" hreflang="zh">
...
<meta name="Description" content="Registers a PHP function for use as an SQL collating function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SQLite3::createCollation - Manual" />
<meta name="twitter:description" content="Registers a PHP function for use as an SQL collating function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SQLite3::createCollation - Manual" />
<meta itemprop="description" content="Registers a PHP function for use as an SQL collating function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Registers a PHP function for use as an SQL collating function" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="sqlite3.createfunction.php">
          SQLite3::createFunction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="sqlite3.createaggregate.php">
          &laquo; SQLite3::createAggregate        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/sqlite3.createcollation.php' selected="selected">English</option>
            <option value='de/sqlite3.createcollation.php'>German</option>
            <option value='es/sqlite3.createcollation.php'>Spanish</option>
            <option value='fr/sqlite3.createcollation.php'>French</option>
            <option value='it/sqlite3.createcollation.php'>Italian</option>
            <option value='ja/sqlite3.createcollation.php'>Japanese</option>
            <option value='pt_BR/sqlite3.createcollation.php'>Brazilian Portuguese</option>
            <option value='ru/sqlite3.createcollation.php'>Russian</option>
            <option value='tr/sqlite3.createcollation.php'>Turkish</option>
            <option value='uk/sqlite3.createcollation.php'>Ukrainian</option>
            <option value='zh/sqlite3.createcollation.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="sqlite3.createcollation" class="refentry">
  ...
  <ul class="simplelist">
   <li>The SQLite collation documentation: <a href="http://sqlite.org/datatype3.html#collation" class="link external">&raquo;&nbsp;http://sqlite.org/datatype3.html#collation</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sqlite3/sqlite3/createcollation.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsqlite3.createcollation%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=sqlite3.createcollation&amp;repo=en&amp;redirect=https://www.php.net/manual/en/sqlite3.createcollation.php">＋<small>add a note</small></a></span>
