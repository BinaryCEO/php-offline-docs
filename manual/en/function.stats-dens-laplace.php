...
<head>
  ...
  <title>PHP: stats_dens_laplace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-dens-laplace.php">
 <link rel="shorturl" href="https://www.php.net/stats-dens-laplace">
 <link rel="alternate" href="https://www.php.net/stats-dens-laplace" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-dens-gamma.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-dens-logistic.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-dens-laplace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-dens-laplace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-dens-laplace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-dens-laplace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-dens-laplace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-dens-laplace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-dens-laplace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-dens-laplace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-dens-laplace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-dens-laplace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-dens-laplace.php" hreflang="zh">
...
<meta name="Description" content="Probability density function of the Laplace distribution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_dens_laplace - Manual" />
<meta name="twitter:description" content="Probability density function of the Laplace distribution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_dens_laplace - Manual" />
<meta itemprop="description" content="Probability density function of the Laplace distribution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Probability density function of the Laplace distribution" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-dens-logistic.php">
          stats_dens_logistic &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-dens-gamma.php">
          &laquo; stats_dens_gamma        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-dens-laplace.php' selected="selected">English</option>
            <option value='de/function.stats-dens-laplace.php'>German</option>
            <option value='es/function.stats-dens-laplace.php'>Spanish</option>
            <option value='fr/function.stats-dens-laplace.php'>French</option>
            <option value='it/function.stats-dens-laplace.php'>Italian</option>
            <option value='ja/function.stats-dens-laplace.php'>Japanese</option>
            <option value='pt_BR/function.stats-dens-laplace.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-dens-laplace.php'>Russian</option>
            <option value='tr/function.stats-dens-laplace.php'>Turkish</option>
            <option value='uk/function.stats-dens-laplace.php'>Ukrainian</option>
            <option value='zh/function.stats-dens-laplace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-dens-laplace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_dens_laplace</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_dens_laplace</span> &mdash; <span class="dc-title">Probability density function of the Laplace distribution</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-dens-laplace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_dens_laplace</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$ave</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$stdev</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-dens-laplace-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-dens-laplace-returnvalues">
  ...
  <p class="para">
   The probability density at <code class="parameter">x</code> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> for failure.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-dens-laplace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-dens-laplace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-dens-laplace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-dens-laplace.php">＋<small>add a note</small></a></span>
