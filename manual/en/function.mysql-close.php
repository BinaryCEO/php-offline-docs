...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-close.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-client-encoding.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-connect.php">
 ...
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-close.php" hreflang="uk">
...
<meta name="Description" content="Close MySQL connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysql_close - Manual" />
<meta name="twitter:description" content="Close MySQL connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_close - Manual" />
<meta itemprop="description" content="Close MySQL connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close MySQL connection" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-close.php' selected="selected">English</option>
            ...
            <option value='ru/function.mysql-close.php'>Russian</option>
            <option value='tr/function.mysql-close.php'>Turkish</option>
            <option value='uk/function.mysql-close.php'>Ukrainian</option>
...
<span class="function"><a href="function.mysql-connect.php" class="function">mysql_connect()</a></span> is assumed. If no connection is found or
established, an <strong><code><a href="errorfunc.constants.php#constant.e-warning">E_WARNING</a></code></strong> level error is
generated.</p></dd>
   </dl>
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-free-result.php" class="function" rel="rdfs-seeAlso">mysql_free_result()</a> - Free result memory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-close.php">＋<small>add a note</small></a></span>
