...
<head>
  ...
  <title>PHP: Imagick::setImagePage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagepage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagepage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagepage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageorientation.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageprofile.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagepage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagepage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagepage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagepage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagepage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagepage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagepage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagepage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagepage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagepage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagepage.php" hreflang="zh">
...
<meta name="Description" content="Sets the page geometry of the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImagePage - Manual" />
<meta name="twitter:description" content="Sets the page geometry of the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImagePage - Manual" />
<meta itemprop="description" content="Sets the page geometry of the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the page geometry of the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimageprofile.php">
          Imagick::setImageProfile &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageorientation.php">
          &laquo; Imagick::setImageOrientation        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagepage.php' selected="selected">English</option>
            <option value='de/imagick.setimagepage.php'>German</option>
            <option value='es/imagick.setimagepage.php'>Spanish</option>
            <option value='fr/imagick.setimagepage.php'>French</option>
            <option value='it/imagick.setimagepage.php'>Italian</option>
            <option value='ja/imagick.setimagepage.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagepage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagepage.php'>Russian</option>
            <option value='tr/imagick.setimagepage.php'>Turkish</option>
            <option value='uk/imagick.setimagepage.php'>Ukrainian</option>
            <option value='zh/imagick.setimagepage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagepage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImagePage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImagePage</span> &mdash; <span class="dc-title">Sets the page geometry of the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagepage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImagePage</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$width</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$height</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagepage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagepage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagepage-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagepage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagepage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagepage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagepage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="90977">  <div class="votes">
    <div id="Vu90977">
    <a href="/manual/vote-note.php?id=90977&amp;page=imagick.setimagepage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90977">
    <a href="/manual/vote-note.php?id=90977&amp;page=imagick.setimagepage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90977" title="66% like this...">
    2
    </div>
  </div>
  <a href="#90977" class="name">
  <strong class="user"><em>Darren Burnhill</em></strong></a><a class="genanchor" href="#90977"> &para;</a><div class="date" title="2009-05-19 05:03"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90977">
<div class="phpcode"><code><span class="html">This would appear to be the equivalent of +repage in ImageMagick.<br /><br /><span class="default">&lt;?php<br />  $ImagickObj </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$sourceImagePath</span><span class="keyword">);<br />  </span><span class="default">$ImagickObj</span><span class="keyword">-&gt;</span><span class="default">cropImage</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'w'</span><span class="keyword">], </span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'h'</span><span class="keyword">], </span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'x'</span><span class="keyword">], </span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'y'</span><span class="keyword">]);<br />  </span><span class="default">$ImagickObj</span><span class="keyword">-&gt;</span><span class="default">setImagePage</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'w'</span><span class="keyword">], </span><span class="default">$_POST</span><span class="keyword">[</span><span class="string">'h'</span><span class="keyword">], </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br />  </span><span class="default">$ImagickObj</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$cropFilePath</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagepage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagepage.php">＋<small>add a note</small></a></div>
