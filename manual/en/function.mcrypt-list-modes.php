...
<head>
  ...
  <title>PHP: mcrypt_list_modes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mcrypt-list-modes.php">
 <link rel="shorturl" href="https://www.php.net/mcrypt-list-modes">
 <link rel="alternate" href="https://www.php.net/mcrypt-list-modes" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mcrypt.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mcrypt-list-algorithms.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mcrypt-module-close.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mcrypt-list-modes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mcrypt-list-modes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mcrypt-list-modes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mcrypt-list-modes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mcrypt-list-modes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mcrypt-list-modes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mcrypt-list-modes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mcrypt-list-modes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mcrypt-list-modes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mcrypt-list-modes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mcrypt-list-modes.php" hreflang="zh">
...
<meta name="Description" content="Gets an array of all supported modes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mcrypt_list_modes - Manual" />
<meta name="twitter:description" content="Gets an array of all supported modes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mcrypt_list_modes - Manual" />
<meta itemprop="description" content="Gets an array of all supported modes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets an array of all supported modes" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mcrypt-module-close.php">
          mcrypt_module_close &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mcrypt-list-algorithms.php">
          &laquo; mcrypt_list_algorithms        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mcrypt-list-modes.php' selected="selected">English</option>
            <option value='de/function.mcrypt-list-modes.php'>German</option>
            <option value='es/function.mcrypt-list-modes.php'>Spanish</option>
            <option value='fr/function.mcrypt-list-modes.php'>French</option>
            <option value='it/function.mcrypt-list-modes.php'>Italian</option>
            <option value='ja/function.mcrypt-list-modes.php'>Japanese</option>
            <option value='pt_BR/function.mcrypt-list-modes.php'>Brazilian Portuguese</option>
            <option value='ru/function.mcrypt-list-modes.php'>Russian</option>
            <option value='tr/function.mcrypt-list-modes.php'>Turkish</option>
            <option value='uk/function.mcrypt-list-modes.php'>Ukrainian</option>
            <option value='zh/function.mcrypt-list-modes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mcrypt-list-modes" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mcrypt_list_modes</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.2, PHP 5, PHP 7 &lt; 7.2.0, PECL mcrypt &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">mcrypt_list_modes</span> &mdash; <span class="dc-title">Gets an array of all supported modes</span></p>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       specified, the value of the <code class="literal">mcrypt.modes_dir</code>
 ...
 <div class="refsect1 examples" id="refsect1-function.mcrypt-list-modes-examples">
  ...
  <p class="para">
   <div class="example" id="example-1001">
    <p><strong>Example #1 <span class="function"><strong>mcrypt_list_modes()</strong></span> Example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />    $modes </span><span style="color: #007700">= </span><span style="color: #0000BB">mcrypt_list_modes</span><span style="color: #007700">();<br /><br />    foreach (</span><span style="color: #0000BB">$modes </span><span style="color: #007700">as </span><span style="color: #0000BB">$mode</span><span style="color: #007700">) {<br />        echo </span><span style="color: #DD0000">"</span><span style="color: #0000BB">$mode</span><span style="color: #DD0000"> &lt;br /&gt;\n"</span><span style="color: #007700">;<br />    }<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="example-contents"><p>
     ...
     with the <code class="literal">mcrypt.modes_dir</code> <var class="filename">php.ini</var>
     directive, the default directory of mcrypt is used (which
     is <var class="filename">/usr/local/lib/libmcrypt</var>).
    </p></div>
   </div>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mcrypt/functions/mcrypt-list-modes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mcrypt-list-modes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mcrypt-list-modes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mcrypt-list-modes.php">＋<small>add a note</small></a></span>
