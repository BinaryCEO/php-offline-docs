...
<head>
  ...
  <title>PHP: Gmagick::getimageredprimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageredprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageredprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageredprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimageprofile.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagerenderingintent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageredprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageredprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageredprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageredprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageredprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageredprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageredprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageredprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageredprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageredprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageredprimary.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageredprimary - Manual" />
<meta name="twitter:description" content="Returns the chromaticity red primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageredprimary - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagerenderingintent.php">
          Gmagick::getimagerenderingintent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimageprofile.php">
          &laquo; Gmagick::getimageprofile        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageredprimary.php' selected="selected">English</option>
            <option value='de/gmagick.getimageredprimary.php'>German</option>
            <option value='es/gmagick.getimageredprimary.php'>Spanish</option>
            <option value='fr/gmagick.getimageredprimary.php'>French</option>
            <option value='it/gmagick.getimageredprimary.php'>Italian</option>
            <option value='ja/gmagick.getimageredprimary.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageredprimary.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageredprimary.php'>Russian</option>
            <option value='tr/gmagick.getimageredprimary.php'>Turkish</option>
            <option value='uk/gmagick.getimageredprimary.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageredprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageredprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageredprimary</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageredprimary</span> &mdash; <span class="dc-title">Returns the chromaticity red primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageredprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageredprimary</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimageredprimary-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageredprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageredprimary-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageredprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageredprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageredprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageredprimary.php">＋<small>add a note</small></a></span>
