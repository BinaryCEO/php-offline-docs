...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-set-type.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-set.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-sub.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-set-type.php' selected="selected">English</option>
            ...
            <option value='zh/function.variant-set-type.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.variant-get-type.php" class="function" rel="rdfs-seeAlso">variant_get_type()</a> - Returns the type of a variant object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-set-type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-set-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-set-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-set-type.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">In my application I was using ADODB to retrieve data from Microsoft Access.  During queries, fields defined as "Date/Time" in Access were being returned to PHP as instances of the Variant class.<br /><br />For some reason, the variant_date_to_timestamp function returned incorrect timestamps.  As a workaround, I used variant_set_type($variant, VT_BSTR) to get a string representation of the date.  This can be used for most variant types PHP doesn't handle.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.variant-set-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-set-type.php">＋<small>add a note</small></a></div>
