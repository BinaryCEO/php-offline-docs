...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurescopeclass.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurescopeclass.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurescopeclass.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionfunctionabstract.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurecalledclass.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionfunctionabstract.getclosurethis.php">
...
<meta name="Description" content="Returns the class corresponding to the scope inside a closure" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionFunctionAbstract::getClosureScopeClass - Manual" />
<meta name="twitter:description" content="Returns the class corresponding to the scope inside a closure" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionFunctionAbstract::getClosureScopeClass - Manual" />
<meta itemprop="description" content="Returns the class corresponding to the scope inside a closure" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the class corresponding to the scope inside a closure" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionfunctionabstract.getclosurescopeclass.php' selected="selected">English</option>
            ...
            <option value='pt_BR/reflectionfunctionabstract.getclosurescopeclass.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionFunctionAbstract::getClosureScopeClass</span> &mdash; <span class="dc-title">Returns the class corresponding to the scope inside a closure</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-reflectionfunctionabstract.getclosurescopeclass-returnvalues">
  ...
  <p class="simpara">
   ...
   whose scope is being used inside the <span class="classname"><a href="class.closure.php" class="classname">Closure</a></span>.
 ...
 <div class="refsect1 examples" id="refsect1-reflectionfunctionabstract.getclosurescopeclass-examples">
  ...
  <div class="example" id="example-5554">
   <p><strong>Example #1 
...
object(ReflectionClass)#4 (1) {
  ...
  <div class="example" id="example-5555">
   <p><strong>Example #2 
    Example showcasing difference between
    <span class="methodname"><a href="reflectionfunctionabstract.getclosurecalledclass.php" class="methodname">ReflectionFunctionAbstract::getClosureCalledClass()</a></span>,
    <span class="methodname"><strong>ReflectionFunctionAbstract::getClosureScopeClass()</strong></span>,
  ...
  <ul class="simplelist">
   ...
   <li><a href="language.oop5.late-static-bindings.php" class="xref">Late Static Bindings</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionfunctionabstract/getclosurescopeclass.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionfunctionabstract.getclosurescopeclass%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionfunctionabstract.getclosurescopeclass&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionfunctionabstract.getclosurescopeclass.php">＋<small>add a note</small></a></span>
