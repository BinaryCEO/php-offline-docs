...
<head>
  ...
  <title>PHP: SolrQuery::getHighlightRegexPattern - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.gethighlightregexpattern.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.gethighlightregexpattern.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightregexpattern.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.gethighlightregexmaxanalyzedchars.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gethighlightregexslop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.gethighlightregexpattern.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.gethighlightregexpattern.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.gethighlightregexpattern.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.gethighlightregexpattern.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.gethighlightregexpattern.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.gethighlightregexpattern.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.gethighlightregexpattern.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.gethighlightregexpattern.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.gethighlightregexpattern.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.gethighlightregexpattern.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.gethighlightregexpattern.php" hreflang="zh">
...
<meta name="Description" content="Returns the regular expression for fragmenting" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getHighlightRegexPattern - Manual" />
<meta name="twitter:description" content="Returns the regular expression for fragmenting" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getHighlightRegexPattern - Manual" />
<meta itemprop="description" content="Returns the regular expression for fragmenting" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the regular expression for fragmenting" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gethighlightregexslop.php">
          SolrQuery::getHighlightRegexSlop &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.gethighlightregexmaxanalyzedchars.php">
          &laquo; SolrQuery::getHighlightRegexMaxAnalyzedChars        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.gethighlightregexpattern.php' selected="selected">English</option>
            <option value='de/solrquery.gethighlightregexpattern.php'>German</option>
            <option value='es/solrquery.gethighlightregexpattern.php'>Spanish</option>
            <option value='fr/solrquery.gethighlightregexpattern.php'>French</option>
            <option value='it/solrquery.gethighlightregexpattern.php'>Italian</option>
            <option value='ja/solrquery.gethighlightregexpattern.php'>Japanese</option>
            <option value='pt_BR/solrquery.gethighlightregexpattern.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.gethighlightregexpattern.php'>Russian</option>
            <option value='tr/solrquery.gethighlightregexpattern.php'>Turkish</option>
            <option value='uk/solrquery.gethighlightregexpattern.php'>Ukrainian</option>
            <option value='zh/solrquery.gethighlightregexpattern.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.gethighlightregexpattern" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getHighlightRegexPattern</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getHighlightRegexPattern</span> &mdash; <span class="dc-title">Returns the regular expression for fragmenting</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.gethighlightregexpattern-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getHighlightRegexPattern</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.gethighlightregexpattern-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.gethighlightregexpattern-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/gethighlightregexpattern.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.gethighlightregexpattern%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.gethighlightregexpattern&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.gethighlightregexpattern.php">＋<small>add a note</small></a></span>
