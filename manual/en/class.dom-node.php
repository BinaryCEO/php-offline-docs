...
<head>
  ...
  <title>PHP: Dom\Node - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.dom-node.php">
 <link rel="shorturl" href="https://www.php.net/dom-node">
 <link rel="alternate" href="https://www.php.net/dom-node" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.dom.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.dom-namespaceinfo.php">
 <link rel="next" href="https://www.php.net/manual/en/class.dom-nodelist.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.dom-node.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.dom-node.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.dom-node.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.dom-node.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.dom-node.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.dom-node.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.dom-node.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.dom-node.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.dom-node.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.dom-node.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.dom-node.php" hreflang="zh">
...
<meta name="Description" content="The Dom\Node class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Dom\Node - Manual" />
<meta name="twitter:description" content="The Dom\Node class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Dom\Node - Manual" />
<meta itemprop="description" content="The Dom\Node class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Dom\Node class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.dom-nodelist.php">
          Dom\NodeList &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.dom-namespaceinfo.php">
          &laquo; Dom\NamespaceInfo        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.dom-node.php' selected="selected">English</option>
            <option value='de/class.dom-node.php'>German</option>
            <option value='es/class.dom-node.php'>Spanish</option>
            <option value='fr/class.dom-node.php'>French</option>
            <option value='it/class.dom-node.php'>Italian</option>
            <option value='ja/class.dom-node.php'>Japanese</option>
            <option value='pt_BR/class.dom-node.php'>Brazilian Portuguese</option>
            <option value='ru/class.dom-node.php'>Russian</option>
            <option value='tr/class.dom-node.php'>Turkish</option>
            <option value='uk/class.dom-node.php'>Ukrainian</option>
            <option value='zh/class.dom-node.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.dom-node" class="reference">
 <h1 class="title">The Dom\Node class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 8 &gt;= 8.4.0)</p>

  <div class="section" id="dom-node.intro">
  ...
  <div class="section" id="dom-node.synopsis">
   <h2 class="title">Class synopsis</h2>
    <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">Dom\Node</strong></strong>
     {</div>
    ...
    <div class="fieldsynopsis">
     ...
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.dom-node.php#dom-node.constants.document-position-disconnected"><var class="varname">DOCUMENT_POSITION_DISCONNECTED</var></a></var><span class="initializer"> = 0x1</span>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.dom-node.php#dom-node.constants.document-position-preceding"><var class="varname">DOCUMENT_POSITION_PRECEDING</var></a></var><span class="initializer"> = 0x2</span>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.dom-node.php#dom-node.constants.document-position-following"><var class="varname">DOCUMENT_POSITION_FOLLOWING</var></a></var><span class="initializer"> = 0x4</span>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.dom-node.php#dom-node.constants.document-position-contains"><var class="varname">DOCUMENT_POSITION_CONTAINS</var></a></var><span class="initializer"> = 0x8</span>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.dom-node.php#dom-node.constants.document-position-contained-by"><var class="varname">DOCUMENT_POSITION_CONTAINED_BY</var></a></var><span class="initializer"> = 0x10</span>;</div>

    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="modifier">const</span>
     <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>
      <var class="fieldsynopsis_varname"><a href="class.dom-node.php#dom-node.constants.document-position-implementation-specific"><var class="varname">DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC</var></a></var><span class="initializer"> = 0x20</span>;</div>
  ...
  <div class="section" id="dom-node.constants">
   <h2 class="title">Predefined Constants</h2>
   <dl>
    
     <dt id="dom-node.constants.document-position-disconnected">
     ...
     <dt id="dom-node.constants.document-position-preceding">
     ...
     <dt id="dom-node.constants.document-position-following">
     ...
     <dt id="dom-node.constants.document-position-contains">
     ...
     <dt id="dom-node.constants.document-position-contained-by">
     ...
     <dt id="dom-node.constants.document-position-implementation-specific">
  ...
  <div class="section" id="dom-node.props">
   <h2 class="title">Properties</h2>
   <dl>
    
     <dt id="dom-node.props.nodetype"><var class="varname">nodeType</var></dt><dd>
     ...
     <dt id="dom-node.props.nodename"><var class="varname">nodeName</var></dt>
     <dd>
      <span class="simpara">Returns the most accurate name for the current node type.</span>
      <ul class="itemizedlist">
       <li class="listitem"><span class="simpara">For elements, this is the HTML-uppercased qualified name.</span></li>
       <li class="listitem"><span class="simpara">For attributes, this is the qualified name.</span></li>
       <li class="listitem"><span class="simpara">For processing instructions, this is the target.</span></li>
       <li class="listitem"><span class="simpara">For document type nodes, this is the name.</span></li>
      </ul>
     </dd>
    
    
     <dt id="dom-node.props.baseuri"><var class="varname">baseURI</var></dt><dd>
      <p class="para">
     ...
     <dt id="dom-node.props.isconnected"><var class="varname">isConnected</var></dt><dd>
      <p class="para">Whether the node is connected to a document</p>
     </dd>
    
    
     <dt id="dom-node.props.ownerdocument"><var class="varname">ownerDocument</var></dt>
     <dd>
      <span class="simpara">
       The <span class="classname"><a href="class.dom-document.php" class="classname">Dom\Document</a></span> object associated with
       this node, or <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if this node is a document.
      </span>
     </dd>
    
    
     <dt id="dom-node.props.parentnode"><var class="varname">parentNode</var></dt><dd>
     ...
     <dt id="dom-node.props.parentelement"><var class="varname">parentElement</var></dt><dd>
     ...
     <dt id="dom-node.props.childnodes"><var class="varname">childNodes</var></dt>
     <dd>
      <span class="simpara">
       A <span class="classname"><a href="class.dom-nodelist.php" class="classname">Dom\NodeList</a></span> that contains all
     ...
     <dt id="dom-node.props.firstchild"><var class="varname">firstChild</var></dt><dd>
      <p class="para">
     ...
     <dt id="dom-node.props.lastchild"><var class="varname">lastChild</var></dt><dd>
     ...
     <dt id="dom-node.props.previoussibling"><var class="varname">previousSibling</var></dt><dd>
      <p class="para">
     ...
     <dt id="dom-node.props.nextsibling"><var class="varname">nextSibling</var></dt><dd>
      <p class="para">
     ...
     <dt id="dom-node.props.nodevalue"><var class="varname">nodeValue</var></dt>
     <dd>
      <span class="simpara">
     ...
     <dt id="dom-node.props.textcontent"><var class="varname">textContent</var></dt><dd>
 ...
 <span class="simpara">
  ...
  <div class="section">
   ...
   <ul class="simplelist">
    <li><a href="https://dom.spec.whatwg.org/#interface-node" class="link external">&raquo;&nbsp;WHATWG specification of Node</a></li>
   </ul>
  </div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dom/dom/dom-node.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.dom-node%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.dom-node&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.dom-node.php">＋<small>add a note</small></a></span>
