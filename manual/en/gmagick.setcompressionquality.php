...
<head>
  ...
  <title>PHP: Gmagick::setCompressionQuality - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setcompressionquality.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setcompressionquality.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setcompressionquality.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.separateimagechannel.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setfilename.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setcompressionquality.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setcompressionquality.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setcompressionquality.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setcompressionquality.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setcompressionquality.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setcompressionquality.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setcompressionquality.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setcompressionquality.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setcompressionquality.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setcompressionquality.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setcompressionquality.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setCompressionQuality - Manual" />
<meta name="twitter:description" content="Sets the object's default compression quality" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setCompressionQuality - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setfilename.php">
          Gmagick::setfilename &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.separateimagechannel.php">
          &laquo; Gmagick::separateimagechannel        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setcompressionquality.php' selected="selected">English</option>
            <option value='de/gmagick.setcompressionquality.php'>German</option>
            <option value='es/gmagick.setcompressionquality.php'>Spanish</option>
            <option value='fr/gmagick.setcompressionquality.php'>French</option>
            <option value='it/gmagick.setcompressionquality.php'>Italian</option>
            <option value='ja/gmagick.setcompressionquality.php'>Japanese</option>
            <option value='pt_BR/gmagick.setcompressionquality.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setcompressionquality.php'>Russian</option>
            <option value='tr/gmagick.setcompressionquality.php'>Turkish</option>
            <option value='uk/gmagick.setcompressionquality.php'>Ukrainian</option>
            <option value='zh/gmagick.setcompressionquality.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setcompressionquality" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setCompressionQuality</h1>
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">Gmagick::setCompressionQuality</span> &mdash; <span class="dc-title">Sets the object&#039;s default compression quality</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setcompressionquality-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>Gmagick::setCompressionQuality</strong></span>(<span class="methodparam">
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setcompressionquality-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setcompressionquality-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setcompressionquality-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
 ...
 <div class="refsect1 examples" id="refsect1-gmagick.setcompressionquality-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
    <div class="example" id="example-2955">
      <p><strong>Example #1  <span class="function"><strong>Gmagick::setCompressionQuality()</strong></span></strong></p>
      <div class="example-contents">
      <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$gm </span><span style="color: #007700">= new </span><span style="color: #0000BB">Gmagick</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$gm</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">read</span><span style="color: #007700">(</span><span style="color: #DD0000">"magick:rose"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$gm</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setCompressionQuality</span><span style="color: #007700">(</span><span style="color: #0000BB">2</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setcompressionquality.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setcompressionquality%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setcompressionquality&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setcompressionquality.php">＋<small>add a note</small></a></span>
