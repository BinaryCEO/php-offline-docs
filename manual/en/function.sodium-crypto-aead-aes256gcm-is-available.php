...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-is-available.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-keygen.php">
...
<meta name="Description" content="Check if hardware supports AES256-GCM" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_aead_aes256gcm_is_available - Manual" />
<meta name="twitter:description" content="Check if hardware supports AES256-GCM" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_aead_aes256gcm_is_available - Manual" />
<meta itemprop="description" content="Check if hardware supports AES256-GCM" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if hardware supports AES256-GCM" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-aead-aes256gcm-is-available.php' selected="selected">English</option>
            ...
            <option value='ru/function.sodium-crypto-aead-aes256gcm-is-available.php'>Russian</option>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-aead-aes256gcm-is-available-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if it is safe to encrypt with AES-256-GCM, and <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-aead-aes256gcm-is-available.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-aead-aes256gcm-is-available%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-aes256gcm-is-available&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-is-available.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">The reason libsodium has an "is_available()" API for AES-GCM and not the ChaCha-Poly AEAD ciphers is that, unlike OpenSSL, libsodium will not expose AES-GCM unless your processor supports hardware-accelerated AES and PCLMULQDQ instructions.<br /><br />If you're wondering what that means: software AES is vulnerable to cache-timing vulnerabilities, due to its internal dependence on table look-ups: <a href="https://cr.yp.to/antiforgery/cachetiming-20050414.pdf" rel="nofollow" target="_blank">https://cr.yp.to/antiforgery/cachetiming-20050414.pdf</a> (PDF)<br /><br />There's a similar attack on the authentication step in GCM (called GMAC or GHASH, depending on context), which leaks the GHASH key (called H) and can be used to perform chosen-ciphertext attacks freely.<br /><br />- You can learn more about GCM exploits here (under the condition of nonce reuse rather than timing leaks, but the consequence is the same): <a href="https://www.youtube.com/watch?v=uxuXFK5XKEU" rel="nofollow" target="_blank">https://www.youtube.com/watch?v=uxuXFK5XKEU</a><br /><br />- You can learn more about AES-GCM here: <a href="https://soatok.blog/2020/05/13/why-aes-gcm-sucks/" rel="nofollow" target="_blank">https://soatok.blog/2020/05/13/why-aes-gcm-sucks/</a><br /><br />- You can learn more about how it compares to other encryption modes here: <a href="https://soatok.blog/2020/07/12/comparison-of-symmetric-encryption-methods/" rel="nofollow" target="_blank">https://soatok.blog/2020/07/12/comparison-of-symmetric-encryption-methods/</a><br /><br />The other AEAD modes are safe to implement in software without risk of side-channel leakage.<br /><br />The take-away is: AES-GCM isn't guaranteed to be available on all hardware because, without hardware support, libsodium will not provide insecure implementations. <br /><br />If you want something guaranteed to be available even on hardware you do not control (hello open source maintainers), your choices are ChaCha20-Poly1305 and XChaCha20-Poly1305.<br /><br />If you can control the hardware and explicitly need AES-GCM (n.b. for FIPS 140-2 validation), feel free to use AES-256-GCM.<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">function </span><span class="default">do_something</span><span class="keyword">(</span><span class="default">string $message</span><span class="keyword">, </span><span class="default">CryptoKeyObject $key</span><span class="keyword">): </span><span class="default">string </span><span class="keyword">{<br />    if (!</span><span class="default">sodium_crypto_aead_aes256gcm_is_available</span><span class="keyword">()) {<br />        throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"AES-256-GCM isn't available on your hardware"</span><span class="keyword">);<br />    }<br />    </span><span class="comment">// ... your code here ...<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-aes256gcm-is-available&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-is-available.php">＋<small>add a note</small></a></div>
