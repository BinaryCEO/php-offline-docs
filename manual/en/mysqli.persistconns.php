...
<head>
  ...
  <title>PHP: The mysqli Extension and Persistent Connections - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.persistconns.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.persistconns.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.persistconns.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.constants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.persistconns.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.persistconns.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.persistconns.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.persistconns.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.persistconns.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.persistconns.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.persistconns.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.persistconns.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.persistconns.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.persistconns.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.persistconns.php" hreflang="zh">
...
<meta name="Description" content="The mysqli Extension and Persistent Connections" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: The mysqli Extension and Persistent Connections - Manual" />
<meta name="twitter:description" content="The mysqli Extension and Persistent Connections" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: The mysqli Extension and Persistent Connections - Manual" />
<meta itemprop="description" content="The mysqli Extension and Persistent Connections" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The mysqli Extension and Persistent Connections" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.persistconns.php' selected="selected">English</option>
            <option value='de/mysqli.persistconns.php'>German</option>
            <option value='es/mysqli.persistconns.php'>Spanish</option>
            <option value='fr/mysqli.persistconns.php'>French</option>
            <option value='it/mysqli.persistconns.php'>Italian</option>
            <option value='ja/mysqli.persistconns.php'>Japanese</option>
            <option value='pt_BR/mysqli.persistconns.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.persistconns.php'>Russian</option>
            <option value='tr/mysqli.persistconns.php'>Turkish</option>
            <option value='uk/mysqli.persistconns.php'>Ukrainian</option>
            <option value='zh/mysqli.persistconns.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.persistconns" class="chapter">
   ...
   Library.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/persistconns.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.persistconns%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.persistconns&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.persistconns.php">＋<small>add a note</small></a></span>
