...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/locale.getdisplayname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/locale.getdisplayname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/locale.getdisplayname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.locale.php">
 <link rel="prev" href="https://www.php.net/manual/en/locale.getdisplaylanguage.php">
 <link rel="next" href="https://www.php.net/manual/en/locale.getdisplayregion.php">
...
<meta name="Description" content="Returns an appropriately localized display name for the input locale" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Locale::getDisplayName - Manual" />
<meta name="twitter:description" content="Returns an appropriately localized display name for the input locale" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Locale::getDisplayName - Manual" />
<meta itemprop="description" content="Returns an appropriately localized display name for the input locale" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an appropriately localized display name for the input locale" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/locale.getdisplayname.php' selected="selected">English</option>
            <option value='de/locale.getdisplayname.php'>German</option>
            <option value='es/locale.getdisplayname.php'>Spanish</option>
            <option value='fr/locale.getdisplayname.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL intl &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Locale::getDisplayName</span> -- <span class="refname">locale_get_display_name</span> &mdash; <span class="dc-title">Returns an appropriately localized display name for the input locale</span></p>
 ...
 <div class="refsect1 description" id="refsect1-locale.getdisplayname-description">
  ...
  <p class="para rdfs-comment">
   Returns an appropriately localized display name for the input locale. If <code class="parameter">locale</code> is
   <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> then the default locale is used.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-locale.getdisplayname-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">optional format locale</p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-locale.getdisplayname-returnvalues">
  ...
  <p class="para">
   Display name of the locale in the format appropriate for <code class="parameter">displayLocale</code>,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-locale.getdisplayname-examples">
  ...
  <div class="example" id="example-2538">
   <p><strong>Example #1 <span class="function"><strong>locale_get_display_name()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="locale.getdisplayvariant.php" class="function" rel="rdfs-seeAlso">locale_get_display_variant()</a> - Returns an appropriately localized display name for variants of the input locale</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/locale/get-display-name.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flocale.getdisplayname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=locale.getdisplayname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/locale.getdisplayname.php">＋<small>add a note</small></a></span>
