...
<head>
  ...
  <title>PHP: gzgetss - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gzgetss.php">
 <link rel="shorturl" href="https://www.php.net/gzgetss">
 <link rel="alternate" href="https://www.php.net/gzgetss" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.zlib.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gzgets.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gzinflate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gzgetss.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gzgetss.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gzgetss.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gzgetss.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gzgetss.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gzgetss.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gzgetss.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gzgetss.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gzgetss.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gzgetss.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gzgetss.php" hreflang="zh">
...
<meta name="Description" content="Get line from gz-file pointer and strip HTML tags" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gzgetss - Manual" />
<meta name="twitter:description" content="Get line from gz-file pointer and strip HTML tags" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gzgetss - Manual" />
<meta itemprop="description" content="Get line from gz-file pointer and strip HTML tags" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get line from gz-file pointer and strip HTML tags" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gzgetss.php' selected="selected">English</option>
            <option value='de/function.gzgetss.php'>German</option>
            <option value='es/function.gzgetss.php'>Spanish</option>
            <option value='fr/function.gzgetss.php'>French</option>
            <option value='it/function.gzgetss.php'>Italian</option>
            <option value='ja/function.gzgetss.php'>Japanese</option>
            <option value='pt_BR/function.gzgetss.php'>Brazilian Portuguese</option>
            <option value='ru/function.gzgetss.php'>Russian</option>
            <option value='tr/function.gzgetss.php'>Turkish</option>
            <option value='uk/function.gzgetss.php'>Ukrainian</option>
            <option value='zh/function.gzgetss.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gzgetss" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gzgetss</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7)</p><p class="refpurpose"><span class="refname">gzgetss</span> &mdash; <span class="dc-title">
   Get line from gz-file pointer and strip HTML tags
  </span></p>

 </div>

 <div id="function.gzgetss-refsynopsisdiv">
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-function.gzgetss-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gzgetss</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$zp</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$allowable_tags</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gzgetss-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">zp</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gzgetss-returnvalues">
  ...
  <p class="para">
   The uncompressed and stripped string, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$handle </span><span style="color: #007700">= </span><span style="color: #0000BB">gzopen</span><span style="color: #007700">(</span><span style="color: #DD0000">'somefile.gz'</span><span style="color: #007700">, </span><span style="color: #DD0000">'r'</span><span style="color: #007700">);<br />while (!</span><span style="color: #0000BB">gzeof</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">)) {<br />   </span><span style="color: #0000BB">$buffer </span><span style="color: #007700">= </span><span style="color: #0000BB">gzgetss</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">, </span><span style="color: #0000BB">4096</span><span style="color: #007700">);<br />   echo </span><span style="color: #0000BB">$buffer</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">gzclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$handle</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.gzgetss-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.strip-tags.php" class="function" rel="rdfs-seeAlso">strip_tags()</a> - Strip HTML and PHP tags from a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zlib/functions/gzgetss.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gzgetss%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gzgetss&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gzgetss.php">＋<small>add a note</small></a></span>
