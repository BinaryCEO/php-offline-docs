...
<head>
  ...
  <title>PHP: mysqli::kill - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.kill.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.kill.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.kill.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.insert-id.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli.more-results.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.kill.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.kill.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.kill.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.kill.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.kill.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.kill.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.kill.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.kill.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.kill.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.kill.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.kill.php" hreflang="zh">
...
<meta name="Description" content="Asks the server to kill a MySQL thread" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::kill - Manual" />
<meta name="twitter:description" content="Asks the server to kill a MySQL thread" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::kill - Manual" />
<meta itemprop="description" content="Asks the server to kill a MySQL thread" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Asks the server to kill a MySQL thread" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli.more-results.php">
          mysqli::more_results &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli.insert-id.php">
          &laquo; mysqli::$insert_id        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.kill.php' selected="selected">English</option>
            <option value='de/mysqli.kill.php'>German</option>
            <option value='es/mysqli.kill.php'>Spanish</option>
            <option value='fr/mysqli.kill.php'>French</option>
            <option value='it/mysqli.kill.php'>Italian</option>
            <option value='ja/mysqli.kill.php'>Japanese</option>
            <option value='pt_BR/mysqli.kill.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.kill.php'>Russian</option>
            <option value='tr/mysqli.kill.php'>Turkish</option>
            <option value='uk/mysqli.kill.php'>Ukrainian</option>
            <option value='zh/mysqli.kill.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.kill" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli::kill</h1>
  <h1 class="refname">mysqli_kill</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::kill</span> -- <span class="refname">mysqli_kill</span> &mdash; <span class="dc-title">Asks the server to kill a MySQL thread</span></p>

 </div>

 <div id="mysqli.kill-refsynopsisdiv">
...
is highly discouraged.</p></div>
 ...
 <div class="refsect1 description" id="refsect1-mysqli.kill-description">
  ...
  <div class="methodsynopsis dc-description">
   ...
   <span class="modifier">public</span> <span class="methodname"><strong>mysqli::kill</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$process_id</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">Procedural style</p>
  <div class="methodsynopsis dc-description"><span class="attribute"><a href="class.deprecated.php">#[\Deprecated]</a> </span><br>
   <span class="methodname"><strong>mysqli_kill</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli.php" class="type mysqli">mysqli</a></span> <code class="parameter">$mysql</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$process_id</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   This function is used to ask the server to kill a MySQL thread specified
   by the <code class="parameter">process_id</code> parameter. This value must be
   retrieved by calling the <span class="function"><a href="mysqli.thread-id.php" class="function">mysqli_thread_id()</a></span> function.
  </p>
  <p class="para">
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
 ...
 <div class="refsect1 errors" id="refsect1-mysqli.kill-errors">
...
a <span class="classname"><a href="class.mysqli-sql-exception.php" class="classname">mysqli_sql_exception</a></span> is thrown instead.</p>
 ...
 <div class="refsect1 changelog" id="refsect1-mysqli.kill-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.4.0</td>
      <td>
       Both <span class="methodname"><strong>mysqli::kill()</strong></span> and
       <span class="function"><strong>mysqli_kill()</strong></span> are now deprecated. Use the
       <code class="literal">KILL</code> SQL command instead.
      </td>
     </tr>
 ...
 <div class="refsect1 examples" id="refsect1-mysqli.kill-examples">
  ...
  <div class="example" id="example-1604">
   <p><strong>Example #1 <span class="methodname"><strong>mysqli::kill()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Error: MySQL server has gone away</pre>
</div>
   </div>
  </div>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.kill-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="mysqli.thread-id.php" class="function" rel="rdfs-seeAlso">mysqli_thread_id()</a> - Returns the thread ID for the current connection</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/kill.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.kill%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.kill&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.kill.php">＋<small>add a note</small></a></span>
