...
<head>
  ...
  <title>PHP: iconv_strpos - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.iconv-strpos.php">
 <link rel="shorturl" href="https://www.php.net/iconv-strpos">
 <link rel="alternate" href="https://www.php.net/iconv-strpos" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.iconv.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.iconv-strlen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.iconv-strrpos.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.iconv-strpos.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.iconv-strpos.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.iconv-strpos.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.iconv-strpos.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.iconv-strpos.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.iconv-strpos.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.iconv-strpos.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.iconv-strpos.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.iconv-strpos.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.iconv-strpos.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.iconv-strpos.php" hreflang="zh">
...
<meta name="Description" content="Finds position of first occurrence of a needle within a haystack" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: iconv_strpos - Manual" />
<meta name="twitter:description" content="Finds position of first occurrence of a needle within a haystack" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: iconv_strpos - Manual" />
<meta itemprop="description" content="Finds position of first occurrence of a needle within a haystack" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Finds position of first occurrence of a needle within a haystack" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.iconv-strpos.php' selected="selected">English</option>
            <option value='de/function.iconv-strpos.php'>German</option>
            <option value='es/function.iconv-strpos.php'>Spanish</option>
            <option value='fr/function.iconv-strpos.php'>French</option>
            <option value='it/function.iconv-strpos.php'>Italian</option>
            <option value='ja/function.iconv-strpos.php'>Japanese</option>
            <option value='pt_BR/function.iconv-strpos.php'>Brazilian Portuguese</option>
            <option value='ru/function.iconv-strpos.php'>Russian</option>
            <option value='tr/function.iconv-strpos.php'>Turkish</option>
            <option value='uk/function.iconv-strpos.php'>Ukrainian</option>
            <option value='zh/function.iconv-strpos.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.iconv-strpos" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-strpos.php" class="function" rel="rdfs-seeAlso">mb_strpos()</a> - Find position of first occurrence of string in a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/iconv/functions/iconv-strpos.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.iconv-strpos%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.iconv-strpos&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.iconv-strpos.php">＋<small>add a note</small></a></span>
