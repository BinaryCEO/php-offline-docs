...
<head>
  ...
  <title>PHP: ps_stringwidth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-stringwidth.php">
 <link rel="shorturl" href="https://www.php.net/ps-stringwidth">
 <link rel="alternate" href="https://www.php.net/ps-stringwidth" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-string-geometry.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-stroke.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-stringwidth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-stringwidth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-stringwidth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-stringwidth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-stringwidth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-stringwidth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-stringwidth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-stringwidth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-stringwidth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-stringwidth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-stringwidth.php" hreflang="zh">
...
<meta name="Description" content="Gets width of a string" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_stringwidth - Manual" />
<meta name="twitter:description" content="Gets width of a string" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_stringwidth - Manual" />
<meta itemprop="description" content="Gets width of a string" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets width of a string" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-stringwidth.php' selected="selected">English</option>
            <option value='de/function.ps-stringwidth.php'>German</option>
            <option value='es/function.ps-stringwidth.php'>Spanish</option>
            <option value='fr/function.ps-stringwidth.php'>French</option>
            <option value='it/function.ps-stringwidth.php'>Italian</option>
            <option value='ja/function.ps-stringwidth.php'>Japanese</option>
            <option value='pt_BR/function.ps-stringwidth.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-stringwidth.php'>Russian</option>
            <option value='tr/function.ps-stringwidth.php'>Turkish</option>
            <option value='uk/function.ps-stringwidth.php'>Ukrainian</option>
            <option value='zh/function.ps-stringwidth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-stringwidth" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-string-geometry.php" class="function" rel="rdfs-seeAlso">ps_string_geometry()</a> - Gets geometry of a string</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-stringwidth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-stringwidth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-stringwidth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-stringwidth.php">＋<small>add a note</small></a></span>
