...
<head>
  ...
  <title>PHP: cubrid_column_types - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.cubrid-column-types.php">
 <link rel="shorturl" href="https://www.php.net/cubrid-column-types">
 <link rel="alternate" href="https://www.php.net/cubrid-column-types" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.cubrid.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.cubrid-column-names.php">
 <link rel="next" href="https://www.php.net/manual/en/function.cubrid-commit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.cubrid-column-types.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.cubrid-column-types.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.cubrid-column-types.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.cubrid-column-types.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.cubrid-column-types.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.cubrid-column-types.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.cubrid-column-types.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.cubrid-column-types.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.cubrid-column-types.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.cubrid-column-types.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.cubrid-column-types.php" hreflang="zh">
...
<meta name="Description" content="Get column types in result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: cubrid_column_types - Manual" />
<meta name="twitter:description" content="Get column types in result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: cubrid_column_types - Manual" />
<meta itemprop="description" content="Get column types in result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get column types in result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.cubrid-commit.php">
          cubrid_commit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.cubrid-column-names.php">
          &laquo; cubrid_column_names        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.cubrid-column-types.php' selected="selected">English</option>
            <option value='de/function.cubrid-column-types.php'>German</option>
            <option value='es/function.cubrid-column-types.php'>Spanish</option>
            <option value='fr/function.cubrid-column-types.php'>French</option>
            <option value='it/function.cubrid-column-types.php'>Italian</option>
            <option value='ja/function.cubrid-column-types.php'>Japanese</option>
            <option value='pt_BR/function.cubrid-column-types.php'>Brazilian Portuguese</option>
            <option value='ru/function.cubrid-column-types.php'>Russian</option>
            <option value='tr/function.cubrid-column-types.php'>Turkish</option>
            <option value='uk/function.cubrid-column-types.php'>Ukrainian</option>
            <option value='zh/function.cubrid-column-types.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.cubrid-column-types" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">cubrid_column_types</h1>
  <p class="verinfo">(PECL CUBRID &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">cubrid_column_types</span> &mdash; <span class="dc-title">Get column types in result</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.cubrid-column-types-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>cubrid_column_types</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$req_identifier</code></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
    The <span class="function"><strong>cubrid_column_types()</strong></span> function gets column types of
    query results by using <code class="parameter">req_identifier</code>.
  </p>
 </div>


  <div class="refsect1 parameters" id="refsect1-function.cubrid-column-types-parameters">
 ...
 <p class="para">
  ...
  <div class="refsect1 returnvalues" id="refsect1-function.cubrid-column-types-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
    Array of string values containing the column types, when process is successful, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.cubrid-column-types-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="example-1223">
   <p><strong>Example #1 <span class="function"><strong>cubrid_column_types()</strong></span> example</strong></p>
...
game_date                      date                           10</pre>
    ...
    <div class="refsect1 seealso" id="refsect1-function.cubrid-column-types-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
   <li><span class="function"><a href="function.cubrid-column-names.php" class="function" rel="rdfs-seeAlso">cubrid_column_names()</a> - Get the column names in result</span></li>
    ...
    <li><span class="function"><a href="function.cubrid-execute.php" class="function" rel="rdfs-seeAlso">cubrid_execute()</a> - Execute a prepared SQL statement</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cubrid/functions/cubrid-column-types.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.cubrid-column-types%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.cubrid-column-types&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.cubrid-column-types.php">＋<small>add a note</small></a></span>
