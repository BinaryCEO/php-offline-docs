...
<head>
  ...
  <title>PHP: streamWrapper::stream_seek - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/streamwrapper.stream-seek.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/streamwrapper.stream-seek.php">
 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-seek.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.streamwrapper.php">
 <link rel="prev" href="https://www.php.net/manual/en/streamwrapper.stream-read.php">
 <link rel="next" href="https://www.php.net/manual/en/streamwrapper.stream-set-option.php">

 <link rel="alternate" href="https://www.php.net/manual/en/streamwrapper.stream-seek.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/streamwrapper.stream-seek.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/streamwrapper.stream-seek.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/streamwrapper.stream-seek.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/streamwrapper.stream-seek.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/streamwrapper.stream-seek.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/streamwrapper.stream-seek.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/streamwrapper.stream-seek.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/streamwrapper.stream-seek.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/streamwrapper.stream-seek.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/streamwrapper.stream-seek.php" hreflang="zh">
...
<meta name="Description" content="Seeks to specific location in a stream" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: streamWrapper::stream_seek - Manual" />
<meta name="twitter:description" content="Seeks to specific location in a stream" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: streamWrapper::stream_seek - Manual" />
<meta itemprop="description" content="Seeks to specific location in a stream" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Seeks to specific location in a stream" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="streamwrapper.stream-set-option.php">
          streamWrapper::stream_set_option &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="streamwrapper.stream-read.php">
          &laquo; streamWrapper::stream_read        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/streamwrapper.stream-seek.php' selected="selected">English</option>
            <option value='de/streamwrapper.stream-seek.php'>German</option>
            <option value='es/streamwrapper.stream-seek.php'>Spanish</option>
            <option value='fr/streamwrapper.stream-seek.php'>French</option>
            <option value='it/streamwrapper.stream-seek.php'>Italian</option>
            <option value='ja/streamwrapper.stream-seek.php'>Japanese</option>
            <option value='pt_BR/streamwrapper.stream-seek.php'>Brazilian Portuguese</option>
            <option value='ru/streamwrapper.stream-seek.php'>Russian</option>
            <option value='tr/streamwrapper.stream-seek.php'>Turkish</option>
            <option value='uk/streamwrapper.stream-seek.php'>Ukrainian</option>
            <option value='zh/streamwrapper.stream-seek.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="streamwrapper.stream-seek" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fseek.php" class="function" rel="rdfs-seeAlso">fseek()</a> - Seeks on a file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/streamwrapper/stream-seek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fstreamwrapper.stream-seek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=streamwrapper.stream-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.stream-seek.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="115111">  <div class="votes">
    <div id="Vu115111">
    <a href="/manual/vote-note.php?id=115111&amp;page=streamwrapper.stream-seek&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115111">
    <a href="/manual/vote-note.php?id=115111&amp;page=streamwrapper.stream-seek&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115111" title="80% like this...">
    3
    </div>
  </div>
  <a href="#115111" class="name">
  <strong class="user"><em>fb at tigermedia dot dk</em></strong></a><a class="genanchor" href="#115111"> &para;</a><div class="date" title="2014-05-27 08:55"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom115111">
<div class="phpcode"><code><span class="html">Please notice that the return value of this function is a boolean but the return value of fseek is 0 for ok and -1 for failure.<br /><br />Please use this implementation when working with files:<br /><br />function stream_seek($offset, $whence) {<br />        if(0 === fseek($this-&gt;_handler, $offset, $whence)){<br />            return true;<br />        }<br />        return false;<br />}</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=streamwrapper.stream-seek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/streamwrapper.stream-seek.php">＋<small>add a note</small></a></div>
