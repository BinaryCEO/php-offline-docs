...
<head>
  ...
  <title>PHP: Parser examples - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/parle.examples.parser.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/parle.examples.parser.php">
 <link rel="alternate" href="https://www.php.net/manual/en/parle.examples.parser.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/parle.examples.php">
 <link rel="prev" href="https://www.php.net/manual/en/parle.examples.lexer.php">
 <link rel="next" href="https://www.php.net/manual/en/class.parle-lexer.php">

 <link rel="alternate" href="https://www.php.net/manual/en/parle.examples.parser.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/parle.examples.parser.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/parle.examples.parser.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/parle.examples.parser.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/parle.examples.parser.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/parle.examples.parser.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/parle.examples.parser.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/parle.examples.parser.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/parle.examples.parser.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/parle.examples.parser.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/parle.examples.parser.php" hreflang="zh">
...
<meta name="Description" content="Parser examples" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Parser examples - Manual" />
<meta name="twitter:description" content="Parser examples" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Parser examples - Manual" />
<meta itemprop="description" content="Parser examples" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parser examples" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.parle-lexer.php">
          Parle\Lexer &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="parle.examples.lexer.php">
          &laquo; Lexer examples        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.text.php'>Text Processing</a></li>      <li><a href='book.parle.php'>Parle</a></li>      <li><a href='parle.examples.php'>Examples</a></li>      </ul>
    </div>
  </div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #007700">use </span><span style="color: #0000BB">Parle</span><span style="color: #007700">\{</span><span style="color: #0000BB">Lexer</span><span style="color: #007700">, </span><span style="color: #0000BB">Token</span><span style="color: #007700">, </span><span style="color: #0000BB">Parser</span><span style="color: #007700">, </span><span style="color: #0000BB">ParserException</span><span style="color: #007700">};<br /><br /></span><span style="color: #0000BB">$p </span><span style="color: #007700">= new </span><span style="color: #0000BB">Parser</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">token</span><span style="color: #007700">(</span><span style="color: #DD0000">"WORD"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">push</span><span style="color: #007700">(</span><span style="color: #DD0000">"START"</span><span style="color: #007700">, </span><span style="color: #DD0000">"SENTENCE"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">push</span><span style="color: #007700">(</span><span style="color: #DD0000">"SENTENCE"</span><span style="color: #007700">, </span><span style="color: #DD0000">"WORDS"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$prod_word_0 </span><span style="color: #007700">= </span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">push</span><span style="color: #007700">(</span><span style="color: #DD0000">"WORDS"</span><span style="color: #007700">, </span><span style="color: #DD0000">"WORDS WORD"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$prod_word_1 </span><span style="color: #007700">= </span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">push</span><span style="color: #007700">(</span><span style="color: #DD0000">"WORDS"</span><span style="color: #007700">, </span><span style="color: #DD0000">"WORD"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">build</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$lex </span><span style="color: #007700">= new </span><span style="color: #0000BB">Lexer</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$lex</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">push</span><span style="color: #007700">(</span><span style="color: #DD0000">"[^\s]{-}[\.,\:\;\?]+"</span><span style="color: #007700">, </span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">tokenId</span><span style="color: #007700">(</span><span style="color: #DD0000">"WORD"</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">$lex</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">push</span><span style="color: #007700">(</span><span style="color: #DD0000">"[\s\.,\:\;\?]+"</span><span style="color: #007700">, </span><span style="color: #0000BB">Token</span><span style="color: #007700">::</span><span style="color: #0000BB">SKIP</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$lex</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">build</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$in </span><span style="color: #007700">= </span><span style="color: #DD0000">"Dis-moi où est ton papa?"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">consume</span><span style="color: #007700">(</span><span style="color: #0000BB">$in</span><span style="color: #007700">, </span><span style="color: #0000BB">$lex</span><span style="color: #007700">);<br />do {<br />    switch (</span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">action</span><span style="color: #007700">) {<br />    case </span><span style="color: #0000BB">Parser</span><span style="color: #007700">::</span><span style="color: #0000BB">ACTION_ERROR</span><span style="color: #007700">:<br />        throw new </span><span style="color: #0000BB">ParserException</span><span style="color: #007700">(</span><span style="color: #DD0000">"Error"</span><span style="color: #007700">);<br />        break;<br />    case </span><span style="color: #0000BB">Parser</span><span style="color: #007700">::</span><span style="color: #0000BB">ACTION_SHIFT</span><span style="color: #007700">:<br />    case </span><span style="color: #0000BB">Parser</span><span style="color: #007700">::</span><span style="color: #0000BB">ACTION_GOTO</span><span style="color: #007700">:<br />        </span><span style="color: #FF8000">/* var_dump($p-&gt;trace());*/<br />        </span><span style="color: #007700">break;<br />    case </span><span style="color: #0000BB">Parser</span><span style="color: #007700">::</span><span style="color: #0000BB">ACTION_REDUCE</span><span style="color: #007700">:<br />        </span><span style="color: #0000BB">$rid </span><span style="color: #007700">= </span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">reduceId</span><span style="color: #007700">();<br />        if (</span><span style="color: #0000BB">$rid </span><span style="color: #007700">== </span><span style="color: #0000BB">$prod_word_1</span><span style="color: #007700">) {<br />            </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">sigil</span><span style="color: #007700">(</span><span style="color: #0000BB">0</span><span style="color: #007700">));<br />        } if (</span><span style="color: #0000BB">$rid </span><span style="color: #007700">== </span><span style="color: #0000BB">$prod_word_0</span><span style="color: #007700">) {<br />            </span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">sigil</span><span style="color: #007700">(</span><span style="color: #0000BB">1</span><span style="color: #007700">));<br />        }<br />        break;<br />    }<br />    </span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">advance</span><span style="color: #007700">();<br />} while (</span><span style="color: #0000BB">Parser</span><span style="color: #007700">::</span><span style="color: #0000BB">ACTION_ACCEPT </span><span style="color: #007700">!= </span><span style="color: #0000BB">$p</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">action</span><span style="color: #007700">);</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/parle/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fparle.examples.parser%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=parle.examples.parser&amp;repo=en&amp;redirect=https://www.php.net/manual/en/parle.examples.parser.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128455">  <div class="votes">
    <div id="Vu128455">
    <a href="/manual/vote-note.php?id=128455&amp;page=parle.examples.parser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128455">
    <a href="/manual/vote-note.php?id=128455&amp;page=parle.examples.parser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128455" title="75% like this...">
    2
    </div>
  </div>
  <a href="#128455" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#128455"> &para;</a><div class="date" title="2023-05-07 08:13"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128455">
<div class="phpcode"><code><span class="html">For example 1:<br /><br />$p-&gt;left("'+' '-' '*' '/'");<br /><br />should be<br /><br />$p-&gt;left("'+' '-'");<br />$p-&gt;left("'*' '/'");<br /><br />in order for operator precedence to be respected.</span></code></div>
  </div>
 </div>
  <div class="note" id="124952">  <div class="votes">
    <div id="Vu124952">
    <a href="/manual/vote-note.php?id=124952&amp;page=parle.examples.parser&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124952">
    <a href="/manual/vote-note.php?id=124952&amp;page=parle.examples.parser&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124952" title="57% like this...">
    1
    </div>
  </div>
  <a href="#124952" class="name">
  <strong class="user"><em>andres1gb at gmail dot com</em></strong></a><a class="genanchor" href="#124952"> &para;</a><div class="date" title="2020-04-27 03:45"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124952">
<div class="phpcode"><code><span class="html">The second example (word count) calls a method reduceId(), instead of retrieving the value of the reduceId property.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=parle.examples.parser&amp;repo=en&amp;redirect=https://www.php.net/manual/en/parle.examples.parser.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="parle.examples.php">Examples</a>

                                    <ul class='child-menu-list'>

                                                <li class="">
                            <a href="parle.examples.lexer.php" title="Lexer examples">Lexer examples</a>
                        </li>
                                                <li class="current">
                            <a href="parle.examples.parser.php" title="Parser examples">Parser examples</a>
                        </li>
