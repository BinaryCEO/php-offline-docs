...
<head>
  ...
  <title>PHP: ReflectionParameter::hasType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionparameter.hastype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionparameter.hastype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.hastype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionparameter.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionparameter.gettype.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionparameter.isarray.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionparameter.hastype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionparameter.hastype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionparameter.hastype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionparameter.hastype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionparameter.hastype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionparameter.hastype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionparameter.hastype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionparameter.hastype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionparameter.hastype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionparameter.hastype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionparameter.hastype.php" hreflang="zh">
...
<meta name="Description" content="Checks if parameter has a type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionParameter::hasType - Manual" />
<meta name="twitter:description" content="Checks if parameter has a type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionParameter::hasType - Manual" />
<meta itemprop="description" content="Checks if parameter has a type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if parameter has a type" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionparameter.isarray.php">
          ReflectionParameter::isArray &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionparameter.gettype.php">
          &laquo; ReflectionParameter::getType        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionparameter.hastype.php' selected="selected">English</option>
            <option value='de/reflectionparameter.hastype.php'>German</option>
            <option value='es/reflectionparameter.hastype.php'>Spanish</option>
            <option value='fr/reflectionparameter.hastype.php'>French</option>
            <option value='it/reflectionparameter.hastype.php'>Italian</option>
            <option value='ja/reflectionparameter.hastype.php'>Japanese</option>
            <option value='pt_BR/reflectionparameter.hastype.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionparameter.hastype.php'>Russian</option>
            <option value='tr/reflectionparameter.hastype.php'>Turkish</option>
            <option value='uk/reflectionparameter.hastype.php'>Ukrainian</option>
            <option value='zh/reflectionparameter.hastype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionparameter.hastype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionParameter::hasType</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionParameter::hasType</span> &mdash; <span class="dc-title">Checks if parameter has a type</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionparameter.hastype-examples">
  ...
  <p class="para">
   <div class="example" id="example-5589">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionParameter::hasType()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionparameter.gettype.php" class="methodname" rel="rdfs-seeAlso">ReflectionParameter::getType()</a> - Gets a parameter's type</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionparameter/hastype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionparameter.hastype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionparameter.hastype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionparameter.hastype.php">＋<small>add a note</small></a></span>
