...
<head>
  ...
  <title>PHP: Phar::getModified - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.getmodified.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.getmodified.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.getmodified.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.getmetadata.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.getpath.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.getmodified.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.getmodified.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.getmodified.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.getmodified.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.getmodified.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.getmodified.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.getmodified.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.getmodified.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.getmodified.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.getmodified.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.getmodified.php" hreflang="zh">
...
<meta name="Description" content="Return whether phar was modified" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::getModified - Manual" />
<meta name="twitter:description" content="Return whether phar was modified" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::getModified - Manual" />
<meta itemprop="description" content="Return whether phar was modified" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return whether phar was modified" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="phar.getpath.php">
          Phar::getPath &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.getmetadata.php">
          &laquo; Phar::getMetadata        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.getmodified.php' selected="selected">English</option>
            <option value='de/phar.getmodified.php'>German</option>
            <option value='es/phar.getmodified.php'>Spanish</option>
            <option value='fr/phar.getmodified.php'>French</option>
            <option value='it/phar.getmodified.php'>Italian</option>
            <option value='ja/phar.getmodified.php'>Japanese</option>
            <option value='pt_BR/phar.getmodified.php'>Brazilian Portuguese</option>
            <option value='ru/phar.getmodified.php'>Russian</option>
            <option value='tr/phar.getmodified.php'>Turkish</option>
            <option value='uk/phar.getmodified.php'>Ukrainian</option>
            <option value='zh/phar.getmodified.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.getmodified" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Phar::getModified</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8, PECL phar &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">Phar::getModified</span> &mdash; <span class="dc-title">Return whether phar was modified</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-phar.getmodified-returnvalues">
  ...
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the phar has been modified since opened, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/getModified.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.getmodified%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.getmodified&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.getmodified.php">＋<small>add a note</small></a></span>
