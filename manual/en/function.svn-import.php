...
<head>
  ...
  <title>PHP: svn_import - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-import.php">
 <link rel="shorturl" href="https://www.php.net/svn-import">
 <link rel="alternate" href="https://www.php.net/svn-import" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-fs-youngest-rev.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-log.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-import.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-import.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-import.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-import.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-import.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-import.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-import.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-import.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-import.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-import.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-import.php" hreflang="zh">
...
<meta name="Description" content="Imports an unversioned path into a repository" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_import - Manual" />
<meta name="twitter:description" content="Imports an unversioned path into a repository" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_import - Manual" />
<meta itemprop="description" content="Imports an unversioned path into a repository" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Imports an unversioned path into a repository" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-import.php' selected="selected">English</option>
            <option value='de/function.svn-import.php'>German</option>
            <option value='es/function.svn-import.php'>Spanish</option>
            <option value='fr/function.svn-import.php'>French</option>
            <option value='it/function.svn-import.php'>Italian</option>
            <option value='ja/function.svn-import.php'>Japanese</option>
            <option value='pt_BR/function.svn-import.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-import.php'>Russian</option>
            <option value='tr/function.svn-import.php'>Turkish</option>
            <option value='uk/function.svn-import.php'>Ukrainian</option>
            <option value='zh/function.svn-import.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-import" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="http://svnbook.red-bean.com/en/1.2/svn.ref.svn.c.import.html" class="link external">&raquo;&nbsp;SVN documentation for svn import</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-import.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-import%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-import&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-import.php">＋<small>add a note</small></a></span>
