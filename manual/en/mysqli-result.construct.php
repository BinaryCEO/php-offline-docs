...
<head>
  ...
  <title>PHP: mysqli_result::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-result.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-result.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-result.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.mysqli-result.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-result.current-field.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-result.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-result.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-result.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-result.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-result.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-result.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-result.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-result.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-result.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-result.construct.php" hreflang="zh">
...
<meta name="Description" content="Constructs a mysqli_result object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_result::__construct - Manual" />
<meta name="twitter:description" content="Constructs a mysqli_result object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_result::__construct - Manual" />
<meta itemprop="description" content="Constructs a mysqli_result object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Constructs a mysqli_result object" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli-result.current-field.php">
          mysqli_result::$current_field &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.mysqli-result.php">
          &laquo; mysqli_result        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-result.construct.php' selected="selected">English</option>
            <option value='de/mysqli-result.construct.php'>German</option>
            <option value='es/mysqli-result.construct.php'>Spanish</option>
            <option value='fr/mysqli-result.construct.php'>French</option>
            <option value='it/mysqli-result.construct.php'>Italian</option>
            <option value='ja/mysqli-result.construct.php'>Japanese</option>
            <option value='pt_BR/mysqli-result.construct.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-result.construct.php'>Russian</option>
            <option value='tr/mysqli-result.construct.php'>Turkish</option>
            <option value='uk/mysqli-result.construct.php'>Ukrainian</option>
            <option value='zh/mysqli-result.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-result.construct" class="refentry">
...
a <span class="classname"><a href="class.mysqli-sql-exception.php" class="classname">mysqli_sql_exception</a></span> is thrown instead.</p>
 ...
 <div class="refsect1 examples" id="refsect1-mysqli-result.construct-examples">
  ...
  <div class="example" id="example-1652">
   <p><strong>Example #1 Creation of a <span class="classname"><a href="class.mysqli-result.php" class="classname">mysqli_result</a></span> object</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.use-result.php" class="function" rel="rdfs-seeAlso">mysqli_use_result()</a> - Initiate a result set retrieval</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_result/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-result.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-result.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-result.construct.php">＋<small>add a note</small></a></span>
