...
<head>
  ...
  <title>PHP: MongoDB\BSON\Binary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-bson-binary.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-bson-binary">
 <link rel="alternate" href="https://www.php.net/mongodb-bson-binary" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-iterator.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-binary.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-bson-binary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-bson-binary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-bson-binary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-bson-binary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-bson-binary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-bson-binary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-bson-binary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-bson-binary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-bson-binary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-bson-binary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-bson-binary.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\BSON\Binary class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Binary - Manual" />
<meta name="twitter:description" content="The MongoDB\BSON\Binary class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Binary - Manual" />
<meta itemprop="description" content="The MongoDB\BSON\Binary class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\BSON\Binary class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-bson-binary.construct.php">
          MongoDB\BSON\Binary::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-iterator.valid.php">
          &laquo; MongoDB\BSON\Iterator::valid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-bson-binary.php' selected="selected">English</option>
            <option value='de/class.mongodb-bson-binary.php'>German</option>
            <option value='es/class.mongodb-bson-binary.php'>Spanish</option>
            <option value='fr/class.mongodb-bson-binary.php'>French</option>
            <option value='it/class.mongodb-bson-binary.php'>Italian</option>
            <option value='ja/class.mongodb-bson-binary.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-bson-binary.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-bson-binary.php'>Russian</option>
            <option value='tr/class.mongodb-bson-binary.php'>Turkish</option>
            <option value='uk/class.mongodb-bson-binary.php'>Ukrainian</option>
            <option value='zh/class.mongodb-bson-binary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-bson-binary" class="reference">
...
<div class="methodsynopsis dc-description"><span class="modifier">final</span> <span class="modifier">public</span> <span class="methodname"><a href="mongodb-bson-binary.tostring.php" class="methodname">__toString</a></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
  ...
  <div class="section" id="mongodb-bson-binary.constants">
   ...
   <dl>
     ...
     <dd>
      <p class="para">Generic binary data (deprecated in favor of <strong><code><a href="class.mongodb-bson-binary.php#mongodb-bson-binary.constants.type-generic">MongoDB\BSON\Binary::TYPE_GENERIC</a></code></strong>).</p>
     </dd>
     ...
     <dd>
      <p class="para">
       ...
       <strong><code><a href="class.mongodb-bson-binary.php#mongodb-bson-binary.constants.type-uuid">MongoDB\BSON\Binary::TYPE_UUID</a></code></strong>). When using this
     ...
     <dd>
      <p class="para">Column data. This subtype is used for time-series collections.</p>
     </dd>
    ...
    <table class="doctable informaltable">
      ...
      <tbody class="tbody">
       ...
       <tr>
        ...
        <td>
         Added <strong><code><a href="class.mongodb-bson-binary.php#mongodb-bson-binary.constants.type-sensitive">MongoDB\BSON\Binary::TYPE_SENSITIVE</a></code></strong>.
        </td>
       </tr>
       ...
       <tr>
        ...
        <td>
         ...
         <p class="para">
          Added <strong><code><a href="class.mongodb-bson-binary.php#mongodb-bson-binary.constants.type-column">MongoDB\BSON\Binary::TYPE_COLUMN</a></code></strong>.
         </p>
        </td>
       </tr>
       ...
       <tr>
        ...
        <td>
         Added <strong><code><a href="class.mongodb-bson-binary.php#mongodb-bson-binary.constants.type-encrypted">MongoDB\BSON\Binary::TYPE_ENCRYPTED</a></code></strong>.
        </td>
       </tr>
       ...
       <tr>
        ...
        <td>
         Implements <span class="interfacename"><a href="class.mongodb-bson-binaryinterface.php" class="interfacename">MongoDB\BSON\BinaryInterface</a></span>.
        </td>
       </tr>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-bson-binary.construct.php">MongoDB\BSON\Binary::__construct</a> — Construct a new Binary</li><li><a href="mongodb-bson-binary.getdata.php">MongoDB\BSON\Binary::getData</a> — Returns the Binary's data</li><li><a href="mongodb-bson-binary.gettype.php">MongoDB\BSON\Binary::getType</a> — Returns the Binary's type</li><li><a href="mongodb-bson-binary.jsonserialize.php">MongoDB\BSON\Binary::jsonSerialize</a> — Returns a representation that can be converted to JSON</li><li><a href="mongodb-bson-binary.tostring.php">MongoDB\BSON\Binary::__toString</a> — Returns the Binary's data</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/binary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-bson-binary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-bson-binary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-binary.php">＋<small>add a note</small></a></span>
