...
<head>
  ...
  <title>PHP: fdf_remove_item - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fdf-remove-item.php">
 <link rel="shorturl" href="https://www.php.net/fdf-remove-item">
 <link rel="alternate" href="https://www.php.net/fdf-remove-item" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fdf.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fdf-open-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fdf-save.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fdf-remove-item.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fdf-remove-item.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fdf-remove-item.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fdf-remove-item.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fdf-remove-item.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fdf-remove-item.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fdf-remove-item.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fdf-remove-item.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fdf-remove-item.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fdf-remove-item.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fdf-remove-item.php" hreflang="zh">
...
<meta name="Description" content="Sets target frame for form" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fdf_remove_item - Manual" />
<meta name="twitter:description" content="Sets target frame for form" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fdf_remove_item - Manual" />
<meta itemprop="description" content="Sets target frame for form" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets target frame for form" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fdf-remove-item.php' selected="selected">English</option>
            <option value='de/function.fdf-remove-item.php'>German</option>
            <option value='es/function.fdf-remove-item.php'>Spanish</option>
            <option value='fr/function.fdf-remove-item.php'>French</option>
            <option value='it/function.fdf-remove-item.php'>Italian</option>
            <option value='ja/function.fdf-remove-item.php'>Japanese</option>
            <option value='pt_BR/function.fdf-remove-item.php'>Brazilian Portuguese</option>
            <option value='ru/function.fdf-remove-item.php'>Russian</option>
            <option value='tr/function.fdf-remove-item.php'>Turkish</option>
            <option value='uk/function.fdf-remove-item.php'>Ukrainian</option>
            <option value='zh/function.fdf-remove-item.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fdf-remove-item" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fdf_remove_item</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5 &lt; 5.3.0, PECL fdf SVN)</p><p class="refpurpose"><span class="refname">fdf_remove_item</span> &mdash; <span class="dc-title">Sets target frame for form</span></p>
...
currently not documented; only its argument list is available.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fdf/functions/fdf-remove-item.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fdf-remove-item%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fdf-remove-item&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fdf-remove-item.php">＋<small>add a note</small></a></span>
