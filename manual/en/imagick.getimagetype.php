...
<head>
  ...
  <title>PHP: Imagick::getImageType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagetype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagetype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagetype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagetotalinkdensity.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageunits.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagetype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagetype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagetype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagetype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagetype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagetype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagetype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagetype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagetype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagetype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagetype.php" hreflang="zh">
...
<meta name="Description" content="Gets the potential image type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageType - Manual" />
<meta name="twitter:description" content="Gets the potential image type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageType - Manual" />
<meta itemprop="description" content="Gets the potential image type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the potential image type" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimageunits.php">
          Imagick::getImageUnits &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagetotalinkdensity.php">
          &laquo; Imagick::getImageTotalInkDensity        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagetype.php' selected="selected">English</option>
            <option value='de/imagick.getimagetype.php'>German</option>
            <option value='es/imagick.getimagetype.php'>Spanish</option>
            <option value='fr/imagick.getimagetype.php'>French</option>
            <option value='it/imagick.getimagetype.php'>Italian</option>
            <option value='ja/imagick.getimagetype.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagetype.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagetype.php'>Russian</option>
            <option value='tr/imagick.getimagetype.php'>Turkish</option>
            <option value='uk/imagick.getimagetype.php'>Ukrainian</option>
            <option value='zh/imagick.getimagetype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagetype" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageType</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageType</span> &mdash; <span class="dc-title">Gets the potential image type</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagetype-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageType</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagetype-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>

 
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagetype-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagetype-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagetype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagetype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagetype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagetype.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108737">  <div class="votes">
    <div id="Vu108737">
    <a href="/manual/vote-note.php?id=108737&amp;page=imagick.getimagetype&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108737">
    <a href="/manual/vote-note.php?id=108737&amp;page=imagick.getimagetype&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108737" title="no votes...">
    0
    </div>
  </div>
  <a href="#108737" class="name">
  <strong class="user"><em>holdoffhunger at gmail dot com</em></strong></a><a class="genanchor" href="#108737"> &para;</a><div class="date" title="2012-05-21 11:18"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108737">
<div class="phpcode"><code><span class="html">This function will return an integer, with that value being equal to the evaluated value of the IMGType Constants as defined by the ImageMagick class.  When accessing them, they look like "imagick::IMGTYPE_PALETTE", but with "_VALUE" values of: undefined, bilevel, grayscale, grayscalematte, palette, palettematte, truecolor, truecolormatte, colorseparation, colorseparationmatte, and optimize.  If you were to print out these values, you would have '0' for undefined, '1' for bilevel, '2' for grayscale, and so on.<br /><br />For a BMP picture drawn in paint, I got back the value # 4 - Palette.  For a BMP or JPEG photograph of the ocean or jungle, I got back the value # 6 - Truecolor.  For an animated GIF file, I got back the value # 5 - Palette Matte.  For a black-and-white JPEG drawing, I got back the value # 2 - Grayscale.  These are the most common results I have gotten back with this function.<br /><br />Some sample code :<br /><br /><span class="default">&lt;?php<br /><br />            </span><span class="comment">// Author: holdoffhunger@gmail.com<br />    <br />        // Imagick Type<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Open File<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$file_to_grab </span><span class="keyword">= </span><span class="string">"image_workshop_directory/test.bmp"</span><span class="keyword">;<br />    <br />    </span><span class="default">$file_handle_for_viewing_image_file </span><span class="keyword">= </span><span class="default">fopen</span><span class="keyword">(</span><span class="default">$file_to_grab</span><span class="keyword">, </span><span class="string">'a+'</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Grab File<br />        // ---------------------------------------------<br /><br />    </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">readImageFile</span><span class="keyword">(</span><span class="default">$file_handle_for_viewing_image_file</span><span class="keyword">);<br />    <br />        </span><span class="comment">// Get Image Type Value<br />        // ---------------------------------------------<br />        <br />    </span><span class="default">$image_type </span><span class="keyword">= </span><span class="default">$imagick_type</span><span class="keyword">-&gt;</span><span class="default">getImageType</span><span class="keyword">();<br />    <br />        </span><span class="comment">// Interpret Image Type Value<br />        // ---------------------------------------------<br /><br />    </span><span class="keyword">switch(</span><span class="default">$image_type</span><span class="keyword">)<br />    {<br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_UNDEFINED</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Undefined"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_BILEVEL</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Bilevel"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_GRAYSCALE</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Grayscale"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_GRAYSCALEMATTE</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Grayscale Matte"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_PALETTE</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Palette"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_PALETTEMATTE</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Palette Matte"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_TRUECOLOR</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Truecolor"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_TRUECOLORMATTE</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Truecolor Matte"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_COLORSEPARATION</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Color Separation"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_COLORSEPARATIONMATTE</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Color Separation Matte"</span><span class="keyword">;<br />            break;<br />            <br />        case </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">IMGTYPE_OPTIMIZE</span><span class="keyword">:<br />            </span><span class="default">$image_type_title </span><span class="keyword">= </span><span class="string">"Optimize"</span><span class="keyword">;<br />            break;<br />    }<br />    <br />        </span><span class="comment">// Print Image Type Value<br />        // ---------------------------------------------<br />        <br />    </span><span class="keyword">print(</span><span class="string">"# </span><span class="default">$image_type</span><span class="string"> - </span><span class="default">$image_type_title</span><span class="string">"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="88205">  <div class="votes">
    <div id="Vu88205">
    <a href="/manual/vote-note.php?id=88205&amp;page=imagick.getimagetype&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd88205">
    <a href="/manual/vote-note.php?id=88205&amp;page=imagick.getimagetype&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V88205" title="0% like this...">
    -2
    </div>
  </div>
  <a href="#88205" class="name">
  <strong class="user"><em>lukeydeluxe at gmail dot com</em></strong></a><a class="genanchor" href="#88205"> &para;</a><div class="date" title="2009-01-15 04:13"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom88205">
<div class="phpcode"><code><span class="html">Remember, the result, if successful, is an Array, wich means you should call for example "$var[format]" if you want to know what format the file uses.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimagetype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagetype.php">＋<small>add a note</small></a></div>
