...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-hex2bin.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-stream-xor.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-increment.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-hex2bin.php' selected="selected">English</option>
            <option value='de/function.sodium-hex2bin.php'>German</option>
            <option value='es/function.sodium-hex2bin.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_hex2bin</span> &mdash; <span class="dc-title">Decodes a hexadecimally encoded binary string</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-hex2bin-description">
  ...
  <p class="para">
   Like <span class="function"><a href="function.sodium-bin2hex.php" class="function">sodium_bin2hex()</a></span>, <span class="function"><strong>sodium_hex2bin()</strong></span>
   is resistant to side-channel attacks while <span class="function"><a href="function.hex2bin.php" class="function">hex2bin()</a></span> is not.
  </p> 
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-hex2bin-returnvalues">
  ...
  <p class="para">
   Returns the binary representation of the given <code class="parameter">string</code> data.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-hex2bin.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-hex2bin%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-hex2bin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-hex2bin.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>o-ren-shi at o2 dot pl</em></strong></a><a class="genanchor" href="#130184"> &para;</a><div class="date" title="2025-03-23 11:56"><strong>6 months ago</strong></div>
  <div class="text" id="Hcom130184">
<div class="phpcode"><code><span class="html">For some very, very weird reason, if you pass an invalid argument to this function:<br /><br /><span class="default">&lt;?php $cfg</span><span class="keyword">[</span><span class="string">'blowfish_secret'</span><span class="keyword">] = </span><span class="default">sodium_hex2bin</span><span class="keyword">(</span><span class="string">'f16ce59f45714194371b48dZGBmq4sRDUFy99glKIlKjlxaB76luP64d6fb13851'</span><span class="keyword">); </span><span class="default">?&gt;<br /></span><br />then you'll get "Fatal error: Uncaught Error: Call to undefined function sodium_hex2bin()" error instead of any error that would tell you that your argument is invalid.<br /><br />I still keep wondering why this isn't intercepted internally and how can PHP find one of its internal functions undefined only due to the wrong argument developer calls them with.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-hex2bin&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-hex2bin.php">＋<small>add a note</small></a></div>
