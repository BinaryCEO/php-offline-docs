...
<head>
  ...
  <title>PHP: SolrQuery::setMltMinTermFrequency - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmltmintermfrequency.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmltmintermfrequency.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmintermfrequency.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmltmindocfrequency.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmltminwordlength.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmintermfrequency.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setmltmintermfrequency.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setmltmintermfrequency.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setmltmintermfrequency.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setmltmintermfrequency.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setmltmintermfrequency.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setmltmintermfrequency.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setmltmintermfrequency.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setmltmintermfrequency.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setmltmintermfrequency.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setmltmintermfrequency.php" hreflang="zh">
...
<meta name="Description" content="Sets the frequency below which terms will be ignored in the source docs" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMltMinTermFrequency - Manual" />
<meta name="twitter:description" content="Sets the frequency below which terms will be ignored in the source docs" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMltMinTermFrequency - Manual" />
<meta itemprop="description" content="Sets the frequency below which terms will be ignored in the source docs" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the frequency below which terms will be ignored in the source docs" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setmltminwordlength.php">
          SolrQuery::setMltMinWordLength &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setmltmindocfrequency.php">
          &laquo; SolrQuery::setMltMinDocFrequency        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmltmintermfrequency.php' selected="selected">English</option>
            <option value='de/solrquery.setmltmintermfrequency.php'>German</option>
            <option value='es/solrquery.setmltmintermfrequency.php'>Spanish</option>
            <option value='fr/solrquery.setmltmintermfrequency.php'>French</option>
            <option value='it/solrquery.setmltmintermfrequency.php'>Italian</option>
            <option value='ja/solrquery.setmltmintermfrequency.php'>Japanese</option>
            <option value='pt_BR/solrquery.setmltmintermfrequency.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setmltmintermfrequency.php'>Russian</option>
            <option value='tr/solrquery.setmltmintermfrequency.php'>Turkish</option>
            <option value='uk/solrquery.setmltmintermfrequency.php'>Ukrainian</option>
            <option value='zh/solrquery.setmltmintermfrequency.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setmltmintermfrequency" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setMltMinTermFrequency</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setMltMinTermFrequency</span> &mdash; <span class="dc-title">Sets the frequency below which terms will be ignored in the source docs</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setmltmintermfrequency-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setMltMinTermFrequency</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$minTermFrequency</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setmltmintermfrequency-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">minTermFrequency</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setmltmintermfrequency-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmltmintermfrequency.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmltmintermfrequency%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmltmintermfrequency&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmltmintermfrequency.php">＋<small>add a note</small></a></span>
