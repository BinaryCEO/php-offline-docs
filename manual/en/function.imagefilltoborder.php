...
<head>
  ...
  <title>PHP: imagefilltoborder - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagefilltoborder.php">
 <link rel="shorturl" href="https://www.php.net/imagefilltoborder">
 <link rel="alternate" href="https://www.php.net/imagefilltoborder" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagefilledrectangle.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagefilter.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagefilltoborder.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagefilltoborder.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagefilltoborder.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagefilltoborder.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagefilltoborder.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagefilltoborder.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagefilltoborder.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagefilltoborder.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagefilltoborder.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagefilltoborder.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagefilltoborder.php" hreflang="zh">
...
<meta name="Description" content="Flood fill to specific color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagefilltoborder - Manual" />
<meta name="twitter:description" content="Flood fill to specific color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagefilltoborder - Manual" />
<meta itemprop="description" content="Flood fill to specific color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Flood fill to specific color" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagefilltoborder.php' selected="selected">English</option>
            <option value='de/function.imagefilltoborder.php'>German</option>
            <option value='es/function.imagefilltoborder.php'>Spanish</option>
            <option value='fr/function.imagefilltoborder.php'>French</option>
            <option value='it/function.imagefilltoborder.php'>Italian</option>
            <option value='ja/function.imagefilltoborder.php'>Japanese</option>
            <option value='pt_BR/function.imagefilltoborder.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagefilltoborder.php'>Russian</option>
            <option value='tr/function.imagefilltoborder.php'>Turkish</option>
            <option value='uk/function.imagefilltoborder.php'>Ukrainian</option>
            <option value='zh/function.imagefilltoborder.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagefilltoborder" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagefilltoborder</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagefilltoborder</span> &mdash; <span class="dc-title">Flood fill to specific color</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagefilltoborder-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagefilltoborder</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$x</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$y</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$border_color</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$color</code></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imagefilltoborder()</strong></span> performs a flood fill
   whose border color is defined by <code class="parameter">border_color</code>.
   The starting point for the fill is <code class="parameter">x</code>,
   <code class="parameter">y</code> (top left is 0, 0) and the region is
   filled with color <code class="parameter">color</code>.
  </p>
 </div>
...
such as <span class="function"><a href="function.imagecreatetruecolor.php" class="function">imagecreatetruecolor()</a></span>.</p></dd>
     ...
     <dt><code class="parameter">border_color</code></dt>
     <dd>
      <p class="para">
       The border color. A color identifier created with <span class="function"><a href="function.imagecolorallocate.php" class="function">imagecolorallocate()</a></span>.
      </p>
     </dd>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/21009b70229598c6a80eef8b45bf282b-imagefilltoborder.png" alt="Output of example : Filling an ellipse with a color" width="100" height="100" />
     </div>
    </div>
   </div>
  </p>
  ...
  <p class="simpara">
   ...
   that is already used in the image may yield undesired results.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagefilltoborder.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagefilltoborder%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagefilltoborder&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagefilltoborder.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="32930">  <div class="votes">
    <div id="Vu32930">
    <a href="/manual/vote-note.php?id=32930&amp;page=function.imagefilltoborder&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd32930">
    <a href="/manual/vote-note.php?id=32930&amp;page=function.imagefilltoborder&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V32930" title="60% like this...">
    1
    </div>
  </div>
  <a href="#32930" class="name">
  <strong class="user"><em>edrad at wanadoo dot fr</em></strong></a><a class="genanchor" href="#32930"> &para;</a><div class="date" title="2003-06-11 05:02"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom32930">
<div class="phpcode"><code><span class="html">Very useful to build a pseudo-sphere with a color gradient...<br /><br /><span class="default">&lt;?php<br /> $width </span><span class="keyword">= </span><span class="default">300</span><span class="keyword">;<br /> </span><span class="default">$center </span><span class="keyword">= </span><span class="default">$width </span><span class="keyword">/ </span><span class="default">2</span><span class="keyword">;<br /> </span><span class="default">$colordivs </span><span class="keyword">= </span><span class="default">255 </span><span class="keyword">/ </span><span class="default">$center</span><span class="keyword">;<br /> </span><span class="default">$im </span><span class="keyword">= @</span><span class="default">imagecreate</span><span class="keyword">(</span><span class="default">$width</span><span class="keyword">, </span><span class="default">$width</span><span class="keyword">);<br /> </span><span class="default">$back_color </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">, </span><span class="default">20</span><span class="keyword">, </span><span class="default">30</span><span class="keyword">, </span><span class="default">40</span><span class="keyword">);<br /> </span><span class="default">imagefill</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$back_color</span><span class="keyword">); <br /> for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt;= </span><span class="default">$center</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++)<br /> {<br />     </span><span class="default">$diametre </span><span class="keyword">= </span><span class="default">$width </span><span class="keyword">- </span><span class="default">2 </span><span class="keyword">* </span><span class="default">$i</span><span class="keyword">;<br />    </span><span class="default">$el_color </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">, </span><span class="default">$i </span><span class="keyword">* </span><span class="default">$colordivs</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br />    </span><span class="default">imagearc</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">, </span><span class="default">$center</span><span class="keyword">, </span><span class="default">$center</span><span class="keyword">, </span><span class="default">$diametre</span><span class="keyword">, </span><span class="default">$diametre</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">360</span><span class="keyword">, </span><span class="default">$el_color</span><span class="keyword">);<br />    </span><span class="default">imagefilltoborder</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">, </span><span class="default">$center</span><span class="keyword">, </span><span class="default">$center</span><span class="keyword">, </span><span class="default">$el_color</span><span class="keyword">, </span><span class="default">$el_color</span><span class="keyword">);<br /> }<br /> </span><span class="default">imagepng</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Dark Skull Software<br /><a href="http://www.darkskull.net" rel="nofollow" target="_blank">http://www.darkskull.net</a></span></code></div>
  </div>
 </div>
  <div class="note" id="45567">  <div class="votes">
    <div id="Vu45567">
    <a href="/manual/vote-note.php?id=45567&amp;page=function.imagefilltoborder&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd45567">
    <a href="/manual/vote-note.php?id=45567&amp;page=function.imagefilltoborder&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V45567" title="no votes...">
    0
    </div>
  </div>
  <a href="#45567" class="name">
  <strong class="user"><em>admin at worldlanguages dot tk</em></strong></a><a class="genanchor" href="#45567"> &para;</a><div class="date" title="2004-09-10 02:54"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom45567">
<div class="phpcode"><code><span class="html">In the example below, for those with newer GD versions, it makes more sense to replace:<br /><br />imagearc($im, $center, $center, $diametre, $diametre, 0, 360, $el_color);<br /><br />with:<br /><br />imageellipse($im, $center, $center, $diametre, $diametre, $el_color);<br /><br />This is obviously simpler.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagefilltoborder&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagefilltoborder.php">＋<small>add a note</small></a></div>
