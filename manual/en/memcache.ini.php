...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcache.ini.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcache.ini.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcache.ini.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/memcache.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcache.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/memcache.resources.php">

 <link rel="alternate" href="https://www.php.net/manual/en/memcache.ini.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/memcache.ini.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/memcache.ini.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/memcache.ini.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/memcache.ini.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/memcache.ini.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/memcache.ini.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/memcache.ini.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/memcache.ini.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/memcache.ini.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/memcache.ini.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="memcache.resources.php">
          Resource Types &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="memcache.installation.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcache.ini.php' selected="selected">English</option>
            <option value='de/memcache.ini.php'>German</option>
            <option value='es/memcache.ini.php'>Spanish</option>
            <option value='fr/memcache.ini.php'>French</option>
            <option value='it/memcache.ini.php'>Italian</option>
            <option value='ja/memcache.ini.php'>Japanese</option>
            <option value='pt_BR/memcache.ini.php'>Brazilian Portuguese</option>
            <option value='ru/memcache.ini.php'>Russian</option>
            <option value='tr/memcache.ini.php'>Turkish</option>
            <option value='uk/memcache.ini.php'>Ukrainian</option>
            <option value='zh/memcache.ini.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="memcache.ini" class="section">
    ...
    <p class="para">
     ...
     <code class="literal">&quot;tcp://host1:11211?persistent=1&amp;weight=1&amp;timeout=1&amp;retry_interval=15&quot;</code>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/memcache/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcache.ini%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcache.ini&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcache.ini.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96909">  <div class="votes">
    <div id="Vu96909">
    <a href="/manual/vote-note.php?id=96909&amp;page=memcache.ini&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96909">
    <a href="/manual/vote-note.php?id=96909&amp;page=memcache.ini&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96909" title="44% like this...">
    -3
    </div>
  </div>
  <a href="#96909" class="name">
  <strong class="user"><em>kross at escapistmag dot com</em></strong></a><a class="genanchor" href="#96909"> &para;</a><div class="date" title="2010-03-22 09:06"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96909">
<div class="phpcode"><code><span class="html">There's a currently undocumented variable that is now available (you can see it in php_info()) for session handling:<br /><br />memcache.session_redundancy<br /><br />The default seems to be "2", and it is supposed to influence how many copies of a particular session object that Memcache will store for failover purposes (so with a redundancy of 2, it will store a session on 2 different shards).<br /><br />This will add slight overhead with extra writes, but overall seems worth it for purposes of failover.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcache.ini&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcache.ini.php">＋<small>add a note</small></a></div>
