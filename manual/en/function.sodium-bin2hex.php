...
<head>
  ...
  <title>PHP: sodium_bin2hex - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-bin2hex.php">
 <link rel="shorturl" href="https://www.php.net/sodium-bin2hex">
 <link rel="alternate" href="https://www.php.net/sodium-bin2hex" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-bin2base64.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-compare.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-bin2hex.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-bin2hex.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-bin2hex.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-bin2hex.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-bin2hex.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-bin2hex.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-bin2hex.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-bin2hex.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-bin2hex.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-bin2hex.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-bin2hex.php" hreflang="zh">
...
<meta name="Description" content="Encode to hexadecimal" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_bin2hex - Manual" />
<meta name="twitter:description" content="Encode to hexadecimal" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_bin2hex - Manual" />
<meta itemprop="description" content="Encode to hexadecimal" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encode to hexadecimal" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-compare.php">
          sodium_compare &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-bin2base64.php">
          &laquo; sodium_bin2base64        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-bin2hex.php' selected="selected">English</option>
            <option value='de/function.sodium-bin2hex.php'>German</option>
            <option value='es/function.sodium-bin2hex.php'>Spanish</option>
            <option value='fr/function.sodium-bin2hex.php'>French</option>
            <option value='it/function.sodium-bin2hex.php'>Italian</option>
            <option value='ja/function.sodium-bin2hex.php'>Japanese</option>
            <option value='pt_BR/function.sodium-bin2hex.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-bin2hex.php'>Russian</option>
            <option value='tr/function.sodium-bin2hex.php'>Turkish</option>
            <option value='uk/function.sodium-bin2hex.php'>Ukrainian</option>
            <option value='zh/function.sodium-bin2hex.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-bin2hex" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_bin2hex</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_bin2hex</span> &mdash; <span class="dc-title">Encode to hexadecimal</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-bin2hex-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_bin2hex</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$string</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>

  <p class="para rdfs-comment">
   Converts a raw binary string into a hex-encoded string. Unlike the standard hex-encoding function,
   <span class="function"><strong>sodium_bin2hex()</strong></span> is constant-time (a property that is important for any code that
 ...
 <div class="refsect1 parameters" id="refsect1-function.sodium-bin2hex-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-bin2hex-returnvalues">
  ...
  <p class="para">
   Hex encoded string.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-bin2hex.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-bin2hex%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-bin2hex&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-bin2hex.php">＋<small>add a note</small></a></span>
