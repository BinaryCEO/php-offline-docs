...
<head>
  ...
  <title>PHP: IntlChar::getBidiPairedBracket - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlchar.getbidipairedbracket.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlchar.getbidipairedbracket.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getbidipairedbracket.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlchar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlchar.fordigit.php">
 <link rel="next" href="https://www.php.net/manual/en/intlchar.getblockcode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlchar.getbidipairedbracket.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlchar.getbidipairedbracket.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlchar.getbidipairedbracket.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlchar.getbidipairedbracket.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlchar.getbidipairedbracket.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlchar.getbidipairedbracket.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlchar.getbidipairedbracket.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlchar.getbidipairedbracket.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlchar.getbidipairedbracket.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlchar.getbidipairedbracket.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlchar.getbidipairedbracket.php" hreflang="zh">
...
<meta name="Description" content="Get the paired bracket character for a code point" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlChar::getBidiPairedBracket - Manual" />
<meta name="twitter:description" content="Get the paired bracket character for a code point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlChar::getBidiPairedBracket - Manual" />
<meta itemprop="description" content="Get the paired bracket character for a code point" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the paired bracket character for a code point" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlchar.getblockcode.php">
          IntlChar::getBlockCode &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="intlchar.fordigit.php">
          &laquo; IntlChar::forDigit        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlchar.getbidipairedbracket.php' selected="selected">English</option>
            <option value='de/intlchar.getbidipairedbracket.php'>German</option>
            <option value='es/intlchar.getbidipairedbracket.php'>Spanish</option>
            <option value='fr/intlchar.getbidipairedbracket.php'>French</option>
            <option value='it/intlchar.getbidipairedbracket.php'>Italian</option>
            <option value='ja/intlchar.getbidipairedbracket.php'>Japanese</option>
            <option value='pt_BR/intlchar.getbidipairedbracket.php'>Brazilian Portuguese</option>
            <option value='ru/intlchar.getbidipairedbracket.php'>Russian</option>
            <option value='tr/intlchar.getbidipairedbracket.php'>Turkish</option>
            <option value='uk/intlchar.getbidipairedbracket.php'>Ukrainian</option>
            <option value='zh/intlchar.getbidipairedbracket.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlchar.getbidipairedbracket" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlChar::getBidiPairedBracket</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">IntlChar::getBidiPairedBracket</span> &mdash; <span class="dc-title">Get the paired bracket character for a code point</span></p>
 ...
 <div class="refsect1 description" id="refsect1-intlchar.getbidipairedbracket-description">
  ...
  <p class="para">
   For <code class="code">IntlChar::PROPERTY_BIDI_PAIRED_BRACKET_TYPE !== IntlChar::BPT_NONE</code>, this is the same as <span class="function"><a href="intlchar.charmirror.php" class="function">IntlChar::charMirror()</a></span>.
   Otherwise <code class="parameter">codepoint</code> itself is returned.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlchar.getbidipairedbracket-returnvalues">
  ...
  <p class="para">
   Returns the paired bracket code point, or <code class="parameter">codepoint</code> itself if there is no such mapping. Returns
   <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> on failure.
  </p>
   ...
   <ul class="simplelist">
    ...
    <li><strong><code><a href="class.intlchar.php#intlchar.constants.property-bidi-paired-bracket-type">IntlChar::PROPERTY_BIDI_PAIRED_BRACKET_TYPE</a></code></strong></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlchar/getbidipairedbracket.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlchar.getbidipairedbracket%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlchar.getbidipairedbracket&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlchar.getbidipairedbracket.php">＋<small>add a note</small></a></span>
