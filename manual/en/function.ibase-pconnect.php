...
<head>
  ...
  <title>PHP: ibase_pconnect - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-pconnect.php">
 <link rel="shorturl" href="https://www.php.net/ibase-pconnect">
 <link rel="alternate" href="https://www.php.net/ibase-pconnect" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-param-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-prepare.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-pconnect.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-pconnect.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-pconnect.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-pconnect.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-pconnect.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-pconnect.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-pconnect.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-pconnect.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-pconnect.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-pconnect.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-pconnect.php" hreflang="zh">
...
<meta name="Description" content="Open a persistent connection to an InterBase database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_pconnect - Manual" />
<meta name="twitter:description" content="Open a persistent connection to an InterBase database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_pconnect - Manual" />
<meta itemprop="description" content="Open a persistent connection to an InterBase database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Open a persistent connection to an InterBase database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-prepare.php">
          ibase_prepare &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-param-info.php">
          &laquo; ibase_param_info        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-pconnect.php' selected="selected">English</option>
            <option value='de/function.ibase-pconnect.php'>German</option>
            <option value='es/function.ibase-pconnect.php'>Spanish</option>
            <option value='fr/function.ibase-pconnect.php'>French</option>
            <option value='it/function.ibase-pconnect.php'>Italian</option>
            <option value='ja/function.ibase-pconnect.php'>Japanese</option>
            <option value='pt_BR/function.ibase-pconnect.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-pconnect.php'>Russian</option>
            <option value='tr/function.ibase-pconnect.php'>Turkish</option>
            <option value='uk/function.ibase-pconnect.php'>Ukrainian</option>
            <option value='zh/function.ibase-pconnect.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-pconnect" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-connect.php" class="function" rel="rdfs-seeAlso">ibase_connect()</a> - Open a connection to a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-pconnect.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-pconnect%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-pconnect&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-pconnect.php">＋<small>add a note</small></a></span>
