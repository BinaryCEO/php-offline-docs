...
<head>
  ...
  <title>PHP: ibase_drop_db - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-drop-db.php">
 <link rel="shorturl" href="https://www.php.net/ibase-drop-db">
 <link rel="alternate" href="https://www.php.net/ibase-drop-db" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-delete-user.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-errcode.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-drop-db.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-drop-db.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-drop-db.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-drop-db.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-drop-db.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-drop-db.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-drop-db.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-drop-db.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-drop-db.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-drop-db.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-drop-db.php" hreflang="zh">
...
<meta name="Description" content="Drops a database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_drop_db - Manual" />
<meta name="twitter:description" content="Drops a database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_drop_db - Manual" />
<meta itemprop="description" content="Drops a database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Drops a database" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-errcode.php">
          ibase_errcode &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-delete-user.php">
          &laquo; ibase_delete_user        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-drop-db.php' selected="selected">English</option>
            <option value='de/function.ibase-drop-db.php'>German</option>
            <option value='es/function.ibase-drop-db.php'>Spanish</option>
            <option value='fr/function.ibase-drop-db.php'>French</option>
            <option value='it/function.ibase-drop-db.php'>Italian</option>
            <option value='ja/function.ibase-drop-db.php'>Japanese</option>
            <option value='pt_BR/function.ibase-drop-db.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-drop-db.php'>Russian</option>
            <option value='tr/function.ibase-drop-db.php'>Turkish</option>
            <option value='uk/function.ibase-drop-db.php'>Ukrainian</option>
            <option value='zh/function.ibase-drop-db.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-drop-db" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_drop_db</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_drop_db</span> &mdash; <span class="dc-title">Drops a database</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-drop-db-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_drop_db</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   This functions drops a database that was opened by either <span class="function"><a href="function.ibase-connect.php" class="function">ibase_connect()</a></span>
   or <span class="function"><a href="function.ibase-pconnect.php" class="function">ibase_pconnect()</a></span>. The database is closed and deleted from the server.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.ibase-drop-db-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-drop-db-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-drop-db-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-pconnect.php" class="function" rel="rdfs-seeAlso">ibase_pconnect()</a> - Open a persistent connection to an InterBase database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-drop-db.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-drop-db%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-drop-db&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-drop-db.php">＋<small>add a note</small></a></span>
