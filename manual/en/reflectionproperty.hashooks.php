...
<head>
  ...
  <title>PHP: ReflectionProperty::hasHooks - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.hashooks.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.hashooks.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.hashooks.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.hashook.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.hastype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.hashooks.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.hashooks.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.hashooks.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.hashooks.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.hashooks.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.hashooks.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.hashooks.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.hashooks.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.hashooks.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.hashooks.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.hashooks.php" hreflang="zh">
...
<meta name="Description" content="Returns whether the property has any hooks defined" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::hasHooks - Manual" />
<meta name="twitter:description" content="Returns whether the property has any hooks defined" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::hasHooks - Manual" />
<meta itemprop="description" content="Returns whether the property has any hooks defined" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether the property has any hooks defined" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionproperty.hastype.php">
          ReflectionProperty::hasType &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.hashook.php">
          &laquo; ReflectionProperty::hasHook        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.hashooks.php' selected="selected">English</option>
            <option value='de/reflectionproperty.hashooks.php'>German</option>
            <option value='es/reflectionproperty.hashooks.php'>Spanish</option>
            <option value='fr/reflectionproperty.hashooks.php'>French</option>
            <option value='it/reflectionproperty.hashooks.php'>Italian</option>
            <option value='ja/reflectionproperty.hashooks.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.hashooks.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.hashooks.php'>Russian</option>
            <option value='tr/reflectionproperty.hashooks.php'>Turkish</option>
            <option value='uk/reflectionproperty.hashooks.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.hashooks.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.hashooks" class="refentry">
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 examples" id="refsect1-reflectionproperty.hashooks-examples">
  ...
  <div class="example" id="reflectionproperty.hashooks.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>ReflectionProperty::hasHooks()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="reflectionproperty.gethooks.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::getHooks()</a> - Returns an array of all hooks on this property</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/hashooks.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.hashooks%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.hashooks&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.hashooks.php">＋<small>add a note</small></a></span>
