...
<head>
  ...
  <title>PHP: stream_context_set_options - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-context-set-options.php">
 <link rel="shorturl" href="https://www.php.net/stream-context-set-options">
 <link rel="alternate" href="https://www.php.net/stream-context-set-options" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-context-set-option.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-context-set-params.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-context-set-options.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-context-set-options.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-context-set-options.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-context-set-options.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-context-set-options.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-context-set-options.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-context-set-options.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-context-set-options.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-context-set-options.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-context-set-options.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-context-set-options.php" hreflang="zh">
...
<meta name="Description" content="Sets options on the specified context" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_context_set_options - Manual" />
<meta name="twitter:description" content="Sets options on the specified context" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_context_set_options - Manual" />
<meta itemprop="description" content="Sets options on the specified context" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets options on the specified context" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-context-set-params.php">
          stream_context_set_params &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-context-set-option.php">
          &laquo; stream_context_set_option        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-context-set-options.php' selected="selected">English</option>
            <option value='de/function.stream-context-set-options.php'>German</option>
            <option value='es/function.stream-context-set-options.php'>Spanish</option>
            <option value='fr/function.stream-context-set-options.php'>French</option>
            <option value='it/function.stream-context-set-options.php'>Italian</option>
            <option value='ja/function.stream-context-set-options.php'>Japanese</option>
            <option value='pt_BR/function.stream-context-set-options.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-context-set-options.php'>Russian</option>
            <option value='tr/function.stream-context-set-options.php'>Turkish</option>
            <option value='uk/function.stream-context-set-options.php'>Ukrainian</option>
            <option value='zh/function.stream-context-set-options.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-context-set-options" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_context_set_options</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">stream_context_set_options</span> &mdash; <span class="dc-title">Sets options on the specified context</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.stream-context-set-options-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stream_context_set_options</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$context</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$options</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-context-set-options-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The options to set for <code class="parameter">context</code>.
      </p>
      <blockquote class="note"><p><strong class="note">Note</strong>: 
       <p class="para">
        <code class="parameter">options</code> must be an associative
        <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of associative arrays in the format
        <code class="code">$array[&#039;wrapper&#039;][&#039;option&#039;] = $value</code>.
       </p>
       <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stream-context-set-options-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.stream-context-set-options-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-4049">
    <p><strong>Example #1 <span class="function"><strong>stream_context_set_options()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$context </span><span style="color: #007700">= </span><span style="color: #0000BB">stream_context_create</span><span style="color: #007700">();<br /><br /></span><span style="color: #0000BB">$options </span><span style="color: #007700">= [<br />    </span><span style="color: #DD0000">'http' </span><span style="color: #007700">=&gt; [<br />        </span><span style="color: #DD0000">'protocol_version' </span><span style="color: #007700">=&gt; </span><span style="color: #0000BB">1.1</span><span style="color: #007700">,<br />        </span><span style="color: #DD0000">'user_agent' </span><span style="color: #007700">=&gt; </span><span style="color: #DD0000">'PHPT Agent'</span><span style="color: #007700">,<br />    ],<br />];<br /><br /></span><span style="color: #0000BB">stream_context_set_options</span><span style="color: #007700">(</span><span style="color: #0000BB">$context</span><span style="color: #007700">, </span><span style="color: #0000BB">$options</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">stream_context_get_options</span><span style="color: #007700">(</span><span style="color: #0000BB">$context</span><span style="color: #007700">));<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
<div class="examplescode"><pre class="examplescode">array(1) {
 ...
 <div class="refsect1 seealso" id="refsect1-function.stream-context-set-options-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.stream-context-set-option.php" class="function" rel="rdfs-seeAlso">stream_context_set_option()</a> - Sets an option for a stream/wrapper/context</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-context-set-options.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-context-set-options%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-context-set-options&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-context-set-options.php">＋<small>add a note</small></a></span>
