...
<head>
  ...
  <title>PHP: Imagick::getRegistry - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getregistry.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getregistry.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getregistry.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getquantumrange.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getreleasedate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getregistry.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getregistry.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getregistry.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getregistry.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getregistry.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getregistry.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getregistry.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getregistry.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getregistry.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getregistry.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getregistry.php" hreflang="zh">
...
<meta name="Description" content="Get a StringRegistry entry" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getRegistry - Manual" />
<meta name="twitter:description" content="Get a StringRegistry entry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getRegistry - Manual" />
<meta itemprop="description" content="Get a StringRegistry entry" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get a StringRegistry entry" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getreleasedate.php">
          Imagick::getReleaseDate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getquantumrange.php">
          &laquo; Imagick::getQuantumRange        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getregistry.php' selected="selected">English</option>
            <option value='de/imagick.getregistry.php'>German</option>
            <option value='es/imagick.getregistry.php'>Spanish</option>
            <option value='fr/imagick.getregistry.php'>French</option>
            <option value='it/imagick.getregistry.php'>Italian</option>
            <option value='ja/imagick.getregistry.php'>Japanese</option>
            <option value='pt_BR/imagick.getregistry.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getregistry.php'>Russian</option>
            <option value='tr/imagick.getregistry.php'>Turkish</option>
            <option value='uk/imagick.getregistry.php'>Ukrainian</option>
            <option value='zh/imagick.getregistry.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getregistry" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getRegistry</h1>
  <p class="verinfo">(PECL imagick 3 &gt;= 3.3.0)</p><p class="refpurpose"><span class="refname">Imagick::getRegistry</span> &mdash; <span class="dc-title">Get a StringRegistry entry</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getregistry-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="modifier">static</span> <span class="methodname"><strong>Imagick::getRegistry</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getregistry-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getregistry-returnvalues">
  ...
  <p class="para">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getregistry.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getregistry%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getregistry&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getregistry.php">＋<small>add a note</small></a></span>
