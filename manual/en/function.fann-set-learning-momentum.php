...
<head>
  ...
  <title>PHP: fann_set_learning_momentum - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-learning-momentum.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-learning-momentum">
 <link rel="alternate" href="https://www.php.net/fann-set-learning-momentum" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-input-scaling-params.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-learning-rate.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-learning-momentum.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-learning-momentum.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-learning-momentum.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-learning-momentum.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-learning-momentum.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-learning-momentum.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-learning-momentum.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-learning-momentum.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-learning-momentum.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-learning-momentum.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-learning-momentum.php" hreflang="zh">
...
<meta name="Description" content="Sets the learning momentum" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_learning_momentum - Manual" />
<meta name="twitter:description" content="Sets the learning momentum" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_learning_momentum - Manual" />
<meta itemprop="description" content="Sets the learning momentum" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the learning momentum" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-set-learning-rate.php">
          fann_set_learning_rate &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-input-scaling-params.php">
          &laquo; fann_set_input_scaling_params        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-learning-momentum.php' selected="selected">English</option>
            <option value='de/function.fann-set-learning-momentum.php'>German</option>
            <option value='es/function.fann-set-learning-momentum.php'>Spanish</option>
            <option value='fr/function.fann-set-learning-momentum.php'>French</option>
            <option value='it/function.fann-set-learning-momentum.php'>Italian</option>
            <option value='ja/function.fann-set-learning-momentum.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-learning-momentum.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-learning-momentum.php'>Russian</option>
            <option value='tr/function.fann-set-learning-momentum.php'>Turkish</option>
            <option value='uk/function.fann-set-learning-momentum.php'>Ukrainian</option>
            <option value='zh/function.fann-set-learning-momentum.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-learning-momentum" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_learning_momentum</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_learning_momentum</span> &mdash; <span class="dc-title">Sets the learning momentum</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-set-learning-momentum-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_learning_momentum</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$learning_momentum</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Sets the learning momentum.
  </p>
  <p class="para">
   More info available in <span class="function"><a href="function.fann-get-learning-momentum.php" class="function">fann_get_learning_momentum()</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-set-learning-momentum-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">learning_momentum</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-learning-momentum-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-set-learning-momentum-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-get-learning-momentum.php" class="function" rel="rdfs-seeAlso">fann_get_learning_momentum()</a> - Returns the learning momentum</span></li>
    <li><span class="function"><a href="function.fann-set-training-algorithm.php" class="function" rel="rdfs-seeAlso">fann_set_training_algorithm()</a> - Sets the training algorithm</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-learning-momentum.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-learning-momentum%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-learning-momentum&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-learning-momentum.php">＋<small>add a note</small></a></span>
