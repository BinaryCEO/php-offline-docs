...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.getdate.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.date-timezone-set.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gettimeofday.php">
...
<meta name="Description" content="Get date/time information" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: getdate - Manual" />
<meta name="twitter:description" content="Get date/time information" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: getdate - Manual" />
<meta itemprop="description" content="Get date/time information" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get date/time information" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.getdate.php' selected="selected">English</option>
            <option value='de/function.getdate.php'>German</option>
            <option value='es/function.getdate.php'>Spanish</option>
            <option value='fr/function.getdate.php'>French</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.setlocale.php" class="function" rel="rdfs-seeAlso">setlocale()</a> - Set locale information</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/functions/getdate.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.getdate%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.getdate&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.getdate.php">＋<small>add a note</small></a></span>
