...
<head>
  ...
  <title>PHP: db2_cursor_type - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-cursor-type.php">
 <link rel="shorturl" href="https://www.php.net/db2-cursor-type">
 <link rel="alternate" href="https://www.php.net/db2-cursor-type" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-connect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-escape-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-cursor-type.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-cursor-type.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-cursor-type.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-cursor-type.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-cursor-type.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-cursor-type.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-cursor-type.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-cursor-type.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-cursor-type.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-cursor-type.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-cursor-type.php" hreflang="zh">
...
<meta name="Description" content="Returns the cursor type used by a statement resource" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_cursor_type - Manual" />
<meta name="twitter:description" content="Returns the cursor type used by a statement resource" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_cursor_type - Manual" />
<meta itemprop="description" content="Returns the cursor type used by a statement resource" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the cursor type used by a statement resource" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-cursor-type.php' selected="selected">English</option>
            <option value='de/function.db2-cursor-type.php'>German</option>
            <option value='es/function.db2-cursor-type.php'>Spanish</option>
            <option value='fr/function.db2-cursor-type.php'>French</option>
            <option value='it/function.db2-cursor-type.php'>Italian</option>
            <option value='ja/function.db2-cursor-type.php'>Japanese</option>
            <option value='pt_BR/function.db2-cursor-type.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-cursor-type.php'>Russian</option>
            <option value='tr/function.db2-cursor-type.php'>Turkish</option>
            <option value='uk/function.db2-cursor-type.php'>Ukrainian</option>
            <option value='zh/function.db2-cursor-type.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-cursor-type" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-cursor-type-returnvalues">
  ...
  <p class="para">
   Returns either <strong><code><a href="ibm-db2.constants.php#constant.db2-forward-only">DB2_FORWARD_ONLY</a></code></strong> if the statement
   resource uses a forward-only cursor or <strong><code><a href="ibm-db2.constants.php#constant.db2-scrollable">DB2_SCROLLABLE</a></code></strong> if
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.db2-prepare.php" class="function" rel="rdfs-seeAlso">db2_prepare()</a> - Prepares an SQL statement to be executed</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-cursor-type.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-cursor-type%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-cursor-type&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-cursor-type.php">＋<small>add a note</small></a></span>
