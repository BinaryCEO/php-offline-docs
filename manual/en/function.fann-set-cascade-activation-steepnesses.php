...
<head>
  ...
  <title>PHP: fann_set_cascade_activation_steepnesses - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-set-cascade-activation-steepnesses.php">
 <link rel="shorturl" href="https://www.php.net/fann-set-cascade-activation-steepnesses">
 <link rel="alternate" href="https://www.php.net/fann-set-cascade-activation-steepnesses" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-set-cascade-activation-functions.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-set-cascade-candidate-change-fraction.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-set-cascade-activation-steepnesses.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-set-cascade-activation-steepnesses.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-set-cascade-activation-steepnesses.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-set-cascade-activation-steepnesses.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-set-cascade-activation-steepnesses.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-set-cascade-activation-steepnesses.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-set-cascade-activation-steepnesses.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-set-cascade-activation-steepnesses.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-set-cascade-activation-steepnesses.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-set-cascade-activation-steepnesses.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-set-cascade-activation-steepnesses.php" hreflang="zh">
...
<meta name="Description" content="Sets the array of cascade candidate activation steepnesses" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_set_cascade_activation_steepnesses - Manual" />
<meta name="twitter:description" content="Sets the array of cascade candidate activation steepnesses" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_set_cascade_activation_steepnesses - Manual" />
<meta itemprop="description" content="Sets the array of cascade candidate activation steepnesses" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the array of cascade candidate activation steepnesses" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-set-cascade-candidate-change-fraction.php">
          fann_set_cascade_candidate_change_fraction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-set-cascade-activation-functions.php">
          &laquo; fann_set_cascade_activation_functions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-set-cascade-activation-steepnesses.php' selected="selected">English</option>
            <option value='de/function.fann-set-cascade-activation-steepnesses.php'>German</option>
            <option value='es/function.fann-set-cascade-activation-steepnesses.php'>Spanish</option>
            <option value='fr/function.fann-set-cascade-activation-steepnesses.php'>French</option>
            <option value='it/function.fann-set-cascade-activation-steepnesses.php'>Italian</option>
            <option value='ja/function.fann-set-cascade-activation-steepnesses.php'>Japanese</option>
            <option value='pt_BR/function.fann-set-cascade-activation-steepnesses.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-set-cascade-activation-steepnesses.php'>Russian</option>
            <option value='tr/function.fann-set-cascade-activation-steepnesses.php'>Turkish</option>
            <option value='uk/function.fann-set-cascade-activation-steepnesses.php'>Ukrainian</option>
            <option value='zh/function.fann-set-cascade-activation-steepnesses.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-set-cascade-activation-steepnesses" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_set_cascade_activation_steepnesses</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_set_cascade_activation_steepnesses</span> &mdash; <span class="dc-title">Sets the array of cascade candidate activation steepnesses</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-set-cascade-activation-steepnesses-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_set_cascade_activation_steepnesses</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$cascade_activation_steepnesses_count</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-set-cascade-activation-steepnesses-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">cascade_activation_steepnesses_count</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-set-cascade-activation-steepnesses-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.fann-set-cascade-activation-steepnesses-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-get-cascade-activation-steepnesses-count.php" class="function" rel="rdfs-seeAlso">fann_get_cascade_activation_steepnesses_count()</a> - The number of activation steepnesses</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-set-cascade-activation-steepnesses.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-set-cascade-activation-steepnesses%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-set-cascade-activation-steepnesses&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-set-cascade-activation-steepnesses.php">＋<small>add a note</small></a></span>
