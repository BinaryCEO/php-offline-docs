...
<head>
  ...
  <title>PHP: ldap_connect_wallet - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-connect-wallet.php">
 <link rel="shorturl" href="https://www.php.net/ldap-connect-wallet">
 <link rel="alternate" href="https://www.php.net/ldap-connect-wallet" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-connect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-control-paged-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-connect-wallet.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-connect-wallet.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-connect-wallet.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-connect-wallet.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-connect-wallet.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-connect-wallet.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-connect-wallet.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-connect-wallet.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-connect-wallet.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-connect-wallet.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-connect-wallet.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ldap_connect_wallet - Manual" />
<meta name="twitter:description" content="Connect to an LDAP server" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_connect_wallet - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ldap-control-paged-result.php">
          ldap_control_paged_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ldap-connect.php">
          &laquo; ldap_connect        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-connect-wallet.php' selected="selected">English</option>
            <option value='de/function.ldap-connect-wallet.php'>German</option>
            <option value='es/function.ldap-connect-wallet.php'>Spanish</option>
            <option value='fr/function.ldap-connect-wallet.php'>French</option>
            <option value='it/function.ldap-connect-wallet.php'>Italian</option>
            <option value='ja/function.ldap-connect-wallet.php'>Japanese</option>
            <option value='pt_BR/function.ldap-connect-wallet.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-connect-wallet.php'>Russian</option>
            <option value='tr/function.ldap-connect-wallet.php'>Turkish</option>
            <option value='uk/function.ldap-connect-wallet.php'>Ukrainian</option>
            <option value='zh/function.ldap-connect-wallet.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-connect-wallet" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_connect_wallet</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">ldap_connect_wallet</span> &mdash; <span class="dc-title">Connect to an LDAP server</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ldap-connect-wallet-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_connect_wallet</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$uri</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$wallet</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$password</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$auth_mode</code><span class="initializer"> = <strong><code><a href="ldap.constants.php#constant.gslc-ssl-no-auth">GSLC_SSL_NO_AUTH</a></code></strong></span></span><br>): <span class="type"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-connect-wallet-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">wallet</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">auth_mode</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ldap-connect-wallet-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-connect-wallet-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ldap-connect.php" class="function" rel="rdfs-seeAlso">ldap_connect()</a> - Connect to an LDAP server</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-connect-wallet.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-connect-wallet%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-connect-wallet&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-connect-wallet.php">＋<small>add a note</small></a></span>
