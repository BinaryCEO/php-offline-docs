...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-lcm.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-kronecker.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-legendre.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-lcm.php' selected="selected">English</option>
            ...
            <option value='zh/function.gmp-lcm.php'>Chinese (Simplified)</option>
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.gmp-gcd.php" class="function" rel="rdfs-seeAlso">gmp_gcd()</a> - Calculate GCD</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-lcm.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-lcm%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-lcm&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-lcm.php">＋<small>add a note</small></a></span>
