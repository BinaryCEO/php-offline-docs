...
<head>
  ...
  <title>PHP: ldap_escape - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-escape.php">
 <link rel="shorturl" href="https://www.php.net/ldap-escape">
 <link rel="alternate" href="https://www.php.net/ldap-escape" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-exop.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-escape.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-escape.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-escape.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-escape.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-escape.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-escape.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-escape.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-escape.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-escape.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-escape.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-escape.php" hreflang="zh">
...
<meta name="Description" content="Escape a string for use in an LDAP filter or DN" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ldap_escape - Manual" />
<meta name="twitter:description" content="Escape a string for use in an LDAP filter or DN" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_escape - Manual" />
<meta itemprop="description" content="Escape a string for use in an LDAP filter or DN" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Escape a string for use in an LDAP filter or DN" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-escape.php' selected="selected">English</option>
            <option value='de/function.ldap-escape.php'>German</option>
            <option value='es/function.ldap-escape.php'>Spanish</option>
            <option value='fr/function.ldap-escape.php'>French</option>
            <option value='it/function.ldap-escape.php'>Italian</option>
            <option value='ja/function.ldap-escape.php'>Japanese</option>
            <option value='pt_BR/function.ldap-escape.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-escape.php'>Russian</option>
            <option value='tr/function.ldap-escape.php'>Turkish</option>
            <option value='uk/function.ldap-escape.php'>Ukrainian</option>
            <option value='zh/function.ldap-escape.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-escape" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.ldap-escape-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_escape</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$value</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$ignore</code><span class="initializer"> = &quot;&quot;</span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       <strong><code><a href="ldap.constants.php#constant.ldap-escape-filter">LDAP_ESCAPE_FILTER</a></code></strong> for filters to be used with
       <span class="function"><a href="function.ldap-search.php" class="function">ldap_search()</a></span>, or
       <strong><code><a href="ldap.constants.php#constant.ldap-escape-dn">LDAP_ESCAPE_DN</a></code></strong> for DNs.
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// $ds is a valid LDAP\Connection instance for a directory server<br /><br />// $mail is an email address provided by the user in a form<br /><br /></span><span style="color: #0000BB">$base   </span><span style="color: #007700">= </span><span style="color: #DD0000">"o=My Company, c=US"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$filter </span><span style="color: #007700">= </span><span style="color: #DD0000">"(mail="</span><span style="color: #007700">.</span><span style="color: #0000BB">ldap_escape</span><span style="color: #007700">(</span><span style="color: #0000BB">$mail</span><span style="color: #007700">, </span><span style="color: #DD0000">""</span><span style="color: #007700">, </span><span style="color: #0000BB">LDAP_ESCAPE_FILTER</span><span style="color: #007700">).</span><span style="color: #DD0000">")"</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">$sr </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_search</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #0000BB">$base</span><span style="color: #007700">, </span><span style="color: #0000BB">$filter</span><span style="color: #007700">, array(</span><span style="color: #DD0000">"sn"</span><span style="color: #007700">, </span><span style="color: #DD0000">"givenname"</span><span style="color: #007700">, </span><span style="color: #DD0000">"mail"</span><span style="color: #007700">));<br /><br /></span><span style="color: #0000BB">$info </span><span style="color: #007700">= </span><span style="color: #0000BB">ldap_get_entries</span><span style="color: #007700">(</span><span style="color: #0000BB">$ds</span><span style="color: #007700">, </span><span style="color: #0000BB">$sr</span><span style="color: #007700">);<br /><br />echo </span><span style="color: #0000BB">$info</span><span style="color: #007700">[</span><span style="color: #DD0000">"count"</span><span style="color: #007700">].</span><span style="color: #DD0000">" entries returned\n"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-escape.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-escape%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-escape&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-escape.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124752">  <div class="votes">
    <div id="Vu124752">
    <a href="/manual/vote-note.php?id=124752&amp;page=function.ldap-escape&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124752">
    <a href="/manual/vote-note.php?id=124752&amp;page=function.ldap-escape&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124752" title="66% like this...">
    1
    </div>
  </div>
  <a href="#124752" class="name">
  <strong class="user"><em>support at extollit dot com</em></strong></a><a class="genanchor" href="#124752"> &para;</a><div class="date" title="2020-02-24 06:44"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124752">
<div class="phpcode"><code><span class="html">Suppose you want to reverse the operation, here is a way to "ldap_unescape"<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">function </span><span class="default">ldap_unescape</span><span class="keyword">(</span><span class="default">$string</span><span class="keyword">) {<br />    return<br />        </span><span class="default">preg_replace_callback</span><span class="keyword">(<br />            </span><span class="string">"/\\\\[\da-z]{2}/"</span><span class="keyword">,<br />            function (</span><span class="default">$matches</span><span class="keyword">) {<br />                </span><span class="default">$match </span><span class="keyword">= </span><span class="default">array_shift</span><span class="keyword">(</span><span class="default">$matches</span><span class="keyword">);<br />                return </span><span class="default">hex2bin</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$match</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">));<br />            },<br />            </span><span class="default">$string<br />        </span><span class="keyword">);<br />}<br /><br /></span><span class="default">$result </span><span class="keyword">= </span><span class="default">ldap_unescape</span><span class="keyword">(</span><span class="string">"uid=\\61\\6c\\70\\68\\6f\\6e\\7a\\6f,ou=people,dc=foo,dc=com"</span><span class="keyword">); </span><span class="comment">// uid=alphonzo,ou=people,dc=foo,dc=com<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="118127">  <div class="votes">
    <div id="Vu118127">
    <a href="/manual/vote-note.php?id=118127&amp;page=function.ldap-escape&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118127">
    <a href="/manual/vote-note.php?id=118127&amp;page=function.ldap-escape&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118127" title="45% like this...">
    -1
    </div>
  </div>
  <a href="#118127" class="name">
  <strong class="user"><em>martin dot keckeis1 at gmail dot com</em></strong></a><a class="genanchor" href="#118127"> &para;</a><div class="date" title="2015-10-09 08:48"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118127">
<div class="phpcode"><code><span class="html">You can use it like this for filtering<br /><br /><span class="default">&lt;?php<br />$badSearchInput </span><span class="keyword">= </span><span class="string">'Domain\username'</span><span class="keyword">;<br /><br /></span><span class="default">$escapedSearchInput </span><span class="keyword">= </span><span class="default">ldap_escape</span><span class="keyword">(</span><span class="default">$badSearchInput</span><span class="keyword">, </span><span class="default">null</span><span class="keyword">, </span><span class="default">LDAP_ESCAPE_FILTER</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.ldap-escape&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-escape.php">＋<small>add a note</small></a></div>
