...
<head>
  ...
  <title>PHP: pcntl_getcpuaffinity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pcntl-getcpuaffinity.php">
 <link rel="shorturl" href="https://www.php.net/pcntl-getcpuaffinity">
 <link rel="alternate" href="https://www.php.net/pcntl-getcpuaffinity" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pcntl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pcntl-get-last-error.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pcntl-getpriority.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pcntl-getcpuaffinity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pcntl-getcpuaffinity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pcntl-getcpuaffinity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pcntl-getcpuaffinity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pcntl-getcpuaffinity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pcntl-getcpuaffinity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pcntl-getcpuaffinity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pcntl-getcpuaffinity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pcntl-getcpuaffinity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pcntl-getcpuaffinity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pcntl-getcpuaffinity.php" hreflang="zh">
...
<meta name="Description" content="Get the cpu affinity of a process" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pcntl_getcpuaffinity - Manual" />
<meta name="twitter:description" content="Get the cpu affinity of a process" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pcntl_getcpuaffinity - Manual" />
<meta itemprop="description" content="Get the cpu affinity of a process" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the cpu affinity of a process" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pcntl-getpriority.php">
          pcntl_getpriority &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pcntl-get-last-error.php">
          &laquo; pcntl_get_last_error        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pcntl-getcpuaffinity.php' selected="selected">English</option>
            <option value='de/function.pcntl-getcpuaffinity.php'>German</option>
            <option value='es/function.pcntl-getcpuaffinity.php'>Spanish</option>
            <option value='fr/function.pcntl-getcpuaffinity.php'>French</option>
            <option value='it/function.pcntl-getcpuaffinity.php'>Italian</option>
            <option value='ja/function.pcntl-getcpuaffinity.php'>Japanese</option>
            <option value='pt_BR/function.pcntl-getcpuaffinity.php'>Brazilian Portuguese</option>
            <option value='ru/function.pcntl-getcpuaffinity.php'>Russian</option>
            <option value='tr/function.pcntl-getcpuaffinity.php'>Turkish</option>
            <option value='uk/function.pcntl-getcpuaffinity.php'>Ukrainian</option>
            <option value='zh/function.pcntl-getcpuaffinity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pcntl-getcpuaffinity" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.pcntl-getcpuaffinity-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pcntl_getcpuaffinity</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.integer.php" class="type int">int</a></span></span> <code class="parameter">$pid</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>|<span class="type"><a href="language.types.array.php" class="type array">array</a></span></span></div>

  <p class="simpara">
   Retrieve the cpu affinity of the <code class="parameter">pid</code>.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pcntl-getcpuaffinity-returnvalues">
  ...
  <p class="simpara">
   Returns the cpu affinity mask of the process,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
...
function.</p></div>
 ...
 <div class="refsect1 errors" id="refsect1-function.pcntl-getcpuaffinity-errors">
  ...
  <p class="simpara">
   If <code class="parameter">pid</code> is a process for which the current
  ...
  <ul class="simplelist">
   <li><span class="function"><a href="function.pcntl-setcpuaffinity.php" class="function" rel="rdfs-seeAlso">pcntl_setcpuaffinity()</a> - Set the cpu affinity of a process</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pcntl/functions/pcntl-getcpuaffinity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pcntl-getcpuaffinity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pcntl-getcpuaffinity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pcntl-getcpuaffinity.php">＋<small>add a note</small></a></span>
