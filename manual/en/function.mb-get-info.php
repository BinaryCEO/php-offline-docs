...
<head>
  ...
  <title>PHP: mb_get_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-get-info.php">
 <link rel="shorturl" href="https://www.php.net/mb-get-info">
 <link rel="alternate" href="https://www.php.net/mb-get-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-eregi-replace.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-http-input.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-get-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-get-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-get-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-get-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-get-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-get-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-get-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-get-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-get-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-get-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-get-info.php" hreflang="zh">
...
<meta name="Description" content="Get internal settings of mbstring" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_get_info - Manual" />
<meta name="twitter:description" content="Get internal settings of mbstring" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_get_info - Manual" />
<meta itemprop="description" content="Get internal settings of mbstring" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get internal settings of mbstring" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-get-info.php' selected="selected">English</option>
            <option value='de/function.mb-get-info.php'>German</option>
            <option value='es/function.mb-get-info.php'>Spanish</option>
            <option value='fr/function.mb-get-info.php'>French</option>
            <option value='it/function.mb-get-info.php'>Italian</option>
            <option value='ja/function.mb-get-info.php'>Japanese</option>
            <option value='pt_BR/function.mb-get-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-get-info.php'>Russian</option>
            <option value='tr/function.mb-get-info.php'>Turkish</option>
            <option value='uk/function.mb-get-info.php'>Ukrainian</option>
            <option value='zh/function.mb-get-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-get-info" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_get_info</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_get_info</span> &mdash; <span class="dc-title">Get internal settings of mbstring</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-get-info-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       If <code class="parameter">type</code> is not specified or is specified as <code class="literal">&quot;all&quot;</code>,
       ...
       and <code class="literal">&quot;strict_detection&quot;</code>
       will be returned. 
      </p>
      <p class="para">
       If <code class="parameter">type</code> is specified as
       <code class="literal">&quot;internal_encoding&quot;</code>, <code class="literal">&quot;http_input&quot;</code>,
       <code class="literal">&quot;http_output&quot;</code>, <code class="literal">&quot;http_output_conv_mimetypes&quot;</code>,
       <code class="literal">&quot;mail_charset&quot;</code>, <code class="literal">&quot;mail_header_encoding&quot;</code>,
       <code class="literal">&quot;mail_body_encoding&quot;</code>, <code class="literal">&quot;illegal_chars&quot;</code>,
       <code class="literal">&quot;encoding_translation&quot;</code>, <code class="literal">&quot;language&quot;</code>,
       <code class="literal">&quot;detect_order&quot;</code>, <code class="literal">&quot;substitute_character&quot;</code>
       or <code class="literal">&quot;strict_detection&quot;</code>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.mb-get-info-returnvalues">
  ...
  <p class="para">
   An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> of type information if <code class="parameter">type</code> 
   is not specified, otherwise a specific <code class="parameter">type</code>,
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       The <code class="parameter">type</code>s <code class="literal">&quot;func_overload&quot;</code>
       and <code class="literal">&quot;func_overload_list&quot;</code> are no longer supported.
      </td>
     </tr>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-http-output.php" class="function" rel="rdfs-seeAlso">mb_http_output()</a> - Set/Get HTTP output character encoding</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-get-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-get-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-get-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-get-info.php">＋<small>add a note</small></a></span>
