...
<head>
  ...
  <title>PHP: snmp2_set - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.snmp2-set.php">
 <link rel="shorturl" href="https://www.php.net/snmp2-set">
 <link rel="alternate" href="https://www.php.net/snmp2-set" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.snmp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.snmp2-real-walk.php">
 <link rel="next" href="https://www.php.net/manual/en/function.snmp2-walk.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.snmp2-set.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.snmp2-set.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.snmp2-set.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.snmp2-set.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.snmp2-set.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.snmp2-set.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.snmp2-set.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.snmp2-set.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.snmp2-set.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.snmp2-set.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.snmp2-set.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: snmp2_set - Manual" />
<meta name="twitter:description" content="Set the value of an SNMP object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: snmp2_set - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.snmp2-walk.php">
          snmp2_walk &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.snmp2-real-walk.php">
          &laquo; snmp2_real_walk        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.snmp2-set.php' selected="selected">English</option>
            <option value='de/function.snmp2-set.php'>German</option>
            <option value='es/function.snmp2-set.php'>Spanish</option>
            <option value='fr/function.snmp2-set.php'>French</option>
            <option value='it/function.snmp2-set.php'>Italian</option>
            <option value='ja/function.snmp2-set.php'>Japanese</option>
            <option value='pt_BR/function.snmp2-set.php'>Brazilian Portuguese</option>
            <option value='ru/function.snmp2-set.php'>Russian</option>
            <option value='tr/function.snmp2-set.php'>Turkish</option>
            <option value='uk/function.snmp2-set.php'>Ukrainian</option>
            <option value='zh/function.snmp2-set.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.snmp2-set" class="refentry">
...
<p class="para">
 ...
 <div class="refsect1 examples" id="refsect1-function.snmp2-set-examples">
  <h3 class="title">Examples</h3>
   <div class="example" id="example-4763">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.snmp2-get.php" class="function" rel="rdfs-seeAlso">snmp2_get()</a> - Fetch an SNMP object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/snmp/functions/snmp2-set.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.snmp2-set%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.snmp2-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmp2-set.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="101420">  <div class="votes">
    <div id="Vu101420">
    <a href="/manual/vote-note.php?id=101420&amp;page=function.snmp2-set&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd101420">
    <a href="/manual/vote-note.php?id=101420&amp;page=function.snmp2-set&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V101420" title="50% like this...">
    0
    </div>
  </div>
  <a href="#101420" class="name">
  <strong class="user"><em>jhuebel at gmail dot com</em></strong></a><a class="genanchor" href="#101420"> &para;</a><div class="date" title="2010-12-15 09:31"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom101420">
<div class="phpcode"><code><span class="html">The "type" parameter must be one of the following, depending on the type of variable to set on the SNMP host:<br /><br />i    INTEGER<br />u    unsigned INTEGER<br />t    TIMETICKS<br />a    IPADDRESS<br />o    OBJID<br />s    STRING<br />x    HEX STRING<br />d    DECIMAL STRING<br /><br />If OPAQUE_SPECIAL_TYPES was defined while compiling the SNMP library, the following are also valid:<br /><br />U    unsigned int64<br />I    signed int64<br />F    float<br />D    double</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.snmp2-set&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.snmp2-set.php">＋<small>add a note</small></a></div>
