...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-renamemailbox.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-rename.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-reopen.php">
...
<meta name="Description" content="Rename an old mailbox to new mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_renamemailbox - Manual" />
<meta name="twitter:description" content="Rename an old mailbox to new mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_renamemailbox - Manual" />
<meta itemprop="description" content="Rename an old mailbox to new mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Rename an old mailbox to new mailbox" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-renamemailbox.php' selected="selected">English</option>
            ...
            <option value='fr/function.imap-renamemailbox.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_renamemailbox</span> &mdash; <span class="dc-title">Rename an old mailbox to new mailbox</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.imap-renamemailbox-description">
  ...
  <p class="para rdfs-comment">
   ...
   <span class="function"><a href="function.imap-open.php" class="function">imap_open()</a></span> for the format of
   <code class="parameter">mbox</code> names).
  </p>
 </div>
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
     ...
     <dd>
      <p class="para">
       The old mailbox name, see <span class="function"><a href="function.imap-open.php" class="function">imap_open()</a></span> for more
       information
      </p>
...
<a href="imap.configuration.php#ini.imap.enable-insecure-rsh" class="link">imap.enable_insecure_rsh</a> is disabled.
     ...
     <dd>
      <p class="para">
       The new mailbox name, see <span class="function"><a href="function.imap-open.php" class="function">imap_open()</a></span> for more
       information
      </p>
      <div class="warning"><strong class="warning">Warning</strong><p class="simpara">
Passing untrusted data to this parameter is <em>insecure</em>, unless
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.imap-deletemailbox.php" class="function" rel="rdfs-seeAlso">imap_deletemailbox()</a> - Delete a mailbox</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-renamemailbox.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-renamemailbox%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-renamemailbox&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-renamemailbox.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">Don't let "...string old_mbox, string new_mbox);" fool you. You have to add the server and port to the mailbox name also. So it would be something like: 
<br />
<br />imap_renamemailbox($mailbox, "{localhost:143}$oldfolder", "{localhost:143}$newfolder")
<br />
<br />Just thought I would point it out, it took me a while to figure it out.</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>Christoffer Lindahl</em></strong></a><a class="genanchor" href="#100383"> &para;</a><div class="date" title="2010-10-12 10:27"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom100383">
<div class="phpcode"><code><span class="html">Don't forget that you can't be connected to the mailbox that you are going to rename (or delete).
<br />
<br />If you have the following mailboxes:
<br />INBOX
<br />INBOX.Foo
<br />
<br />...and want to rename "INBOX.Foo" to "INBOX.Bar" you have to be connected to "INBOX":
<br />
<br /><span class="default">&lt;?php
<br />$mbox </span><span class="keyword">= </span><span class="default">imap_open</span><span class="keyword">(</span><span class="string">'{imap.example.com}INBOX'</span><span class="keyword">, </span><span class="string">'username'</span><span class="keyword">, </span><span class="string">'password'</span><span class="keyword">);
<br /></span><span class="default">imap_renamemailbox</span><span class="keyword">(</span><span class="default">$mbox</span><span class="keyword">, </span><span class="string">'{imap.example.com}INBOX.Foo'</span><span class="keyword">, </span><span class="string">'{imap.example.com}INBOX.Bar'</span><span class="keyword">);
...
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-renamemailbox&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-renamemailbox.php">＋<small>add a note</small></a></div>
