...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-table.existsindatabase.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-table.existsindatabase.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-table.existsindatabase.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-table.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-table.delete.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-table.getname.php">
...
<meta name="Description" content="Check if table exists in database" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Table::existsInDatabase - Manual" />
<meta name="twitter:description" content="Check if table exists in database" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Table::existsInDatabase - Manual" />
<meta itemprop="description" content="Check if table exists in database" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check if table exists in database" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-table.existsindatabase.php' selected="selected">English</option>
            ...
            <option value='fr/mysql-xdevapi-table.existsindatabase.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">Table::existsInDatabase</span> &mdash; <span class="dc-title">Check if table exists in database</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysql-xdevapi-table.existsindatabase-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if table exists in the database, else <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if it does not.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-table.existsindatabase-examples">
  ...
  <div class="example" id="example-1837">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\Table::existsInDatabase()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">Yes, this table still exists in the session&#039;s schema.</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/table/existsindatabase.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-table.existsindatabase%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-table.existsindatabase&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-table.existsindatabase.php">＋<small>add a note</small></a></span>
