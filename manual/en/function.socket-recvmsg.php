...
<head>
  ...
  <title>PHP: socket_recvmsg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-recvmsg.php">
 <link rel="shorturl" href="https://www.php.net/socket-recvmsg">
 <link rel="alternate" href="https://www.php.net/socket-recvmsg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-recvfrom.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-select.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-recvmsg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-recvmsg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-recvmsg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-recvmsg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-recvmsg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-recvmsg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-recvmsg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-recvmsg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-recvmsg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-recvmsg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-recvmsg.php" hreflang="zh">
...
<meta name="Description" content="Read a message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_recvmsg - Manual" />
<meta name="twitter:description" content="Read a message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_recvmsg - Manual" />
<meta itemprop="description" content="Read a message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Read a message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.socket-select.php">
          socket_select &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.socket-recvfrom.php">
          &laquo; socket_recvfrom        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-recvmsg.php' selected="selected">English</option>
            <option value='de/function.socket-recvmsg.php'>German</option>
            <option value='es/function.socket-recvmsg.php'>Spanish</option>
            <option value='fr/function.socket-recvmsg.php'>French</option>
            <option value='it/function.socket-recvmsg.php'>Italian</option>
            <option value='ja/function.socket-recvmsg.php'>Japanese</option>
            <option value='pt_BR/function.socket-recvmsg.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-recvmsg.php'>Russian</option>
            <option value='tr/function.socket-recvmsg.php'>Turkish</option>
            <option value='uk/function.socket-recvmsg.php'>Ukrainian</option>
            <option value='zh/function.socket-recvmsg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-recvmsg" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">socket_recvmsg</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">socket_recvmsg</span> &mdash; <span class="dc-title">Read a message</span></p>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 seealso" id="refsect1-function.socket-recvmsg-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.socket-sendmsg.php" class="function" rel="rdfs-seeAlso">socket_sendmsg()</a> - Send a message</span></li>
    <li><span class="function"><a href="function.socket-cmsg-space.php" class="function" rel="rdfs-seeAlso">socket_cmsg_space()</a> - Calculate message buffer size</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-recvmsg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-recvmsg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-recvmsg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-recvmsg.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128403">  <div class="votes">
    <div id="Vu128403">
    <a href="/manual/vote-note.php?id=128403&amp;page=function.socket-recvmsg&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128403">
    <a href="/manual/vote-note.php?id=128403&amp;page=function.socket-recvmsg&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128403" title="30% like this...">
    -4
    </div>
  </div>
  <a href="#128403" class="name">
  <strong class="user"><em>251701981 at qq dot com</em></strong></a><a class="genanchor" href="#128403"> &para;</a><div class="date" title="2023-04-18 07:58"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128403">
<div class="phpcode"><code><span class="html">$sockets = [];<br />        \socket_create_pair(AF_UNIX,SOCK_DGRAM,0,$sockets);<br /><br />        $proc = new \Swoole\Process(function()use($sockets){<br /><br />            socket_close($sockets[0]);<br /><br />            $f = fopen(__FILE__,'r');<br />            var_dump($f);<br />            socket_sendmsg($sockets[1],[ 'control'=&gt;[['level'=&gt;SOL_SOCKET,'type'=&gt;SCM_RIGHTS,'data'=&gt;[$f]] ] ],0);<br />            sleep(10);<br /><br />        },false,2,1);<br /><br />        $proc-&gt;start();<br /><br />        socket_close($sockets[1]);<br /><br />        $data = [<br />            'controllen'=&gt;socket_cmsg_space(SOL_SOCKET,SCM_RIGHTS,1)<br />        ];<br /><br />        socket_recvmsg($sockets[0],$data,0);<br /><br />        var_dump($data);<br /><br />        sleep(10);</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.socket-recvmsg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-recvmsg.php">＋<small>add a note</small></a></div>
