...
<head>
  ...
  <title>PHP: Phar::delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/phar.delete.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/phar.delete.php">
 <link rel="alternate" href="https://www.php.net/manual/en/phar.delete.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.phar.php">
 <link rel="prev" href="https://www.php.net/manual/en/phar.delmetadata.php">
 <link rel="next" href="https://www.php.net/manual/en/phar.destruct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/phar.delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/phar.delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/phar.delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/phar.delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/phar.delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/phar.delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/phar.delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/phar.delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/phar.delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/phar.delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/phar.delete.php" hreflang="zh">
...
<meta name="Description" content="Delete a file within a phar archive" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Phar::delete - Manual" />
<meta name="twitter:description" content="Delete a file within a phar archive" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Phar::delete - Manual" />
<meta itemprop="description" content="Delete a file within a phar archive" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete a file within a phar archive" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="phar.destruct.php">
          Phar::__destruct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="phar.delmetadata.php">
          &laquo; Phar::delMetadata        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/phar.delete.php' selected="selected">English</option>
            <option value='de/phar.delete.php'>German</option>
            <option value='es/phar.delete.php'>Spanish</option>
            <option value='fr/phar.delete.php'>French</option>
            <option value='it/phar.delete.php'>Italian</option>
            <option value='ja/phar.delete.php'>Japanese</option>
            <option value='pt_BR/phar.delete.php'>Brazilian Portuguese</option>
            <option value='ru/phar.delete.php'>Russian</option>
            <option value='tr/phar.delete.php'>Turkish</option>
            <option value='uk/phar.delete.php'>Ukrainian</option>
            <option value='zh/phar.delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="phar.delete" class="refentry">
...
objects.  Otherwise, a <span class="classname"><a href="class.pharexception.php" class="classname">PharException</a></span> will be thrown.</p></p></blockquote>
 ...
 <div class="refsect1 examples" id="refsect1-phar.delete-examples">
  ...
  <p class="para">
   <div class="example" id="example-817">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="phar.unlinkarchive.php" class="function" rel="rdfs-seeAlso">Phar::unlinkArchive()</a> - Completely remove a phar archive from disk and from memory</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/phar/Phar/delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fphar.delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=phar.delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/phar.delete.php">＋<small>add a note</small></a></span>
