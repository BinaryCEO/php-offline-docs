...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addfacetquery.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addfilterquery.php">
...
<meta name="Description" content="Specifies which fields to return in the result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addField - Manual" />
<meta name="twitter:description" content="Specifies which fields to return in the result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addField - Manual" />
<meta itemprop="description" content="Specifies which fields to return in the result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Specifies which fields to return in the result" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addfield.php' selected="selected">English</option>
            <option value='de/solrquery.addfield.php'>German</option>
            <option value='es/solrquery.addfield.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addField</span> &mdash; <span class="dc-title">Specifies which fields to return in the result</span></p>
 ...
 <div class="refsect1 description" id="refsect1-solrquery.addfield-description">
  ...
  <p class="para">It should be called multiple time, once for each field name.</p>
  ...
  <p class="para">
   Returns the current SolrQuery object
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addfield.php">＋<small>add a note</small></a></span>
