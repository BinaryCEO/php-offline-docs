...
<head>
  ...
  <title>PHP: Imagick::setImageChannelDepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagechanneldepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagechanneldepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagechanneldepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagebordercolor.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageclipmask.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagechanneldepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagechanneldepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagechanneldepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagechanneldepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagechanneldepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagechanneldepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagechanneldepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagechanneldepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagechanneldepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagechanneldepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagechanneldepth.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::setImageChannelDepth - Manual" />
<meta name="twitter:description" content="Sets the depth of a particular image channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageChannelDepth - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimageclipmask.php">
          Imagick::setImageClipMask &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagebordercolor.php">
          &laquo; Imagick::setImageBorderColor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagechanneldepth.php' selected="selected">English</option>
            <option value='de/imagick.setimagechanneldepth.php'>German</option>
            <option value='es/imagick.setimagechanneldepth.php'>Spanish</option>
            <option value='fr/imagick.setimagechanneldepth.php'>French</option>
            <option value='it/imagick.setimagechanneldepth.php'>Italian</option>
            <option value='ja/imagick.setimagechanneldepth.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagechanneldepth.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagechanneldepth.php'>Russian</option>
            <option value='tr/imagick.setimagechanneldepth.php'>Turkish</option>
            <option value='uk/imagick.setimagechanneldepth.php'>Ukrainian</option>
            <option value='zh/imagick.setimagechanneldepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagechanneldepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageChannelDepth</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageChannelDepth</span> &mdash; <span class="dc-title">Sets the depth of a particular image channel</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagechanneldepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageChannelDepth</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$depth</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagechanneldepth-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagechanneldepth-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagechanneldepth-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagechanneldepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagechanneldepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagechanneldepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagechanneldepth.php">＋<small>add a note</small></a></span>
