...
<head>
  ...
  <title>PHP: mysql_set_charset - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mysql-set-charset.php">
 <link rel="shorturl" href="https://www.php.net/mysql-set-charset">
 <link rel="alternate" href="https://www.php.net/mysql-set-charset" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mysql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mysql-select-db.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mysql-stat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mysql-set-charset.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mysql-set-charset.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mysql-set-charset.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mysql-set-charset.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mysql-set-charset.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mysql-set-charset.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mysql-set-charset.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mysql-set-charset.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mysql-set-charset.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mysql-set-charset.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mysql-set-charset.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: mysql_set_charset - Manual" />
<meta name="twitter:description" content="Sets the client character set" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysql_set_charset - Manual" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mysql-set-charset.php' selected="selected">English</option>
            <option value='de/function.mysql-set-charset.php'>German</option>
            <option value='es/function.mysql-set-charset.php'>Spanish</option>
            <option value='fr/function.mysql-set-charset.php'>French</option>
            <option value='it/function.mysql-set-charset.php'>Italian</option>
            <option value='ja/function.mysql-set-charset.php'>Japanese</option>
            <option value='pt_BR/function.mysql-set-charset.php'>Brazilian Portuguese</option>
            <option value='ru/function.mysql-set-charset.php'>Russian</option>
            <option value='tr/function.mysql-set-charset.php'>Turkish</option>
            <option value='uk/function.mysql-set-charset.php'>Ukrainian</option>
            <option value='zh/function.mysql-set-charset.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mysql-set-charset" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mysql-client-encoding.php" class="function" rel="rdfs-seeAlso">mysql_client_encoding()</a> - Returns the name of the character set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql/functions/mysql-set-charset.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mysql-set-charset%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mysql-set-charset&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mysql-set-charset.php">＋<small>add a note</small></a></span>
