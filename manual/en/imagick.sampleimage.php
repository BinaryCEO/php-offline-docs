...
<head>
  ...
  <title>PHP: Imagick::sampleImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.sampleimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.sampleimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.sampleimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.roundcorners.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.scaleimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.sampleimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.sampleimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.sampleimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.sampleimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.sampleimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.sampleimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.sampleimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.sampleimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.sampleimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.sampleimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.sampleimage.php" hreflang="zh">
...
<meta name="Description" content="Scales an image with pixel sampling" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::sampleImage - Manual" />
<meta name="twitter:description" content="Scales an image with pixel sampling" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::sampleImage - Manual" />
<meta itemprop="description" content="Scales an image with pixel sampling" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Scales an image with pixel sampling" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.scaleimage.php">
          Imagick::scaleImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.roundcorners.php">
          &laquo; Imagick::roundCorners        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.sampleimage.php' selected="selected">English</option>
            <option value='de/imagick.sampleimage.php'>German</option>
            <option value='es/imagick.sampleimage.php'>Spanish</option>
            <option value='fr/imagick.sampleimage.php'>French</option>
            <option value='it/imagick.sampleimage.php'>Italian</option>
            <option value='ja/imagick.sampleimage.php'>Japanese</option>
            <option value='pt_BR/imagick.sampleimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.sampleimage.php'>Russian</option>
            <option value='tr/imagick.sampleimage.php'>Turkish</option>
            <option value='uk/imagick.sampleimage.php'>Ukrainian</option>
            <option value='zh/imagick.sampleimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.sampleimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::sampleImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::sampleImage</span> &mdash; <span class="dc-title">Scales an image with pixel sampling</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.sampleimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::sampleImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$columns</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$rows</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.sampleimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.sampleimage-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/sampleimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.sampleimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.sampleimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.sampleimage.php">＋<small>add a note</small></a></span>
