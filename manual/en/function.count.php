...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.count.php">
 <link rel="shorturl" href="https://www.php.net/count">
 <link rel="alternate" href="https://www.php.net/count" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.compact.php">
 <link rel="next" href="https://www.php.net/manual/en/function.current.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.count.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.count.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.count.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.count.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.count.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.count.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.count.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.count.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.count.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.count.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.count.php" hreflang="zh">
...
<meta name="Description" content="Counts all elements in an array or in a Countable object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: count - Manual" />
<meta name="twitter:description" content="Counts all elements in an array or in a Countable object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: count - Manual" />
<meta itemprop="description" content="Counts all elements in an array or in a Countable object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Counts all elements in an array or in a Countable object" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.count.php' selected="selected">English</option>
            <option value='de/function.count.php'>German</option>
            <option value='es/function.count.php'>Spanish</option>
            <option value='fr/function.count.php'>French</option>
            <option value='it/function.count.php'>Italian</option>
            <option value='ja/function.count.php'>Japanese</option>
            <option value='pt_BR/function.count.php'>Brazilian Portuguese</option>
            <option value='ru/function.count.php'>Russian</option>
            <option value='tr/function.count.php'>Turkish</option>
            <option value='uk/function.count.php'>Ukrainian</option>
            <option value='zh/function.count.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.count" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="language.types.array.php" class="link">Arrays</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.count.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">6 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114924">  <div class="votes">
    <div id="Vu114924">
    <a href="/manual/vote-note.php?id=114924&amp;page=function.count&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114924">
    <a href="/manual/vote-note.php?id=114924&amp;page=function.count&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114924" title="62% like this...">
    143
    </div>
  </div>
  <a href="#114924" class="name">
  <strong class="user"><em>onlyranga at gmail dot com</em></strong></a><a class="genanchor" href="#114924"> &para;</a><div class="date" title="2014-04-28 02:14"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114924">
<div class="phpcode"><code><span class="html">[Editor's note: array at from dot pl had pointed out that count() is a cheap operation; however, there's still the function call overhead.]
<br />
...
<br />}</span></code></div>
  ...
  <div class="note" id="123669">  <div class="votes">
    <div id="Vu123669">
    <a href="/manual/vote-note.php?id=123669&amp;page=function.count&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123669">
    <a href="/manual/vote-note.php?id=123669&amp;page=function.count&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123669" title="52% like this...">
    3
    </div>
  </div>
  <a href="#123669" class="name">
  <strong class="user"><em>lucasfsmartins at gmail dot com</em></strong></a><a class="genanchor" href="#123669"> &para;</a><div class="date" title="2019-03-07 11:26"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123669">
<div class="phpcode"><code><span class="html">If you are on PHP 7.2+, you need to be aware of "Changelog" and use something like this:<br /><br /><span class="default">&lt;?php<br />$countFruits </span><span class="keyword">= </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$countFruits</span><span class="keyword">) || </span><span class="default">$countFruits </span><span class="keyword">instanceof </span><span class="default">Countable </span><span class="keyword">? </span><span class="default">count</span><span class="keyword">(</span><span class="default">$countFruits</span><span class="keyword">) : </span><span class="default">0</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />You can organize your code to ensure that the variable is an array, or you can extend the Countable so that you don't have to do this check.</span></code></div>
  </div>
 </div>
  <div class="note" id="75737">  <div class="votes">
    <div id="Vu75737">
    <a href="/manual/vote-note.php?id=75737&amp;page=function.count&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd75737">
    <a href="/manual/vote-note.php?id=75737&amp;page=function.count&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V75737" title="50% like this...">
    13
    </div>
  </div>
  <a href="#75737" class="name">
  <strong class="user"><em>danny at dannymendel dot com</em></strong></a><a class="genanchor" href="#75737"> &para;</a><div class="date" title="2007-06-13 01:14"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom75737">
<div class="phpcode"><code><span class="html">I actually find the following function more useful when it comes to multidimension arrays when you do not want all levels of the array tree.
<br />
<br />// $limit is set to the number of recursions
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">function </span><span class="default">count_recursive </span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="default">$limit</span><span class="keyword">) {
<br />    </span><span class="default">$count </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;
<br />    foreach (</span><span class="default">$array </span><span class="keyword">as </span><span class="default">$id </span><span class="keyword">=&gt; </span><span class="default">$_array</span><span class="keyword">) {
<br />        if (</span><span class="default">is_array </span><span class="keyword">(</span><span class="default">$_array</span><span class="keyword">) &amp;&amp; </span><span class="default">$limit </span><span class="keyword">&gt; </span><span class="default">0</span><span class="keyword">) {
<br />            </span><span class="default">$count </span><span class="keyword">+= </span><span class="default">count_recursive </span><span class="keyword">(</span><span class="default">$_array</span><span class="keyword">, </span><span class="default">$limit </span><span class="keyword">- </span><span class="default">1</span><span class="keyword">);
<br />        } else {
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="117404">  <div class="votes">
    <div id="Vu117404">
    <a href="/manual/vote-note.php?id=117404&amp;page=function.count&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd117404">
    <a href="/manual/vote-note.php?id=117404&amp;page=function.count&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V117404" title="50% like this...">
    3
    </div>
  </div>
  <a href="#117404" class="name">
  <strong class="user"><em>pied-pierre</em></strong></a><a class="genanchor" href="#117404"> &para;</a><div class="date" title="2015-06-04 05:27"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom117404">
<div class="phpcode"><code><span class="html">A function of one line to find the number of elements that are not arrays, recursively :<br /><br />function count_elt($array, &amp;$count=0){<br />  foreach($array as $v) if(is_array($v)) count_elt($v,$count); else ++$count;<br />  return $count;<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="71015">  <div class="votes">
    <div id="Vu71015">
    <a href="/manual/vote-note.php?id=71015&amp;page=function.count&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd71015">
    <a href="/manual/vote-note.php?id=71015&amp;page=function.count&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V71015" title="50% like this...">
    10
    </div>
  </div>
  <a href="#71015" class="name">
  <strong class="user"><em>alexandr at vladykin dot pp dot ru</em></strong></a><a class="genanchor" href="#71015"> &para;</a><div class="date" title="2006-11-08 04:28"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom71015">
<div class="phpcode"><code><span class="html">My function returns the number of elements in array for multidimensional arrays subject to depth of array. (Almost COUNT_RECURSIVE, but you can point on which depth you want to plunge).
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="124263">  <div class="votes">
    <div id="Vu124263">
    <a href="/manual/vote-note.php?id=124263&amp;page=function.count&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124263">
    <a href="/manual/vote-note.php?id=124263&amp;page=function.count&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124263" title="50% like this...">
    0
    </div>
  </div>
  <a href="#124263" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#124263"> &para;</a><div class="date" title="2019-10-05 05:52"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124263">
<div class="phpcode"><code><span class="html">For a Non Countable Objects<br /><br />$count = count($data);<br />print "Count: $count\n";<br /><br />Warning:  count(): Parameter must be an array or an object that implements Countable in example.php on line 159<br /><br />#Quick fix is to just cast the non-countable object as an array..  <br /><br />$count = count((array) $data);<br />print "Count: $count\n";<br /><br />Count: 250</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.count.php">＋<small>add a note</small></a></div>
