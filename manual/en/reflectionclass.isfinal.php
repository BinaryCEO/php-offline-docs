...
<head>
  ...
  <title>PHP: ReflectionClass::isFinal - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.isfinal.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.isfinal.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isfinal.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.isenum.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.isinstance.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.isfinal.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.isfinal.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.isfinal.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.isfinal.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.isfinal.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.isfinal.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.isfinal.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.isfinal.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.isfinal.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.isfinal.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.isfinal.php" hreflang="zh">
...
<meta name="Description" content="Checks if class is final" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::isFinal - Manual" />
<meta name="twitter:description" content="Checks if class is final" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::isFinal - Manual" />
<meta itemprop="description" content="Checks if class is final" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if class is final" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.isinstance.php">
          ReflectionClass::isInstance &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.isenum.php">
          &laquo; ReflectionClass::isEnum        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.isfinal.php' selected="selected">English</option>
            <option value='de/reflectionclass.isfinal.php'>German</option>
            <option value='es/reflectionclass.isfinal.php'>Spanish</option>
            <option value='fr/reflectionclass.isfinal.php'>French</option>
            <option value='it/reflectionclass.isfinal.php'>Italian</option>
            <option value='ja/reflectionclass.isfinal.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.isfinal.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.isfinal.php'>Russian</option>
            <option value='tr/reflectionclass.isfinal.php'>Turkish</option>
            <option value='uk/reflectionclass.isfinal.php'>Ukrainian</option>
            <option value='zh/reflectionclass.isfinal.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.isfinal" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::isFinal</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::isFinal</span> &mdash; <span class="dc-title">Checks if class is final</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.isfinal-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::isFinal</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.isfinal-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.isfinal-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionclass.isfinal-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-5499">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionClass::isFinal()</strong></span> example</strong></p>
...
bool(true)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionclass.isfinal-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><a href="language.oop5.final.php" class="link">Final Keyword</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/isfinal.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.isfinal%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.isfinal&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.isfinal.php">＋<small>add a note</small></a></span>
