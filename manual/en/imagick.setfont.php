...
<head>
  ...
  <title>PHP: Imagick::setFont - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setfont.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setfont.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setfont.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setfirstiterator.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setformat.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setfont.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setfont.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setfont.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setfont.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setfont.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setfont.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setfont.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setfont.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setfont.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setfont.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setfont.php" hreflang="zh">
...
<meta name="Description" content="Sets font" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setFont - Manual" />
<meta name="twitter:description" content="Sets font" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setFont - Manual" />
<meta itemprop="description" content="Sets font" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets font" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setformat.php">
          Imagick::setFormat &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setfirstiterator.php">
          &laquo; Imagick::setFirstIterator        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setfont.php' selected="selected">English</option>
            <option value='de/imagick.setfont.php'>German</option>
            <option value='es/imagick.setfont.php'>Spanish</option>
            <option value='fr/imagick.setfont.php'>French</option>
            <option value='it/imagick.setfont.php'>Italian</option>
            <option value='ja/imagick.setfont.php'>Japanese</option>
            <option value='pt_BR/imagick.setfont.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setfont.php'>Russian</option>
            <option value='tr/imagick.setfont.php'>Turkish</option>
            <option value='uk/imagick.setfont.php'>Ukrainian</option>
            <option value='zh/imagick.setfont.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setfont" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setFont</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.1.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setFont</span> &mdash; <span class="dc-title">Sets font</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setfont-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setFont</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$font</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   or a file by the name of <code class="parameter">font</code> must exist. This method should
   not be confused with <span class="function"><a href="imagickdraw.setfont.php" class="function">ImagickDraw::setFont()</a></span> which sets the font
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setfont-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">font</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setfont-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.setfont-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-3090">
    <p><strong>Example #1 A <span class="function"><strong>Imagick::setFont()</strong></span> example</strong></p>
    <div class="example-contents"><p>
     Example of using Imagick::setFont
    </p></div>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Create new imagick object */<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">/* Set the font for the object */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setFont</span><span style="color: #007700">(</span><span style="color: #DD0000">"example.ttf"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Create new caption */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newPseudoImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #DD0000">"caption:Hello"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Do something with the image */<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.setfont-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.getfont.php" class="function" rel="rdfs-seeAlso">Imagick::getFont()</a> - Gets font</span></li>
    ...
    <li><span class="function"><a href="imagickdraw.getfont.php" class="function" rel="rdfs-seeAlso">ImagickDraw::getFont()</a> - Returns the font</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setfont.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setfont%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setfont&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setfont.php">＋<small>add a note</small></a></span>
