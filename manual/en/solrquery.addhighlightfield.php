...
<head>
  ...
  <title>PHP: SolrQuery::addHighlightField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.addhighlightfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.addhighlightfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addhighlightfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.addgroupsortfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.addmltfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.addhighlightfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.addhighlightfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.addhighlightfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.addhighlightfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.addhighlightfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.addhighlightfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.addhighlightfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.addhighlightfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.addhighlightfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.addhighlightfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.addhighlightfield.php" hreflang="zh">
...
<meta name="Description" content="Maps to hl.fl" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::addHighlightField - Manual" />
<meta name="twitter:description" content="Maps to hl.fl" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::addHighlightField - Manual" />
<meta itemprop="description" content="Maps to hl.fl" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Maps to hl.fl" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.addmltfield.php">
          SolrQuery::addMltField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.addgroupsortfield.php">
          &laquo; SolrQuery::addGroupSortField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.addhighlightfield.php' selected="selected">English</option>
            <option value='de/solrquery.addhighlightfield.php'>German</option>
            <option value='es/solrquery.addhighlightfield.php'>Spanish</option>
            <option value='fr/solrquery.addhighlightfield.php'>French</option>
            <option value='it/solrquery.addhighlightfield.php'>Italian</option>
            <option value='ja/solrquery.addhighlightfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.addhighlightfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.addhighlightfield.php'>Russian</option>
            <option value='tr/solrquery.addhighlightfield.php'>Turkish</option>
            <option value='uk/solrquery.addhighlightfield.php'>Ukrainian</option>
            <option value='zh/solrquery.addhighlightfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.addhighlightfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::addHighlightField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::addHighlightField</span> &mdash; <span class="dc-title">Maps to hl.fl</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.addhighlightfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::addHighlightField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.addhighlightfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.addhighlightfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/addhighlightfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.addhighlightfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.addhighlightfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.addhighlightfield.php">＋<small>add a note</small></a></span>
