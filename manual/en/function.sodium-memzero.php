...
<head>
  ...
  <title>PHP: sodium_memzero - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-memzero.php">
 <link rel="shorturl" href="https://www.php.net/sodium-memzero">
 <link rel="alternate" href="https://www.php.net/sodium-memzero" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-memcmp.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-pad.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-memzero.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-memzero.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-memzero.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-memzero.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-memzero.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-memzero.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-memzero.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-memzero.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-memzero.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-memzero.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-memzero.php" hreflang="zh">
...
<meta name="Description" content="Overwrite a string with NUL characters" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_memzero - Manual" />
<meta name="twitter:description" content="Overwrite a string with NUL characters" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_memzero - Manual" />
<meta itemprop="description" content="Overwrite a string with NUL characters" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Overwrite a string with NUL characters" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-pad.php">
          sodium_pad &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-memcmp.php">
          &laquo; sodium_memcmp        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-memzero.php' selected="selected">English</option>
            <option value='de/function.sodium-memzero.php'>German</option>
            <option value='es/function.sodium-memzero.php'>Spanish</option>
            <option value='fr/function.sodium-memzero.php'>French</option>
            <option value='it/function.sodium-memzero.php'>Italian</option>
            <option value='ja/function.sodium-memzero.php'>Japanese</option>
            <option value='pt_BR/function.sodium-memzero.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-memzero.php'>Russian</option>
            <option value='tr/function.sodium-memzero.php'>Turkish</option>
            <option value='uk/function.sodium-memzero.php'>Ukrainian</option>
            <option value='zh/function.sodium-memzero.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-memzero" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_memzero</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_memzero</span> &mdash; <span class="dc-title">Overwrite a string with NUL characters</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-memzero-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_memzero</strong></span>(<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$string</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>sodium_memzero()</strong></span> zeroes out the string that is passed by reference.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-memzero-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-memzero-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-memzero.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-memzero%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-memzero&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-memzero.php">＋<small>add a note</small></a></span>
