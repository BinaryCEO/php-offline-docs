...
<head>
  ...
  <title>PHP: posix_pathconf - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.posix-pathconf.php">
 <link rel="shorturl" href="https://www.php.net/posix-pathconf">
 <link rel="alternate" href="https://www.php.net/posix-pathconf" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.posix.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.posix-mknod.php">
 <link rel="next" href="https://www.php.net/manual/en/function.posix-setegid.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.posix-pathconf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.posix-pathconf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.posix-pathconf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.posix-pathconf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.posix-pathconf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.posix-pathconf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.posix-pathconf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.posix-pathconf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.posix-pathconf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.posix-pathconf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.posix-pathconf.php" hreflang="zh">
...
<meta name="Description" content="Returns the value of a configurable limit" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: posix_pathconf - Manual" />
<meta name="twitter:description" content="Returns the value of a configurable limit" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: posix_pathconf - Manual" />
<meta itemprop="description" content="Returns the value of a configurable limit" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the value of a configurable limit" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.posix-pathconf.php' selected="selected">English</option>
            <option value='de/function.posix-pathconf.php'>German</option>
            <option value='es/function.posix-pathconf.php'>Spanish</option>
            <option value='fr/function.posix-pathconf.php'>French</option>
            <option value='it/function.posix-pathconf.php'>Italian</option>
            <option value='ja/function.posix-pathconf.php'>Japanese</option>
            <option value='pt_BR/function.posix-pathconf.php'>Brazilian Portuguese</option>
            <option value='ru/function.posix-pathconf.php'>Russian</option>
            <option value='tr/function.posix-pathconf.php'>Turkish</option>
            <option value='uk/function.posix-pathconf.php'>Ukrainian</option>
            <option value='zh/function.posix-pathconf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.posix-pathconf" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">posix_pathconf</h1>
  <p class="verinfo">(PHP 8 &gt;= 8.3.0)</p><p class="refpurpose"><span class="refname">posix_pathconf</span> &mdash; <span class="dc-title">Returns the value of a configurable limit</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.posix-pathconf-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>posix_pathconf</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$path</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$name</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <div class="warning"><strong class="warning">Warning</strong><p class="simpara">This function is
currently not documented; only its argument list is available.
</p></div>
  <p class="para">
   Returns the value of a configurable limit from <code class="parameter">name</code> for a <code class="parameter">path</code>
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.posix-pathconf-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.posix-pathconf-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-function.posix-pathconf-errors">
  <h3 class="title">Errors/Exceptions</h3>
  <p class="para">
   Throws a <span class="classname"><a href="class.valueerror.php" class="classname">ValueError</a></span>
   when <code class="parameter">path</code> is empty.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.posix-pathconf-examples">
  <h3 class="title">Examples</h3>
  <div class="example" id="function.posix-pathconf.example.basic">
   <p><strong>Example #1 <span class="function"><strong>posix_pathconf()</strong></span> example</strong></p>
   <div class="example-contents"><p>
    This example will get the max path name&#039;s length in bytes
    for the tmp dir.
   </p></div>
   <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">posix_pathconf</span><span style="color: #007700">(</span><span style="color: #0000BB">sys_get_temp_dir</span><span style="color: #007700">(), </span><span style="color: #0000BB">POSIX_PC_PATH_MAX</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
   </div>
...
<div class="examplescode"><pre class="examplescode">4096</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-function.posix-pathconf-seealso">
  <h3 class="title">See Also</h3>
  <ul class="simplelist">
   <li><span class="function"><a href="function.posix-fpathconf.php" class="function" rel="rdfs-seeAlso">posix_fpathconf()</a> - Returns the value of a configurable limit</span></li>
  </ul>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/posix/functions/posix-pathconf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.posix-pathconf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.posix-pathconf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.posix-pathconf.php">＋<small>add a note</small></a></span>
