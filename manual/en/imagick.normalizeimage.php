...
<head>
  ...
  <title>PHP: Imagick::normalizeImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.normalizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.normalizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.normalizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.nextimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.oilpaintimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.normalizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.normalizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.normalizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.normalizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.normalizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.normalizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.normalizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.normalizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.normalizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.normalizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.normalizeimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::normalizeImage - Manual" />
<meta name="twitter:description" content="Enhances the contrast of a color image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::normalizeImage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.oilpaintimage.php">
          Imagick::oilPaintImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.nextimage.php">
          &laquo; Imagick::nextImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.normalizeimage.php' selected="selected">English</option>
            <option value='de/imagick.normalizeimage.php'>German</option>
            <option value='es/imagick.normalizeimage.php'>Spanish</option>
            <option value='fr/imagick.normalizeimage.php'>French</option>
            <option value='it/imagick.normalizeimage.php'>Italian</option>
            <option value='ja/imagick.normalizeimage.php'>Japanese</option>
            <option value='pt_BR/imagick.normalizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.normalizeimage.php'>Russian</option>
            <option value='tr/imagick.normalizeimage.php'>Turkish</option>
            <option value='uk/imagick.normalizeimage.php'>Ukrainian</option>
            <option value='zh/imagick.normalizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.normalizeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::normalizeImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::normalizeImage</span> &mdash; <span class="dc-title">Enhances the contrast of a color image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.normalizeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::normalizeImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Imagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.normalizeimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.normalizeimage-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3060">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/normalizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.normalizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.normalizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.normalizeimage.php">＋<small>add a note</small></a></span>
