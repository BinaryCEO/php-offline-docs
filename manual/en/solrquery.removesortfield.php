...
<head>
  ...
  <title>PHP: SolrQuery::removeSortField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removesortfield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removesortfield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removesortfield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removemltqueryfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removestatsfacet.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removesortfield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removesortfield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removesortfield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removesortfield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removesortfield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removesortfield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removesortfield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removesortfield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removesortfield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removesortfield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removesortfield.php" hreflang="zh">
...
<meta name="Description" content="Removes one of the sort fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeSortField - Manual" />
<meta name="twitter:description" content="Removes one of the sort fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeSortField - Manual" />
<meta itemprop="description" content="Removes one of the sort fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes one of the sort fields" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.removestatsfacet.php">
          SolrQuery::removeStatsFacet &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removemltqueryfield.php">
          &laquo; SolrQuery::removeMltQueryField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removesortfield.php' selected="selected">English</option>
            <option value='de/solrquery.removesortfield.php'>German</option>
            <option value='es/solrquery.removesortfield.php'>Spanish</option>
            <option value='fr/solrquery.removesortfield.php'>French</option>
            <option value='it/solrquery.removesortfield.php'>Italian</option>
            <option value='ja/solrquery.removesortfield.php'>Japanese</option>
            <option value='pt_BR/solrquery.removesortfield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removesortfield.php'>Russian</option>
            <option value='tr/solrquery.removesortfield.php'>Turkish</option>
            <option value='uk/solrquery.removesortfield.php'>Ukrainian</option>
            <option value='zh/solrquery.removesortfield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removesortfield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeSortField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::removeSortField</span> &mdash; <span class="dc-title">Removes one of the sort fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removesortfield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeSortField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removesortfield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removesortfield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removesortfield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removesortfield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removesortfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removesortfield.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="99039">  <div class="votes">
    <div id="Vu99039">
    <a href="/manual/vote-note.php?id=99039&amp;page=solrquery.removesortfield&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd99039">
    <a href="/manual/vote-note.php?id=99039&amp;page=solrquery.removesortfield&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V99039" title="no votes...">
    0
    </div>
  </div>
  <a href="#99039" class="name">
  <strong class="user"><em>hasbridge at gmail dot com</em></strong></a><a class="genanchor" href="#99039"> &para;</a><div class="date" title="2010-07-23 02:16"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom99039">
<div class="phpcode"><code><span class="html">This method will generate a notice if you try and remove a sort field that isn't set. This can happen if you call getSortFields, which will return an array like:<br /><br />[0] =&gt; 'fieldName asc',<br />[1] =&gt; 'fieldName desc<br /><br />But if you try and call:<br /><br /><span class="default">&lt;?php<br />$object</span><span class="keyword">-&gt;</span><span class="default">removeSortField</span><span class="keyword">(</span><span class="string">'fieldName asc'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />You will get a notice. Instead, you need to truncate the sort order (' asc', ' desc') part of it. Something like:<br /><br /><span class="default">&lt;?php<br />$fieldName </span><span class="keyword">= </span><span class="default">trim</span><span class="keyword">(</span><span class="default">str_replace</span><span class="keyword">(array(</span><span class="string">'asc'</span><span class="keyword">, </span><span class="string">'desc'</span><span class="keyword">)), </span><span class="string">''</span><span class="keyword">, </span><span class="default">$fieldName</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=solrquery.removesortfield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removesortfield.php">＋<small>add a note</small></a></div>
