...
<head>
  ...
  <title>PHP: mt_rand - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mt-rand.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.mt-getrandmax.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mt-srand.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mt-rand.php" hreflang="en">
 ...
 <link rel="alternate" href="https://www.php.net/manual/it/function.mt-rand.php" hreflang="it">
 ...
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mt-rand.php" hreflang="uk">
...
<meta name="Description" content="Generate a random value via the Mersenne Twister Random Number Generator" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mt_rand - Manual" />
<meta name="twitter:description" content="Generate a random value via the Mersenne Twister Random Number Generator" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mt_rand - Manual" />
<meta itemprop="description" content="Generate a random value via the Mersenne Twister Random Number Generator" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a random value via the Mersenne Twister Random Number Generator" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.mt-srand.php">
          mt_srand &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mt-getrandmax.php">
          &laquo; mt_getrandmax        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mt-rand.php' selected="selected">English</option>
            <option value='de/function.mt-rand.php'>German</option>
            <option value='es/function.mt-rand.php'>Spanish</option>
            <option value='fr/function.mt-rand.php'>French</option>
            <option value='it/function.mt-rand.php'>Italian</option>
            <option value='ja/function.mt-rand.php'>Japanese</option>
            <option value='pt_BR/function.mt-rand.php'>Brazilian Portuguese</option>
            <option value='ru/function.mt-rand.php'>Russian</option>
            <option value='tr/function.mt-rand.php'>Turkish</option>
            <option value='uk/function.mt-rand.php'>Ukrainian</option>
            <option value='zh/function.mt-rand.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mt-rand" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.random-bytes.php" class="function" rel="rdfs-seeAlso">random_bytes()</a> - Get cryptographically secure random bytes</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/random/functions/mt-rand.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mt-rand%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mt-rand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mt-rand.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123458">  <div class="votes">
    <div id="Vu123458">
    <a href="/manual/vote-note.php?id=123458&amp;page=function.mt-rand&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123458">
    <a href="/manual/vote-note.php?id=123458&amp;page=function.mt-rand&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123458" title="50% like this...">
    2
    </div>
  </div>
  <a href="#123458" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#123458"> &para;</a><div class="date" title="2018-12-20 08:24"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123458">
<div class="phpcode"><code><span class="html">The seed is the PID + LCG (<a href="https://github.com/php/php-src/search?q=GENERATE_SEED&amp;unscoped_q=GENERATE_SEED" rel="nofollow" target="_blank">https://github.com/php/php-src/search?q=GENERATE_SEED&amp;unscoped_q=GENERATE_SEED</a>)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mt-rand&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mt-rand.php">＋<small>add a note</small></a></div>
