...
<head>
  ...
  <title>PHP: db2_lob_read - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-lob-read.php">
 <link rel="shorturl" href="https://www.php.net/db2-lob-read">
 <link rel="alternate" href="https://www.php.net/db2-lob-read" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-last-insert-id.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-next-result.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-lob-read.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-lob-read.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-lob-read.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-lob-read.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-lob-read.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-lob-read.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-lob-read.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-lob-read.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-lob-read.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-lob-read.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-lob-read.php" hreflang="zh">
...
<meta name="Description" content="Gets a user defined size of LOB files with each invocation" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_lob_read - Manual" />
<meta name="twitter:description" content="Gets a user defined size of LOB files with each invocation" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_lob_read - Manual" />
<meta itemprop="description" content="Gets a user defined size of LOB files with each invocation" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets a user defined size of LOB files with each invocation" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-next-result.php">
          db2_next_result &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-last-insert-id.php">
          &laquo; db2_last_insert_id        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-lob-read.php' selected="selected">English</option>
            <option value='de/function.db2-lob-read.php'>German</option>
            <option value='es/function.db2-lob-read.php'>Spanish</option>
            <option value='fr/function.db2-lob-read.php'>French</option>
            <option value='it/function.db2-lob-read.php'>Italian</option>
            <option value='ja/function.db2-lob-read.php'>Japanese</option>
            <option value='pt_BR/function.db2-lob-read.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-lob-read.php'>Russian</option>
            <option value='tr/function.db2-lob-read.php'>Turkish</option>
            <option value='uk/function.db2-lob-read.php'>Ukrainian</option>
            <option value='zh/function.db2-lob-read.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-lob-read" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.db2-lob-read-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_lob_read</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$stmt</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$colnum</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$length</code></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-lob-read-returnvalues">
  ...
  <p class="para">
   ...
   <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if the data cannot be retrieved.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-result.php" class="function" rel="rdfs-seeAlso">db2_result()</a> - Returns a single column from a row in the result set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-lob-read.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-lob-read%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-lob-read&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-lob-read.php">＋<small>add a note</small></a></span>
