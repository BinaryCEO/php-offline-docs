...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-close.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-cancel.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-create.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-close.php' selected="selected">English</option>
            ...
            <option value='zh/function.ibase-blob-close.php'>Chinese (Simplified)</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-blob-open.php" class="function" rel="rdfs-seeAlso">ibase_blob_open()</a> - Open blob for retrieving data parts</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-close.php">＋<small>add a note</small></a></span>
