...
<head>
  ...
  <title>PHP: ZipArchive::getFromName - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ziparchive.getfromname.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ziparchive.getfromname.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getfromname.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.ziparchive.php">
 <link rel="prev" href="https://www.php.net/manual/en/ziparchive.getfromindex.php">
 <link rel="next" href="https://www.php.net/manual/en/ziparchive.getnameindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ziparchive.getfromname.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ziparchive.getfromname.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ziparchive.getfromname.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ziparchive.getfromname.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ziparchive.getfromname.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ziparchive.getfromname.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ziparchive.getfromname.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ziparchive.getfromname.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ziparchive.getfromname.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ziparchive.getfromname.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ziparchive.getfromname.php" hreflang="zh">
...
<meta name="Description" content="Returns the entry contents using its name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZipArchive::getFromName - Manual" />
<meta name="twitter:description" content="Returns the entry contents using its name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZipArchive::getFromName - Manual" />
<meta itemprop="description" content="Returns the entry contents using its name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the entry contents using its name" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="ziparchive.getnameindex.php">
          ZipArchive::getNameIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ziparchive.getfromindex.php">
          &laquo; ZipArchive::getFromIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ziparchive.getfromname.php' selected="selected">English</option>
            <option value='de/ziparchive.getfromname.php'>German</option>
            <option value='es/ziparchive.getfromname.php'>Spanish</option>
            <option value='fr/ziparchive.getfromname.php'>French</option>
            <option value='it/ziparchive.getfromname.php'>Italian</option>
            <option value='ja/ziparchive.getfromname.php'>Japanese</option>
            <option value='pt_BR/ziparchive.getfromname.php'>Brazilian Portuguese</option>
            <option value='ru/ziparchive.getfromname.php'>Russian</option>
            <option value='tr/ziparchive.getfromname.php'>Turkish</option>
            <option value='uk/ziparchive.getfromname.php'>Ukrainian</option>
            <option value='zh/ziparchive.getfromname.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ziparchive.getfromname" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-ziparchive.getfromname-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ZipArchive::getFromName</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$len</code><span class="initializer"> = 0</span></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = 0</span></span>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$z </span><span style="color: #007700">= new </span><span style="color: #0000BB">ZipArchive</span><span style="color: #007700">();<br />if (</span><span style="color: #0000BB">$z</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">open</span><span style="color: #007700">(</span><span style="color: #0000BB">dirname</span><span style="color: #007700">(</span><span style="color: #0000BB">__FILE__</span><span style="color: #007700">) . </span><span style="color: #DD0000">'/test_im.zip'</span><span style="color: #007700">)) {<br />    </span><span style="color: #0000BB">$im_string </span><span style="color: #007700">= </span><span style="color: #0000BB">$z</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getFromName</span><span style="color: #007700">(</span><span style="color: #DD0000">"pear_item.gif"</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$im </span><span style="color: #007700">= </span><span style="color: #0000BB">imagecreatefromstring</span><span style="color: #007700">(</span><span style="color: #0000BB">$im_string</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">imagepng</span><span style="color: #007700">(</span><span style="color: #0000BB">$im</span><span style="color: #007700">, </span><span style="color: #DD0000">'b.png'</span><span style="color: #007700">);<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-ziparchive.getfromname-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="ziparchive.getfromindex.php" class="methodname" rel="rdfs-seeAlso">ZipArchive::getFromIndex()</a> - Returns the entry contents using its index</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zip/ziparchive/getfromname.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fziparchive.getfromname%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ziparchive.getfromname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getfromname.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119932">  <div class="votes">
    <div id="Vu119932">
    <a href="/manual/vote-note.php?id=119932&amp;page=ziparchive.getfromname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119932">
    <a href="/manual/vote-note.php?id=119932&amp;page=ziparchive.getfromname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119932" title="37% like this...">
    -2
    </div>
  </div>
  <a href="#119932" class="name">
  <strong class="user"><em>henrik dot haftmann at gmail dot com</em></strong></a><a class="genanchor" href="#119932"> &para;</a><div class="date" title="2016-09-22 11:02"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119932">
<div class="phpcode"><code><span class="html">The handling of file names containing non-ASCII characters is undocumented. It seems that this function calls <span class="default">&lt;?php mb_convert_encoding</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">,</span><span class="string">"CP850"</span><span class="keyword">,</span><span class="string">"UTF-8"</span><span class="keyword">) </span><span class="default">?&gt;</span> and therefore expects DOS encoding in the zipfile but UTF-8 encoding for the name. If the zipfile uses UTF-8 names (Pkzip 4.5 / Winzip 11.2), this function fails. Use getFromIndex instead as a workaround.</span></code></div>
  </div>
 </div>
  <div class="note" id="124649">  <div class="votes">
    <div id="Vu124649">
    <a href="/manual/vote-note.php?id=124649&amp;page=ziparchive.getfromname&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124649">
    <a href="/manual/vote-note.php?id=124649&amp;page=ziparchive.getfromname&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124649" title="22% like this...">
    -5
    </div>
  </div>
  <a href="#124649" class="name">
  <strong class="user"><em>masterboreq at gmail dot com</em></strong></a><a class="genanchor" href="#124649"> &para;</a><div class="date" title="2020-01-26 08:33"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124649">
<div class="phpcode"><code><span class="html">When passing to the method explicit string which contains a relative path (inside the ZIP archive), e.g. 'path/to/file.php/' please make sure you used single quotation mark (') not the double one ("). Double quotation mark produce FALSE (at least at Windows machine) giving no further hints what gone wrong.<br />Also, please make sure that the path delimiters used inside your ZIP file is backslash or forward slash since it's make a difference in this place too.<br />I hope I saved you a headache while working with this (so far) unmentioned "feature" :)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=ziparchive.getfromname&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ziparchive.getfromname.php">＋<small>add a note</small></a></div>
