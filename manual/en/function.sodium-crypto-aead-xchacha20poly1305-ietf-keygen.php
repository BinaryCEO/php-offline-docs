...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-xchacha20poly1305-ietf-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-auth.php">
...
<meta name="Description" content="Generate a random XChaCha20-Poly1305 key." />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_aead_xchacha20poly1305_ietf_keygen - Manual" />
<meta name="twitter:description" content="Generate a random XChaCha20-Poly1305 key." />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_aead_xchacha20poly1305_ietf_keygen - Manual" />
<meta itemprop="description" content="Generate a random XChaCha20-Poly1305 key." />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generate a random XChaCha20-Poly1305 key." />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen.php' selected="selected">English</option>
            ...
            <option value='ja/function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen.php'>Japanese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_aead_xchacha20poly1305_ietf_keygen</span> &mdash; <span class="dc-title">Generate a random XChaCha20-Poly1305 key.</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen-description">
  ...
  <p class="para rdfs-comment">
   Generate a random key for use with <span class="function"><a href="function.sodium-crypto-aead-xchacha20poly1305-ietf-encrypt.php" class="function">sodium_crypto_aead_xchacha20poly1305_ietf_encrypt()</a></span> and
  ...
  <p class="para">
   Returns a 256-bit random key.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-aead-xchacha20poly1305-ietf-keygen.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-aead-xchacha20poly1305-ietf-keygen%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-xchacha20poly1305-ietf-keygen.php">＋<small>add a note</small></a></span>
