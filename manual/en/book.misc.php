...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.misc.php">
 <link rel="shorturl" href="https://www.php.net/misc">
 <link rel="alternate" href="https://www.php.net/misc" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/refs.basic.other.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.luasandboxtimeouterror.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.misc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.misc.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.misc.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.misc.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.misc.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.misc.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.misc.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.misc.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.misc.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.misc.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.misc.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.misc.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Misc. - Manual" />
<meta name="twitter:description" content="Miscellaneous Functions" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Misc. - Manual" />
<meta itemprop="description" content="Miscellaneous Functions" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Miscellaneous Functions" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="intro.misc.php">
          Introduction &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.luasandboxtimeouterror.php">
          &laquo; LuaSandboxTimeoutError        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.misc.php' selected="selected">English</option>
            <option value='de/book.misc.php'>German</option>
            <option value='es/book.misc.php'>Spanish</option>
            <option value='fr/book.misc.php'>French</option>
            <option value='it/book.misc.php'>Italian</option>
            <option value='ja/book.misc.php'>Japanese</option>
            <option value='pt_BR/book.misc.php'>Brazilian Portuguese</option>
            <option value='ru/book.misc.php'>Russian</option>
            <option value='tr/book.misc.php'>Turkish</option>
            <option value='uk/book.misc.php'>Ukrainian</option>
            <option value='zh/book.misc.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.misc" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.misc.php">Introduction</a></li><li><a href="misc.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="misc.configuration.php">Runtime Configuration</a></li></ul></li><li><a href="misc.constants.php">Predefined Constants</a></li><li><a href="ref.misc.php">Misc. Functions</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="function.connection-aborted.php">connection_aborted</a> — Check whether client disconnected</li><li><a href="function.connection-status.php">connection_status</a> — Returns connection status bitfield</li><li><a href="function.constant.php">constant</a> — Returns the value of a constant</li><li><a href="function.define.php">define</a> — Defines a named constant</li><li><a href="function.defined.php">defined</a> — Checks whether a constant with the given name exists</li><li><a href="function.die.php">die</a> — Alias of exit</li><li><a href="function.eval.php">eval</a> — Evaluate a string as PHP code</li><li><a href="function.exit.php">exit</a> — Terminate the current script with a status code or message</li><li><a href="function.get-browser.php">get_browser</a> — Tells what the user's browser is capable of</li><li><a href="function.halt-compiler.php">__halt_compiler</a> — Halts the compiler execution</li><li><a href="function.highlight-file.php">highlight_file</a> — Syntax highlighting of a file</li><li><a href="function.highlight-string.php">highlight_string</a> — Syntax highlighting of a string</li><li><a href="function.hrtime.php">hrtime</a> — Get the system's high resolution time</li><li><a href="function.ignore-user-abort.php">ignore_user_abort</a> — Set whether a client disconnect should abort script execution</li><li><a href="function.pack.php">pack</a> — Pack data into binary string</li><li><a href="function.php-strip-whitespace.php">php_strip_whitespace</a> — Return source with stripped comments and whitespace</li><li><a href="function.sapi-windows-cp-conv.php">sapi_windows_cp_conv</a> — Convert string from one codepage to another</li><li><a href="function.sapi-windows-cp-get.php">sapi_windows_cp_get</a> — Get current codepage</li><li><a href="function.sapi-windows-cp-is-utf8.php">sapi_windows_cp_is_utf8</a> — Indicates whether the codepage is UTF-8 compatible</li><li><a href="function.sapi-windows-cp-set.php">sapi_windows_cp_set</a> — Set process codepage</li><li><a href="function.sapi-windows-generate-ctrl-event.php">sapi_windows_generate_ctrl_event</a> — Send a CTRL event to another process</li><li><a href="function.sapi-windows-set-ctrl-handler.php">sapi_windows_set_ctrl_handler</a> — Set or remove a CTRL event handler</li><li><a href="function.sapi-windows-vt100-support.php">sapi_windows_vt100_support</a> — Get or set VT100 support for the specified stream associated to an output buffer of a Windows console.</li><li><a href="function.show-source.php">show_source</a> — Alias of highlight_file</li><li><a href="function.sleep.php">sleep</a> — Delay execution</li><li><a href="function.sys-getloadavg.php">sys_getloadavg</a> — Gets system load average</li><li><a href="function.time-nanosleep.php">time_nanosleep</a> — Delay for a number of seconds and nanoseconds</li><li><a href="function.time-sleep-until.php">time_sleep_until</a> — Make the script sleep until the specified time</li><li><a href="function.uniqid.php">uniqid</a> — Generate a time-based identifier</li><li><a href="function.unpack.php">unpack</a> — Unpack data from binary string</li><li><a href="function.usleep.php">usleep</a> — Delay execution in microseconds</li></ul></li><li><a href="changelog.misc.php">Changelog</a></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.misc%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.misc&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.misc.php">＋<small>add a note</small></a></span>
