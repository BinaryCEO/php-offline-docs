...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.types.array.php">
 <link rel="shorturl" href="https://www.php.net/types.array">
 <link rel="alternate" href="https://www.php.net/types.array" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.types.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.types.numeric-strings.php">
 <link rel="next" href="https://www.php.net/manual/en/language.types.object.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.types.array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.types.array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.types.array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.types.array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.types.array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.types.array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.types.array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.types.array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.types.array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.types.array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.types.array.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            ...
            <option value='it/language.types.array.php'>Italian</option>
            ...
            <option value='uk/language.types.array.php'>Ukrainian</option>
...
<div class="annotation-interactive phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$arr1 </span><span style="color: #007700">= array(</span><span style="color: #0000BB">2</span><span style="color: #007700">, </span><span style="color: #0000BB">3</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$arr2 </span><span style="color: #007700">= </span><span style="color: #0000BB">$arr1</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$arr2</span><span style="color: #007700">[] = </span><span style="color: #0000BB">4</span><span style="color: #007700">; </span><span style="color: #FF8000">// $arr2 is changed,<br />             // $arr1 is still array(2, 3)<br /><br /></span><span style="color: #0000BB">$arr3 </span><span style="color: #007700">= &amp;</span><span style="color: #0000BB">$arr1</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$arr3</span><span style="color: #007700">[] = </span><span style="color: #0000BB">4</span><span style="color: #007700">; </span><span style="color: #FF8000">// now $arr1 and $arr3 are the same<br /><br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">$arr1</span><span style="color: #007700">, </span><span style="color: #0000BB">$arr2</span><span style="color: #007700">, </span><span style="color: #0000BB">$arr3</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/types/array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.types.array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types.array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.types.array.php">＋<small>add a note</small></a></span>
  ...
  <div class="note" id="104064">  <div class="votes">
    ...
    <div class="tally" id="V104064" title="55% like this...">
    126
    </div>
  </div>
  <a href="#104064" class="name">
  <strong class="user"><em>mlvljr</em></strong></a><a class="genanchor" href="#104064"> &para;</a><div class="date" title="2011-05-20 06:37"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom104064">
<div class="phpcode"><code><span class="html">please note that when arrays are copied, the "reference status" of their members is preserved (<a href="http://www.php.net/manual/en/language.references.whatdo.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/language.references.whatdo.php</a>).</span></code></div>
  </div>
 </div>
  <div class="note" id="118855">  <div class="votes">
    ...
    <div class="tally" id="V118855" title="58% like this...">
    76
    </div>
  </div>
  <a href="#118855" class="name">
  <strong class="user"><em>thomas tulinsky</em></strong></a><a class="genanchor" href="#118855"> &para;</a><div class="date" title="2016-02-17 08:10"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118855">
<div class="phpcode"><code><span class="html">I think your first, main example is needlessly confusing, very confusing to newbies:<br /><br />$array = array(<br />    "foo" =&gt; "bar",<br />    "bar" =&gt; "foo",<br />);<br /><br />It should be removed.<br /> <br />For newbies:<br />An array index can be any string value, even a value that is also a value in the array. <br />The value of array["foo"] is "bar".<br />The value of array["bar"] is "foo"<br /><br />The following expressions are both true:<br />$array["foo"] == "bar"<br />$array["bar"] == "foo"</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>ken underscore yap atsign email dot com</em></strong></a><a class="genanchor" href="#80311"> &para;</a><div class="date" title="2008-01-09 08:00"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom80311">
<div class="phpcode"><code><span class="html">"If you convert a NULL value to an array, you get an empty array."
<br />
...
<div class="phpcode"><code><span class="html">Beware that if you're using strings as indices in the $_POST array, that periods are transformed into underscores:<br /><br />&lt;html&gt;<br />&lt;body&gt;<br /><span class="default">&lt;?php<br />    printf</span><span class="keyword">(</span><span class="string">"POST: "</span><span class="keyword">); </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">); </span><span class="default">printf</span><span class="keyword">(</span><span class="string">"&lt;br/&gt;"</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span>&lt;form method="post" action="<span class="default">&lt;?php </span><span class="keyword">echo </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_SELF'</span><span class="keyword">]; </span><span class="default">?&gt;</span>"&gt;<br />    &lt;input type="hidden" name="Windows3.1" value="Sux"&gt;<br />    &lt;input type="submit" value="Click" /&gt;<br />&lt;/form&gt;<br />&lt;/body&gt;<br />&lt;/html&gt;<br /><br />Once you click on the button, the page displays the following:<br /><br />POST: Array ( [Windows3_1] =&gt; Sux )</span></code></div>
  ...
  <div class="note" id="112289">  <div class="votes">
    ...
    <div class="tally" id="V112289" title="52% like this...">
    37
    </div>
  </div>
  <a href="#112289" class="name">
  <strong class="user"><em>chris at ocportal dot com</em></strong></a><a class="genanchor" href="#112289"> &para;</a><div class="date" title="2013-05-28 09:01"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom112289">
<div class="phpcode"><code><span class="html">Note that array value buckets are reference-safe, even through serialization.
<br />
...
<br /></span>
<br />This can be useful in some cases, for example saving RAM within complex structures.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.types.array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.types.array.php">＋<small>add a note</small></a></div>
