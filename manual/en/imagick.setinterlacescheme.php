...
<head>
  ...
  <title>PHP: Imagick::setInterlaceScheme - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setinterlacescheme.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setinterlacescheme.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setinterlacescheme.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimagewhitepoint.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setiteratorindex.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setinterlacescheme.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setinterlacescheme.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setinterlacescheme.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setinterlacescheme.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setinterlacescheme.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setinterlacescheme.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setinterlacescheme.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setinterlacescheme.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setinterlacescheme.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setinterlacescheme.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setinterlacescheme.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::setInterlaceScheme - Manual" />
<meta name="twitter:description" content="Sets the image compression" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setInterlaceScheme - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setiteratorindex.php">
          Imagick::setIteratorIndex &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimagewhitepoint.php">
          &laquo; Imagick::setImageWhitePoint        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setinterlacescheme.php' selected="selected">English</option>
            <option value='de/imagick.setinterlacescheme.php'>German</option>
            <option value='es/imagick.setinterlacescheme.php'>Spanish</option>
            <option value='fr/imagick.setinterlacescheme.php'>French</option>
            <option value='it/imagick.setinterlacescheme.php'>Italian</option>
            <option value='ja/imagick.setinterlacescheme.php'>Japanese</option>
            <option value='pt_BR/imagick.setinterlacescheme.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setinterlacescheme.php'>Russian</option>
            <option value='tr/imagick.setinterlacescheme.php'>Turkish</option>
            <option value='uk/imagick.setinterlacescheme.php'>Ukrainian</option>
            <option value='zh/imagick.setinterlacescheme.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setinterlacescheme" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setInterlaceScheme</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setInterlaceScheme</span> &mdash; <span class="dc-title">Sets the image compression</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setinterlacescheme-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setInterlaceScheme</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$interlace_scheme</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setinterlacescheme-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">interlace_scheme</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setinterlacescheme-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setinterlacescheme.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setinterlacescheme%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setinterlacescheme.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="83132">  <div class="votes">
    <div id="Vu83132">
    <a href="/manual/vote-note.php?id=83132&amp;page=imagick.setinterlacescheme&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd83132">
    <a href="/manual/vote-note.php?id=83132&amp;page=imagick.setinterlacescheme&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V83132" title="60% like this...">
    5
    </div>
  </div>
  <a href="#83132" class="name">
  <strong class="user"><em>hayvanAdam</em></strong></a><a class="genanchor" href="#83132"> &para;</a><div class="date" title="2008-05-12 03:24"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom83132">
<div class="phpcode"><code><span class="html">save progressive jpeg<br /><br /><span class="default">&lt;?php<br /><br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'image.jpg'</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">thumbnailImage</span><span class="keyword">(</span><span class="default">500</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">);<br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setInterlaceScheme</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">INTERLACE_PLANE</span><span class="keyword">);<br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'progressive.jpg'</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setinterlacescheme&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setinterlacescheme.php">＋<small>add a note</small></a></div>
