...
<head>
  ...
  <title>PHP: imap_num_msg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-num-msg.php">
 <link rel="shorturl" href="https://www.php.net/imap-num-msg">
 <link rel="alternate" href="https://www.php.net/imap-num-msg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-mutf7-to-utf8.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-num-recent.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-num-msg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-num-msg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-num-msg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-num-msg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-num-msg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-num-msg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-num-msg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-num-msg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-num-msg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-num-msg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-num-msg.php" hreflang="zh">
...
<meta name="Description" content="Gets the number of messages in the current mailbox" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_num_msg - Manual" />
<meta name="twitter:description" content="Gets the number of messages in the current mailbox" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_num_msg - Manual" />
<meta itemprop="description" content="Gets the number of messages in the current mailbox" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the number of messages in the current mailbox" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-num-recent.php">
          imap_num_recent &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-mutf7-to-utf8.php">
          &laquo; imap_mutf7_to_utf8        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-num-msg.php' selected="selected">English</option>
            <option value='de/function.imap-num-msg.php'>German</option>
            <option value='es/function.imap-num-msg.php'>Spanish</option>
            <option value='fr/function.imap-num-msg.php'>French</option>
            <option value='it/function.imap-num-msg.php'>Italian</option>
            <option value='ja/function.imap-num-msg.php'>Japanese</option>
            <option value='pt_BR/function.imap-num-msg.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-num-msg.php'>Russian</option>
            <option value='tr/function.imap-num-msg.php'>Turkish</option>
            <option value='uk/function.imap-num-msg.php'>Ukrainian</option>
            <option value='zh/function.imap-num-msg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-num-msg" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imap_num_msg</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imap_num_msg</span> &mdash; <span class="dc-title">Gets the number of messages in the current mailbox</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imap-num-msg-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imap_num_msg</strong></span>(<span class="methodparam"><span class="type"><a href="class.imap-connection.php" class="type IMAP\Connection">IMAP\Connection</a></span> <code class="parameter">$imap</code></span>): <span class="type"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.imap-num-msg-parameters">
...
<code class="parameter">imap</code></dt><dd><p class="para">An <span class="classname"><a href="class.imap-connection.php" class="classname">IMAP\Connection</a></span> instance.</p></dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-num-msg-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Return the number of messages in the current mailbox, as an integer, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.imap-num-msg-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-num-msg-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-num-recent.php" class="function" rel="rdfs-seeAlso">imap_num_recent()</a> - Gets the number of recent messages in current mailbox</span></li>
    <li><span class="function"><a href="function.imap-status.php" class="function" rel="rdfs-seeAlso">imap_status()</a> - Returns status information on a mailbox</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-num-msg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-num-msg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-num-msg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-num-msg.php">＋<small>add a note</small></a></span>
