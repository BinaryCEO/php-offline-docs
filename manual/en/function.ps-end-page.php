...
<head>
  ...
  <title>PHP: ps_end_page - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ps-end-page.php">
 <link rel="shorturl" href="https://www.php.net/ps-end-page">
 <link rel="alternate" href="https://www.php.net/ps-end-page" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ps.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ps-delete.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ps-end-pattern.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ps-end-page.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ps-end-page.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ps-end-page.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ps-end-page.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ps-end-page.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ps-end-page.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ps-end-page.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ps-end-page.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ps-end-page.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ps-end-page.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ps-end-page.php" hreflang="zh">
...
<meta name="Description" content="End a page" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ps_end_page - Manual" />
<meta name="twitter:description" content="End a page" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ps_end_page - Manual" />
<meta itemprop="description" content="End a page" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="End a page" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ps-end-page.php' selected="selected">English</option>
            <option value='de/function.ps-end-page.php'>German</option>
            <option value='es/function.ps-end-page.php'>Spanish</option>
            <option value='fr/function.ps-end-page.php'>French</option>
            <option value='it/function.ps-end-page.php'>Italian</option>
            <option value='ja/function.ps-end-page.php'>Japanese</option>
            <option value='pt_BR/function.ps-end-page.php'>Brazilian Portuguese</option>
            <option value='ru/function.ps-end-page.php'>Russian</option>
            <option value='tr/function.ps-end-page.php'>Turkish</option>
            <option value='uk/function.ps-end-page.php'>Ukrainian</option>
            <option value='zh/function.ps-end-page.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ps-end-page" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.ps-begin-page.php" class="function" rel="rdfs-seeAlso">ps_begin_page()</a> - Start a new page</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ps/functions/ps-end-page.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ps-end-page%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ps-end-page&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ps-end-page.php">＋<small>add a note</small></a></span>
