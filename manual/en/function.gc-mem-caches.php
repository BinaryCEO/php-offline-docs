...
<head>
  ...
  <title>PHP: gc_mem_caches - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gc-mem-caches.php">
 <link rel="shorturl" href="https://www.php.net/gc-mem-caches">
 <link rel="alternate" href="https://www.php.net/gc-mem-caches" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gc-enabled.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gc-status.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gc-mem-caches.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gc-mem-caches.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gc-mem-caches.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gc-mem-caches.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gc-mem-caches.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gc-mem-caches.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gc-mem-caches.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gc-mem-caches.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gc-mem-caches.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gc-mem-caches.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gc-mem-caches.php" hreflang="zh">
...
<meta name="Description" content="Reclaims memory used by the Zend Engine memory manager" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gc_mem_caches - Manual" />
<meta name="twitter:description" content="Reclaims memory used by the Zend Engine memory manager" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gc_mem_caches - Manual" />
<meta itemprop="description" content="Reclaims memory used by the Zend Engine memory manager" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reclaims memory used by the Zend Engine memory manager" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.gc-status.php">
          gc_status &raquo;
              ...
              <div class="prev">
        <a href="function.gc-enabled.php">
          &laquo; gc_enabled        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gc-mem-caches.php' selected="selected">English</option>
            <option value='de/function.gc-mem-caches.php'>German</option>
            <option value='es/function.gc-mem-caches.php'>Spanish</option>
            <option value='fr/function.gc-mem-caches.php'>French</option>
            <option value='it/function.gc-mem-caches.php'>Italian</option>
            <option value='ja/function.gc-mem-caches.php'>Japanese</option>
            <option value='pt_BR/function.gc-mem-caches.php'>Brazilian Portuguese</option>
            <option value='ru/function.gc-mem-caches.php'>Russian</option>
            <option value='tr/function.gc-mem-caches.php'>Turkish</option>
            <option value='uk/function.gc-mem-caches.php'>Ukrainian</option>
            <option value='zh/function.gc-mem-caches.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gc-mem-caches" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gc_mem_caches</h1>
  <p class="verinfo">(PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gc_mem_caches</span> &mdash; <span class="dc-title">
   Reclaims memory used by the Zend Engine memory manager
 </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.gc-mem-caches-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gc_mem_caches</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.gc-mem-caches-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>

 
 <div class="refsect1 returnvalues" id="refsect1-function.gc-mem-caches-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.gc-mem-caches-seealso">
   ...
   <ul class="simplelist">
    <li><a href="features.gc.php" class="link">Garbage Collection</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/gc-mem-caches.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gc-mem-caches%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gc-mem-caches&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gc-mem-caches.php">＋<small>add a note</small></a></span>
