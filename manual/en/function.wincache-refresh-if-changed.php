...
<head>
  ...
  <title>PHP: wincache_refresh_if_changed - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-refresh-if-changed.php">
 <link rel="shorturl" href="https://www.php.net/wincache-refresh-if-changed">
 <link rel="alternate" href="https://www.php.net/wincache-refresh-if-changed" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ocache-meminfo.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-rplist-fileinfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-refresh-if-changed.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-refresh-if-changed.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-refresh-if-changed.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-refresh-if-changed.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-refresh-if-changed.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-refresh-if-changed.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-refresh-if-changed.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-refresh-if-changed.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-refresh-if-changed.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-refresh-if-changed.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-refresh-if-changed.php" hreflang="zh">
...
<meta name="Description" content="Refreshes the cache entries for the cached files" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_refresh_if_changed - Manual" />
<meta name="twitter:description" content="Refreshes the cache entries for the cached files" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_refresh_if_changed - Manual" />
<meta itemprop="description" content="Refreshes the cache entries for the cached files" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Refreshes the cache entries for the cached files" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.wincache-rplist-fileinfo.php">
          wincache_rplist_fileinfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ocache-meminfo.php">
          &laquo; wincache_ocache_meminfo        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-refresh-if-changed.php' selected="selected">English</option>
            <option value='de/function.wincache-refresh-if-changed.php'>German</option>
            <option value='es/function.wincache-refresh-if-changed.php'>Spanish</option>
            <option value='fr/function.wincache-refresh-if-changed.php'>French</option>
            <option value='it/function.wincache-refresh-if-changed.php'>Italian</option>
            <option value='ja/function.wincache-refresh-if-changed.php'>Japanese</option>
            <option value='pt_BR/function.wincache-refresh-if-changed.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-refresh-if-changed.php'>Russian</option>
            <option value='tr/function.wincache-refresh-if-changed.php'>Turkish</option>
            <option value='uk/function.wincache-refresh-if-changed.php'>Ukrainian</option>
            <option value='zh/function.wincache-refresh-if-changed.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-refresh-if-changed" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.wincache-refresh-if-changed-examples">
  ...
  <p class="para">
   ...
   <div class="example" id="example-741">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-ucache-info.php" class="function" rel="rdfs-seeAlso">wincache_ucache_info()</a> - Retrieves information about data stored in the user cache</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-refresh-if-changed.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-refresh-if-changed%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-refresh-if-changed&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-refresh-if-changed.php">＋<small>add a note</small></a></span>
