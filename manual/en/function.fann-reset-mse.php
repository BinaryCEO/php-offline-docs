...
<head>
  ...
  <title>PHP: fann_reset_MSE - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-reset-mse.php">
 <link rel="shorturl" href="https://www.php.net/fann-reset-mse">
 <link rel="alternate" href="https://www.php.net/fann-reset-mse" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-reset-errstr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-run.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-reset-mse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-reset-mse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-reset-mse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-reset-mse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-reset-mse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-reset-mse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-reset-mse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-reset-mse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-reset-mse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-reset-mse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-reset-mse.php" hreflang="zh">
...
<meta name="Description" content="Resets the mean square error from the network" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_reset_MSE - Manual" />
<meta name="twitter:description" content="Resets the mean square error from the network" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_reset_MSE - Manual" />
<meta itemprop="description" content="Resets the mean square error from the network" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Resets the mean square error from the network" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-reset-mse.php' selected="selected">English</option>
            <option value='de/function.fann-reset-mse.php'>German</option>
            <option value='es/function.fann-reset-mse.php'>Spanish</option>
            <option value='fr/function.fann-reset-mse.php'>French</option>
            <option value='it/function.fann-reset-mse.php'>Italian</option>
            <option value='ja/function.fann-reset-mse.php'>Japanese</option>
            <option value='pt_BR/function.fann-reset-mse.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-reset-mse.php'>Russian</option>
            <option value='tr/function.fann-reset-mse.php'>Turkish</option>
            <option value='uk/function.fann-reset-mse.php'>Ukrainian</option>
            <option value='zh/function.fann-reset-mse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-reset-mse" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fann-get-bit-fail-limit.php" class="function" rel="rdfs-seeAlso">fann_get_bit_fail_limit()</a> - Returns the bit fail limit used during training</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-reset-mse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-reset-mse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-reset-mse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-reset-mse.php">＋<small>add a note</small></a></span>
