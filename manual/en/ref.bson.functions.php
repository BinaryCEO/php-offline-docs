...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ref.bson.functions.php">
 <link rel="shorturl" href="https://www.php.net/bson.functions">
 <link rel="alternate" href="https://www.php.net/bson.functions" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mongodb.bson-fromjson.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ref.bson.functions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ref.bson.functions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ref.bson.functions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ref.bson.functions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ref.bson.functions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ref.bson.functions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ref.bson.functions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ref.bson.functions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ref.bson.functions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ref.bson.functions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ref.bson.functions.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mongodb.bson-fromjson.php">
          MongoDB\BSON\fromJSON &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb.bson.php">
          &laquo; MongoDB\BSON        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ref.bson.functions.php' selected="selected">English</option>
            <option value='de/ref.bson.functions.php'>German</option>
            <option value='es/ref.bson.functions.php'>Spanish</option>
            <option value='fr/ref.bson.functions.php'>French</option>
            <option value='it/ref.bson.functions.php'>Italian</option>
            <option value='ja/ref.bson.functions.php'>Japanese</option>
            <option value='pt_BR/ref.bson.functions.php'>Brazilian Portuguese</option>
            <option value='ru/ref.bson.functions.php'>Russian</option>
            <option value='tr/ref.bson.functions.php'>Turkish</option>
            <option value='uk/ref.bson.functions.php'>Ukrainian</option>
            <option value='zh/ref.bson.functions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ref.bson.functions" class="reference">
  ...
  <h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="function.mongodb.bson-fromjson.php">MongoDB\BSON\fromJSON</a> — Returns the BSON representation of a JSON value</li><li><a href="function.mongodb.bson-fromphp.php">MongoDB\BSON\fromPHP</a> — Returns the BSON representation of a PHP value</li><li><a href="function.mongodb.bson-tocanonicalextendedjson.php">MongoDB\BSON\toCanonicalExtendedJSON</a> — Returns the Canonical Extended JSON representation of a BSON value</li><li><a href="function.mongodb.bson-tojson.php">MongoDB\BSON\toJSON</a> — Returns the Legacy Extended JSON representation of a BSON value</li><li><a href="function.mongodb.bson-tophp.php">MongoDB\BSON\toPHP</a> — Returns the PHP representation of a BSON value</li><li><a href="function.mongodb.bson-torelaxedextendedjson.php">MongoDB\BSON\toRelaxedExtendedJSON</a> — Returns the Relaxed Extended JSON representation of a BSON value</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fref.bson.functions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ref.bson.functions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ref.bson.functions.php">＋<small>add a note</small></a></span>
