...
<head>
  ...
  <title>PHP: Why enums aren't extendable - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.enumerations.object-differences.inheritance.php">
 <link rel="shorturl" href="https://www.php.net/enumerations.object-differences.inheritance">
 <link rel="alternate" href="https://www.php.net/enumerations.object-differences.inheritance" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.enumerations.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.enumerations.serialization.php">
 <link rel="next" href="https://www.php.net/manual/en/language.enumerations.examples.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.enumerations.object-differences.inheritance.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.enumerations.object-differences.inheritance.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.enumerations.object-differences.inheritance.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.enumerations.object-differences.inheritance.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.enumerations.object-differences.inheritance.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.enumerations.object-differences.inheritance.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.enumerations.object-differences.inheritance.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.enumerations.object-differences.inheritance.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.enumerations.object-differences.inheritance.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.enumerations.object-differences.inheritance.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.enumerations.object-differences.inheritance.php" hreflang="zh">
...
<meta name="Description" content="Why enums aren't extendable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Why enums aren't extendable - Manual" />
<meta name="twitter:description" content="Why enums aren't extendable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Why enums aren't extendable - Manual" />
<meta itemprop="description" content="Why enums aren't extendable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Why enums aren't extendable" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="language.enumerations.examples.php">
          Examples &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="language.enumerations.serialization.php">
          &laquo; Serialization        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.enumerations.object-differences.inheritance.php' selected="selected">English</option>
            <option value='de/language.enumerations.object-differences.inheritance.php'>German</option>
            <option value='es/language.enumerations.object-differences.inheritance.php'>Spanish</option>
            <option value='fr/language.enumerations.object-differences.inheritance.php'>French</option>
            <option value='it/language.enumerations.object-differences.inheritance.php'>Italian</option>
            <option value='ja/language.enumerations.object-differences.inheritance.php'>Japanese</option>
            <option value='pt_BR/language.enumerations.object-differences.inheritance.php'>Brazilian Portuguese</option>
            <option value='ru/language.enumerations.object-differences.inheritance.php'>Russian</option>
            <option value='tr/language.enumerations.object-differences.inheritance.php'>Turkish</option>
            <option value='uk/language.enumerations.object-differences.inheritance.php'>Ukrainian</option>
            <option value='zh/language.enumerations.object-differences.inheritance.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="language.enumerations.object-differences.inheritance" class="sect1">
  ...
  <p class="simpara">
   Because of this enums are final and can&#039;t be extended.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.enumerations.object-differences.inheritance%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.enumerations.object-differences.inheritance&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.enumerations.object-differences.inheritance.php">＋<small>add a note</small></a></span>
