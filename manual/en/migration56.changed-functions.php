...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/migration56.changed-functions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/migration56.changed-functions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/migration56.changed-functions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/migration56.php">
 <link rel="prev" href="https://www.php.net/manual/en/migration56.deprecated.php">
 <link rel="next" href="https://www.php.net/manual/en/migration56.new-functions.php">

 <link rel="alternate" href="https://www.php.net/manual/en/migration56.changed-functions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/migration56.changed-functions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/migration56.changed-functions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/migration56.changed-functions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/migration56.changed-functions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/migration56.changed-functions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/migration56.changed-functions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/migration56.changed-functions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/migration56.changed-functions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/migration56.changed-functions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/migration56.changed-functions.php" hreflang="zh">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="migration56.deprecated.php">
          &laquo; Deprecated features in PHP 5.6.x        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/migration56.changed-functions.php' selected="selected">English</option>
            <option value='de/migration56.changed-functions.php'>German</option>
            <option value='es/migration56.changed-functions.php'>Spanish</option>
            <option value='fr/migration56.changed-functions.php'>French</option>
            <option value='it/migration56.changed-functions.php'>Italian</option>
            <option value='ja/migration56.changed-functions.php'>Japanese</option>
            <option value='pt_BR/migration56.changed-functions.php'>Brazilian Portuguese</option>
            <option value='ru/migration56.changed-functions.php'>Russian</option>
            <option value='tr/migration56.changed-functions.php'>Turkish</option>
            <option value='uk/migration56.changed-functions.php'>Ukrainian</option>
            <option value='zh/migration56.changed-functions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="migration56.changed-functions" class="sect1">
    ...
    <span class="simpara">
     ...
     <span class="methodname"><a href="xmlreader.getattribute.php" class="methodname">XMLReader::getAttribute()</a></span>.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/migration56/changed-functions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmigration56.changed-functions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=migration56.changed-functions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/migration56.changed-functions.php">＋<small>add a note</small></a></span>
