...
<head>
  ...
  <title>PHP: GearmanWorker::setTimeout - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanworker.settimeout.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanworker.settimeout.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanworker.settimeout.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanworker.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanworker.setoptions.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanworker.timeout.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanworker.settimeout.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanworker.settimeout.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanworker.settimeout.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanworker.settimeout.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanworker.settimeout.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanworker.settimeout.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanworker.settimeout.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanworker.settimeout.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanworker.settimeout.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanworker.settimeout.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanworker.settimeout.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: GearmanWorker::setTimeout - Manual" />
<meta name="twitter:description" content="Set socket I/O activity timeout" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanWorker::setTimeout - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanworker.timeout.php">
          GearmanWorker::timeout &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanworker.setoptions.php">
          &laquo; GearmanWorker::setOptions        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanworker.settimeout.php' selected="selected">English</option>
            <option value='de/gearmanworker.settimeout.php'>German</option>
            <option value='es/gearmanworker.settimeout.php'>Spanish</option>
            <option value='fr/gearmanworker.settimeout.php'>French</option>
            <option value='it/gearmanworker.settimeout.php'>Italian</option>
            <option value='ja/gearmanworker.settimeout.php'>Japanese</option>
            <option value='pt_BR/gearmanworker.settimeout.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanworker.settimeout.php'>Russian</option>
            <option value='tr/gearmanworker.settimeout.php'>Turkish</option>
            <option value='uk/gearmanworker.settimeout.php'>Ukrainian</option>
            <option value='zh/gearmanworker.settimeout.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanworker.settimeout" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-gearmanworker.settimeout-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanWorker::setTimeout</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timeout</code></span>): <span class="type"><a href="language.types.singleton.php" class="type true">true</a></span></div>
...
Timeout. Waiting for next job...</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-gearmanworker.settimeout-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="gearmanworker.timeout.php" class="methodname" rel="rdfs-seeAlso">GearmanWorker::timeout()</a> - Get socket I/O activity timeout</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanworker/settimeout.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanworker.settimeout%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanworker.settimeout&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanworker.settimeout.php">＋<small>add a note</small></a></span>
