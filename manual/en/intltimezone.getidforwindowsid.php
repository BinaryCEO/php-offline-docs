...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intltimezone.getidforwindowsid.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intltimezone.getidforwindowsid.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intltimezone.getidforwindowsid.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intltimezone.php">
 <link rel="prev" href="https://www.php.net/manual/en/intltimezone.getid.php">
 <link rel="next" href="https://www.php.net/manual/en/intltimezone.getoffset.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intltimezone.getidforwindowsid.php' selected="selected">English</option>
            ...
            <option value='tr/intltimezone.getidforwindowsid.php'>Turkish</option>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-intltimezone.getidforwindowsid-returnvalues">
  ...
  <p class="para">
   Returns the system timezone or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="intltimezone.getwindowsid.php" class="methodname" rel="rdfs-seeAlso">IntlTimeZone::getWindowsID()</a> - Translate a system timezone into a Windows timezone</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intltimezone/getidforwindowsid.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintltimezone.getidforwindowsid%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intltimezone.getidforwindowsid&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intltimezone.getidforwindowsid.php">＋<small>add a note</small></a></span>
