...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-connection-string-is-quoted.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-connect.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-connection-string-quote.php">
...
<meta name="Description" content="Determines if an ODBC connection string value is quoted" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_connection_string_is_quoted - Manual" />
<meta name="twitter:description" content="Determines if an ODBC connection string value is quoted" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_connection_string_is_quoted - Manual" />
<meta itemprop="description" content="Determines if an ODBC connection string value is quoted" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determines if an ODBC connection string value is quoted" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-connection-string-is-quoted.php' selected="selected">English</option>
            <option value='de/function.odbc-connection-string-is-quoted.php'>German</option>
            <option value='es/function.odbc-connection-string-is-quoted.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 8 &gt;= 8.2.0)</p><p class="refpurpose"><span class="refname">odbc_connection_string_is_quoted</span> &mdash; <span class="dc-title">Determines if an ODBC connection string value is quoted</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.odbc-connection-string-is-quoted-description">
  ...
  <p class="para rdfs-comment">
   Determines if a string is properly quoted for an ODBC connection
   string value. ODBC connection string quoting is performed using curly
   braces, and ending braces within a string must be escaped through
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-connection-string-is-quoted-returnvalues">
  ...
  <p class="para">
   <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if quoted properly, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> if not.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.odbc-connection-string-should-quote.php" class="function" rel="rdfs-seeAlso">odbc_connection_string_should_quote()</a> - Determines if an ODBC connection string value should be quoted</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-connection-string-is-quoted.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-connection-string-is-quoted%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-connection-string-is-quoted&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-connection-string-is-quoted.php">＋<small>add a note</small></a></span>
