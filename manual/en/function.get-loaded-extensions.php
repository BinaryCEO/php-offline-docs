...
<head>
  ...
  <title>PHP: get_loaded_extensions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.get-loaded-extensions.php">
 <link rel="shorturl" href="https://www.php.net/get-loaded-extensions">
 <link rel="alternate" href="https://www.php.net/get-loaded-extensions" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.get-included-files.php">
 <link rel="next" href="https://www.php.net/manual/en/function.get-magic-quotes-gpc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.get-loaded-extensions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.get-loaded-extensions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.get-loaded-extensions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.get-loaded-extensions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.get-loaded-extensions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.get-loaded-extensions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.get-loaded-extensions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.get-loaded-extensions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.get-loaded-extensions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.get-loaded-extensions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.get-loaded-extensions.php" hreflang="zh">
...
<meta name="Description" content="Returns an array with the names of all modules compiled and loaded" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: get_loaded_extensions - Manual" />
<meta name="twitter:description" content="Returns an array with the names of all modules compiled and loaded" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: get_loaded_extensions - Manual" />
<meta itemprop="description" content="Returns an array with the names of all modules compiled and loaded" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array with the names of all modules compiled and loaded" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.get-magic-quotes-gpc.php">
          get_magic_quotes_gpc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.get-included-files.php">
          &laquo; get_included_files        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.get-loaded-extensions.php' selected="selected">English</option>
            <option value='de/function.get-loaded-extensions.php'>German</option>
            <option value='es/function.get-loaded-extensions.php'>Spanish</option>
            <option value='fr/function.get-loaded-extensions.php'>French</option>
            <option value='it/function.get-loaded-extensions.php'>Italian</option>
            <option value='ja/function.get-loaded-extensions.php'>Japanese</option>
            <option value='pt_BR/function.get-loaded-extensions.php'>Brazilian Portuguese</option>
            <option value='ru/function.get-loaded-extensions.php'>Russian</option>
            <option value='tr/function.get-loaded-extensions.php'>Turkish</option>
            <option value='uk/function.get-loaded-extensions.php'>Ukrainian</option>
            <option value='zh/function.get-loaded-extensions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.get-loaded-extensions" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">get_loaded_extensions</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">get_loaded_extensions</span> &mdash; <span class="dc-title">Returns an array with the names of all modules compiled and loaded</span></p>
   ...
   <dl>
     ...
     <dd>
      <p class="para">
       ...
       mysqli are listed. Defaults to <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> (return regular extensions).
      </p>
     </dd>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.phpinfo.php" class="function" rel="rdfs-seeAlso">phpinfo()</a> - Outputs information about PHP's configuration</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/get-loaded-extensions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.get-loaded-extensions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.get-loaded-extensions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-loaded-extensions.php">＋<small>add a note</small></a></span>
