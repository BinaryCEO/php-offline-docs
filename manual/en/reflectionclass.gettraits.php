...
<head>
  ...
  <title>PHP: ReflectionClass::getTraits - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionclass.gettraits.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionclass.gettraits.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.gettraits.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionclass.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionclass.gettraitnames.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionclass.hasconstant.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionclass.gettraits.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionclass.gettraits.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionclass.gettraits.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionclass.gettraits.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionclass.gettraits.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionclass.gettraits.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionclass.gettraits.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionclass.gettraits.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionclass.gettraits.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionclass.gettraits.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionclass.gettraits.php" hreflang="zh">
...
<meta name="Description" content="Returns an array of traits used by this class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionClass::getTraits - Manual" />
<meta name="twitter:description" content="Returns an array of traits used by this class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionClass::getTraits - Manual" />
<meta itemprop="description" content="Returns an array of traits used by this class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns an array of traits used by this class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionclass.hasconstant.php">
          ReflectionClass::hasConstant &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionclass.gettraitnames.php">
          &laquo; ReflectionClass::getTraitNames        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionclass.gettraits.php' selected="selected">English</option>
            <option value='de/reflectionclass.gettraits.php'>German</option>
            <option value='es/reflectionclass.gettraits.php'>Spanish</option>
            <option value='fr/reflectionclass.gettraits.php'>French</option>
            <option value='it/reflectionclass.gettraits.php'>Italian</option>
            <option value='ja/reflectionclass.gettraits.php'>Japanese</option>
            <option value='pt_BR/reflectionclass.gettraits.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionclass.gettraits.php'>Russian</option>
            <option value='tr/reflectionclass.gettraits.php'>Turkish</option>
            <option value='uk/reflectionclass.gettraits.php'>Ukrainian</option>
            <option value='zh/reflectionclass.gettraits.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionclass.gettraits" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ReflectionClass::getTraits</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.4.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">ReflectionClass::getTraits</span> &mdash; <span class="dc-title">Returns an array of traits used by this class</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-reflectionclass.gettraits-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>ReflectionClass::getTraits</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-reflectionclass.gettraits-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-reflectionclass.gettraits-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an array with trait names in keys and instances of trait&#039;s
   <span class="classname"><a href="class.reflectionclass.php" class="classname">ReflectionClass</a></span> in values.
   Returns <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> in case of an error.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionclass/gettraits.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionclass.gettraits%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionclass.gettraits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.gettraits.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116513">  <div class="votes">
    <div id="Vu116513">
    <a href="/manual/vote-note.php?id=116513&amp;page=reflectionclass.gettraits&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116513">
    <a href="/manual/vote-note.php?id=116513&amp;page=reflectionclass.gettraits&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116513" title="81% like this...">
    7
    </div>
  </div>
  <a href="#116513" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#116513"> &para;</a><div class="date" title="2015-01-15 04:03"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116513">
<div class="phpcode"><code><span class="html">Note that getTraits will NOT return any traits inherited from a parent.<br /><br />This is currently viewed as the desired behavior.  See <a href="https://bugs.php.net/bug.php?id=61554" rel="nofollow" target="_blank">https://bugs.php.net/bug.php?id=61554</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionclass.gettraits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionclass.gettraits.php">＋<small>add a note</small></a></div>
