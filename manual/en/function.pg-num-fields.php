...
<head>
  ...
  <title>PHP: pg_num_fields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-num-fields.php">
 <link rel="shorturl" href="https://www.php.net/pg-num-fields">
 <link rel="alternate" href="https://www.php.net/pg-num-fields" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-meta-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-num-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-num-fields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-num-fields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-num-fields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-num-fields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-num-fields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-num-fields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-num-fields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-num-fields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-num-fields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-num-fields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-num-fields.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of fields in a result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_num_fields - Manual" />
<meta name="twitter:description" content="Returns the number of fields in a result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_num_fields - Manual" />
<meta itemprop="description" content="Returns the number of fields in a result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of fields in a result" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-num-rows.php">
          pg_num_rows &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-meta-data.php">
          &laquo; pg_meta_data        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-num-fields.php' selected="selected">English</option>
            <option value='de/function.pg-num-fields.php'>German</option>
            <option value='es/function.pg-num-fields.php'>Spanish</option>
            <option value='fr/function.pg-num-fields.php'>French</option>
            <option value='it/function.pg-num-fields.php'>Italian</option>
            <option value='ja/function.pg-num-fields.php'>Japanese</option>
            <option value='pt_BR/function.pg-num-fields.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-num-fields.php'>Russian</option>
            <option value='tr/function.pg-num-fields.php'>Turkish</option>
            <option value='uk/function.pg-num-fields.php'>Ukrainian</option>
            <option value='zh/function.pg-num-fields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-num-fields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_num_fields</h1> 
  <p class="verinfo">(PHP 4 &gt;= 4.2.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_num_fields</span> &mdash; <span class="dc-title">Returns the number of fields in a result</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-num-fields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_num_fields</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-result.php" class="type PgSql\Result">PgSql\Result</a></span> <code class="parameter">$result</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_num_fields()</strong></span> returns the number of fields
   (columns) in the <span class="classname"><a href="class.pgsql-result.php" class="classname">PgSql\Result</a></span> instance.
  </p>
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    This function used to be called <span class="function"><strong>pg_numfields()</strong></span>.
   </p>
  </p></blockquote>
 </div>


<div class="refsect1 parameters" id="refsect1-function.pg-num-fields-parameters">
...
<span class="function"><a href="function.pg-query-params.php" class="function">pg_query_params()</a></span> or <span class="function"><a href="function.pg-execute.php" class="function">pg_execute()</a></span>(among others).</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-num-fields-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.pg-num-fields-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-num-fields-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2094">
    <p><strong>Example #1 <span class="function"><strong>pg_num_fields()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">2 field(s) returned.</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-num-fields-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-affected-rows.php" class="function" rel="rdfs-seeAlso">pg_affected_rows()</a> - Returns number of affected records (tuples)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-num-fields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-num-fields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-num-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-num-fields.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="30641">  <div class="votes">
    <div id="Vu30641">
    <a href="/manual/vote-note.php?id=30641&amp;page=function.pg-num-fields&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd30641">
    <a href="/manual/vote-note.php?id=30641&amp;page=function.pg-num-fields&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V30641" title="33% like this...">
    -1
    </div>
  </div>
  <a href="#30641" class="name">
  <strong class="user"><em>mark at redbrick dot dcu dot ie</em></strong></a><a class="genanchor" href="#30641"> &para;</a><div class="date" title="2003-03-24 01:02"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom30641">
<div class="phpcode"><code><span class="html">Here is a simple example for using pg_num_feilds, pg_num_rows and pg_result together.  I'm simply SELECTing * from a table named markie on the current pg_connect().  <br /><br /><span class="default">&lt;?php<br />    $pgsql_conn </span><span class="keyword">= </span><span class="default">pg_connect</span><span class="keyword">(</span><span class="string">"dbname=mark host=localhost"</span><span class="keyword">);<br /><br />    if (!</span><span class="default">$pgsql_conn</span><span class="keyword">) {<br />        print </span><span class="default">pg_last_error</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">);<br />        exit;<br />    }<br /><br />    </span><span class="default">$results </span><span class="keyword">= </span><span class="default">pg_query</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">, </span><span class="string">"SELECT * FROM markie"</span><span class="keyword">);<br /><br />    echo </span><span class="string">"&lt;table border=1&gt;\n"</span><span class="keyword">;<br />    for(</span><span class="default">$lt </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$lt </span><span class="keyword">&lt; </span><span class="default">pg_num_rows</span><span class="keyword">(</span><span class="default">$results</span><span class="keyword">); </span><span class="default">$lt</span><span class="keyword">++) {<br />        echo </span><span class="string">"&lt;tr&gt;\n"</span><span class="keyword">;<br />        for(</span><span class="default">$gt </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$gt </span><span class="keyword">&lt; </span><span class="default">pg_num_fields</span><span class="keyword">(</span><span class="default">$results</span><span class="keyword">); </span><span class="default">$gt</span><span class="keyword">++) {<br />            echo </span><span class="string">"&lt;td&gt;" </span><span class="keyword">. </span><span class="default">pg_result</span><span class="keyword">(</span><span class="default">$results</span><span class="keyword">, </span><span class="default">$lt</span><span class="keyword">, </span><span class="default">$gt</span><span class="keyword">) . </span><span class="string">"&lt;/td&gt;\n"</span><span class="keyword">;<br />        }<br />        echo </span><span class="string">"&lt;/tr&gt;\n"</span><span class="keyword">;<br />    }<br />    echo </span><span class="string">"&lt;/table&gt;\n"</span><span class="keyword">;<br /><br />    </span><span class="default">pg_close</span><span class="keyword">(</span><span class="default">$pgsql_conn</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />This code snippet will print out the rows and columns into a HTML table.<br /><br />Regards,  --mark</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-num-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-num-fields.php">＋<small>add a note</small></a></div>
