...
<head>
  ...
  <title>PHP: fann_init_weights - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-init-weights.php">
 <link rel="shorturl" href="https://www.php.net/fann-init-weights">
 <link rel="alternate" href="https://www.php.net/fann-init-weights" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-get-training-algorithm.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-length-train-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-init-weights.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-init-weights.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-init-weights.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-init-weights.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-init-weights.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-init-weights.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-init-weights.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-init-weights.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-init-weights.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-init-weights.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-init-weights.php" hreflang="zh">
...
<meta name="Description" content="Initialize the weights using Widrow + Nguyen&rsquo;s algorithm" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_init_weights - Manual" />
<meta name="twitter:description" content="Initialize the weights using Widrow + Nguyen&rsquo;s algorithm" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_init_weights - Manual" />
<meta itemprop="description" content="Initialize the weights using Widrow + Nguyen&rsquo;s algorithm" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initialize the weights using Widrow + Nguyen&rsquo;s algorithm" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.fann-length-train-data.php">
          fann_length_train_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-get-training-algorithm.php">
          &laquo; fann_get_training_algorithm        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-init-weights.php' selected="selected">English</option>
            <option value='de/function.fann-init-weights.php'>German</option>
            <option value='es/function.fann-init-weights.php'>Spanish</option>
            <option value='fr/function.fann-init-weights.php'>French</option>
            <option value='it/function.fann-init-weights.php'>Italian</option>
            <option value='ja/function.fann-init-weights.php'>Japanese</option>
            <option value='pt_BR/function.fann-init-weights.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-init-weights.php'>Russian</option>
            <option value='tr/function.fann-init-weights.php'>Turkish</option>
            <option value='uk/function.fann-init-weights.php'>Ukrainian</option>
            <option value='zh/function.fann-init-weights.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-init-weights" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_init_weights</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_init_weights</span> &mdash; <span class="dc-title">Initialize the weights using Widrow + Nguyen’s algorithm</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-init-weights-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_init_weights</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$ann</code></span>, <span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$train_data</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Initialize the weights using Widrow + Nguyen’s algorithm.
  </p>
  <p class="para">
   This function behaves similarly to <span class="function"><a href="function.fann-randomize-weights.php" class="function">fann_randomize_weights()</a></span>. It will use the algorithm developed by
 ...
 <div class="refsect1 parameters" id="refsect1-function.fann-init-weights-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-init-weights-returnvalues">
  ...
  <div class="refsect1 seealso" id="refsect1-function.fann-init-weights-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fann-randomize-weights.php" class="function" rel="rdfs-seeAlso">fann_randomize_weights()</a> - Give each connection a random weight between min_weight and max_weight</span></li>
    <li><span class="function"><a href="function.fann-read-train-from-file.php" class="function" rel="rdfs-seeAlso">fann_read_train_from_file()</a> - Reads a file that stores training data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-init-weights.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-init-weights%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-init-weights&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-init-weights.php">＋<small>add a note</small></a></span>
