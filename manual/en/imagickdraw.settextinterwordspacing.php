...
<head>
  ...
  <title>PHP: ImagickDraw::setTextInterwordSpacing - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.settextinterlinespacing.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.settextkerning.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.settextinterwordspacing.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.settextinterwordspacing.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.settextinterwordspacing.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.settextinterwordspacing.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.settextinterwordspacing.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.settextinterwordspacing.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.settextinterwordspacing.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.settextinterwordspacing.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.settextinterwordspacing.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.settextinterwordspacing.php" hreflang="zh">
...
<meta name="Description" content="Sets the text interword spacing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setTextInterwordSpacing - Manual" />
<meta name="twitter:description" content="Sets the text interword spacing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setTextInterwordSpacing - Manual" />
<meta itemprop="description" content="Sets the text interword spacing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the text interword spacing" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.settextkerning.php">
          ImagickDraw::setTextKerning &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.settextinterlinespacing.php">
          &laquo; ImagickDraw::setTextInterlineSpacing        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.settextinterwordspacing.php' selected="selected">English</option>
            <option value='de/imagickdraw.settextinterwordspacing.php'>German</option>
            <option value='es/imagickdraw.settextinterwordspacing.php'>Spanish</option>
            <option value='fr/imagickdraw.settextinterwordspacing.php'>French</option>
            <option value='it/imagickdraw.settextinterwordspacing.php'>Italian</option>
            <option value='ja/imagickdraw.settextinterwordspacing.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.settextinterwordspacing.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.settextinterwordspacing.php'>Russian</option>
            <option value='tr/imagickdraw.settextinterwordspacing.php'>Turkish</option>
            <option value='uk/imagickdraw.settextinterwordspacing.php'>Ukrainian</option>
            <option value='zh/imagickdraw.settextinterwordspacing.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.settextinterwordspacing" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setTextInterwordSpacing</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setTextInterwordSpacing</span> &mdash; <span class="dc-title">Sets the text interword spacing</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.settextinterwordspacing-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setTextInterwordSpacing</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$spacing</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.settextinterwordspacing-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">spacing</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.settextinterwordspacing-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/settextinterwordspacing.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.settextinterwordspacing%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.settextinterwordspacing&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.settextinterwordspacing.php">＋<small>add a note</small></a></span>
