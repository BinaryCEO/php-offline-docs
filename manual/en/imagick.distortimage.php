...
<head>
  ...
  <title>PHP: Imagick::distortImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.distortimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.distortimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.distortimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.displayimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.drawimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.distortimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.distortimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.distortimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.distortimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.distortimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.distortimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.distortimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.distortimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.distortimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.distortimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.distortimage.php" hreflang="zh">
...
<meta name="Description" content="Distorts an image using various distortion methods" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::distortImage - Manual" />
<meta name="twitter:description" content="Distorts an image using various distortion methods" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::distortImage - Manual" />
<meta itemprop="description" content="Distorts an image using various distortion methods" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Distorts an image using various distortion methods" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.drawimage.php">
          Imagick::drawImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.displayimages.php">
          &laquo; Imagick::displayImages        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.distortimage.php' selected="selected">English</option>
            <option value='de/imagick.distortimage.php'>German</option>
            <option value='es/imagick.distortimage.php'>Spanish</option>
            <option value='fr/imagick.distortimage.php'>French</option>
            <option value='it/imagick.distortimage.php'>Italian</option>
            <option value='ja/imagick.distortimage.php'>Japanese</option>
            <option value='pt_BR/imagick.distortimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.distortimage.php'>Russian</option>
            <option value='tr/imagick.distortimage.php'>Turkish</option>
            <option value='uk/imagick.distortimage.php'>Ukrainian</option>
            <option value='zh/imagick.distortimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.distortimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::distortImage</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.0.1, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::distortImage</span> &mdash; <span class="dc-title">Distorts an image using various distortion methods</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.distortimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::distortImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$method</code></span>, <span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$arguments</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$bestfit</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   size as the source image, unless &#039;bestfit&#039; is set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>.
  </p>
  <p class="para">
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.distortimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The method of image distortion. See <a href="imagick.constants.php#imagick.constants.distortion" class="link">distortion constants</a>
      </p>
     </dd>
...
something similar to:</p></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.distortimage-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.blurimage.php" class="function" rel="rdfs-seeAlso">Imagick::blurImage()</a> - Adds blur filter to image</span></li>
    ...
    <li><span class="function"><a href="imagick.radialblurimage.php" class="function" rel="rdfs-seeAlso">Imagick::radialBlurImage()</a> - Radial blurs an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/distortimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.distortimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.distortimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.distortimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="103403">  <div class="votes">
    <div id="Vu103403">
    <a href="/manual/vote-note.php?id=103403&amp;page=imagick.distortimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103403">
    <a href="/manual/vote-note.php?id=103403&amp;page=imagick.distortimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103403" title="73% like this...">
    11
    </div>
  </div>
  <a href="#103403" class="name">
  <strong class="user"><em>DJ Mike</em></strong></a><a class="genanchor" href="#103403"> &para;</a><div class="date" title="2011-04-11 11:11"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103403">
<div class="phpcode"><code><span class="html">Affine<br /><br /><span class="default">&lt;?php <br />$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"opossum.jpg" </span><span class="keyword">); <br /></span><span class="default">$points </span><span class="keyword">= array( <br />                </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">25</span><span class="keyword">,</span><span class="default">25</span><span class="keyword">,   <br />               </span><span class="default">100</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">,</span><span class="default">50 <br />               </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setimagebackgroundcolor</span><span class="keyword">(</span><span class="string">"#fad888"</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">( </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_BACKGROUND </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">(  </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_AFFINE</span><span class="keyword">, </span><span class="default">$points</span><span class="keyword">, </span><span class="default">TRUE </span><span class="keyword">); <br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/jpeg" </span><span class="keyword">); <br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Affine Projection<br /><br /><span class="default">&lt;?php <br />$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"opossum.jpg" </span><span class="keyword">); <br /></span><span class="default">$points </span><span class="keyword">= array( </span><span class="default">0.9</span><span class="keyword">,</span><span class="default">0.3</span><span class="keyword">,<br />                -</span><span class="default">0.2</span><span class="keyword">,</span><span class="default">0.7</span><span class="keyword">,<br />                 </span><span class="default">20</span><span class="keyword">,</span><span class="default">15 </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setimagebackgroundcolor</span><span class="keyword">(</span><span class="string">"#fad888"</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">( </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_BACKGROUND </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">( </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_AFFINEPROJECTION</span><span class="keyword">, </span><span class="default">$points</span><span class="keyword">, </span><span class="default">TRUE </span><span class="keyword">); <br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/jpeg" </span><span class="keyword">); <br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Arc<br /><br /><span class="default">&lt;?php <br />$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"opossum.jpg" </span><span class="keyword">); <br /></span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">imagickdraw</span><span class="keyword">(); <br /></span><span class="default">$degrees </span><span class="keyword">= array( </span><span class="default">180 </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setimagebackgroundcolor</span><span class="keyword">(</span><span class="string">"#fad888"</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">( </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_BACKGROUND </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">( </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_ARC</span><span class="keyword">, </span><span class="default">$degrees</span><span class="keyword">, </span><span class="default">TRUE </span><span class="keyword">); <br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/jpeg" </span><span class="keyword">); <br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Rotated Arc<br /><br /><span class="default">&lt;?php <br />$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"opossum.jpg" </span><span class="keyword">); <br /></span><span class="default">$draw </span><span class="keyword">= new </span><span class="default">imagickdraw</span><span class="keyword">(); <br /></span><span class="default">$degrees </span><span class="keyword">= array( </span><span class="default">180</span><span class="keyword">, </span><span class="default">45</span><span class="keyword">, </span><span class="default">100</span><span class="keyword">, </span><span class="default">20 </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setimagebackgroundcolor</span><span class="keyword">(</span><span class="string">"#fad888"</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">( </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_BACKGROUND </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">( </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_ARC</span><span class="keyword">, </span><span class="default">$degrees</span><span class="keyword">, </span><span class="default">TRUE </span><span class="keyword">); <br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/jpeg" </span><span class="keyword">); <br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Bilinear<br /><br /><span class="default">&lt;?php <br />$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"opossum.jpg" </span><span class="keyword">); <br /></span><span class="default">$points </span><span class="keyword">= array( <br />                </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">25</span><span class="keyword">,</span><span class="default">25</span><span class="keyword">, </span><span class="comment"># top left  <br />                </span><span class="default">176</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">126</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="comment"># top right<br />                </span><span class="default">0</span><span class="keyword">,</span><span class="default">135</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,</span><span class="default">105</span><span class="keyword">, </span><span class="comment"># bottom right <br />                </span><span class="default">176</span><span class="keyword">,</span><span class="default">135</span><span class="keyword">, </span><span class="default">176</span><span class="keyword">,</span><span class="default">135 </span><span class="comment"># bottum left<br />                </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setimagebackgroundcolor</span><span class="keyword">(</span><span class="string">"#fad888"</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">( </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_BACKGROUND </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">( </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_BILINEAR</span><span class="keyword">, </span><span class="default">$points</span><span class="keyword">, </span><span class="default">TRUE </span><span class="keyword">); <br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/jpeg" </span><span class="keyword">); <br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Perspective<br /><br /><span class="default">&lt;?php <br />$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"opossum.jpg" </span><span class="keyword">); <br /></span><span class="default">$points </span><span class="keyword">= array( <br />                </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">25</span><span class="keyword">,</span><span class="default">25</span><span class="keyword">, </span><span class="comment"># top left  <br />                </span><span class="default">176</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="default">126</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">, </span><span class="comment"># top right<br />                </span><span class="default">0</span><span class="keyword">,</span><span class="default">135</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,</span><span class="default">105</span><span class="keyword">, </span><span class="comment"># bottom right <br />                </span><span class="default">176</span><span class="keyword">,</span><span class="default">135</span><span class="keyword">, </span><span class="default">176</span><span class="keyword">,</span><span class="default">135 </span><span class="comment"># bottum left<br />                </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setimagebackgroundcolor</span><span class="keyword">(</span><span class="string">"#fad888"</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">( </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_BACKGROUND </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">( </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_PERSPECTIVE</span><span class="keyword">, </span><span class="default">$points</span><span class="keyword">, </span><span class="default">TRUE </span><span class="keyword">); <br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/jpeg" </span><span class="keyword">); <br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;<br /></span><br />Scale Rotate Translate<br /><br /><span class="default">&lt;?php <br />$image </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="string">"opossum.jpg" </span><span class="keyword">); <br /></span><span class="default">$points </span><span class="keyword">= array( <br />                 </span><span class="default">1.5</span><span class="keyword">, </span><span class="comment"># scale 150%<br />                 </span><span class="default">150 </span><span class="comment"># rotate<br />               </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setimagebackgroundcolor</span><span class="keyword">(</span><span class="string">"#fad888"</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">( </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_BACKGROUND </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">( </span><span class="default">imagick</span><span class="keyword">::</span><span class="default">DISTORTION_SCALEROTATETRANSLATE</span><span class="keyword">, </span><span class="default">$points</span><span class="keyword">, </span><span class="default">TRUE </span><span class="keyword">); <br /></span><span class="default">header</span><span class="keyword">( </span><span class="string">"Content-Type: image/jpeg" </span><span class="keyword">); <br />echo </span><span class="default">$image</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="116416">  <div class="votes">
    <div id="Vu116416">
    <a href="/manual/vote-note.php?id=116416&amp;page=imagick.distortimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116416">
    <a href="/manual/vote-note.php?id=116416&amp;page=imagick.distortimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116416" title="100% like this...">
    4
    </div>
  </div>
  <a href="#116416" class="name">
  <strong class="user"><em>peter dot e dot lind at gmail dot com</em></strong></a><a class="genanchor" href="#116416"> &para;</a><div class="date" title="2014-12-30 08:55"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116416">
<div class="phpcode"><code><span class="html">It is worth nothing that details on distorts as well as arguments can be found at <a href="http://www.imagemagick.org/Usage/distorts/" rel="nofollow" target="_blank">http://www.imagemagick.org/Usage/distorts/</a> - the PHP manual doesn't give much, if any, detail on arguments.
<br />
<br />I found this very useful when I had to do a translated rotation on an image - i.e. rotating around a point in the image that was not square in the center. This can be achieved by using distortImage with Imagick::DISTORTION_SCALEROTATETRANSLATE like this:
<br />
<br /><span class="default">&lt;?php
<br />
<br />$imagick </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'/path/to/image'</span><span class="keyword">);
<br /></span><span class="default">$args </span><span class="keyword">= array(
<br />    </span><span class="default">20</span><span class="keyword">, </span><span class="comment"># x point to rotate around
<br />    </span><span class="default">20</span><span class="keyword">, </span><span class="comment"># y point to rotate around
<br />    </span><span class="default">1</span><span class="keyword">, </span><span class="comment"># scaling factor - 1 means no scaling
<br />    </span><span class="default">90</span><span class="keyword">, </span><span class="comment"># angle to rotate
<br /></span><span class="keyword">);
<br />
<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_TRANSPARENT</span><span class="keyword">);
<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_SCALEROTATETRANSLATE</span><span class="keyword">, </span><span class="default">$args</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);
<br />
<br /></span><span class="default">?&gt;
<br /></span>
<br />Note that this type of distort takes from 1 to 7 arguments, depending on what you want to do exactly - there is a lot of flexibility here.</span></code></div>
  </div>
 </div>
  <div class="note" id="125815">  <div class="votes">
    <div id="Vu125815">
    <a href="/manual/vote-note.php?id=125815&amp;page=imagick.distortimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125815">
    <a href="/manual/vote-note.php?id=125815&amp;page=imagick.distortimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125815" title="75% like this...">
    2
    </div>
  </div>
  <a href="#125815" class="name">
  <strong class="user"><em>Abe</em></strong></a><a class="genanchor" href="#125815"> &para;</a><div class="date" title="2021-02-13 05:21"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125815">
<div class="phpcode"><code><span class="html">Control Points for DISTORTION_PERSPECTIVE are pairs of x0, y0, x1, y1 coordinates, where x0/y0 is the original point and x1/y1 is the destination point, <br /><br />e.g. for a four point distortion:<br /><br />    <span class="default">&lt;?php <br /><br />    $im </span><span class="keyword">= new </span><span class="default">imagick</span><span class="keyword">( </span><span class="default">$fn</span><span class="keyword">); <br /><br />    </span><span class="default">$w</span><span class="keyword">=</span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">();<br />    </span><span class="default">$h</span><span class="keyword">=</span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">();<br />    </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png'</span><span class="keyword">);<br /><br />    </span><span class="default">$controlPoints </span><span class="keyword">= array(<br />                    </span><span class="default">$tLx</span><span class="keyword">, </span><span class="default">$tLy</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,  </span><span class="comment">// top left<br />                    </span><span class="default">$tRx</span><span class="keyword">, </span><span class="default">$tRy</span><span class="keyword">, </span><span class="default">$w</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="comment">// top right<br />                    </span><span class="default">$bRx</span><span class="keyword">, </span><span class="default">$bRy</span><span class="keyword">, </span><span class="default">$w</span><span class="keyword">, </span><span class="default">$h</span><span class="keyword">, </span><span class="comment">// bottom right<br />                    </span><span class="default">$bLx</span><span class="keyword">, </span><span class="default">$bLy</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$h </span><span class="comment">// bottom left<br />                </span><span class="keyword">);<br /><br />    </span><span class="comment">/* Perform the distortion */<br />    </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_PERSPECTIVE</span><span class="keyword">, </span><span class="default">$controlPoints</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);<br /><br />    </span><span class="comment">// Output the image<br />    </span><span class="default">$output </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getimageblob</span><span class="keyword">();<br />    </span><span class="default">$outputtype </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getFormat</span><span class="keyword">();<br /><br />    </span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-type: </span><span class="default">$outputtype</span><span class="string">"</span><span class="keyword">);<br />    echo </span><span class="default">$output</span><span class="keyword">;<br />     <br />    </span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="102255">  <div class="votes">
    <div id="Vu102255">
    <a href="/manual/vote-note.php?id=102255&amp;page=imagick.distortimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102255">
    <a href="/manual/vote-note.php?id=102255&amp;page=imagick.distortimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102255" title="60% like this...">
    1
    </div>
  </div>
  <a href="#102255" class="name">
  <strong class="user"><em>ashokmca.g at gmail dot com</em></strong></a><a class="genanchor" href="#102255"> &para;</a><div class="date" title="2011-02-04 02:13"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102255">
<div class="phpcode"><code><span class="html">Slide image with shadow using distortImage<br /><br /><span class="default">&lt;?php<br /><br />$slideValue </span><span class="keyword">= </span><span class="default">150</span><span class="keyword">;<br /><br /></span><span class="comment">// Create new object <br /></span><span class="default">$im </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"grnhrs.jpg"</span><span class="keyword">);<br /><br /></span><span class="comment">// Resize <br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">thumbnailImage</span><span class="keyword">(</span><span class="default">500</span><span class="keyword">,</span><span class="default">400</span><span class="keyword">);<br /><br /></span><span class="comment">// Set the image format to png <br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">'png'</span><span class="keyword">);<br /><br /></span><span class="comment">//Clone the current object<br /></span><span class="default">$shadow </span><span class="keyword">= </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">clone</span><span class="keyword">();<br /><br /></span><span class="comment">//Set image background color to black (this is the color of the shadow)<br /></span><span class="default">$shadow</span><span class="keyword">-&gt;</span><span class="default">setImageBackgroundColor</span><span class="keyword">( new </span><span class="default">ImagickPixel</span><span class="keyword">( </span><span class="string">'black' </span><span class="keyword">) );<br /> <br /> </span><span class="comment">//Create the shadow <br /></span><span class="default">$shadow</span><span class="keyword">-&gt;</span><span class="default">shadowImage</span><span class="keyword">( </span><span class="default">80</span><span class="keyword">, </span><span class="default">10</span><span class="keyword">, </span><span class="default">5</span><span class="keyword">, </span><span class="default">5 </span><span class="keyword">);<br /><br /></span><span class="comment">// Fill background area with transparent for image<br />//VIRTUALPIXELMETHOD_TRANSPARENT<br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageVirtualPixelMethod</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">VIRTUALPIXELMETHOD_ TRANSPARENT</span><span class="keyword">);<br /><br /></span><span class="comment">// Activate matte <br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageMatte</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="comment">//Control points for the distortion <br /></span><span class="default">$controlPoints </span><span class="keyword">= array( </span><span class="default">0</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,<br />                        </span><span class="default">$slideValue</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,<br />                        <br />                        </span><span class="default">0</span><span class="keyword">, </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">(),<br />                        </span><span class="default">0</span><span class="keyword">, </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">(),<br />                        <br />                        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">(), </span><span class="default">0</span><span class="keyword">,<br />                        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">(), </span><span class="default">0</span><span class="keyword">,<br />                        <br />                        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">(), </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">(),<br />                        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageWidth</span><span class="keyword">()-</span><span class="default">$slideValue</span><span class="keyword">, </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">getImageHeight</span><span class="keyword">());<br />                        <br /></span><span class="comment">// Perform the distortion <br /></span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_PERSPECTIVEPROJECTION</span><span class="keyword">, </span><span class="default">$controlPoints</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="comment">// Perform the distortion in shadow image<br /></span><span class="default">$shadow</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_PERSPECTIVEPROJECTION</span><span class="keyword">, </span><span class="default">$controlPoints</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="comment">// Imagick::shadowImage only creates the shadow.<br />// That is why the original image is composited over it <br /></span><span class="default">$shadow</span><span class="keyword">-&gt;</span><span class="default">compositeImage</span><span class="keyword">( </span><span class="default">$im</span><span class="keyword">, </span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COMPOSITE_OVER</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">0 </span><span class="keyword">);<br /><br /></span><span class="comment">/* Ouput the image */<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">);<br />echo </span><span class="default">$shadow</span><span class="keyword">;<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.distortimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.distortimage.php">＋<small>add a note</small></a></div>
