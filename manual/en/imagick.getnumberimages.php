...
<head>
  ...
  <title>PHP: Imagick::getNumberImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getnumberimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getnumberimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getnumberimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getiteratorindex.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getoption.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getnumberimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getnumberimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getnumberimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getnumberimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getnumberimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getnumberimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getnumberimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getnumberimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getnumberimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getnumberimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getnumberimages.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of images in the object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getNumberImages - Manual" />
<meta name="twitter:description" content="Returns the number of images in the object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getNumberImages - Manual" />
<meta itemprop="description" content="Returns the number of images in the object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of images in the object" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getoption.php">
          Imagick::getOption &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getiteratorindex.php">
          &laquo; Imagick::getIteratorIndex        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getnumberimages.php' selected="selected">English</option>
            <option value='de/imagick.getnumberimages.php'>German</option>
            <option value='es/imagick.getnumberimages.php'>Spanish</option>
            <option value='fr/imagick.getnumberimages.php'>French</option>
            <option value='it/imagick.getnumberimages.php'>Italian</option>
            <option value='ja/imagick.getnumberimages.php'>Japanese</option>
            <option value='pt_BR/imagick.getnumberimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getnumberimages.php'>Russian</option>
            <option value='tr/imagick.getnumberimages.php'>Turkish</option>
            <option value='uk/imagick.getnumberimages.php'>Ukrainian</option>
            <option value='zh/imagick.getnumberimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getnumberimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getNumberImages</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getNumberImages</span> &mdash; <span class="dc-title">Returns the number of images in the object</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getnumberimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getNumberImages</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getnumberimages-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-imagick.getnumberimages-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getnumberimages-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getnumberimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getnumberimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getnumberimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getnumberimages.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="90118">  <div class="votes">
    <div id="Vu90118">
    <a href="/manual/vote-note.php?id=90118&amp;page=imagick.getnumberimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd90118">
    <a href="/manual/vote-note.php?id=90118&amp;page=imagick.getnumberimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V90118" title="71% like this...">
    3
    </div>
  </div>
  <a href="#90118" class="name">
  <strong class="user"><em>gzabriskie at yahoo dot com</em></strong></a><a class="genanchor" href="#90118"> &para;</a><div class="date" title="2009-04-07 05:21"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom90118">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /></span><span class="comment">/* Create the object */<br /></span><span class="default">$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'YourImageLocation.tif'</span><span class="keyword">);<br /></span><span class="default">$count </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getNumberImages</span><span class="keyword">();<br /><br />echo </span><span class="string">"&lt;h3 style=\"font: bold 12pt Arial\"&gt;Total Number of Images Extracted "</span><span class="keyword">.<br />     </span><span class="string">"from the TIF : "</span><span class="keyword">.</span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getNumberImages</span><span class="keyword">().</span><span class="string">"&lt;/h3&gt;"</span><span class="keyword">;<br /><br />for (</span><span class="default">$x </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;</span><span class="default">$x </span><span class="keyword">&lt;= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getNumberImages</span><span class="keyword">(); </span><span class="default">$x</span><span class="keyword">++) {<br />  </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">previousImage</span><span class="keyword">();<br />  </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">thumbnailImage</span><span class="keyword">( </span><span class="default">400</span><span class="keyword">, </span><span class="default">null </span><span class="keyword">);<br />  </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'img'</span><span class="keyword">.</span><span class="default">$count</span><span class="keyword">.</span><span class="string">'.png'</span><span class="keyword">);<br />  </span><span class="default">$count</span><span class="keyword">--;<br />}<br /></span><span class="default">?&gt;<br /></span><br />&lt;html&gt;<br />  &lt;head&gt;<br />    &lt;title&gt;Extracting Images Form TIFF&lt;/title&gt;<br />  &lt;/head&gt;<br />  &lt;body&gt;<br />    &lt;table cellspacing="10" style="background: #ddd"&gt;&lt;tr&gt;<br />      <span class="default">&lt;?php<br />      </span><span class="keyword">for (</span><span class="default">$x </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;</span><span class="default">$x </span><span class="keyword">&lt;= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getNumberImages</span><span class="keyword">(); </span><span class="default">$x</span><span class="keyword">++) {<br />        echo </span><span class="string">"&lt;td&gt;&lt;img src=\"img</span><span class="default">$x</span><span class="string">.png\"&lt;br /&gt;&lt;p style=\"font: bold 12pt Arial;"</span><span class="keyword">.<br />             </span><span class="string">"text-align: center\"&gt;image </span><span class="default">$x</span><span class="string"> (png)&lt;/p&gt;&lt;/td&gt;"</span><span class="keyword">;<br />      }<br />      </span><span class="default">?&gt;<br /></span>    &lt;/tr&gt;&lt;/table&gt;<br />  &lt;/body&gt;<br />&lt;/html&gt;</span></code></div>
  </div>
 </div>
  <div class="note" id="111196">  <div class="votes">
    <div id="Vu111196">
    <a href="/manual/vote-note.php?id=111196&amp;page=imagick.getnumberimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111196">
    <a href="/manual/vote-note.php?id=111196&amp;page=imagick.getnumberimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111196" title="60% like this...">
    2
    </div>
  </div>
  <a href="#111196" class="name">
  <strong class="user"><em>benkuhl at gmail dot com</em></strong></a><a class="genanchor" href="#111196"> &para;</a><div class="date" title="2013-01-24 07:26"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111196">
<div class="phpcode"><code><span class="html">For PDFs this function indicates the number of pages on the PDF, NOT images that might be embedded within the PDF.<br /><br /><span class="default">&lt;?php<br /><br />$document </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'2_pager.pdf'</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$document</span><span class="keyword">-&gt;</span><span class="default">getNumberImages</span><span class="keyword">()); </span><span class="comment">//returns 2<br /><br /></span><span class="default">$document </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'1_pager.pdf'</span><span class="keyword">);<br /><br /></span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$document</span><span class="keyword">-&gt;</span><span class="default">getNumberImages</span><span class="keyword">()); </span><span class="comment">//returns 1<br /><br /></span><span class="default">?&gt;<br /></span><br />From my research it is not possible to obtain the images embedded within a PDF by using the PHP Imagick library.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getnumberimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getnumberimages.php">＋<small>add a note</small></a></div>
