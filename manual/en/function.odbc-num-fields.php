...
<head>
  ...
  <title>PHP: odbc_num_fields - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-num-fields.php">
 <link rel="shorturl" href="https://www.php.net/odbc-num-fields">
 <link rel="alternate" href="https://www.php.net/odbc-num-fields" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-next-result.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-num-rows.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-num-fields.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-num-fields.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-num-fields.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-num-fields.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-num-fields.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-num-fields.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-num-fields.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-num-fields.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-num-fields.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-num-fields.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-num-fields.php" hreflang="zh">
...
<meta name="Description" content="Number of columns in a result" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_num_fields - Manual" />
<meta name="twitter:description" content="Number of columns in a result" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_num_fields - Manual" />
<meta itemprop="description" content="Number of columns in a result" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Number of columns in a result" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-num-fields.php' selected="selected">English</option>
            <option value='de/function.odbc-num-fields.php'>German</option>
            <option value='es/function.odbc-num-fields.php'>Spanish</option>
            <option value='fr/function.odbc-num-fields.php'>French</option>
            <option value='it/function.odbc-num-fields.php'>Italian</option>
            <option value='ja/function.odbc-num-fields.php'>Japanese</option>
            <option value='pt_BR/function.odbc-num-fields.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-num-fields.php'>Russian</option>
            <option value='tr/function.odbc-num-fields.php'>Turkish</option>
            <option value='uk/function.odbc-num-fields.php'>Ukrainian</option>
            <option value='zh/function.odbc-num-fields.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-num-fields" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">odbc_num_fields</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">odbc_num_fields</span> &mdash; <span class="dc-title">Number of columns in a result</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.odbc-num-fields-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>odbc_num_fields</strong></span>(<span class="methodparam"><span class="type">Odbc\Result</span> <code class="parameter">$statement</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.odbc-num-fields-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.odbc-num-fields-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-function.odbc-num-fields-changelog">
 ...
 <td>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-num-fields.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-num-fields%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-num-fields&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-num-fields.php">＋<small>add a note</small></a></span>
