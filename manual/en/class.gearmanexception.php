...
<head>
  ...
  <title>PHP: GearmanException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.gearmanexception.php">
 <link rel="shorturl" href="https://www.php.net/gearmanexception">
 <link rel="alternate" href="https://www.php.net/gearmanexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.gearman.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanworker.work.php">
 <link rel="next" href="https://www.php.net/manual/en/book.ldap.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.gearmanexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.gearmanexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.gearmanexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.gearmanexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.gearmanexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.gearmanexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.gearmanexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.gearmanexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.gearmanexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.gearmanexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.gearmanexception.php" hreflang="zh">
...
<meta name="Description" content="The GearmanException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanException - Manual" />
<meta name="twitter:description" content="The GearmanException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanException - Manual" />
<meta itemprop="description" content="The GearmanException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The GearmanException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.ldap.php">
          LDAP &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanworker.work.php">
          &laquo; GearmanWorker::work        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.gearmanexception.php' selected="selected">English</option>
            <option value='de/class.gearmanexception.php'>German</option>
            <option value='es/class.gearmanexception.php'>Spanish</option>
            <option value='fr/class.gearmanexception.php'>French</option>
            <option value='it/class.gearmanexception.php'>Italian</option>
            <option value='ja/class.gearmanexception.php'>Japanese</option>
            <option value='pt_BR/class.gearmanexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.gearmanexception.php'>Russian</option>
            <option value='tr/class.gearmanexception.php'>Turkish</option>
            <option value='uk/class.gearmanexception.php'>Ukrainian</option>
            <option value='zh/class.gearmanexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.gearmanexception" class="reference">

 <h1 class="title">The GearmanException class</h1>
 

 <div class="partintro"><p class="verinfo">(PECL gearman &gt;= 0.5.0)</p>


  <div class="section" id="gearmanexception.intro">
  ...
  <div class="section" id="gearmanexception.synopsis">
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.gearmanexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.gearmanexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.gearmanexception.php">＋<small>add a note</small></a></span>
