...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stristr.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.stripslashes.php">
 <link rel="next" href="https://www.php.net/manual/en/function.strlen.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stristr.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stristr.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stristr.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stristr.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stristr.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stristr.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stristr.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stristr.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stristr.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stristr.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stristr.php" hreflang="zh">
...
<meta name="Description" content="Case-insensitive strstr" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stristr - Manual" />
<meta name="twitter:description" content="Case-insensitive strstr" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stristr - Manual" />
<meta itemprop="description" content="Case-insensitive strstr" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Case-insensitive strstr" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stristr.php' selected="selected">English</option>
            ...
            <option value='tr/function.stristr.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stristr</span> &mdash; <span class="dc-title">Case-insensitive <span class="function"><a href="function.strstr.php" class="function">strstr()</a></span></span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.stristr-description">
  ...
  <p class="para rdfs-comment">
   Returns all of <code class="parameter">haystack</code> starting from and including the first
   occurrence of <code class="parameter">needle</code> to the end.
  </p>
 </div>
 ...
 <p class="para">
  ...
  or an explicit call to <span class="function"><a href="function.chr.php" class="function">chr()</a></span> should be performed.
     ...
     <dd>
      <p class="para">
       If <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, <span class="function"><strong>stristr()</strong></span>
       returns the part of the <code class="parameter">haystack</code> before the
       first occurrence of the <code class="parameter">needle</code> (excluding needle).
      </p>
     </dd>
  ...
  <p class="para">
   <code class="parameter">needle</code> and <code class="parameter">haystack</code>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stristr-returnvalues">
  ...
  <p class="para">
   Returns the matched substring. If <code class="parameter">needle</code> is not
   found, returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.preg-match.php" class="function" rel="rdfs-seeAlso">preg_match()</a> - Perform a regular expression match</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/stristr.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stristr%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stristr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stristr.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">There was a change in PHP 4.2.3 that can cause a warning message<br />to be generated when using stristr(), even though no message was<br />generated in older versions of PHP.<br /><br />The following will generate a warning message in 4.0.6 and 4.2.3:<br />  stristr("haystack", "");<br />     OR<br />  $needle = "";  stristr("haystack", $needle);<br /><br />This will _not_ generate an "Empty Delimiter" warning message in<br />4.0.6, but _will_ in 4.2.3:<br />  unset($needle); stristr("haystack", $needle);<br /><br />Here's a URL that documents what was changed:<br /><a href="http://groups.google.ca/groups?selm=cvshholzgra1031224321%40cvsserver" rel="nofollow" target="_blank">http://groups.google.ca/groups?selm=cvshholzgra1031224321%40cvsserver</a></span></code></div>
  ...
  <strong class="user"><em>giz at gbdesign dot net</em></strong></a><a class="genanchor" href="#78321"> &para;</a><div class="date" title="2007-10-06 05:02"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78321">
<div class="phpcode"><code><span class="html">Just been caught out by stristr trying to converting the needle from an Int to an ASCII value.
<br />
<br />Got round this by casting the value to a string.
<br />
<br /><span class="default">&lt;?php
<br /></span><span class="keyword">if( !</span><span class="default">stristr</span><span class="keyword">( </span><span class="default">$file</span><span class="keyword">, (string) </span><span class="default">$myCustomer</span><span class="keyword">-&gt;</span><span class="default">getCustomerID</span><span class="keyword">()  ) ) {
<br />  </span><span class="comment">// Permission denied
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <strong class="user"><em>Techdeck at Techdeck dot org</em></strong></a><a class="genanchor" href="#26781"> &para;</a><div class="date" title="2002-11-12 12:26"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom26781">
<div class="phpcode"><code><span class="html">An example for the stristr() function:<br /><br /><span class="default">&lt;?php<br />$a </span><span class="keyword">= </span><span class="string">"I like php"</span><span class="keyword">;<br />if (</span><span class="default">stristr</span><span class="keyword">(</span><span class="string">"</span><span class="default">$a</span><span class="string">"</span><span class="keyword">, </span><span class="string">"LikE PhP"</span><span class="keyword">)) {<br />print (</span><span class="string">"According to \$a, you like PHP."</span><span class="keyword">);<br />}<br /></span><span class="default">?&gt;<br /></span><br />It will look in $a for "like php" (NOT case sensetive. though, strstr() is case-sensetive).<br /><br />For the ones of you who uses linux.. It is similiar to the "grep" command.<br />Actually.. "grep -i".</span></code></div>
  </div>
 </div>
  <div class="note" id="53535">  <div class="votes">
    ...
    <div class="tally" id="V53535" title="50% like this...">
    0
    </div>
  </div>
...
<br />
<br /></span><span class="keyword">function </span><span class="default">stristr_reverse</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">) {
<br />  </span><span class="default">$pos </span><span class="keyword">= </span><span class="default">stripos</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">$needle</span><span class="keyword">) + </span><span class="default">strlen</span><span class="keyword">(</span><span class="default">$needle</span><span class="keyword">);
<br />  return </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$haystack</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">$pos</span><span class="keyword">);
<br />}
<br /></span><span class="default">$email </span><span class="keyword">= </span><span class="string">'USER@EXAMPLE.com'</span><span class="keyword">;
<br />echo </span><span class="default">stristr_reverse</span><span class="keyword">(</span><span class="default">$email</span><span class="keyword">, </span><span class="string">'er'</span><span class="keyword">);
<br /></span><span class="comment">// outputs USER
<br />
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I think there is a bug in php 5.3 in stristr with uppercase Ä containing other character<br /><br /><a href="http://pastebin.com/5bP6uztY" rel="nofollow" target="_blank">http://pastebin.com/5bP6uztY</a><br /><br />if you search only with täry it works, but as soon as the word is tärylä  it does not. TÄRYL works fine</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stristr&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stristr.php">＋<small>add a note</small></a></div>
