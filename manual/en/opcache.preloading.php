...
<head>
  ...
  <title>PHP: Preloading - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/opcache.preloading.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/opcache.preloading.php">
 <link rel="alternate" href="https://www.php.net/manual/en/opcache.preloading.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.opcache.php">
 <link rel="prev" href="https://www.php.net/manual/en/opcache.configuration.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.opcache.php">

 <link rel="alternate" href="https://www.php.net/manual/en/opcache.preloading.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/opcache.preloading.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/opcache.preloading.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/opcache.preloading.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/opcache.preloading.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/opcache.preloading.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/opcache.preloading.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/opcache.preloading.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/opcache.preloading.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/opcache.preloading.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/opcache.preloading.php" hreflang="zh">
...
<meta name="Description" content="Preloading" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Preloading - Manual" />
<meta name="twitter:description" content="Preloading" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Preloading - Manual" />
<meta itemprop="description" content="Preloading" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Preloading" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="ref.opcache.php">
          OPcache Functions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="opcache.configuration.php">
          &laquo; Runtime Configuration        </a>
      </div>
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.basic.php.php'>Affecting PHP's Behaviour</a></li>      <li><a href='book.opcache.php'>OPcache</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/opcache.preloading.php' selected="selected">English</option>
            <option value='de/opcache.preloading.php'>German</option>
            <option value='es/opcache.preloading.php'>Spanish</option>
            <option value='fr/opcache.preloading.php'>French</option>
            <option value='it/opcache.preloading.php'>Italian</option>
            <option value='ja/opcache.preloading.php'>Japanese</option>
            <option value='pt_BR/opcache.preloading.php'>Brazilian Portuguese</option>
            <option value='ru/opcache.preloading.php'>Russian</option>
            <option value='tr/opcache.preloading.php'>Turkish</option>
            <option value='uk/opcache.preloading.php'>Ukrainian</option>
            <option value='zh/opcache.preloading.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="opcache.preloading" class="chapter">
  ...
  otherwise be loaded manually, <span class="function"><a href="function.include.php" class="function">include</a></span> will be more robust.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/opcache/preload.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fopcache.preloading%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=opcache.preloading&amp;repo=en&amp;redirect=https://www.php.net/manual/en/opcache.preloading.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="127788">  <div class="votes">
    <div id="Vu127788">
    <a href="/manual/vote-note.php?id=127788&amp;page=opcache.preloading&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127788">
    <a href="/manual/vote-note.php?id=127788&amp;page=opcache.preloading&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127788" title="80% like this...">
    6
    </div>
  </div>
  <a href="#127788" class="name">
  <strong class="user"><em>postmaster at greg0ire dot fr</em></strong></a><a class="genanchor" href="#127788"> &para;</a><div class="date" title="2022-10-20 07:17"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127788">
<div class="phpcode"><code><span class="html">PHP 8.1 comes with an inheritance cache that partially overlaps with what the preloading already does. If you enabled preloading on lower versions then migrated to PHP 8.1, you might want to turn off preloading and see if that comes with a performance penalty or not.</span></code></div>
  </div>
 </div>
  <div class="note" id="127916">  <div class="votes">
    <div id="Vu127916">
    <a href="/manual/vote-note.php?id=127916&amp;page=opcache.preloading&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd127916">
    <a href="/manual/vote-note.php?id=127916&amp;page=opcache.preloading&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V127916" title="55% like this...">
    1
    </div>
  </div>
  <a href="#127916" class="name">
  <strong class="user"><em>postmaster at greg0ire dot fr</em></strong></a><a class="genanchor" href="#127916"> &para;</a><div class="date" title="2022-11-11 08:57"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom127916">
<div class="phpcode"><code><span class="html">There are caveats when enabling preloading, one of them being that it should be enabled via a php.ini file. Enabling it with a php-fpm pool configuration won't work, for instance, since preloading is global and not per-pool. To make sure that you successfully enabled preloading, you should check for a preload_statistics key in the output of opcache_get_status(). There should already be an opcache_statistics key, but that's something else entirely.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=opcache.preloading&amp;repo=en&amp;redirect=https://www.php.net/manual/en/opcache.preloading.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="book.opcache.php">OPcache</a>

                                    <ul class='child-menu-list'>

                                                <li class="">
                            <a href="intro.opcache.php" title="Introduction">Introduction</a>
                        </li>
                                                <li class="">
                            <a href="opcache.setup.php" title="Installing/Configuring">Installing/Configuring</a>
                        </li>
                                                <li class="current">
                            <a href="opcache.preloading.php" title="Preloading">Preloading</a>
                        </li>
                                                <li class="">
                            <a href="ref.opcache.php" title="OPcache Functions">OPcache Functions</a>
                        </li>
