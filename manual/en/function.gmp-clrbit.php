...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-clrbit.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-binomial.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-cmp.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-clrbit.php' selected="selected">English</option>
            <option value='de/function.gmp-clrbit.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-clrbit-examples">
  ...
  <div class="example" id="example-3315">
   <p><strong>Example #1 <span class="function"><strong>gmp_clrbit()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.gmp-testbit.php" class="function" rel="rdfs-seeAlso">gmp_testbit()</a> - Tests if a bit is set</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-clrbit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-clrbit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-clrbit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-clrbit.php">＋<small>add a note</small></a></span>
