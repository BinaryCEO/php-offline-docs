...
<head>
  ...
  <title>PHP: ArithmeticError - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.arithmeticerror.php">
 <link rel="shorturl" href="https://www.php.net/arithmeticerror">
 <link rel="alternate" href="https://www.php.net/arithmeticerror" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/reserved.exceptions.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.argumentcounterror.php">
 <link rel="next" href="https://www.php.net/manual/en/class.assertionerror.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.arithmeticerror.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.arithmeticerror.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.arithmeticerror.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.arithmeticerror.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.arithmeticerror.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.arithmeticerror.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.arithmeticerror.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.arithmeticerror.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.arithmeticerror.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.arithmeticerror.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.arithmeticerror.php" hreflang="zh">
...
<meta name="Description" content="ArithmeticError" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ArithmeticError - Manual" />
<meta name="twitter:description" content="ArithmeticError" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ArithmeticError - Manual" />
<meta itemprop="description" content="ArithmeticError" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="ArithmeticError" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="class.assertionerror.php">
          AssertionError &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.argumentcounterror.php">
          &laquo; ArgumentCountError        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.arithmeticerror.php' selected="selected">English</option>
            <option value='de/class.arithmeticerror.php'>German</option>
            <option value='es/class.arithmeticerror.php'>Spanish</option>
            <option value='fr/class.arithmeticerror.php'>French</option>
            <option value='it/class.arithmeticerror.php'>Italian</option>
            <option value='ja/class.arithmeticerror.php'>Japanese</option>
            <option value='pt_BR/class.arithmeticerror.php'>Brazilian Portuguese</option>
            <option value='ru/class.arithmeticerror.php'>Russian</option>
            <option value='tr/class.arithmeticerror.php'>Turkish</option>
            <option value='uk/class.arithmeticerror.php'>Ukrainian</option>
            <option value='zh/class.arithmeticerror.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.arithmeticerror" class="reference">
 <h1 class="title">ArithmeticError</h1>
 
 
 <div class="partintro"><p class="verinfo">(PHP 7, PHP 8)</p>
 

  <div class="section" id="arithmeticerror.intro">
   <h2 class="title">Introduction</h2>
   <p class="para">
    <span class="ooclass"><span class="classname"><strong class="classname">ArithmeticError</strong></span></span> is thrown when
    ...
    amount, and any call to <span class="function"><a href="function.intdiv.php" class="function">intdiv()</a></span> that would result in a
    value outside the possible bounds of an <span class="type"><a href="language.types.integer.php" class="type int">int</a></span>.
   </p>
  </div>

 
  <div class="section" id="arithmeticerror.synopsis">
   <h2 class="title">Class synopsis</h2>
 

   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">ArithmeticError</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="error.clone.php" class="methodname">Error::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/language/predefined/arithmeticerror.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.arithmeticerror%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.arithmeticerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.arithmeticerror.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125434">  <div class="votes">
    <div id="Vu125434">
    <a href="/manual/vote-note.php?id=125434&amp;page=class.arithmeticerror&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125434">
    <a href="/manual/vote-note.php?id=125434&amp;page=class.arithmeticerror&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125434" title="47% like this...">
    -1
    </div>
  </div>
  <a href="#125434" class="name">
  <strong class="user"><em>nima dot shirinzadeh at gmail dot com</em></strong></a><a class="genanchor" href="#125434"> &para;</a><div class="date" title="2020-10-12 05:45"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125434">
<div class="phpcode"><code><span class="html">the first example shifted by the positive number and the result is 4, but the second example shifted by the negative number and the result is ArithmeticError(this example is the same for left shift)<br /><span class="default">&lt;?php<br /><br /> $shif </span><span class="keyword">=</span><span class="default">1</span><span class="keyword">;<br /> </span><span class="default">$number </span><span class="keyword">= </span><span class="default">8</span><span class="keyword">;<br /> </span><span class="default">$result </span><span class="keyword">=  </span><span class="default">$number </span><span class="keyword">&gt;&gt; </span><span class="default">$shif</span><span class="keyword">;<br /> echo </span><span class="default">$result</span><span class="keyword">; </span><span class="comment">//// 1000 &gt;&gt; 01000 = 4<br /><br /></span><span class="default">$shif </span><span class="keyword">=-</span><span class="default">1</span><span class="keyword">;<br /> </span><span class="default">$number </span><span class="keyword">= </span><span class="default">8</span><span class="keyword">;<br /> </span><span class="default">$result </span><span class="keyword">=  </span><span class="default">$number </span><span class="keyword">&gt;&gt; </span><span class="default">$shif</span><span class="keyword">;<br /> </span><span class="comment">////result is ArithmeticError<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.arithmeticerror&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.arithmeticerror.php">＋<small>add a note</small></a></div>
