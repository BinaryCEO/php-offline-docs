...
<head>
  ...
  <title>PHP: EventBufferEvent::getOutput - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/eventbufferevent.getoutput.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/eventbufferevent.getoutput.php">
 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.getoutput.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.eventbufferevent.php">
 <link rel="prev" href="https://www.php.net/manual/en/eventbufferevent.getinput.php">
 <link rel="next" href="https://www.php.net/manual/en/eventbufferevent.read.php">

 <link rel="alternate" href="https://www.php.net/manual/en/eventbufferevent.getoutput.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/eventbufferevent.getoutput.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/eventbufferevent.getoutput.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/eventbufferevent.getoutput.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/eventbufferevent.getoutput.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/eventbufferevent.getoutput.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/eventbufferevent.getoutput.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/eventbufferevent.getoutput.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/eventbufferevent.getoutput.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/eventbufferevent.getoutput.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/eventbufferevent.getoutput.php" hreflang="zh">
...
<meta name="Description" content="Returns underlying output buffer associated with current buffer
  event" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: EventBufferEvent::getOutput - Manual" />
<meta name="twitter:description" content="Returns underlying output buffer associated with current buffer
  event" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: EventBufferEvent::getOutput - Manual" />
<meta itemprop="description" content="Returns underlying output buffer associated with current buffer
  event" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns underlying output buffer associated with current buffer
  event" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="eventbufferevent.read.php">
          EventBufferEvent::read &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="eventbufferevent.getinput.php">
          &laquo; EventBufferEvent::getInput        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/eventbufferevent.getoutput.php' selected="selected">English</option>
            <option value='de/eventbufferevent.getoutput.php'>German</option>
            <option value='es/eventbufferevent.getoutput.php'>Spanish</option>
            <option value='fr/eventbufferevent.getoutput.php'>French</option>
            <option value='it/eventbufferevent.getoutput.php'>Italian</option>
            <option value='ja/eventbufferevent.getoutput.php'>Japanese</option>
            <option value='pt_BR/eventbufferevent.getoutput.php'>Brazilian Portuguese</option>
            <option value='ru/eventbufferevent.getoutput.php'>Russian</option>
            <option value='tr/eventbufferevent.getoutput.php'>Turkish</option>
            <option value='uk/eventbufferevent.getoutput.php'>Ukrainian</option>
            <option value='zh/eventbufferevent.getoutput.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="eventbufferevent.getoutput" class="refentry">
 ...
 <div class="refsect1 seealso" id="refsect1-eventbufferevent.getoutput-seealso">
  ...
  event</span>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/event/eventbufferevent/getoutput.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Feventbufferevent.getoutput%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=eventbufferevent.getoutput&amp;repo=en&amp;redirect=https://www.php.net/manual/en/eventbufferevent.getoutput.php">＋<small>add a note</small></a></span>
