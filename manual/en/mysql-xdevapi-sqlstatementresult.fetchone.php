...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-sqlstatementresult.fetchone.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-sqlstatementresult.fetchone.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-sqlstatementresult.fetchone.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-sqlstatementresult.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-sqlstatementresult.fetchall.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-sqlstatementresult.getaffecteditemscount.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-sqlstatementresult.fetchone.php' selected="selected">English</option>
            ...
            <option value='pt_BR/mysql-xdevapi-sqlstatementresult.fetchone.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(No version information available, might only be in Git)</p><p class="refpurpose"><span class="refname">SqlStatementResult::fetchOne</span> &mdash; <span class="dc-title">Get single row</span></p>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-sqlstatementresult.fetchone-examples">
  ...
  <div class="example" id="example-1819">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\SqlStatementResult::fetchOne()</strong></span> example</strong></p>
...
(
    ...
    [job] =&gt; bricklayer
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/sqlstatementresult/fetchone.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-sqlstatementresult.fetchone%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-sqlstatementresult.fetchone&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-sqlstatementresult.fetchone.php">＋<small>add a note</small></a></span>
