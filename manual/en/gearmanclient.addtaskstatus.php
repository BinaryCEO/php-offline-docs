...
<head>
  ...
  <title>PHP: GearmanClient::addTaskStatus - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.addtaskstatus.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.addtaskstatus.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.addtaskstatus.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.addtasklowbackground.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.clearcallbacks.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.addtaskstatus.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.addtaskstatus.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.addtaskstatus.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.addtaskstatus.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.addtaskstatus.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.addtaskstatus.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.addtaskstatus.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.addtaskstatus.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.addtaskstatus.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.addtaskstatus.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.addtaskstatus.php" hreflang="zh">
...
<meta name="Description" content="Add a task to get status" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::addTaskStatus - Manual" />
<meta name="twitter:description" content="Add a task to get status" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::addTaskStatus - Manual" />
<meta itemprop="description" content="Add a task to get status" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a task to get status" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gearmanclient.clearcallbacks.php">
          GearmanClient::clearCallbacks &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.addtasklowbackground.php">
          &laquo; GearmanClient::addTaskLowBackground        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.addtaskstatus.php' selected="selected">English</option>
            <option value='de/gearmanclient.addtaskstatus.php'>German</option>
            <option value='es/gearmanclient.addtaskstatus.php'>Spanish</option>
            <option value='fr/gearmanclient.addtaskstatus.php'>French</option>
            <option value='it/gearmanclient.addtaskstatus.php'>Italian</option>
            <option value='ja/gearmanclient.addtaskstatus.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.addtaskstatus.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.addtaskstatus.php'>Russian</option>
            <option value='tr/gearmanclient.addtaskstatus.php'>Turkish</option>
            <option value='uk/gearmanclient.addtaskstatus.php'>Ukrainian</option>
            <option value='zh/gearmanclient.addtaskstatus.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.addtaskstatus" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::addTaskStatus</h1>
  <p class="verinfo">(PECL gearman &gt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanClient::addTaskStatus</span> &mdash; <span class="dc-title">Add a task to get status</span></p>
 ...
 <div class="refsect1 description" id="refsect1-gearmanclient.addtaskstatus-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>GearmanClient::addTaskStatus</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$job_handle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$context</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><span class="type"><a href="class.gearmantask.php" class="type GearmanTask">GearmanTask</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Used to request status information from the Gearman server, which will call the specified
   status callback (set using <span class="methodname"><a href="gearmanclient.setstatuscallback.php" class="methodname">GearmanClient::setStatusCallback()</a></span>).
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-gearmanclient.addtaskstatus-returnvalues">
  ...
  <p class="para">
   A <span class="classname"><a href="class.gearmantask.php" class="classname">GearmanTask</a></span> object or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-gearmanclient.addtaskstatus-examples">
  ...
  <p class="para">
   <div class="example" id="example-4599">
    <p><strong>Example #1 Monitor completion of multiple background tasks</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="gearmanclient.setstatuscallback.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::setStatusCallback()</a> - Set a callback for collecting task status</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/addtaskstatus.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.addtaskstatus%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.addtaskstatus&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.addtaskstatus.php">＋<small>add a note</small></a></span>
