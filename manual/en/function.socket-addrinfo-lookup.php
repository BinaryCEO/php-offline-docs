...
<head>
  ...
  <title>PHP: socket_addrinfo_lookup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.socket-addrinfo-lookup.php">
 <link rel="shorturl" href="https://www.php.net/socket-addrinfo-lookup">
 <link rel="alternate" href="https://www.php.net/socket-addrinfo-lookup" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sockets.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.socket-addrinfo-explain.php">
 <link rel="next" href="https://www.php.net/manual/en/function.socket-atmark.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.socket-addrinfo-lookup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.socket-addrinfo-lookup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.socket-addrinfo-lookup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.socket-addrinfo-lookup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.socket-addrinfo-lookup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.socket-addrinfo-lookup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.socket-addrinfo-lookup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.socket-addrinfo-lookup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.socket-addrinfo-lookup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.socket-addrinfo-lookup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.socket-addrinfo-lookup.php" hreflang="zh">
...
<meta name="Description" content="Get array with contents of getaddrinfo about the given hostname" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: socket_addrinfo_lookup - Manual" />
<meta name="twitter:description" content="Get array with contents of getaddrinfo about the given hostname" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: socket_addrinfo_lookup - Manual" />
<meta itemprop="description" content="Get array with contents of getaddrinfo about the given hostname" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get array with contents of getaddrinfo about the given hostname" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.socket-atmark.php">
          socket_atmark &raquo;
              ...
              <div class="prev">
        <a href="function.socket-addrinfo-explain.php">
          &laquo; socket_addrinfo_explain        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.socket-addrinfo-lookup.php' selected="selected">English</option>
            <option value='de/function.socket-addrinfo-lookup.php'>German</option>
            <option value='es/function.socket-addrinfo-lookup.php'>Spanish</option>
            <option value='fr/function.socket-addrinfo-lookup.php'>French</option>
            <option value='it/function.socket-addrinfo-lookup.php'>Italian</option>
            <option value='ja/function.socket-addrinfo-lookup.php'>Japanese</option>
            <option value='pt_BR/function.socket-addrinfo-lookup.php'>Brazilian Portuguese</option>
            <option value='ru/function.socket-addrinfo-lookup.php'>Russian</option>
            <option value='tr/function.socket-addrinfo-lookup.php'>Turkish</option>
            <option value='uk/function.socket-addrinfo-lookup.php'>Ukrainian</option>
            <option value='zh/function.socket-addrinfo-lookup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.socket-addrinfo-lookup" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.socket-addrinfo-lookup-returnvalues">
  ...
  <p class="para">
   ...
   the <span class="function"><strong>socket_addrinfo_()</strong><span class="replaceable">*</span></span> family of functions.
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       On success, this function returns a array of <span class="classname"><a href="class.addressinfo.php" class="classname">AddressInfo</a></span> instances now;
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.socket-addrinfo-explain.php" class="function" rel="rdfs-seeAlso">socket_addrinfo_explain()</a> - Get information about addrinfo</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sockets/functions/socket-addrinfo-lookup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.socket-addrinfo-lookup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.socket-addrinfo-lookup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.socket-addrinfo-lookup.php">＋<small>add a note</small></a></span>
