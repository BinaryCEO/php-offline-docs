...
<head>
  ...
  <title>PHP: spl_autoload_extensions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.spl-autoload-extensions.php">
 <link rel="shorturl" href="https://www.php.net/spl-autoload-extensions">
 <link rel="alternate" href="https://www.php.net/spl-autoload-extensions" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.spl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.spl-autoload-call.php">
 <link rel="next" href="https://www.php.net/manual/en/function.spl-autoload-functions.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.spl-autoload-extensions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.spl-autoload-extensions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.spl-autoload-extensions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.spl-autoload-extensions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.spl-autoload-extensions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.spl-autoload-extensions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.spl-autoload-extensions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.spl-autoload-extensions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.spl-autoload-extensions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.spl-autoload-extensions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.spl-autoload-extensions.php" hreflang="zh">
...
<meta name="Description" content="Register and return default file extensions for spl_autoload" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: spl_autoload_extensions - Manual" />
<meta name="twitter:description" content="Register and return default file extensions for spl_autoload" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: spl_autoload_extensions - Manual" />
<meta itemprop="description" content="Register and return default file extensions for spl_autoload" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Register and return default file extensions for spl_autoload" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.spl-autoload-functions.php">
          spl_autoload_functions &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.spl-autoload-call.php">
          &laquo; spl_autoload_call        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.spl-autoload-extensions.php' selected="selected">English</option>
            <option value='de/function.spl-autoload-extensions.php'>German</option>
            <option value='es/function.spl-autoload-extensions.php'>Spanish</option>
            <option value='fr/function.spl-autoload-extensions.php'>French</option>
            <option value='it/function.spl-autoload-extensions.php'>Italian</option>
            <option value='ja/function.spl-autoload-extensions.php'>Japanese</option>
            <option value='pt_BR/function.spl-autoload-extensions.php'>Brazilian Portuguese</option>
            <option value='ru/function.spl-autoload-extensions.php'>Russian</option>
            <option value='tr/function.spl-autoload-extensions.php'>Turkish</option>
            <option value='uk/function.spl-autoload-extensions.php'>Ukrainian</option>
            <option value='zh/function.spl-autoload-extensions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.spl-autoload-extensions" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.spl-autoload-extensions-examples">
  ...
  <div class="example" id="example-4031">
   <p><strong>Example #1 <span class="function"><strong>spl_autoload_extensions()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />spl_autoload_extensions</span><span style="color: #007700">(</span><span style="color: #DD0000">".php,.inc"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/functions/spl-autoload-extensions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.spl-autoload-extensions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.spl-autoload-extensions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.spl-autoload-extensions.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121319">  <div class="votes">
    <div id="Vu121319">
    <a href="/manual/vote-note.php?id=121319&amp;page=function.spl-autoload-extensions&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121319">
    <a href="/manual/vote-note.php?id=121319&amp;page=function.spl-autoload-extensions&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121319" title="60% like this...">
    6
    </div>
  </div>
  <a href="#121319" class="name">
  <strong class="user"><em>dantedantas at gmail dot com</em></strong></a><a class="genanchor" href="#121319"> &para;</a><div class="date" title="2017-07-05 09:46"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121319">
<div class="phpcode"><code><span class="html">The order of the extensions influence the velocity of the reply. For example: <br /><br />spl_autoload_extensions(".php, .inc");<br /><br />is more fast than:<br /><br />spl_autoload_extensions(".inc, .php");<br /><br />Check out this example:<br /><br />Some class files:<br /><br />ClassA.php<br /><span class="default">&lt;?php </span><span class="keyword">class </span><span class="default">ClassA </span><span class="keyword">{ var </span><span class="default">$val </span><span class="keyword">= </span><span class="string">'Hello from class "ClassA"'</span><span class="keyword">; } </span><span class="default">?&gt;<br /></span>ClassB.php<br /><span class="default">&lt;?php </span><span class="keyword">class </span><span class="default">ClassB </span><span class="keyword">{ var </span><span class="default">$val </span><span class="keyword">= </span><span class="string">'Hello from class "ClassB"'</span><span class="keyword">; } </span><span class="default">?&gt;<br /></span>ClassC.php<br /><span class="default">&lt;?php </span><span class="keyword">class </span><span class="default">ClassC </span><span class="keyword">{ var </span><span class="default">$val </span><span class="keyword">= </span><span class="string">'Hello from class "ClassC"'</span><span class="keyword">; } </span><span class="default">?&gt;<br /></span>ClassD.php<br /><span class="default">&lt;?php </span><span class="keyword">class </span><span class="default">ClassD </span><span class="keyword">{ var </span><span class="default">$val </span><span class="keyword">= </span><span class="string">'Hello from class "ClassD"'</span><span class="keyword">; } </span><span class="default">?&gt;<br /></span>ClassE.php<br /><span class="default">&lt;?php </span><span class="keyword">class </span><span class="default">ClassE </span><span class="keyword">{ var </span><span class="default">$val </span><span class="keyword">= </span><span class="string">'Hello from class "ClassE"'</span><span class="keyword">; } </span><span class="default">?&gt;<br /></span><br />1. Simple:<br /><span class="default">&lt;?php<br /></span><span class="comment">// default priority: .inc .php<br /></span><span class="keyword">for(</span><span class="default">$n</span><span class="keyword">=</span><span class="default">65</span><span class="keyword">; </span><span class="default">$n</span><span class="keyword">&lt;</span><span class="default">70</span><span class="keyword">; </span><span class="default">$n</span><span class="keyword">++) {<br />    </span><span class="default">$className </span><span class="keyword">= </span><span class="string">'Class'</span><span class="keyword">.</span><span class="default">chr</span><span class="keyword">(</span><span class="default">$n</span><span class="keyword">);<br />    </span><span class="default">spl_autoload</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">);<br />    </span><span class="default">$ins </span><span class="keyword">= new </span><span class="default">$className</span><span class="keyword">;<br />    echo </span><span class="default">$ins</span><span class="keyword">-&gt;</span><span class="default">val</span><span class="keyword">.</span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />}<br /></span><span class="comment">// 4.2 miliseconds<br /></span><span class="default">?&gt;<br /></span><br />2. Change priority:<br /><span class="default">&lt;?php<br />spl_autoload_extensions</span><span class="keyword">(</span><span class="string">'.php,.inc'</span><span class="keyword">);<br /></span><span class="comment">// new priority: .php .inc<br /></span><span class="keyword">for(</span><span class="default">$n</span><span class="keyword">=</span><span class="default">65</span><span class="keyword">; </span><span class="default">$n</span><span class="keyword">&lt;</span><span class="default">70</span><span class="keyword">; </span><span class="default">$n</span><span class="keyword">++) {<br />    </span><span class="default">$className </span><span class="keyword">= </span><span class="string">'Class'</span><span class="keyword">.</span><span class="default">chr</span><span class="keyword">(</span><span class="default">$n</span><span class="keyword">);<br />    </span><span class="default">spl_autoload</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">);<br />    </span><span class="default">$ins </span><span class="keyword">= new </span><span class="default">$className</span><span class="keyword">;<br />    echo </span><span class="default">$ins</span><span class="keyword">-&gt;</span><span class="default">val</span><span class="keyword">.</span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />}<br /></span><span class="comment">// 1.4 miliseconds<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="119305">  <div class="votes">
    <div id="Vu119305">
    <a href="/manual/vote-note.php?id=119305&amp;page=function.spl-autoload-extensions&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119305">
    <a href="/manual/vote-note.php?id=119305&amp;page=function.spl-autoload-extensions&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119305" title="58% like this...">
    3
    </div>
  </div>
  <a href="#119305" class="name">
  <strong class="user"><em>pim dot stoit at gmail dot com</em></strong></a><a class="genanchor" href="#119305"> &para;</a><div class="date" title="2016-05-09 06:00"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119305">
<div class="phpcode"><code><span class="html">Extensions doesn't have to start with a dot, spl_autload() will simply append whatever you supply to the basename. The following example will try to load "test.php" first, and "test/index.php" as well:<br /><br />spl_autoload_register('.php,/index.php');<br />spl_autoload('Test');</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.spl-autoload-extensions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.spl-autoload-extensions.php">＋<small>add a note</small></a></div>
