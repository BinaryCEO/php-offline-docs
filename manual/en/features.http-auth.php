...
<div class="phpcode"><code><span class="html">Workaround for missing Authorization header under CGI/FastCGI Apache:<br /><br />SetEnvIf Authorization .+ HTTP_AUTHORIZATION=$0<br /><br />Now PHP should automatically declare $_SERVER[PHP_AUTH_*] variables if the client sends the Authorization header.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Back to the autherisation in CGI mode. this is the full working example:<br /><br />#  Create the .htaccess file with following contents:<br /># also you can use the condition (search at this page)<br />RewriteEngine on<br />RewriteRule .* - [E=REMOTE_USER:%{HTTP:Authorization},L]<br /><br /># In the beginning the script checking the authorization place the code:<br /><br />$userpass = base64_decode(substr($_SERVER["REDIRECT_REMOTE_USER"],6)) ;<br /><br />$userpass = explode(":", $userpass);<br /><br />if (  count($userpass) == 2  ){<br />     #this part work not for all.<br />     #print_r($userpass);die; #&lt;- this can help find out right username and password<br />     list($name, $password) = explode(':', $userpass);<br />     $_SERVER['PHP_AUTH_USER'] = $name;<br />     $_SERVER['PHP_AUTH_PW'] = $password;<br /><br />}</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">the alternative text should contain the complete text af a (small) valid HTML-Ressource.  It also can contain link relations to CSS.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">You shouldn't use the "last" ("L") directive in the RewriteRule! This will prevent all further rewrite rules to be skipped whenever a Basic or Digest Auth is given, which is almost certainly not what you want.<br /><br />So the following lines are sufficient for the .htaccess (or httpd.conf) file:<br /><br />RewriteEngine On<br />RewriteRule .* - [E=HTTP_AUTHORIZATION:%{HTTP:Authorization}]</span></code></div>
  </div>
 </div>
  ...
  <strong class="user"><em>roychri at php dot net</em></strong></a><a class="genanchor" href="#70305"> &para;</a><div class="date" title="2006-10-10 08:12"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom70305">
<div class="phpcode"><code><span class="html">For PHP with CGI, make sure you put the rewrite rule above any other rewrite rule you might have.<br /><br />In my case, I put this at the top of the .htaccess (below RewriteEngine On):<br />RewriteRule .* - [E=REMOTE_USER:%{HTTP:Authorization}]<br /><br />My symptom was that the REMOTE_USER (or REDIRECT_REMOTE_USER in my case) was not being set at all.<br />The cause: I had some other RewriteRule that was kickin in and was set as LAST rule.<br />I hope this helps.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">The regex in http_digest_parse from Example #2 does not work for me (PHP 5.2.6), because back references are not allowed in a character class.  This worked for me:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="comment">// function to parse the http auth header<br /></span><span class="keyword">function </span><span class="default">http_digest_parse</span><span class="keyword">(</span><span class="default">$txt</span><span class="keyword">)<br />{<br />   </span><span class="comment">// protect against missing data<br />   </span><span class="default">$needed_parts </span><span class="keyword">= array(</span><span class="string">'nonce'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">, </span><span class="string">'nc'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">, </span><span class="string">'cnonce'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">, </span><span class="string">'qop'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">, </span><span class="string">'username'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">, </span><span class="string">'uri'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">, </span><span class="string">'response'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">);<br />   </span><span class="default">$data </span><span class="keyword">= array();<br /><br />   </span><span class="default">preg_match_all</span><span class="keyword">(</span><span class="string">'@(\w+)=(?:(?:\'([^\']+)\'|"([^"]+)")|([^\s,]+))@'</span><span class="keyword">, </span><span class="default">$txt</span><span class="keyword">, </span><span class="default">$matches</span><span class="keyword">, </span><span class="default">PREG_SET_ORDER</span><span class="keyword">);<br /><br />   foreach (</span><span class="default">$matches </span><span class="keyword">as </span><span class="default">$m</span><span class="keyword">) {<br />       </span><span class="default">$data</span><span class="keyword">[</span><span class="default">$m</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]] = </span><span class="default">$m</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">] ? </span><span class="default">$m</span><span class="keyword">[</span><span class="default">2</span><span class="keyword">] : (</span><span class="default">$m</span><span class="keyword">[</span><span class="default">3</span><span class="keyword">] ? </span><span class="default">$m</span><span class="keyword">[</span><span class="default">3</span><span class="keyword">] : </span><span class="default">$m</span><span class="keyword">[</span><span class="default">4</span><span class="keyword">]);<br />       unset(</span><span class="default">$needed_parts</span><span class="keyword">[</span><span class="default">$m</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]]);<br />   }<br /><br />   return </span><span class="default">$needed_parts </span><span class="keyword">? </span><span class="default">false </span><span class="keyword">: </span><span class="default">$data</span><span class="keyword">;<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Note that Microsoft has released a 'security update' which disables the use of username:password@host in http urls.<br /><br />   <a href="http://support.microsoft.com/default.aspx?scid=kb;en-us;834489" rel="nofollow" target="_blank">http://support.microsoft.com/default.aspx?scid=kb;en-us;834489</a><br /><br />The methods described above which rely on this will no longer work in Microsoft browsers, sadly.<br /><br />You can re-enable this functionality as described at<br /><br />   <a href="http://weblogs.asp.net/cumpsd/archive/2004/02/07/69366.aspx" rel="nofollow" target="_blank">http://weblogs.asp.net/cumpsd/archive/2004/02/07/69366.aspx</a><br /><br />but your users will probably be unwilling to do this.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Be careful using http digest authentication (see above, example 34.2) if you have to use the 'setlocale' function *before* validating response with the 'http_digest_parse' function, because there's a conflict with \w in the pattern of 'preg_match_all' function :<br /><br />In fact, as \w is supposed to be any letter or digit or the underscore character, you must not forgot that this may vary depending on your locale configuration (eg. it accepts accented letters in french)...<br /><br />Due to this different pattern interpretation by the 'preg_match_all' function, the 'http_digest_parse' function will always return a false result if you have modified your locale (I mean if your locale accepts some extended characters, see <a href="http://fr.php.net/manual/en/reference.pcre.pattern.syntax.php" rel="nofollow" target="_blank">http://fr.php.net/manual/en/reference.pcre.pattern.syntax.php</a> for further information).<br /><br />IMHO, I suggest you not to use setlocale before having your authentication completed...<br /><br />PS : Here's a non-compatible setlocale declaration...<br />setlocale ( LC_ALL, 'fr_FR', 'fr', 'FR', 'french', 'fra', 'france', 'French', 'fr_FR.ISO8859-1' ) ;</span></code></div>
  ...
  <strong class="user"><em>xsanychx at mail dot ru</em></strong></a><a class="genanchor" href="#110219"> &para;</a><div class="date" title="2012-10-02 09:32"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom110219">
<div class="phpcode"><code><span class="html">New auth:
<br />
...
<div class="phpcode"><code><span class="html">To get it to work with IIS try using this code before setting your "$auth = 0" and the "if (isset($PHP_AUTH_USER) &amp;&amp; isset($PHP_AUTH_PW))"
<br />
<br /><span class="default">&lt;?php
...
<br /></span>
<br />It worked for me on IIS 5 and PHP 4 in ISAPI</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I came up with another approach to work around the problem of browsers caching WWW authentication credentials and creating logout problems. While most browsers have some kind of way to wipe this information, I prefer having my website to take care of the task instead of relying on the user's sanity.<br /><br />Even with Lalit's method of creating a random realm name, it was still possible to get back into the protected area using the back button in Firefox, so that didn't work. Here's my solution:<br /><br />Since browsers attach the credentials to specific URLs, use virtual paths where a component of the path is actually a PHP script, and everything following it is part of the URI, such as:<br /><br /><a href="http://velocitypress.ca/some_dir/login.php/auth/8f631b92/" rel="nofollow" target="_blank">http://velocitypress.ca/some_dir/login.php/auth/8f631b92/</a><br /><br />By choosing a different number for the last component of the URL, browsers can be tricked into thinking that they are dealing with a completely different website, and thus prompting the user for credentials again.<br /><br />Note that using a random, unrestricted number will still allow the user to hit the back button to get back into the page. You should keep track of this number in a server-side file or database and regenerate it upon each successful login, so that the last number(s) become invalid. Using an invalid number might result in a 403 response or, depending on how you feel that day, a 302 to a nasty website.<br /><br />Care should be taken when linking from the page generated in this case, since relative links will be relative to the virtual and non-existant directory rather than the true script directory.</span></code></div>
  ...
  <strong class="user"><em>Carlos</em></strong></a><a class="genanchor" href="#121898"> &para;</a><div class="date" title="2017-11-22 10:44"><strong>7 years ago</strong></div>
  <div class="text" id="Hcom121898">
<div class="phpcode"><code><span class="html">Simpler WorkAround for missing Authorization header under CGI/FastCGI available in Apache HTTP Server 2.4.13 and later<br /><br />     CGIPassAuth On<br /><br />Please don't enable Authorization header with Basic Authentication, is very insecure.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Some servers won't support the HTTP1.0 specification and will give an error 500 (for instance). This happened with a server where I uploaded an authentication script.
<br />
...
<div class="phpcode"><code><span class="html">In Windows 2003 Server/IIS6 with the php4+ cgi I only get HTTP authentication working with:<br /><span class="default">&lt;?php header</span><span class="keyword">(</span><span class="string">"Status: 401 Access Denied"</span><span class="keyword">); </span><span class="default">?&gt;<br /></span>with<br /><span class="default">&lt;?php header</span><span class="keyword">(</span><span class="string">'HTTP/1.0 401 Unauthorized'</span><span class="keyword">); </span><span class="default">?&gt;<br /></span>doesn't work !<br />I also need in "Custom Errors" to select the range of "401;1" through "401;5" and click the "Set to Default" button.<br />Thanks rob at theblip dot com</span></code></div>
  ...
  <strong class="user"><em>SlamJam</em></strong></a><a class="genanchor" href="#70693"> &para;</a><div class="date" title="2006-10-23 11:28"><strong>18 years ago</strong></div>
  <div class="text" id="Hcom70693">
<div class="phpcode"><code><span class="html">I used Louis example (03-Jun-2006) and it works well for me (thanks).
<br />
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />noentry.php is slightely different from comeagain.php.</span></code></div>
  </div>
 </div>
...
<br /><a href="http://support.microsoft.com/kb/834489" rel="nofollow" target="_blank">http://support.microsoft.com/kb/834489</a></span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">The only effective way I've found to wipe out the PHP_AUTH_DIGEST or PHP_AUTH_USER AND PHP_AUTH_PW credentials is to call the header HTTP/1.1 401 Unauthorized.<br /><br />function clear_admin_access(){<br />    header('HTTP/1.1 401 Unauthorized');<br />    die('Admin access turned off');<br />}</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">In the german example #2 (digest), the <span class="default">&lt;?php $realm </span><span class="keyword">= </span><span class="string">"Geschützter Bereich"</span><span class="keyword">; </span><span class="default">?&gt;</span>. As far as I have tested the umlaut ü is problematic, resulting in an password enter infinity loop. In my case it was written in UTF-8. So I suggest using only plain ASCII characters for the realm.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html"># PHP (CGI mode) HTTP Authorization with ModRewrite: <br /># most right example with header check for non empty:<br /> RewriteEngine on<br /> RewriteCond %{HTTP:Authorization}  !^$<br /> RewriteRule .* - [E=REMOTE_USER:%{HTTP:Authorization}, \<br />E=PHP_AUTH_USER:%{HTTP:Authorization},L]</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">public function loginUser(){<br />        $username = filter_var($_GET['username'],FILTER_SANITIZE_STRING);<br />        $pw = filter_var($_GET['pw'],FILTER_SANITIZE_STRING);<br />        $row = $this-&gt;userModel-&gt;selectUser($username);<br /><br />       if (password_verify($pw,$row['pw'])){<br />           $_SESSION["userId"] = $row['id'];<br /><br />           $this-&gt;isLogin();<br />       } else{<br />           new Msg(true,"Benutzername und Passwort stimmen nicht überein!");<br />       }<br /><br />    }<br /><br />A short example for an user Login</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">It forces a auth each time the page is accessed:<br />(maybe can save someone)<br /><br />&lt;?<br />header("Expires: Sat, 01 Jan 2000 00:00:00 GMT");<br />header("Last-Modified: ".gmdate("D, d M Y H:i:s")." GMT");<br />header("Cache-Control: post-check=0, pre-check=0",false);<br />header("Pragma: no-cache");<br />session_cache_limiter("public, no-store");<br />session_start();<br /><br />function http_auth()<br />{<br />    $_SESSION['AUTH'] = 1;<br />    header('HTTP/1.0 401 Unauthorized');<br />    header('WWW-Authenticate: Basic realm="sn4g auth system"');<br />    // The actions to be done when the user clicks on 'cancel'<br />    exit();<br />}<br /><br />if( !isset($_SERVER['PHP_AUTH_USER']) or @$_SESSION['AUTH'] != 1 )<br />{<br />    http_auth();<br />    exit();<br />}<br /><br />// Actions do be done when the user has logged<br /><br />// rest, must clean the session array<br />$_SESSION = array();<br />session_destroy();<br />?&gt;</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Don't use apache authentification in plain text. Is more better to use own script to generete new ID which is relevant to password. Apache auth data are sent to every page, so the posible mistake are known.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I tried example 7, and at first I couldn't get it to work. It took me a while to spot that somewhere along the line, probably by the server, a seemingly random number was being added to the realm - so the valid_result variable wasn't calculated using the correct realm.<br /><br />To get around this, or any similar problems, make the following changes to the example:<br /><br />Around line 43 (44 if after next step ;) ):<br />$needed_parts = array('nonce'=&gt;1, 'nc'=&gt;1, 'cnonce'=&gt;1, 'qop'=&gt;1, 'username'=&gt;1, 'uri'=&gt;1, 'response'=&gt;1, 'realm'=&gt;1);<br /><br />Before line 24:<br />$realm = $data['realm'];<br /><br />These two steps get the real realm used for the authentication request, and substitute it into the "valid_response" query.<br /><br />Hope this helps :)</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">I came up with another approach to work around the problem of browsers caching WWW authentication credentials and creating logout problems. While most browsers have some kind of way to wipe this information, I prefer having my website to take care of the task instead of relying on the user's sanity.<br /><br />Even with Lalit's method of creating a random realm name, it was still possible to get back into the protected area using the back button in Firefox, so that didn't work. Here's my solution:<br /><br />Since browsers attach the credentials to specific URLs, use virtual paths where a component of the path is actually a PHP script, and everything following it is part of the URI, such as:<br /><br /><a href="http://www.example.com/some_dir/login.php/auth/8f631b92/" rel="nofollow" target="_blank">http://www.example.com/some_dir/login.php/auth/8f631b92/</a><br /><br />By choosing a different number for the last component of the URL, browsers can be tricked into thinking that they are dealing with a completely different website, and thus prompting the user for credentials again.<br /><br />Note that using a random, unrestricted number will still allow the user to hit the back button to get back into the page. You should keep track of this number in a server-side file or database and regenerate it upon each successful login, so that the last number(s) become invalid. Using an invalid number might result in a 403 response or, depending on how you feel that day, a 302 to a nasty website.<br /><br />Care should be taken when linking from the page generated in this case, since relative links will be relative to the virtual and non-existant directory rather than the true script directory.<br /><br />Hope this helps somebody.</span></code></div>
  ...
  <strong class="user"><em>Paul</em></strong></a><a class="genanchor" href="#37280"> &para;</a><div class="date" title="2003-11-08 03:53"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom37280">
<div class="phpcode"><code><span class="html">Here is a extremely easy way to successfully logout.
<br />
<br /><span class="default">&lt;?php
...
<br /></span><span class="default">?&gt;
<br /></span>
<br />To log the user out simply change the value of $realm</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">Samples Login / Logout script<br /><br />login.php :<br /><br /><span class="default">&lt;?php<br /><br />    </span><span class="comment">// Initisalition<br />    </span><span class="keyword">if (</span><span class="default">$_COOKIE</span><span class="keyword">[</span><span class="string">"SESSION"</span><span class="keyword">]==</span><span class="string">''</span><span class="keyword">) {<br />        </span><span class="default">setcookie</span><span class="keyword">(</span><span class="string">"SESSION"</span><span class="keyword">, </span><span class="string">'AUTH'</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">,</span><span class="string">'/'</span><span class="keyword">); <br />        <br />    </span><span class="comment">// Identification perdu (time-out ou logoff)<br />    </span><span class="keyword">} else if (</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_AUTH_USER'</span><span class="keyword">]!=</span><span class="string">'' </span><span class="keyword">&amp;&amp; </span><span class="default">$_COOKIE</span><span class="keyword">[</span><span class="string">"USER_SESSION"</span><span class="keyword">]==</span><span class="string">''</span><span class="keyword">) {<br />        </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_AUTH_USER'</span><span class="keyword">] = </span><span class="string">''</span><span class="keyword">;<br />    }<br /><br />    </span><span class="comment">// Controle identification à la base <br />    </span><span class="default">$ident </span><span class="keyword">= </span><span class="default">executeSQL</span><span class="keyword">(</span><span class="string">"SELECT * FROM UTILISATEURS WHERE upper(IDENTIFIANT)=Upper('"</span><span class="keyword">.</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_AUTH_USER'</span><span class="keyword">].</span><span class="string">"')"</span><span class="keyword">);<br />    if (</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_AUTH_USER'</span><span class="keyword">]!=</span><span class="string">'' </span><span class="keyword">&amp;&amp; </span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$ident</span><span class="keyword">[</span><span class="string">'IDENTIFIANT'</span><span class="keyword">])==</span><span class="default">strtoupper</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_AUTH_USER'</span><span class="keyword">]) &amp;&amp; </span><span class="default">$ident</span><span class="keyword">[</span><span class="string">'MOT_DE_PASSE'</span><span class="keyword">]==</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_AUTH_PW'</span><span class="keyword">]) {<br />        </span><span class="default">$user </span><span class="keyword">= </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_AUTH_USER'</span><span class="keyword">];<br />        </span><span class="default">setcookie</span><span class="keyword">(</span><span class="string">"USER_SESSION"</span><span class="keyword">, </span><span class="default">$user</span><span class="keyword">, </span><span class="default">time</span><span class="keyword">()+</span><span class="default">300</span><span class="keyword">,</span><span class="string">'/'</span><span class="keyword">); </span><span class="comment">// 5 Minutes !<br />    <br />    // Mot de passe incorecte : demande identification<br />    </span><span class="keyword">} else {<br />        </span><span class="default">setcookie</span><span class="keyword">(</span><span class="string">"SESSION"</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">,</span><span class="string">'/'</span><span class="keyword">); <br />        </span><span class="default">header</span><span class="keyword">(</span><span class="string">'WWW-Authenticate: Basic realm="My Realm"'</span><span class="keyword">);<br />        </span><span class="default">header</span><span class="keyword">(</span><span class="string">'HTTP/1.0 401 Unauthorized'</span><span class="keyword">);<br />        die;<br />    }<br />    <br /></span><span class="default">?&gt;<br /></span>&lt;html&gt;<br />    &lt;body &gt;<br /><br />        Bonjour <span class="default">&lt;?php </span><span class="keyword">echo </span><span class="default">$ident</span><span class="keyword">[</span><span class="string">'NOM'</span><span class="keyword">].</span><span class="string">' '</span><span class="keyword">.</span><span class="default">$ident</span><span class="keyword">[</span><span class="string">'PRENOM'</span><span class="keyword">]; </span><span class="default">?&gt;<br /></span>        &lt;br&gt;<br />        &lt;br&gt;<br />        &lt;a href="<a href="http://logout.php" rel="nofollow" target="_blank">http://logout.php</a>"&gt;Deconnexion&lt;/a&gt;<br />    &lt;/body&gt;<br />&lt;/html&gt;<br /><br />logout.php :<br /><br /><span class="default">&lt;?php<br />setcookie</span><span class="keyword">(</span><span class="string">"USER_SESSION"</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">,</span><span class="string">'/'</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">'Location: <a href="http://login.php" rel="nofollow" target="_blank">http://login.php</a>'</span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
