...
<head>
  ...
  <title>PHP: Imagick::getImageSignature - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagesignature.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagesignature.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagesignature.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagescene.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagesize.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagesignature.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagesignature.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagesignature.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagesignature.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagesignature.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagesignature.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagesignature.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagesignature.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagesignature.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagesignature.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagesignature.php" hreflang="zh">
...
<meta name="Description" content="Generates an SHA-256 message digest" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageSignature - Manual" />
<meta name="twitter:description" content="Generates an SHA-256 message digest" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageSignature - Manual" />
<meta itemprop="description" content="Generates an SHA-256 message digest" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates an SHA-256 message digest" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagesize.php">
          Imagick::getImageSize &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagescene.php">
          &laquo; Imagick::getImageScene        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagesignature.php' selected="selected">English</option>
            <option value='de/imagick.getimagesignature.php'>German</option>
            <option value='es/imagick.getimagesignature.php'>Spanish</option>
            <option value='fr/imagick.getimagesignature.php'>French</option>
            <option value='it/imagick.getimagesignature.php'>Italian</option>
            <option value='ja/imagick.getimagesignature.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagesignature.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagesignature.php'>Russian</option>
            <option value='tr/imagick.getimagesignature.php'>Turkish</option>
            <option value='uk/imagick.getimagesignature.php'>Ukrainian</option>
            <option value='zh/imagick.getimagesignature.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagesignature" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimagesignature-description">
  ...
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageSignature</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
