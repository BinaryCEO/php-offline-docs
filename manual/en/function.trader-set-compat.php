...
<head>
  ...
  <title>PHP: trader_set_compat - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-set-compat.php">
 <link rel="shorturl" href="https://www.php.net/trader-set-compat">
 <link rel="alternate" href="https://www.php.net/trader-set-compat" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-sarext.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-set-unstable-period.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-set-compat.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-set-compat.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-set-compat.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-set-compat.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-set-compat.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-set-compat.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-set-compat.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-set-compat.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-set-compat.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-set-compat.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-set-compat.php" hreflang="zh">
...
<meta name="Description" content="Set compatibility mode" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_set_compat - Manual" />
<meta name="twitter:description" content="Set compatibility mode" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_set_compat - Manual" />
<meta itemprop="description" content="Set compatibility mode" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set compatibility mode" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-set-unstable-period.php">
          trader_set_unstable_period &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-sarext.php">
          &laquo; trader_sarext        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-set-compat.php' selected="selected">English</option>
            <option value='de/function.trader-set-compat.php'>German</option>
            <option value='es/function.trader-set-compat.php'>Spanish</option>
            <option value='fr/function.trader-set-compat.php'>French</option>
            <option value='it/function.trader-set-compat.php'>Italian</option>
            <option value='ja/function.trader-set-compat.php'>Japanese</option>
            <option value='pt_BR/function.trader-set-compat.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-set-compat.php'>Russian</option>
            <option value='tr/function.trader-set-compat.php'>Turkish</option>
            <option value='uk/function.trader-set-compat.php'>Ukrainian</option>
            <option value='zh/function.trader-set-compat.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-set-compat" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.trader-set-compat-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_set_compat</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$compatId</code></span>): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-set-compat-parameters">
  ...
  <dl>
    ...
    <dt><code class="parameter">compatId</code></dt>
    <dd>
     <p class="para">
      Compatibility Id. <a href="trader.constants.php" class="link">TRADER_COMPATIBILITY_*</a> series of constants should be used. 
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-set-compat-returnvalues">
  ...
  <p class="para">No value is returned.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-set-compat.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-set-compat%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-set-compat&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-set-compat.php">＋<small>add a note</small></a></span>
