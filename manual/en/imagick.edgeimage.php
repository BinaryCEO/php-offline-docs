...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.edgeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.edgeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.edgeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.drawimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.embossimage.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.edgeimage.php' selected="selected">English</option>
            ...
            <option value='tr/imagick.edgeimage.php'>Turkish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::edgeImage</span> &mdash; <span class="dc-title">Enhance edges within the image</span></p>
 ...
 <div class="refsect1 description" id="refsect1-imagick.edgeimage-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::edgeImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$radius</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.edgeimage-examples">
  ...
  <p class="para">
    <div class="example" id="example-2992">
      <p><strong>Example #1  <span class="function"><strong>Imagick::edgeImage()</strong></span></strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/edgeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.edgeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.edgeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.edgeimage.php">＋<small>add a note</small></a></span>
