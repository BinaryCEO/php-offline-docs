...
<head>
  ...
  <title>PHP: mb_ucfirst - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-ucfirst.php">
 <link rel="shorturl" href="https://www.php.net/mb-ucfirst">
 <link rel="alternate" href="https://www.php.net/mb-ucfirst" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-trim.php">
 <link rel="next" href="https://www.php.net/manual/en/book.pspell.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-ucfirst.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-ucfirst.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-ucfirst.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-ucfirst.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-ucfirst.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-ucfirst.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-ucfirst.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-ucfirst.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-ucfirst.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-ucfirst.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-ucfirst.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.pspell.php">
          Pspell &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-trim.php">
          &laquo; mb_trim        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-ucfirst.php' selected="selected">English</option>
            <option value='de/function.mb-ucfirst.php'>German</option>
            <option value='es/function.mb-ucfirst.php'>Spanish</option>
            <option value='fr/function.mb-ucfirst.php'>French</option>
            <option value='it/function.mb-ucfirst.php'>Italian</option>
            <option value='ja/function.mb-ucfirst.php'>Japanese</option>
            <option value='pt_BR/function.mb-ucfirst.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-ucfirst.php'>Russian</option>
            <option value='tr/function.mb-ucfirst.php'>Turkish</option>
            <option value='uk/function.mb-ucfirst.php'>Ukrainian</option>
            <option value='zh/function.mb-ucfirst.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-ucfirst" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.ucfirst.php" class="function" rel="rdfs-seeAlso">ucfirst()</a> - Make a string's first character uppercase</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-ucfirst.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-ucfirst%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-ucfirst&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ucfirst.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129865">  <div class="votes">
    <div id="Vu129865">
    <a href="/manual/vote-note.php?id=129865&amp;page=function.mb-ucfirst&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129865">
    <a href="/manual/vote-note.php?id=129865&amp;page=function.mb-ucfirst&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129865" title="33% like this...">
    -5
    </div>
  </div>
  <a href="#129865" class="name">
  <strong class="user"><em>hans at loltek dot net</em></strong></a><a class="genanchor" href="#129865"> &para;</a><div class="date" title="2024-11-21 09:53"><strong>10 months ago</strong></div>
  <div class="text" id="Hcom129865">
<div class="phpcode"><code><span class="html">polyfill:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">if(</span><span class="default">PHP_VERSION_ID </span><span class="keyword">&lt; </span><span class="default">80400</span><span class="keyword">) {<br />function </span><span class="default">mb_ucfirst</span><span class="keyword">(</span><span class="default">string $str</span><span class="keyword">, </span><span class="default">string $encoding </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">): </span><span class="default">string<br /></span><span class="keyword">{<br />    if (</span><span class="default">$encoding </span><span class="keyword">=== </span><span class="default">null</span><span class="keyword">) {<br />        </span><span class="default">$encoding </span><span class="keyword">= </span><span class="default">mb_internal_encoding</span><span class="keyword">();<br />    }<br />    return </span><span class="default">mb_strtoupper</span><span class="keyword">(</span><span class="default">mb_substr</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">), </span><span class="default">$encoding</span><span class="keyword">) . </span><span class="default">mb_substr</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">null</span><span class="keyword">, </span><span class="default">$encoding</span><span class="keyword">);<br />}<br /><br />}<br /></span><span class="default">?&gt;<br /></span><br />if you wonder why i bother with mb_internal_encoding: prior to php7, $encoding was not nullable. if your polyfill don't need php5.6 support, you can drop it.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-ucfirst&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-ucfirst.php">＋<small>add a note</small></a></div>
