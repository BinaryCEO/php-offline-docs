...
<head>
  ...
  <title>PHP: variant_and - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.variant-and.php">
 <link rel="shorturl" href="https://www.php.net/variant-and">
 <link rel="alternate" href="https://www.php.net/variant-and" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.com.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.variant-add.php">
 <link rel="next" href="https://www.php.net/manual/en/function.variant-cast.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.variant-and.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.variant-and.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.variant-and.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.variant-and.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.variant-and.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.variant-and.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.variant-and.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.variant-and.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.variant-and.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.variant-and.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.variant-and.php" hreflang="zh">
...
<meta name="Description" content="Performs a bitwise AND operation between two variants" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: variant_and - Manual" />
<meta name="twitter:description" content="Performs a bitwise AND operation between two variants" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: variant_and - Manual" />
<meta itemprop="description" content="Performs a bitwise AND operation between two variants" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Performs a bitwise AND operation between two variants" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.variant-cast.php">
          variant_cast &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.variant-and.php' selected="selected">English</option>
            <option value='de/function.variant-and.php'>German</option>
            <option value='es/function.variant-and.php'>Spanish</option>
            <option value='fr/function.variant-and.php'>French</option>
            <option value='it/function.variant-and.php'>Italian</option>
            <option value='ja/function.variant-and.php'>Japanese</option>
            <option value='pt_BR/function.variant-and.php'>Brazilian Portuguese</option>
            <option value='ru/function.variant-and.php'>Russian</option>
            <option value='tr/function.variant-and.php'>Turkish</option>
            <option value='uk/function.variant-and.php'>Ukrainian</option>
            <option value='zh/function.variant-and.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.variant-and" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">variant_and</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">variant_and</span> &mdash; <span class="dc-title">Performs a bitwise AND operation between two variants</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.variant-and-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>variant_and</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$left</code></span>, <span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$right</code></span>): <span class="type"><a href="class.variant.php" class="type variant">variant</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.variant-and-returnvalues">
  ...
  <p class="para">
   <table class="doctable table">
    <caption><strong>Variant AND Rules</strong></caption>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.variant-or.php" class="function" rel="rdfs-seeAlso">variant_or()</a> - Performs a logical disjunction on two variants</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/functions/variant-and.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.variant-and%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.variant-and&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.variant-and.php">＋<small>add a note</small></a></span>
