...
<head>
  ...
  <title>PHP: stats_rand_gen_chisquare - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-gen-chisquare.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-gen-chisquare">
 <link rel="alternate" href="https://www.php.net/stats-rand-gen-chisquare" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-gen-beta.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-gen-exponential.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-gen-chisquare.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-gen-chisquare.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-gen-chisquare.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-gen-chisquare.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-gen-chisquare.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-gen-chisquare.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-gen-chisquare.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-gen-chisquare.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-gen-chisquare.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-gen-chisquare.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-gen-chisquare.php" hreflang="zh">
...
<meta name="Description" content="Generates a random deviate from the chi-square distribution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_gen_chisquare - Manual" />
<meta name="twitter:description" content="Generates a random deviate from the chi-square distribution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_gen_chisquare - Manual" />
<meta itemprop="description" content="Generates a random deviate from the chi-square distribution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates a random deviate from the chi-square distribution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.stats-rand-gen-exponential.php">
          stats_rand_gen_exponential &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-gen-beta.php">
          &laquo; stats_rand_gen_beta        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-gen-chisquare.php' selected="selected">English</option>
            <option value='de/function.stats-rand-gen-chisquare.php'>German</option>
            <option value='es/function.stats-rand-gen-chisquare.php'>Spanish</option>
            <option value='fr/function.stats-rand-gen-chisquare.php'>French</option>
            <option value='it/function.stats-rand-gen-chisquare.php'>Italian</option>
            <option value='ja/function.stats-rand-gen-chisquare.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-gen-chisquare.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-gen-chisquare.php'>Russian</option>
            <option value='tr/function.stats-rand-gen-chisquare.php'>Turkish</option>
            <option value='uk/function.stats-rand-gen-chisquare.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-gen-chisquare.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-gen-chisquare" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_rand_gen_chisquare</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_rand_gen_chisquare</span> &mdash; <span class="dc-title">Generates a random deviate from the chi-square distribution</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-rand-gen-chisquare-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_rand_gen_chisquare</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$df</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>

  <p class="para rdfs-comment">
   Returns a random deviate from the chi-square distribution where the degrees of
   freedom is  <code class="parameter">df</code>.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.stats-rand-gen-chisquare-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-rand-gen-chisquare-returnvalues">
  ...
  <p class="para">
   A random deviate
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-gen-chisquare.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-gen-chisquare%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-gen-chisquare&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-gen-chisquare.php">＋<small>add a note</small></a></span>
