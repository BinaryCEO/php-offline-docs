...
<head>
  ...
  <title>PHP: ReflectionMethod::hasPrototype - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionmethod.hasprototype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionmethod.hasprototype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionmethod.hasprototype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionmethod.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionmethod.getprototype.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionmethod.invoke.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionmethod.hasprototype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionmethod.hasprototype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionmethod.hasprototype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionmethod.hasprototype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionmethod.hasprototype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionmethod.hasprototype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionmethod.hasprototype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionmethod.hasprototype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionmethod.hasprototype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionmethod.hasprototype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionmethod.hasprototype.php" hreflang="zh">
...
<meta name="Description" content="Returns whether a method has a prototype" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionMethod::hasPrototype - Manual" />
<meta name="twitter:description" content="Returns whether a method has a prototype" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionMethod::hasPrototype - Manual" />
<meta itemprop="description" content="Returns whether a method has a prototype" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether a method has a prototype" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionmethod.invoke.php">
          ReflectionMethod::invoke &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionmethod.getprototype.php">
          &laquo; ReflectionMethod::getPrototype        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionmethod.hasprototype.php' selected="selected">English</option>
            <option value='de/reflectionmethod.hasprototype.php'>German</option>
            <option value='es/reflectionmethod.hasprototype.php'>Spanish</option>
            <option value='fr/reflectionmethod.hasprototype.php'>French</option>
            <option value='it/reflectionmethod.hasprototype.php'>Italian</option>
            <option value='ja/reflectionmethod.hasprototype.php'>Japanese</option>
            <option value='pt_BR/reflectionmethod.hasprototype.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionmethod.hasprototype.php'>Russian</option>
            <option value='tr/reflectionmethod.hasprototype.php'>Turkish</option>
            <option value='uk/reflectionmethod.hasprototype.php'>Ukrainian</option>
            <option value='zh/reflectionmethod.hasprototype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionmethod.hasprototype" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="methodname"><a href="reflectionmethod.getprototype.php" class="methodname" rel="rdfs-seeAlso">ReflectionMethod::getPrototype()</a> - Gets the method prototype (if there is one)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionmethod/hasprototype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionmethod.hasprototype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionmethod.hasprototype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionmethod.hasprototype.php">＋<small>add a note</small></a></span>
