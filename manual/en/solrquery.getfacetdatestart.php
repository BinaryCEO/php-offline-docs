...
<head>
  ...
  <title>PHP: SolrQuery::getFacetDateStart - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getfacetdatestart.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getfacetdatestart.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdatestart.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getfacetdateother.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getfacetfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getfacetdatestart.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getfacetdatestart.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getfacetdatestart.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getfacetdatestart.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getfacetdatestart.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getfacetdatestart.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getfacetdatestart.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getfacetdatestart.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getfacetdatestart.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getfacetdatestart.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getfacetdatestart.php" hreflang="zh">
...
<meta name="Description" content="Returns the  lower bound for the first date range for all date faceting on this field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getFacetDateStart - Manual" />
<meta name="twitter:description" content="Returns the  lower bound for the first date range for all date faceting on this field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getFacetDateStart - Manual" />
<meta itemprop="description" content="Returns the  lower bound for the first date range for all date faceting on this field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the  lower bound for the first date range for all date faceting on this field" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getfacetfields.php">
          SolrQuery::getFacetFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getfacetdateother.php">
          &laquo; SolrQuery::getFacetDateOther        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getfacetdatestart.php' selected="selected">English</option>
            <option value='de/solrquery.getfacetdatestart.php'>German</option>
            <option value='es/solrquery.getfacetdatestart.php'>Spanish</option>
            <option value='fr/solrquery.getfacetdatestart.php'>French</option>
            <option value='it/solrquery.getfacetdatestart.php'>Italian</option>
            <option value='ja/solrquery.getfacetdatestart.php'>Japanese</option>
            <option value='pt_BR/solrquery.getfacetdatestart.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getfacetdatestart.php'>Russian</option>
            <option value='tr/solrquery.getfacetdatestart.php'>Turkish</option>
            <option value='uk/solrquery.getfacetdatestart.php'>Ukrainian</option>
            <option value='zh/solrquery.getfacetdatestart.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getfacetdatestart" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getFacetDateStart</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getFacetDateStart</span> &mdash; <span class="dc-title">Returns the  lower bound for the first date range for all date faceting on this field</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getfacetdatestart-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getFacetDateStart</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field_override</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getfacetdatestart-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.getfacetdatestart-returnvalues">
...
Returns a string on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getfacetdatestart.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getfacetdatestart%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getfacetdatestart&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getfacetdatestart.php">＋<small>add a note</small></a></span>
