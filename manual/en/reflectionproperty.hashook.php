...
<head>
  ...
  <title>PHP: ReflectionProperty::hasHook - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.hashook.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.hashook.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.hashook.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.hasdefaultvalue.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.hashooks.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.hashook.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.hashook.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.hashook.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.hashook.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.hashook.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.hashook.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.hashook.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.hashook.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.hashook.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.hashook.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.hashook.php" hreflang="zh">
...
<meta name="Description" content="Returns whether the property has a given hook defined" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::hasHook - Manual" />
<meta name="twitter:description" content="Returns whether the property has a given hook defined" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::hasHook - Manual" />
<meta itemprop="description" content="Returns whether the property has a given hook defined" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether the property has a given hook defined" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionproperty.hashooks.php">
          ReflectionProperty::hasHooks &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.hasdefaultvalue.php">
          &laquo; ReflectionProperty::hasDefaultValue        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.hashook.php' selected="selected">English</option>
            <option value='de/reflectionproperty.hashook.php'>German</option>
            <option value='es/reflectionproperty.hashook.php'>Spanish</option>
            <option value='fr/reflectionproperty.hashook.php'>French</option>
            <option value='it/reflectionproperty.hashook.php'>Italian</option>
            <option value='ja/reflectionproperty.hashook.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.hashook.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.hashook.php'>Russian</option>
            <option value='tr/reflectionproperty.hashook.php'>Turkish</option>
            <option value='uk/reflectionproperty.hashook.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.hashook.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.hashook" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-reflectionproperty.hashook-examples">
  ...
  <div class="example" id="reflectionproperty.hashook.example.basic">
   <p><strong>Example #1 <span class="methodname"><strong>ReflectionProperty::hasHook()</strong></span> example</strong></p>
  ...
  <ul class="simplelist">
   ...
   <li><span class="classname"><a href="enum.propertyhooktype.php" class="classname">PropertyHookType</a></span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/hashook.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.hashook%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.hashook&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.hashook.php">＋<small>add a note</small></a></span>
