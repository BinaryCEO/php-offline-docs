...
<head>
  ...
  <title>PHP: trader_macdfix - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-macdfix.php">
 <link rel="shorturl" href="https://www.php.net/trader-macdfix">
 <link rel="alternate" href="https://www.php.net/trader-macdfix" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-macdext.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-mama.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-macdfix.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-macdfix.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-macdfix.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-macdfix.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-macdfix.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-macdfix.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-macdfix.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-macdfix.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-macdfix.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-macdfix.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-macdfix.php" hreflang="zh">
...
<meta name="Description" content="Moving Average Convergence/Divergence Fix 12/26" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: trader_macdfix - Manual" />
<meta name="twitter:description" content="Moving Average Convergence/Divergence Fix 12/26" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_macdfix - Manual" />
<meta itemprop="description" content="Moving Average Convergence/Divergence Fix 12/26" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Moving Average Convergence/Divergence Fix 12/26" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.trader-mama.php">
          trader_mama &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-macdext.php">
          &laquo; trader_macdext        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-macdfix.php' selected="selected">English</option>
            <option value='de/function.trader-macdfix.php'>German</option>
            <option value='es/function.trader-macdfix.php'>Spanish</option>
            <option value='fr/function.trader-macdfix.php'>French</option>
            <option value='it/function.trader-macdfix.php'>Italian</option>
            <option value='ja/function.trader-macdfix.php'>Japanese</option>
            <option value='pt_BR/function.trader-macdfix.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-macdfix.php'>Russian</option>
            <option value='tr/function.trader-macdfix.php'>Turkish</option>
            <option value='uk/function.trader-macdfix.php'>Ukrainian</option>
            <option value='zh/function.trader-macdfix.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-macdfix" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_macdfix</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_macdfix</span> &mdash; <span class="dc-title">Moving Average Convergence/Divergence Fix 12/26</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-macdfix-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_macdfix</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$signalPeriod</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-macdfix-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-macdfix-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-macdfix.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-macdfix%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-macdfix&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-macdfix.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="120741">  <div class="votes">
    <div id="Vu120741">
    <a href="/manual/vote-note.php?id=120741&amp;page=function.trader-macdfix&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd120741">
    <a href="/manual/vote-note.php?id=120741&amp;page=function.trader-macdfix&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V120741" title="66% like this...">
    3
    </div>
  </div>
  <a href="#120741" class="name">
  <strong class="user"><em>Chileung Chow</em></strong></a><a class="genanchor" href="#120741"> &para;</a><div class="date" title="2017-03-04 05:52"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom120741">
...
<div class="foot"><a href="/manual/add-note.php?sect=function.trader-macdfix&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-macdfix.php">＋<small>add a note</small></a></div>
