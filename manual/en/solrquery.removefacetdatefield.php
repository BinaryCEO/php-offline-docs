...
<head>
  ...
  <title>PHP: SolrQuery::removeFacetDateField - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.removefacetdatefield.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.removefacetdatefield.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefacetdatefield.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.removeexpandsortfield.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.removefacetdateother.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.removefacetdatefield.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.removefacetdatefield.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.removefacetdatefield.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.removefacetdatefield.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.removefacetdatefield.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.removefacetdatefield.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.removefacetdatefield.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.removefacetdatefield.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.removefacetdatefield.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.removefacetdatefield.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.removefacetdatefield.php" hreflang="zh">
...
<meta name="Description" content="Removes one of the facet date fields" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::removeFacetDateField - Manual" />
<meta name="twitter:description" content="Removes one of the facet date fields" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::removeFacetDateField - Manual" />
<meta itemprop="description" content="Removes one of the facet date fields" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Removes one of the facet date fields" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.removefacetdateother.php">
          SolrQuery::removeFacetDateOther &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.removeexpandsortfield.php">
          &laquo; SolrQuery::removeExpandSortField        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.removefacetdatefield.php' selected="selected">English</option>
            <option value='de/solrquery.removefacetdatefield.php'>German</option>
            <option value='es/solrquery.removefacetdatefield.php'>Spanish</option>
            <option value='fr/solrquery.removefacetdatefield.php'>French</option>
            <option value='it/solrquery.removefacetdatefield.php'>Italian</option>
            <option value='ja/solrquery.removefacetdatefield.php'>Japanese</option>
            <option value='pt_BR/solrquery.removefacetdatefield.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.removefacetdatefield.php'>Russian</option>
            <option value='tr/solrquery.removefacetdatefield.php'>Turkish</option>
            <option value='uk/solrquery.removefacetdatefield.php'>Ukrainian</option>
            <option value='zh/solrquery.removefacetdatefield.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.removefacetdatefield" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::removeFacetDateField</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::removeFacetDateField</span> &mdash; <span class="dc-title">Removes one of the facet date fields</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.removefacetdatefield-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::removeFacetDateField</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$field</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.removefacetdatefield-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.removefacetdatefield-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/removefacetdatefield.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.removefacetdatefield%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.removefacetdatefield&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.removefacetdatefield.php">＋<small>add a note</small></a></span>
