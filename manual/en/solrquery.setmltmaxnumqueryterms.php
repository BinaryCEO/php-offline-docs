...
<head>
  ...
  <title>PHP: SolrQuery::setMltMaxNumQueryTerms - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setmltmaxnumqueryterms.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setmltmaxnumqueryterms.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmaxnumqueryterms.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setmltcount.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setmltmaxnumtokens.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setmltmaxnumqueryterms.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setmltmaxnumqueryterms.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setmltmaxnumqueryterms.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setmltmaxnumqueryterms.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setmltmaxnumqueryterms.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setmltmaxnumqueryterms.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setmltmaxnumqueryterms.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setmltmaxnumqueryterms.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setmltmaxnumqueryterms.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setmltmaxnumqueryterms.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setmltmaxnumqueryterms.php" hreflang="zh">
...
<meta name="Description" content="Sets the maximum number of query terms included" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setMltMaxNumQueryTerms - Manual" />
<meta name="twitter:description" content="Sets the maximum number of query terms included" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setMltMaxNumQueryTerms - Manual" />
<meta itemprop="description" content="Sets the maximum number of query terms included" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the maximum number of query terms included" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setmltmaxnumtokens.php">
          SolrQuery::setMltMaxNumTokens &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setmltcount.php">
          &laquo; SolrQuery::setMltCount        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setmltmaxnumqueryterms.php' selected="selected">English</option>
            <option value='de/solrquery.setmltmaxnumqueryterms.php'>German</option>
            <option value='es/solrquery.setmltmaxnumqueryterms.php'>Spanish</option>
            <option value='fr/solrquery.setmltmaxnumqueryterms.php'>French</option>
            <option value='it/solrquery.setmltmaxnumqueryterms.php'>Italian</option>
            <option value='ja/solrquery.setmltmaxnumqueryterms.php'>Japanese</option>
            <option value='pt_BR/solrquery.setmltmaxnumqueryterms.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setmltmaxnumqueryterms.php'>Russian</option>
            <option value='tr/solrquery.setmltmaxnumqueryterms.php'>Turkish</option>
            <option value='uk/solrquery.setmltmaxnumqueryterms.php'>Ukrainian</option>
            <option value='zh/solrquery.setmltmaxnumqueryterms.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setmltmaxnumqueryterms" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setMltMaxNumQueryTerms</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setMltMaxNumQueryTerms</span> &mdash; <span class="dc-title">Sets the maximum number of query terms included</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setmltmaxnumqueryterms-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setMltMaxNumQueryTerms</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setmltmaxnumqueryterms-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setmltmaxnumqueryterms-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setmltmaxnumqueryterms.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setmltmaxnumqueryterms%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setmltmaxnumqueryterms&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setmltmaxnumqueryterms.php">＋<small>add a note</small></a></span>
