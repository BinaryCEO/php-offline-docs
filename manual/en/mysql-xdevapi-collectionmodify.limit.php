...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.limit.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.limit.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.limit.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysql-xdevapi-collectionmodify.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.execute.php">
 <link rel="next" href="https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.patch.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi-collectionmodify.limit.php' selected="selected">English</option>
            ...
            <option value='tr/mysql-xdevapi-collectionmodify.limit.php'>Turkish</option>
 ...
 <div class="refsect1 examples" id="refsect1-mysql-xdevapi-collectionmodify.limit-examples">
  ...
  <div class="example" id="example-1726">
   <p><strong>Example #1 <span class="function"><strong>mysql_xdevapi\CollectionModify::limit()</strong></span> example</strong></p>
...
(
    ...
    [2] =&gt; Array
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/mysql_xdevapi/collectionmodify/limit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi-collectionmodify.limit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi-collectionmodify.limit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi-collectionmodify.limit.php">＋<small>add a note</small></a></span>
