...
<head>
  ...
  <title>PHP: ImagickDraw::pathMoveToAbsolute - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.pathmovetoabsolute.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.pathmovetoabsolute.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathmovetoabsolute.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathlinetoverticalrelative.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.pathmovetorelative.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.pathmovetoabsolute.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.pathmovetoabsolute.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.pathmovetoabsolute.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.pathmovetoabsolute.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.pathmovetoabsolute.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.pathmovetoabsolute.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.pathmovetoabsolute.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.pathmovetoabsolute.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.pathmovetoabsolute.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.pathmovetoabsolute.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.pathmovetoabsolute.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ImagickDraw::pathMoveToAbsolute - Manual" />
<meta name="twitter:description" content="Starts a new sub-path" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::pathMoveToAbsolute - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.pathmovetorelative.php">
          ImagickDraw::pathMoveToRelative &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.pathlinetoverticalrelative.php">
          &laquo; ImagickDraw::pathLineToVerticalRelative        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.pathmovetoabsolute.php' selected="selected">English</option>
            <option value='de/imagickdraw.pathmovetoabsolute.php'>German</option>
            <option value='es/imagickdraw.pathmovetoabsolute.php'>Spanish</option>
            <option value='fr/imagickdraw.pathmovetoabsolute.php'>French</option>
            <option value='it/imagickdraw.pathmovetoabsolute.php'>Italian</option>
            <option value='ja/imagickdraw.pathmovetoabsolute.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.pathmovetoabsolute.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.pathmovetoabsolute.php'>Russian</option>
            <option value='tr/imagickdraw.pathmovetoabsolute.php'>Turkish</option>
            <option value='uk/imagickdraw.pathmovetoabsolute.php'>Ukrainian</option>
            <option value='zh/imagickdraw.pathmovetoabsolute.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.pathmovetoabsolute" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::pathMoveToAbsolute</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::pathMoveToAbsolute</span> &mdash; <span class="dc-title">Starts a new sub-path</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.pathmovetoabsolute-description">
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.pathmovetoabsolute-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.pathmovetoabsolute-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/pathmovetoabsolute.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.pathmovetoabsolute%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.pathmovetoabsolute&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.pathmovetoabsolute.php">＋<small>add a note</small></a></span>
