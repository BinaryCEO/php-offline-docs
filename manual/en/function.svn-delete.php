...
<head>
  ...
  <title>PHP: svn_delete - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.svn-delete.php">
 <link rel="shorturl" href="https://www.php.net/svn-delete">
 <link rel="alternate" href="https://www.php.net/svn-delete" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.svn.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.svn-commit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.svn-diff.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.svn-delete.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.svn-delete.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.svn-delete.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.svn-delete.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.svn-delete.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.svn-delete.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.svn-delete.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.svn-delete.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.svn-delete.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.svn-delete.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.svn-delete.php" hreflang="zh">
...
<meta name="Description" content="Delete items from a working copy or repository" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: svn_delete - Manual" />
<meta name="twitter:description" content="Delete items from a working copy or repository" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: svn_delete - Manual" />
<meta itemprop="description" content="Delete items from a working copy or repository" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Delete items from a working copy or repository" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.svn-delete.php' selected="selected">English</option>
            <option value='de/function.svn-delete.php'>German</option>
            <option value='es/function.svn-delete.php'>Spanish</option>
            <option value='fr/function.svn-delete.php'>French</option>
            <option value='it/function.svn-delete.php'>Italian</option>
            <option value='ja/function.svn-delete.php'>Japanese</option>
            <option value='pt_BR/function.svn-delete.php'>Brazilian Portuguese</option>
            <option value='ru/function.svn-delete.php'>Russian</option>
            <option value='tr/function.svn-delete.php'>Turkish</option>
            <option value='uk/function.svn-delete.php'>Ukrainian</option>
            <option value='zh/function.svn-delete.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.svn-delete" class="refentry">
   ...
   <ul class="simplelist">
    ...
    delete</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/svn/functions/svn-delete.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.svn-delete%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.svn-delete&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.svn-delete.php">＋<small>add a note</small></a></span>
