...
<head>
  ...
  <title>PHP: imap_listscan - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-listscan.php">
 <link rel="shorturl" href="https://www.php.net/imap-listscan">
 <link rel="alternate" href="https://www.php.net/imap-listscan" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-listmailbox.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-listsubscribed.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-listscan.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-listscan.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-listscan.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-listscan.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-listscan.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-listscan.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-listscan.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-listscan.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-listscan.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-listscan.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-listscan.php" hreflang="zh">
...
<meta name="Description" content="Returns the list of mailboxes that matches the given text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_listscan - Manual" />
<meta name="twitter:description" content="Returns the list of mailboxes that matches the given text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_listscan - Manual" />
<meta itemprop="description" content="Returns the list of mailboxes that matches the given text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the list of mailboxes that matches the given text" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-listsubscribed.php">
          imap_listsubscribed &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-listmailbox.php">
          &laquo; imap_listmailbox        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-listscan.php' selected="selected">English</option>
            <option value='de/function.imap-listscan.php'>German</option>
            <option value='es/function.imap-listscan.php'>Spanish</option>
            <option value='fr/function.imap-listscan.php'>French</option>
            <option value='it/function.imap-listscan.php'>Italian</option>
            <option value='ja/function.imap-listscan.php'>Japanese</option>
            <option value='pt_BR/function.imap-listscan.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-listscan.php'>Russian</option>
            <option value='tr/function.imap-listscan.php'>Turkish</option>
            <option value='uk/function.imap-listscan.php'>Ukrainian</option>
            <option value='zh/function.imap-listscan.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-listscan" class="refentry">
...
mailboxes; &#039;<code class="literal">~/mail/%</code>&#039; on <code class="literal">UW_IMAPD</code> will return every mailbox in the <var class="filename">~/mail</var> directory, but none in subfolders of that directory.</p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-listscan-returnvalues">
  ...
  <p class="para">
   Returns an array containing the names of the mailboxes that have
   <code class="parameter">content</code> in the text of the mailbox,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.imap-listscan-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-listmailbox.php" class="function" rel="rdfs-seeAlso">imap_listmailbox()</a> - Alias of imap_list</span></li>
    <li><span class="function"><a href="function.imap-search.php" class="function" rel="rdfs-seeAlso">imap_search()</a> - This function returns an array of messages matching the given search criteria</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-listscan.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-listscan%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-listscan&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-listscan.php">＋<small>add a note</small></a></span>
