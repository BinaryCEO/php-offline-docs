...
<head>
  ...
  <title>PHP: imap_utf8 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-utf8.php">
 <link rel="shorturl" href="https://www.php.net/imap-utf8">
 <link rel="alternate" href="https://www.php.net/imap-utf8" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-utf7-encode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-utf8-to-mutf7.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-utf8.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-utf8.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-utf8.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-utf8.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-utf8.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-utf8.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-utf8.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-utf8.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-utf8.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-utf8.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-utf8.php" hreflang="zh">
...
<meta name="Description" content="Converts MIME-encoded text to UTF-8" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_utf8 - Manual" />
<meta name="twitter:description" content="Converts MIME-encoded text to UTF-8" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_utf8 - Manual" />
<meta itemprop="description" content="Converts MIME-encoded text to UTF-8" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Converts MIME-encoded text to UTF-8" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imap-utf8-to-mutf7.php">
          imap_utf8_to_mutf7 &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imap-utf7-encode.php">
          &laquo; imap_utf7_encode        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-utf8.php' selected="selected">English</option>
            <option value='de/function.imap-utf8.php'>German</option>
            <option value='es/function.imap-utf8.php'>Spanish</option>
            <option value='fr/function.imap-utf8.php'>French</option>
            <option value='it/function.imap-utf8.php'>Italian</option>
            <option value='ja/function.imap-utf8.php'>Japanese</option>
            <option value='pt_BR/function.imap-utf8.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-utf8.php'>Russian</option>
            <option value='tr/function.imap-utf8.php'>Turkish</option>
            <option value='uk/function.imap-utf8.php'>Ukrainian</option>
            <option value='zh/function.imap-utf8.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-utf8" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.imap-utf8-examples">
  ...
  <div class="example" id="imap-utf8.example.basic">
   <p><strong>Example #1 Basic <span class="function"><strong>imap_utf8()</strong></span> Usage</strong></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.imap-mime-header-decode.php" class="function" rel="rdfs-seeAlso">imap_mime_header_decode()</a> - Decode MIME header elements</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-utf8.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-utf8%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-utf8&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-utf8.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102081">  <div class="votes">
    <div id="Vu102081">
    <a href="/manual/vote-note.php?id=102081&amp;page=function.imap-utf8&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102081">
    <a href="/manual/vote-note.php?id=102081&amp;page=function.imap-utf8&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102081" title="61% like this...">
    8
    </div>
  </div>
  <a href="#102081" class="name">
  <strong class="user"><em>esvit at mail dot ru</em></strong></a><a class="genanchor" href="#102081"> &para;</a><div class="date" title="2011-01-26 05:12"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102081">
<div class="phpcode"><code><span class="html">That fixed the all caps issue:
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="106186">  <div class="votes">
    <div id="Vu106186">
    <a href="/manual/vote-note.php?id=106186&amp;page=function.imap-utf8&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd106186">
    <a href="/manual/vote-note.php?id=106186&amp;page=function.imap-utf8&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V106186" title="58% like this...">
    5
    </div>
  </div>
  <a href="#106186" class="name">
  <strong class="user"><em>kloewer at gmail dot com</em></strong></a><a class="genanchor" href="#106186"> &para;</a><div class="date" title="2011-10-17 03:08"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom106186">
<div class="phpcode"><code><span class="html">Use  iconv_mime_decode();<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// This yields "Subject: Prüfung Prüfung"<br /></span><span class="keyword">echo </span><span class="default">iconv_mime_decode</span><span class="keyword">(</span><span class="string">"Subject: =?UTF-8?B?UHLDvGZ1bmcgUHLDvGZ1bmc=?="</span><span class="keyword">,<br />                       </span><span class="default">0</span><span class="keyword">, </span><span class="string">"ISO-8859-1"</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br /><a href="http://php.net/manual/de/function.iconv-mime-decode.php" rel="nofollow" target="_blank">http://php.net/manual/de/function.iconv-mime-decode.php</a></span></code></div>
  </div>
 </div>
  <div class="note" id="49987">  <div class="votes">
    <div id="Vu49987">
    <a href="/manual/vote-note.php?id=49987&amp;page=function.imap-utf8&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd49987">
    <a href="/manual/vote-note.php?id=49987&amp;page=function.imap-utf8&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V49987" title="60% like this...">
    2
    </div>
  </div>
  <a href="#49987" class="name">
  <strong class="user"><em>marcelo at maccoy dot com dot br</em></strong></a><a class="genanchor" href="#49987"> &para;</a><div class="date" title="2005-02-14 12:01"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom49987">
<div class="phpcode"><code><span class="html"># this script are correct with the right signs remove expression<br /># please, ignore the later.<br />function decode_utf8($str){<br />       # paterns<br />           $err="(=\?.{10,13}q\?_?|\?\=)";<br />           $pat = "/=([0-9A-F]{2})/"; <br />           $cha="'.chr(hexdec(";<br />       # erase null signs in string<br />          $str=eregi_replace($err,"",$str);<br />       # to decode with eval and replace<br />          eval("\$str='".<br />                  preg_replace($pat,$cha."'$1')).'",$str)<br />                  ."';");<br />        # return<br />           return $str;<br />} <br />#Note: you can to reduce this script in 3 lines.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-utf8&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-utf8.php">＋<small>add a note</small></a></div>
