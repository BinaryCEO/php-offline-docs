...
<head>
  ...
  <title>PHP: imagesetbrush - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imagesetbrush.php">
 <link rel="shorturl" href="https://www.php.net/imagesetbrush">
 <link rel="alternate" href="https://www.php.net/imagesetbrush" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.image.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imagescale.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imagesetclip.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imagesetbrush.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imagesetbrush.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imagesetbrush.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imagesetbrush.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imagesetbrush.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imagesetbrush.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imagesetbrush.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imagesetbrush.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imagesetbrush.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imagesetbrush.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imagesetbrush.php" hreflang="zh">
...
<meta name="Description" content="Set the brush image for line drawing" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imagesetbrush - Manual" />
<meta name="twitter:description" content="Set the brush image for line drawing" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imagesetbrush - Manual" />
<meta itemprop="description" content="Set the brush image for line drawing" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the brush image for line drawing" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.imagesetclip.php">
          imagesetclip &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.imagescale.php">
          &laquo; imagescale        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imagesetbrush.php' selected="selected">English</option>
            <option value='de/function.imagesetbrush.php'>German</option>
            <option value='es/function.imagesetbrush.php'>Spanish</option>
            <option value='fr/function.imagesetbrush.php'>French</option>
            <option value='it/function.imagesetbrush.php'>Italian</option>
            <option value='ja/function.imagesetbrush.php'>Japanese</option>
            <option value='pt_BR/function.imagesetbrush.php'>Brazilian Portuguese</option>
            <option value='ru/function.imagesetbrush.php'>Russian</option>
            <option value='tr/function.imagesetbrush.php'>Turkish</option>
            <option value='uk/function.imagesetbrush.php'>Ukrainian</option>
            <option value='zh/function.imagesetbrush.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imagesetbrush" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">imagesetbrush</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">imagesetbrush</span> &mdash; <span class="dc-title">Set the brush image for line drawing</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.imagesetbrush-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>imagesetbrush</strong></span>(<span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$image</code></span>, <span class="methodparam"><span class="type"><a href="class.gdimage.php" class="type GdImage">GdImage</a></span> <code class="parameter">$brush</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>imagesetbrush()</strong></span> sets the brush image to be
   used by all line drawing functions (such as <span class="function"><a href="function.imageline.php" class="function">imageline()</a></span>
   ...
   colors <strong><code><a href="image.constants.php#constant.img-color-brushed">IMG_COLOR_BRUSHED</a></code></strong> or
  ...
  <div class="caution"><strong class="caution">Caution</strong>
   <p class="para">
    ...
    <strong><code><a href="image.constants.php#constant.img-color-brushed">IMG_COLOR_BRUSHED</a></code></strong> or
    <strong><code><a href="image.constants.php#constant.img-color-styledbrushed">IMG_COLOR_STYLEDBRUSHED</a></code></strong> colors until you have set a
    new brush image!
   </p>
  </div>
 </div>
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>
       <code class="parameter">image</code> and <code class="parameter">brush</code> expect
 ...
 <div class="refsect1 examples" id="refsect1-function.imagesetbrush-examples">
  ...
  <p class="para">
   <div class="example" id="example-2929">
    <p><strong>Example #1 <span class="function"><strong>imagesetbrush()</strong></span> example</strong></p>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/21009b70229598c6a80eef8b45bf282b-imagesetbrush.png" alt="Output of example : imagesetbrush()" width="100" height="100" />
     </div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/image/functions/imagesetbrush.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imagesetbrush%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imagesetbrush&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagesetbrush.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="68524">  <div class="votes">
    <div id="Vu68524">
    <a href="/manual/vote-note.php?id=68524&amp;page=function.imagesetbrush&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd68524">
    <a href="/manual/vote-note.php?id=68524&amp;page=function.imagesetbrush&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V68524" title="50% like this...">
    0
    </div>
  </div>
  <a href="#68524" class="name">
  <strong class="user"><em>brent at ebrent dot net</em></strong></a><a class="genanchor" href="#68524"> &para;</a><div class="date" title="2006-07-31 10:54"><strong>19 years ago</strong></div>
  <div class="text" id="Hcom68524">
<div class="phpcode"><code><span class="html">Use a brush to create a thick line.<br /><br />To create a 3x3 red brush:<br /><br /><span class="default">&lt;?php<br />$brush_size </span><span class="keyword">= </span><span class="default">3</span><span class="keyword">;<br /></span><span class="default">$brush </span><span class="keyword">= </span><span class="default">imagecreatetruecolor</span><span class="keyword">(</span><span class="default">$brush_size</span><span class="keyword">,</span><span class="default">$brush_size</span><span class="keyword">);<br /></span><span class="default">$brush_color </span><span class="keyword">= </span><span class="default">imagecolorallocate</span><span class="keyword">(</span><span class="default">$brush</span><span class="keyword">,</span><span class="default">255</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">);<br /></span><span class="default">imagefill</span><span class="keyword">(</span><span class="default">$brush</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">$brush_color</span><span class="keyword">);<br /></span><span class="default">imagesetbrush</span><span class="keyword">(</span><span class="default">$im</span><span class="keyword">,</span><span class="default">$brush</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />Then use imageline() or imagepolygon() with IMG_COLOR_BRUSHED as the color.<br /><br />To stop using the brush, destroy it:<br /><br /><span class="default">&lt;?php imagedestroy</span><span class="keyword">(</span><span class="default">$brush</span><span class="keyword">); </span><span class="default">?&gt;<br /></span><br />The brush can also be created from an existing image.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imagesetbrush&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imagesetbrush.php">＋<small>add a note</small></a></div>
