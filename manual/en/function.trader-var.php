...
<head>
  ...
  <title>PHP: trader_var - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.trader-var.php">
 <link rel="shorturl" href="https://www.php.net/trader-var">
 <link rel="alternate" href="https://www.php.net/trader-var" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.trader.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.trader-ultosc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.trader-wclprice.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.trader-var.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.trader-var.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.trader-var.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.trader-var.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.trader-var.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.trader-var.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.trader-var.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.trader-var.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.trader-var.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.trader-var.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.trader-var.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: trader_var - Manual" />
<meta name="twitter:description" content="Variance" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: trader_var - Manual" />
<meta itemprop="description" content="Variance" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Variance" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.trader-wclprice.php">
          trader_wclprice &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.trader-ultosc.php">
          &laquo; trader_ultosc        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.trader-var.php' selected="selected">English</option>
            <option value='de/function.trader-var.php'>German</option>
            <option value='es/function.trader-var.php'>Spanish</option>
            <option value='fr/function.trader-var.php'>French</option>
            <option value='it/function.trader-var.php'>Italian</option>
            <option value='ja/function.trader-var.php'>Japanese</option>
            <option value='pt_BR/function.trader-var.php'>Brazilian Portuguese</option>
            <option value='ru/function.trader-var.php'>Russian</option>
            <option value='tr/function.trader-var.php'>Turkish</option>
            <option value='uk/function.trader-var.php'>Ukrainian</option>
            <option value='zh/function.trader-var.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.trader-var" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">trader_var</h1>
  <p class="verinfo">(PECL trader &gt;= 0.2.0)</p><p class="refpurpose"><span class="refname">trader_var</span> &mdash; <span class="dc-title">Variance</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.trader-var-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>trader_var</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$real</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$timePeriod</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$nbDev</code><span class="initializer"> = ?</span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.trader-var-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.trader-var-returnvalues">
  ...
  <p class="para">Returns an array with calculated data or false on failure.</p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/trader/functions/trader-var.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.trader-var%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.trader-var&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.trader-var.php">＋<small>add a note</small></a></span>
