...
<head>
  ...
  <title>PHP: About manual examples - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/appendices.php">
 <link rel="prev" href="https://www.php.net/manual/en/history.php.publications.php">
 <link rel="next" href="https://www.php.net/manual/en/migration84.php">

 <link rel="alternate" href="https://www.php.net/manual/en/examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/examples.php" hreflang="zh">
...
<meta name="Description" content="About manual examples" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: About manual examples - Manual" />
<meta name="twitter:description" content="About manual examples" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: About manual examples - Manual" />
<meta itemprop="description" content="About manual examples" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="About manual examples" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="migration84.php">
          Migrating from PHP 8.3.x to PHP 8.4.x &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="history.php.publications.php">
          &laquo; Publications about PHP        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/examples.php' selected="selected">English</option>
            <option value='de/examples.php'>German</option>
            <option value='es/examples.php'>Spanish</option>
            <option value='fr/examples.php'>French</option>
            <option value='it/examples.php'>Italian</option>
            <option value='ja/examples.php'>Japanese</option>
            <option value='pt_BR/examples.php'>Brazilian Portuguese</option>
            <option value='ru/examples.php'>Russian</option>
            <option value='tr/examples.php'>Turkish</option>
            <option value='uk/examples.php'>Ukrainian</option>
            <option value='zh/examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="examples" class="appendix">
  ...
  by the extension.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/appendices/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fexamples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/examples.php">＋<small>add a note</small></a></span>
