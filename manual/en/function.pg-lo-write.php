...
<head>
  ...
  <title>PHP: pg_lo_write - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-lo-write.php">
 <link rel="shorturl" href="https://www.php.net/pg-lo-write">
 <link rel="alternate" href="https://www.php.net/pg-lo-write" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-lo-unlink.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-meta-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-lo-write.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-lo-write.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-lo-write.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-lo-write.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-lo-write.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-lo-write.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-lo-write.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-lo-write.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-lo-write.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-lo-write.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-lo-write.php" hreflang="zh">
...
<meta name="Description" content="Write to a large object" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_lo_write - Manual" />
<meta name="twitter:description" content="Write to a large object" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_lo_write - Manual" />
<meta itemprop="description" content="Write to a large object" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Write to a large object" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-meta-data.php">
          pg_meta_data &raquo;
              ...
              <div class="prev">
        <a href="function.pg-lo-unlink.php">
          &laquo; pg_lo_unlink        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-lo-write.php' selected="selected">English</option>
            <option value='de/function.pg-lo-write.php'>German</option>
            <option value='es/function.pg-lo-write.php'>Spanish</option>
            <option value='fr/function.pg-lo-write.php'>French</option>
            <option value='it/function.pg-lo-write.php'>Italian</option>
            <option value='ja/function.pg-lo-write.php'>Japanese</option>
            <option value='pt_BR/function.pg-lo-write.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-lo-write.php'>Russian</option>
            <option value='tr/function.pg-lo-write.php'>Turkish</option>
            <option value='uk/function.pg-lo-write.php'>Ukrainian</option>
            <option value='zh/function.pg-lo-write.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-lo-write" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-lo-open.php" class="function" rel="rdfs-seeAlso">pg_lo_open()</a> - Open a large object</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-lo-write.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-lo-write%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-lo-write&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-write.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="12663">  <div class="votes">
    <div id="Vu12663">
    <a href="/manual/vote-note.php?id=12663&amp;page=function.pg-lo-write&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd12663">
    <a href="/manual/vote-note.php?id=12663&amp;page=function.pg-lo-write&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V12663" title="50% like this...">
    0
    </div>
  </div>
  <a href="#12663" class="name">
  <strong class="user"><em>cedric at isoca.com</em></strong></a><a class="genanchor" href="#12663"> &para;</a><div class="date" title="2001-04-27 05:26"><strong>24 years ago</strong></div>
  <div class="text" id="Hcom12663">
<div class="phpcode"><code><span class="html">Be aware when you modify a lo with pg_lowrite() to remove first the old one : if the new lo is smaller than the one before, it only overwrite the begining and you keep the end of the old lo (open with "w" parameter, PHP 4.04 Linux RH).</span></code></div>
  </div>
 </div>
  <div class="note" id="32732">  <div class="votes">
    <div id="Vu32732">
    <a href="/manual/vote-note.php?id=32732&amp;page=function.pg-lo-write&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd32732">
    <a href="/manual/vote-note.php?id=32732&amp;page=function.pg-lo-write&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V32732" title="0% like this...">
    -1
    </div>
  </div>
  <a href="#32732" class="name">
  <strong class="user"><em>nandrews at logictree dot co dot uk</em></strong></a><a class="genanchor" href="#32732"> &para;</a><div class="date" title="2003-06-05 08:17"><strong>22 years ago</strong></div>
  <div class="text" id="Hcom32732">
<div class="phpcode"><code><span class="html">Using php 4.3.0 and PostgreSQL 7.3.1<br /><br />I can write a simple script in which pg_lo_write seems to always return 1 and not the number of bytes written, as evidenced by extracting the data through another means.<br /><br />Further more, I can make this pg_lo_write fail, or at least fail to write all the data it's pretty difficult to tell without the number of bytes written being returned, and not return the false value. In addition to this, the lo resource has been adjusted so that the oid it contains is 0.<br /><br />Unfortunately, I do not know what exactly the failure mode is, it does seem to be in the ip network communication side of PostgreSQL, which is odd since the unix domain comms works fine for this. However, it would have been useful to have the pg_lo_write() function return as advertised, it would have saved some of the 2 man hours me and the dev. team put into diagnosing this problem.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-lo-write&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-lo-write.php">＋<small>add a note</small></a></div>
