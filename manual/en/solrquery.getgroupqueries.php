...
<head>
  ...
  <title>PHP: SolrQuery::getGroupQueries - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupqueries.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupqueries.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupqueries.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupoffset.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgroupsortfields.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupqueries.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgroupqueries.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgroupqueries.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgroupqueries.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgroupqueries.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgroupqueries.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgroupqueries.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgroupqueries.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgroupqueries.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgroupqueries.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgroupqueries.php" hreflang="zh">
...
<meta name="Description" content="Returns all the group.query parameter values" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupQueries - Manual" />
<meta name="twitter:description" content="Returns all the group.query parameter values" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupQueries - Manual" />
<meta itemprop="description" content="Returns all the group.query parameter values" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns all the group.query parameter values" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.getgroupsortfields.php">
          SolrQuery::getGroupSortFields &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroupoffset.php">
          &laquo; SolrQuery::getGroupOffset        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupqueries.php' selected="selected">English</option>
            <option value='de/solrquery.getgroupqueries.php'>German</option>
            <option value='es/solrquery.getgroupqueries.php'>Spanish</option>
            <option value='fr/solrquery.getgroupqueries.php'>French</option>
            <option value='it/solrquery.getgroupqueries.php'>Italian</option>
            <option value='ja/solrquery.getgroupqueries.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgroupqueries.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgroupqueries.php'>Russian</option>
            <option value='tr/solrquery.getgroupqueries.php'>Turkish</option>
            <option value='uk/solrquery.getgroupqueries.php'>Ukrainian</option>
            <option value='zh/solrquery.getgroupqueries.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgroupqueries" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupQueries</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupQueries</span> &mdash; <span class="dc-title">Returns all the group.query parameter values</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgroupqueries-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupQueries</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgroupqueries-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgroupqueries-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgroupqueries-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.addgroupquery.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::addGroupQuery()</a> - Allows grouping of documents that match the given query</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupqueries.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupqueries%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupqueries&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupqueries.php">＋<small>add a note</small></a></span>
