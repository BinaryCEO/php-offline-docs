...
<head>
  ...
  <title>PHP: Imagick::appendImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.appendimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.appendimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.appendimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.annotateimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.autolevelimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.appendimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.appendimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.appendimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.appendimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.appendimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.appendimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.appendimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.appendimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.appendimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.appendimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.appendimages.php" hreflang="zh">
...
<meta name="Description" content="Append a set of images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::appendImages - Manual" />
<meta name="twitter:description" content="Append a set of images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::appendImages - Manual" />
<meta itemprop="description" content="Append a set of images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Append a set of images" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.autolevelimage.php">
          Imagick::autoLevelImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.annotateimage.php">
          &laquo; Imagick::annotateImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.appendimages.php' selected="selected">English</option>
            <option value='de/imagick.appendimages.php'>German</option>
            <option value='es/imagick.appendimages.php'>Spanish</option>
            <option value='fr/imagick.appendimages.php'>French</option>
            <option value='it/imagick.appendimages.php'>Italian</option>
            <option value='ja/imagick.appendimages.php'>Japanese</option>
            <option value='pt_BR/imagick.appendimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.appendimages.php'>Russian</option>
            <option value='tr/imagick.appendimages.php'>Turkish</option>
            <option value='uk/imagick.appendimages.php'>Ukrainian</option>
            <option value='zh/imagick.appendimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.appendimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::appendImages</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::appendImages</span> &mdash; <span class="dc-title">Append a set of images</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.appendimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::appendImages</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$stack</code></span>): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.appendimages-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">stack</code></dt>
     <dd>
      <p class="para">
       Whether to stack the images vertically.
       By default (or if <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> is specified) images are stacked left-to-right.
       If <code class="parameter">stack</code> is <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>, images are stacked top-to-bottom.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.appendimages-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.appendimages-errors">
 ...
 <div class="refsect1 examples" id="refsect1-imagick.appendimages-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2969">
    <p><strong>Example #1 <span class="methodname"><strong>Imagick::appendImages()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">/* Create new imagick object */<br /></span><span style="color: #0000BB">$im </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">();<br /><br /></span><span style="color: #FF8000">/* create red, green and blue images */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #DD0000">"red"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #DD0000">"green"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">newImage</span><span style="color: #007700">(</span><span style="color: #0000BB">100</span><span style="color: #007700">, </span><span style="color: #0000BB">50</span><span style="color: #007700">, </span><span style="color: #DD0000">"blue"</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Append the images into one */<br /></span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">resetIterator</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$combined </span><span style="color: #007700">= </span><span style="color: #0000BB">$im</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">appendImages</span><span style="color: #007700">(</span><span style="color: #0000BB">true</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Output the image */<br /></span><span style="color: #0000BB">$combined</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">setImageFormat</span><span style="color: #007700">(</span><span style="color: #DD0000">"png"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">"Content-Type: image/png"</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$combined</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
...
something similar to:</p></div>
    <div class="mediaobject">
     ...
     <div class="imageobject">
      <img src="images/c0d23d2d6769e53e24a1b3136c064577-floodfillpaint_intermediate.png" alt="Output of example : Imagick::appendImages()" width="100" height="150" />
     </div>
    </div>
   </div>
  </p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/appendimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.appendimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.appendimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.appendimages.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="94568">  <div class="votes">
    <div id="Vu94568">
    <a href="/manual/vote-note.php?id=94568&amp;page=imagick.appendimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd94568">
    <a href="/manual/vote-note.php?id=94568&amp;page=imagick.appendimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V94568" title="78% like this...">
    13
    </div>
  </div>
  <a href="#94568" class="name">
  <strong class="user"><em>Brandon</em></strong></a><a class="genanchor" href="#94568"> &para;</a><div class="date" title="2009-11-12 12:56"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom94568">
<div class="phpcode"><code><span class="html"># How to combine a multi-page pdf file into a single long image:
<br />
...
<br /></span><span class="default">?&gt;</span></span></code></div>
  ...
  <div class="note" id="115823">  <div class="votes">
    <div id="Vu115823">
    <a href="/manual/vote-note.php?id=115823&amp;page=imagick.appendimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd115823">
    <a href="/manual/vote-note.php?id=115823&amp;page=imagick.appendimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V115823" title="50% like this...">
    0
    </div>
  </div>
  <a href="#115823" class="name">
  <strong class="user"><em>adao at adao dot eti dot br</em></strong></a><a class="genanchor" href="#115823"> &para;</a><div class="date" title="2014-09-30 12:59"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom115823">
<div class="phpcode"><code><span class="html"># change $ima to $ima-&gt;getimagesblob()<br /><br /><span class="default">&lt;?php<br />$im1 </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();  <br /></span><span class="default">$im1</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="string">'multi-page-pdf.pdf'</span><span class="keyword">);<br /></span><span class="default">$im1</span><span class="keyword">-&gt;</span><span class="default">resetIterator</span><span class="keyword">();<br /></span><span class="comment"># Combine multiple images into one, stacked vertically.<br /></span><span class="default">$ima </span><span class="keyword">= </span><span class="default">$im1</span><span class="keyword">-&gt;</span><span class="default">appendImages</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">$ima</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">(</span><span class="string">"png"</span><span class="keyword">);<br /></span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">);<br />echo </span><span class="default">$ima</span><span class="keyword">-&gt;</span><span class="default">getimagesblob</span><span class="keyword">();<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="114635">  <div class="votes">
    <div id="Vu114635">
    <a href="/manual/vote-note.php?id=114635&amp;page=imagick.appendimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114635">
    <a href="/manual/vote-note.php?id=114635&amp;page=imagick.appendimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114635" title="33% like this...">
    -2
    </div>
  </div>
  <a href="#114635" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#114635"> &para;</a><div class="date" title="2014-03-14 05:08"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114635">
<div class="phpcode"><code><span class="html">Sometimes when running this code on a long running apache24 instance on a server with minimal memory the final "echo $ima;" returns an empty string.<br /><br />Doing an "apache graceful" seems to clear this up.  There appears to be no other way to correct OR DETECT this problem. Suckky.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.appendimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.appendimages.php">＋<small>add a note</small></a></div>
