...
<head>
  ...
  <title>PHP: Imagick::waveImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.waveimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.waveimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.waveimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.vignetteimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.whitethresholdimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.waveimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.waveimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.waveimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.waveimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.waveimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.waveimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.waveimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.waveimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.waveimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.waveimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.waveimage.php" hreflang="zh">
...
<meta name="Description" content="Applies wave filter to the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::waveImage - Manual" />
<meta name="twitter:description" content="Applies wave filter to the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::waveImage - Manual" />
<meta itemprop="description" content="Applies wave filter to the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Applies wave filter to the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.whitethresholdimage.php">
          Imagick::whiteThresholdImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.vignetteimage.php">
          &laquo; Imagick::vignetteImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.waveimage.php' selected="selected">English</option>
            <option value='de/imagick.waveimage.php'>German</option>
            <option value='es/imagick.waveimage.php'>Spanish</option>
            <option value='fr/imagick.waveimage.php'>French</option>
            <option value='it/imagick.waveimage.php'>Italian</option>
            <option value='ja/imagick.waveimage.php'>Japanese</option>
            <option value='pt_BR/imagick.waveimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.waveimage.php'>Russian</option>
            <option value='tr/imagick.waveimage.php'>Turkish</option>
            <option value='uk/imagick.waveimage.php'>Ukrainian</option>
            <option value='zh/imagick.waveimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.waveimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::waveImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::waveImage</span> &mdash; <span class="dc-title">Applies wave filter to the image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.waveimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::waveImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$amplitude</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$length</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.waveimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">amplitude</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.waveimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.waveimage-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.waveimage-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.solarizeimage.php" class="function" rel="rdfs-seeAlso">Imagick::solarizeImage()</a> - Applies a solarizing effect to the image</span></li>
    <li><span class="function"><a href="imagick.oilpaintimage.php" class="function" rel="rdfs-seeAlso">Imagick::oilpaintImage()</a> - Simulates an oil painting</span></li>
    <li><span class="function"><a href="imagick.embossimage.php" class="function" rel="rdfs-seeAlso">Imagick::embossImage()</a> - Returns a grayscale image with a three-dimensional effect</span></li>
    <li><span class="function"><a href="imagick.addnoiseimage.php" class="function" rel="rdfs-seeAlso">Imagick::addNoiseImage()</a> - Adds random noise to the image</span></li>
    <li><span class="function"><a href="imagick.swirlimage.php" class="function" rel="rdfs-seeAlso">Imagick::swirlImage()</a> - Swirls the pixels about the center of the image</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/waveimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.waveimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.waveimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.waveimage.php">＋<small>add a note</small></a></span>
