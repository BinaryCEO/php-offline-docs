...
<head>
  ...
  <title>PHP: ImagickDraw::getStrokeOpacity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.getstrokeopacity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.getstrokeopacity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokeopacity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.getstrokemiterlimit.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.getstrokewidth.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.getstrokeopacity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.getstrokeopacity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.getstrokeopacity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.getstrokeopacity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.getstrokeopacity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.getstrokeopacity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.getstrokeopacity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.getstrokeopacity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.getstrokeopacity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.getstrokeopacity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.getstrokeopacity.php" hreflang="zh">
...
<meta name="Description" content="Returns the opacity of stroked object outlines" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::getStrokeOpacity - Manual" />
<meta name="twitter:description" content="Returns the opacity of stroked object outlines" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::getStrokeOpacity - Manual" />
<meta itemprop="description" content="Returns the opacity of stroked object outlines" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the opacity of stroked object outlines" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.getstrokewidth.php">
          ImagickDraw::getStrokeWidth &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.getstrokemiterlimit.php">
          &laquo; ImagickDraw::getStrokeMiterLimit        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.getstrokeopacity.php' selected="selected">English</option>
            <option value='de/imagickdraw.getstrokeopacity.php'>German</option>
            <option value='es/imagickdraw.getstrokeopacity.php'>Spanish</option>
            <option value='fr/imagickdraw.getstrokeopacity.php'>French</option>
            <option value='it/imagickdraw.getstrokeopacity.php'>Italian</option>
            <option value='ja/imagickdraw.getstrokeopacity.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.getstrokeopacity.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.getstrokeopacity.php'>Russian</option>
            <option value='tr/imagickdraw.getstrokeopacity.php'>Turkish</option>
            <option value='uk/imagickdraw.getstrokeopacity.php'>Ukrainian</option>
            <option value='zh/imagickdraw.getstrokeopacity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.getstrokeopacity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::getStrokeOpacity</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::getStrokeOpacity</span> &mdash; <span class="dc-title">Returns the opacity of stroked object outlines</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.getstrokeopacity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::getStrokeOpacity</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.getstrokeopacity-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns a <span class="type"><a href="language.types.float.php" class="type float">float</a></span> describing the opacity.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/getstrokeopacity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.getstrokeopacity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.getstrokeopacity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.getstrokeopacity.php">＋<small>add a note</small></a></span>
