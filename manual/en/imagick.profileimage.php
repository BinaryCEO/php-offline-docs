...
<head>
  ...
  <title>PHP: Imagick::profileImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.profileimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.profileimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.profileimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.previousimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.quantizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.profileimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.profileimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.profileimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.profileimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.profileimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.profileimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.profileimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.profileimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.profileimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.profileimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.profileimage.php" hreflang="zh">
...
<meta name="Description" content="Adds or removes a profile from an image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::profileImage - Manual" />
<meta name="twitter:description" content="Adds or removes a profile from an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::profileImage - Manual" />
<meta itemprop="description" content="Adds or removes a profile from an image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adds or removes a profile from an image" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.quantizeimage.php">
          Imagick::quantizeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.previousimage.php">
          &laquo; Imagick::previousImage        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.profileimage.php' selected="selected">English</option>
            <option value='de/imagick.profileimage.php'>German</option>
            <option value='es/imagick.profileimage.php'>Spanish</option>
            <option value='fr/imagick.profileimage.php'>French</option>
            <option value='it/imagick.profileimage.php'>Italian</option>
            <option value='ja/imagick.profileimage.php'>Japanese</option>
            <option value='pt_BR/imagick.profileimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.profileimage.php'>Russian</option>
            <option value='tr/imagick.profileimage.php'>Turkish</option>
            <option value='uk/imagick.profileimage.php'>Ukrainian</option>
            <option value='zh/imagick.profileimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.profileimage" class="refentry">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/profileimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.profileimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.profileimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.profileimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114781">  <div class="votes">
    <div id="Vu114781">
    <a href="/manual/vote-note.php?id=114781&amp;page=imagick.profileimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114781">
    <a href="/manual/vote-note.php?id=114781&amp;page=imagick.profileimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114781" title="81% like this...">
    7
    </div>
  </div>
  <a href="#114781" class="name">
  <strong class="user"><em>dadima, gmail</em></strong></a><a class="genanchor" href="#114781"> &para;</a><div class="date" title="2014-04-05 08:07"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114781">
<div class="phpcode"><code><span class="html">If profileImage() seems to be doing nothing — and "inverted colors" during a CMYK &gt; RGB conversion is a sign of this — check that ImageMagick has the lcms delegate available.<br />From a command prompt:<br />convert -list configure | grep DELEGATES<br /><br />If you don't see lcms in the list then Imagick won't do any color profile conversions, and won't give any warnings about this.  In that case, install the Little CMS library ( <a href="http://www.littlecms.com/" rel="nofollow" target="_blank">http://www.littlecms.com/</a> ) and recompile ImageMagick.</span></code></div>
  </div>
 </div>
  <div class="note" id="82852">  <div class="votes">
    <div id="Vu82852">
    <a href="/manual/vote-note.php?id=82852&amp;page=imagick.profileimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd82852">
    <a href="/manual/vote-note.php?id=82852&amp;page=imagick.profileimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V82852" title="66% like this...">
    8
    </div>
  </div>
  <a href="#82852" class="name">
  <strong class="user"><em>Eero Niemi (eero at eero dot info)</em></strong></a><a class="genanchor" href="#82852"> &para;</a><div class="date" title="2008-04-29 07:01"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom82852">
<div class="phpcode"><code><span class="html">If you need to convert images that are on CMYK format into RGB and want to preserve colour information, this may be helpful:<br /><br /><span class="default">&lt;?php<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"CMYK_image.jpg"</span><span class="keyword">); </span><span class="comment">// load image<br /></span><span class="default">$profiles </span><span class="keyword">= </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">getImageProfiles</span><span class="keyword">(</span><span class="string">'*'</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">); </span><span class="comment">// get profiles<br /></span><span class="default">$has_icc_profile </span><span class="keyword">= (</span><span class="default">array_search</span><span class="keyword">(</span><span class="string">'icc'</span><span class="keyword">, </span><span class="default">$profiles</span><span class="keyword">) !== </span><span class="default">false</span><span class="keyword">); </span><span class="comment">// we're interested if ICC profile(s) exist<br /><br /></span><span class="keyword">if (</span><span class="default">$has_icc_profile </span><span class="keyword">=== </span><span class="default">false</span><span class="keyword">)<br />{<br />  </span><span class="comment">// image does not have CMYK ICC profile, we add one<br />  </span><span class="default">$icc_cmyk </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">'/path/to/icc/SomeCMYKProfile.icc'</span><span class="keyword">);<br />  </span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">profileImage</span><span class="keyword">(</span><span class="string">'icc'</span><span class="keyword">, </span><span class="default">$icc_cmyk</span><span class="keyword">);<br />}<br /><br /></span><span class="comment">// Then we need to add RGB profile<br /></span><span class="default">$icc_rgb </span><span class="keyword">= </span><span class="default">file_get_contents</span><span class="keyword">(</span><span class="string">'/path/to/icc/SomeRGBProfile.icc'</span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">profileImage</span><span class="keyword">(</span><span class="string">'icc'</span><span class="keyword">, </span><span class="default">$icc_rgb</span><span class="keyword">);<br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageColorSpace</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">COLORSPACE_RGB</span><span class="keyword">);<br /><br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">"RGB_image.jpg"</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;<br /></span><br />There may be better and more elegant ways to do this, but hope this helped.</span></code></div>
  </div>
 </div>
  <div class="note" id="130495">  <div class="votes">
    <div id="Vu130495">
    <a href="/manual/vote-note.php?id=130495&amp;page=imagick.profileimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd130495">
    <a href="/manual/vote-note.php?id=130495&amp;page=imagick.profileimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V130495" title="no votes...">
    0
    </div>
  </div>
  <a href="#130495" class="name">
  <strong class="user"><em>aschmidt at anamera dot net</em></strong></a><a class="genanchor" href="#130495"> &para;</a><div class="date" title="2025-09-27 02:52"><strong>3 days ago</strong></div>
  <div class="text" id="Hcom130495">
<div class="phpcode"><code><span class="html">Instantiating an image files, and attempting to save them in PNG format using setImageFormat('PNG'), I occasionally encountered<br />"gd-png: libpng warning: iCCP: profile 'icc': 'CMYK': invalid ICC profile color space".<br /><br />However, transformimagecolorspace( \Imagick::COLORSPACE_SRGB ) had not effect, because getImageColorspace() did not indicate COLORSPACE_CMYK.<br /><br />Instead, one has to check for the presence of any ICC profile,  inspect the ICC profile header (offset 16) for the "CMYK" color space tag, and then remove the ICC profile:<br /><br />$ICC_count = remove_ICC( $image, 'CMYK');<br /><br />function remove_ICC( \Imagick $image, ?string $colorspace ): int<br />{<br />    $icc_count = 0;<br />    <br />    foreach ( $image-&gt;getImageProfiles( 'icc' ) as $name =&gt; $profile ) {<br />        if ( empty( $colorspace ) or 0 === strcasecmp( $colorspace, substr( $profile, 16, 4 ) ) )<br />            // Either consider all ICC profiles, or just those matching the color space.<br />            $icc_count++;<br />    }<br />    <br />    if ( $icc_count &gt; 0 )<br />        $image-&gt;profileImage( 'icc', null );        // Delete any ICC profiles.<br />        <br />        return $icc_count;<br />}</span></code></div>
  </div>
 </div>
  <div class="note" id="92164">  <div class="votes">
    <div id="Vu92164">
    <a href="/manual/vote-note.php?id=92164&amp;page=imagick.profileimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92164">
    <a href="/manual/vote-note.php?id=92164&amp;page=imagick.profileimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92164" title="50% like this...">
    0
    </div>
  </div>
  <a href="#92164" class="name">
  <strong class="user"><em>gavin at softyolk dot com</em></strong></a><a class="genanchor" href="#92164"> &para;</a><div class="date" title="2009-07-12 04:28"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92164">
<div class="phpcode"><code><span class="html">Thanks for this very valuable information. 
<br />For a further push in the correct direction please 
<br />consider that you have to download the profiles, 
<br />
<br />and your most likely sources are:
<br />
<br /><a href="http://www.color.org/srgbprofiles.xalter" rel="nofollow" target="_blank">http://www.color.org/srgbprofiles.xalter</a>
<br />
<br />and
<br />
<br /><a href="http://www.adobe.com/support/downloads/product.jsp?product=62&amp;platform=Windows" rel="nofollow" target="_blank">http://www.adobe.com/support/downloads/product.jsp?product=62&amp;platform=Windows</a>
<br />
<br />Note that the profiles are free, but you must install them 
<br />to make them available on you host system.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.profileimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.profileimage.php">＋<small>add a note</small></a></div>
