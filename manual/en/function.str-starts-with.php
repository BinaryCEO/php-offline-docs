...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.str-starts-with.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.str-split.php">
 <link rel="next" href="https://www.php.net/manual/en/function.str-word-count.php">
...
<meta name="Description" content="Checks if a string starts with a given substring" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: str_starts_with - Manual" />
<meta name="twitter:description" content="Checks if a string starts with a given substring" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: str_starts_with - Manual" />
<meta itemprop="description" content="Checks if a string starts with a given substring" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Checks if a string starts with a given substring" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.str-starts-with.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.str-starts-with.php'>Brazilian Portuguese</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.str-starts-with-examples">
  ...
  <p class="para">
   <div class="example" id="example-5144">
...
<div class="annotation-interactive examplescode"><pre class="examplescode">All strings start with the empty string</pre>
   ...
   <div class="example" id="example-5145">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.preg-match.php" class="function" rel="rdfs-seeAlso">preg_match()</a> - Perform a regular expression match</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/strings/functions/str-starts-with.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.str-starts-with%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.str-starts-with&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.str-starts-with.php">＋<small>add a note</small></a></span>
