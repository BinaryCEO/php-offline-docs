...
<head>
  ...
  <title>PHP: db2_conn_error - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-conn-error.php">
 <link rel="shorturl" href="https://www.php.net/db2-conn-error">
 <link rel="alternate" href="https://www.php.net/db2-conn-error" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-commit.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-conn-errormsg.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-conn-error.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-conn-error.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-conn-error.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-conn-error.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-conn-error.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-conn-error.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-conn-error.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-conn-error.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-conn-error.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-conn-error.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-conn-error.php" hreflang="zh">
...
<meta name="Description" content="Returns a string containing the SQLSTATE returned by the last connection attempt" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_conn_error - Manual" />
<meta name="twitter:description" content="Returns a string containing the SQLSTATE returned by the last connection attempt" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_conn_error - Manual" />
<meta itemprop="description" content="Returns a string containing the SQLSTATE returned by the last connection attempt" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a string containing the SQLSTATE returned by the last connection attempt" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-conn-error.php' selected="selected">English</option>
            <option value='de/function.db2-conn-error.php'>German</option>
            <option value='es/function.db2-conn-error.php'>Spanish</option>
            <option value='fr/function.db2-conn-error.php'>French</option>
            <option value='it/function.db2-conn-error.php'>Italian</option>
            <option value='ja/function.db2-conn-error.php'>Japanese</option>
            <option value='pt_BR/function.db2-conn-error.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-conn-error.php'>Russian</option>
            <option value='tr/function.db2-conn-error.php'>Turkish</option>
            <option value='uk/function.db2-conn-error.php'>Ukrainian</option>
            <option value='zh/function.db2-conn-error.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-conn-error" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_conn_error</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_conn_error</span> &mdash; <span class="dc-title">
   Returns a string containing the SQLSTATE returned by the last connection attempt
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.db2-conn-error-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_conn_error</strong></span>(<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></span> <code class="parameter">$connection</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>



  <p class="para rdfs-comment">
   <span class="function"><strong>db2_conn_error()</strong></span> returns an SQLSTATE value representing
   the reason the last attempt to connect to a database failed. As
   <span class="function"><a href="function.db2-connect.php" class="function">db2_connect()</a></span> returns <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> in the event of a failed
   connection attempt, you do not pass any parameters to
   <span class="function"><strong>db2_conn_error()</strong></span> to retrieve the SQLSTATE value.
  </p>
  <p class="para">
  ...
  <p class="para">
   ...
   can also call <span class="function"><a href="function.db2-conn-errormsg.php" class="function">db2_conn_errormsg()</a></span> to retrieve an
   explicit error message and the associated SQLCODE value.
  </p>
 </div>

 <div class="refsect1 parameters" id="refsect1-function.db2-conn-error-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-conn-error-returnvalues">
 ...
 <div class="refsect1 examples" id="refsect1-function.db2-conn-error-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1346">
    <p><strong>Example #1 Retrieving an SQLSTATE value for a failed connection attempt</strong></p>
...
<div class="examplescode"><pre class="examplescode">SQLSTATE value: 08001</pre>
</div>
    </div>
   </div>
  </p>
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-conn-error-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-stmt-errormsg.php" class="function" rel="rdfs-seeAlso">db2_stmt_errormsg()</a> - Returns a string containing the last SQL statement error message</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-conn-error.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-conn-error%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-conn-error&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-conn-error.php">＋<small>add a note</small></a></span>
