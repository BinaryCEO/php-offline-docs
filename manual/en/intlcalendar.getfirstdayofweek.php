...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.getfirstdayofweek.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.getfirstdayofweek.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.getfirstdayofweek.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/intlcalendar.geterrormessage.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.getgreatestminimum.php">
...
<meta name="Description" content="Get the first day of the week for the calendarʼs locale" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::getFirstDayOfWeek - Manual" />
<meta name="twitter:description" content="Get the first day of the week for the calendarʼs locale" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::getFirstDayOfWeek - Manual" />
<meta itemprop="description" content="Get the first day of the week for the calendarʼs locale" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Get the first day of the week for the calendarʼs locale" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.getfirstdayofweek.php' selected="selected">English</option>
            <option value='de/intlcalendar.getfirstdayofweek.php'>German</option>
            <option value='es/intlcalendar.getfirstdayofweek.php'>Spanish</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::getFirstDayOfWeek</span> &mdash; <span class="dc-title">Get the first day of the week for the calendarʼs locale</span></p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.getfirstdayofweek-returnvalues">
  ...
  <p class="para">
   ...
   <strong><code><a href="class.intlcalendar.php#intlcalendar.constants.dow-saturday">IntlCalendar::DOW_SATURDAY</a></code></strong> or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
...
int(6)</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-intlcalendar.getfirstdayofweek-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="methodname"><a href="intlcalendar.setfirstdayofweek.php" class="methodname" rel="rdfs-seeAlso">IntlCalendar::setFirstDayOfWeek()</a> - Set the day on which the week is deemed to start</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/getfirstdayofweek.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.getfirstdayofweek%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.getfirstdayofweek&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.getfirstdayofweek.php">＋<small>add a note</small></a></span>
