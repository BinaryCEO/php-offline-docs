...
<head>
  ...
  <title>PHP: gc_status - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gc-status.php">
 <link rel="shorturl" href="https://www.php.net/gc-status">
 <link rel="alternate" href="https://www.php.net/gc-status" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.gc-mem-caches.php">
 <link rel="next" href="https://www.php.net/manual/en/function.get-cfg-var.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.gc-status.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.gc-status.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.gc-status.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.gc-status.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.gc-status.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.gc-status.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.gc-status.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.gc-status.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.gc-status.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.gc-status.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.gc-status.php" hreflang="zh">
...
<meta name="Description" content="Gets information about the garbage collector" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: gc_status - Manual" />
<meta name="twitter:description" content="Gets information about the garbage collector" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gc_status - Manual" />
<meta itemprop="description" content="Gets information about the garbage collector" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets information about the garbage collector" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gc-status.php' selected="selected">English</option>
            <option value='de/function.gc-status.php'>German</option>
            <option value='es/function.gc-status.php'>Spanish</option>
            <option value='fr/function.gc-status.php'>French</option>
            <option value='it/function.gc-status.php'>Italian</option>
            <option value='ja/function.gc-status.php'>Japanese</option>
            <option value='pt_BR/function.gc-status.php'>Brazilian Portuguese</option>
            <option value='ru/function.gc-status.php'>Russian</option>
            <option value='tr/function.gc-status.php'>Turkish</option>
            <option value='uk/function.gc-status.php'>Ukrainian</option>
            <option value='zh/function.gc-status.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.gc-status" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">gc_status</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.3.0, PHP 8)</p><p class="refpurpose"><span class="refname">gc_status</span> &mdash; <span class="dc-title">Gets information about the garbage collector</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gc-status-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>gc_status</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.gc-status-returnvalues">
  ...
  <p class="para">
   ...
   <ul class="itemizedlist">
    ...
    <li class="listitem">
     <span class="simpara">
      <code class="literal">&quot;application_time&quot;</code>
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">&quot;collector_time&quot;</code>
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">&quot;destructor_time&quot;</code>
     </span>
    </li>
    <li class="listitem">
     <span class="simpara">
      <code class="literal">&quot;free_time&quot;</code>
     </span>
    </li>
   </ul> 
  </p>
 ...
 <div class="refsect1 changelog" id="refsect1-function.gc-status-changelog">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      <tr>
       <td>8.3.0</td>
       <td>
        <span class="function"><strong>gc_status()</strong></span> now returns the following additional fields:
        <code class="literal">&quot;running&quot;</code>, <code class="literal">&quot;protected&quot;</code>,
        <code class="literal">&quot;full&quot;</code>, <code class="literal">&quot;buffer_size&quot;</code>,
        <code class="literal">&quot;application_time&quot;</code>, <code class="literal">&quot;collector_time&quot;</code>,
        <code class="literal">&quot;destructor_time&quot;</code>, and <code class="literal">&quot;free_time&quot;</code>.
       </td>
      </tr>
   ...
   <ul class="simplelist">
    <li><a href="features.gc.php" class="link">Garbage Collection</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/gc-status.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gc-status%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gc-status&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gc-status.php">＋<small>add a note</small></a></span>
