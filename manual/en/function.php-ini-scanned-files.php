...
<head>
  ...
  <title>PHP: php_ini_scanned_files - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.php-ini-scanned-files.php">
 <link rel="shorturl" href="https://www.php.net/php-ini-scanned-files">
 <link rel="alternate" href="https://www.php.net/php-ini-scanned-files" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.php-ini-loaded-file.php">
 <link rel="next" href="https://www.php.net/manual/en/function.php-sapi-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.php-ini-scanned-files.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.php-ini-scanned-files.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.php-ini-scanned-files.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.php-ini-scanned-files.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.php-ini-scanned-files.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.php-ini-scanned-files.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.php-ini-scanned-files.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.php-ini-scanned-files.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.php-ini-scanned-files.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.php-ini-scanned-files.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.php-ini-scanned-files.php" hreflang="zh">
...
<meta name="Description" content="Return a list of .ini files parsed from the additional ini dir" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: php_ini_scanned_files - Manual" />
<meta name="twitter:description" content="Return a list of .ini files parsed from the additional ini dir" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: php_ini_scanned_files - Manual" />
<meta itemprop="description" content="Return a list of .ini files parsed from the additional ini dir" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return a list of .ini files parsed from the additional ini dir" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.php-sapi-name.php">
          php_sapi_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.php-ini-loaded-file.php">
          &laquo; php_ini_loaded_file        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.php-ini-scanned-files.php' selected="selected">English</option>
            <option value='de/function.php-ini-scanned-files.php'>German</option>
            <option value='es/function.php-ini-scanned-files.php'>Spanish</option>
            <option value='fr/function.php-ini-scanned-files.php'>French</option>
            <option value='it/function.php-ini-scanned-files.php'>Italian</option>
            <option value='ja/function.php-ini-scanned-files.php'>Japanese</option>
            <option value='pt_BR/function.php-ini-scanned-files.php'>Brazilian Portuguese</option>
            <option value='ru/function.php-ini-scanned-files.php'>Russian</option>
            <option value='tr/function.php-ini-scanned-files.php'>Turkish</option>
            <option value='uk/function.php-ini-scanned-files.php'>Ukrainian</option>
            <option value='zh/function.php-ini-scanned-files.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.php-ini-scanned-files" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">php_ini_scanned_files</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.3.0, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">php_ini_scanned_files</span> &mdash; <span class="dc-title">Return a list of .ini files parsed from the additional ini dir</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.php-ini-scanned-files-description">
  ...
  <p class="para rdfs-comment">
   ...
   list of configuration files parsed after <var class="filename">php.ini</var>. The directories
   ...
   <a href="configuration.file.php#configuration.file.scan" class="link">installation guide</a>.
  </p>
  <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.php-ini-scanned-files-returnvalues">
  ...
  <p class="para">
   ...
   followed by a newline. If the configure directive <strong class="option configure">--with-config-file-scan-dir</strong> wasn&#039;t set and the
   <var class="varname">PHP_INI_SCAN_DIR</var> environment variable isn&#039;t set, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>
 ...
 <div class="refsect1 seealso" id="refsect1-function.php-ini-scanned-files-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.php-ini-loaded-file.php" class="function" rel="rdfs-seeAlso">php_ini_loaded_file()</a> - Retrieve a path to the loaded php.ini file</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/php-ini-scanned-files.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.php-ini-scanned-files%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.php-ini-scanned-files&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.php-ini-scanned-files.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123799">  <div class="votes">
    <div id="Vu123799">
    <a href="/manual/vote-note.php?id=123799&amp;page=function.php-ini-scanned-files&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123799">
    <a href="/manual/vote-note.php?id=123799&amp;page=function.php-ini-scanned-files&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123799" title="55% like this...">
    1
    </div>
  </div>
  <a href="#123799" class="name">
  <strong class="user"><em>atesin () gmail ! com</em></strong></a><a class="genanchor" href="#123799"> &para;</a><div class="date" title="2019-04-25 04:00"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123799">
<div class="phpcode"><code><span class="html">&lt;warning&gt;<br /><br />until i load more .ini files from &lt;php-dir&gt;/php.d/ as listed in phpinfo() (sections "Scan this dir for additional .ini files" and "Additional .ini files parsed"), php_ini_scanned_files() returns me NOTHING!<br /><br />then i realized my php binary was not compiled with the "--with-config-file-scan-dir" option as listed in phpinfo() (section "Configure Command")<br /><br />then i remembered the additional .ini files dir was set through the "PHP_INI_SCAN_DIR" system variable (new since php 5.2.0, see <a href="https://php.net/manual/en/configuration.file.php#configuration.file.scan" rel="nofollow" target="_blank">https://php.net/manual/en/configuration.file.php#configuration.file.scan</a>)<br /><br />until confusing and annoying, is the documented behavior... too bad now i don't know how to get the additional ini files purely with php functions (except "shell_exec()" maybe?)<br /><br />&lt;/warning&gt;</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.php-ini-scanned-files&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.php-ini-scanned-files.php">＋<small>add a note</small></a></div>
