...
<head>
  ...
  <title>PHP: odbc_connection_string_quote - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-connection-string-quote.php">
 <link rel="shorturl" href="https://www.php.net/odbc-connection-string-quote">
 <link rel="alternate" href="https://www.php.net/odbc-connection-string-quote" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.uodbc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-connection-string-is-quoted.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-connection-string-should-quote.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.odbc-connection-string-quote.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.odbc-connection-string-quote.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.odbc-connection-string-quote.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.odbc-connection-string-quote.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.odbc-connection-string-quote.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.odbc-connection-string-quote.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.odbc-connection-string-quote.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.odbc-connection-string-quote.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.odbc-connection-string-quote.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.odbc-connection-string-quote.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.odbc-connection-string-quote.php" hreflang="zh">
...
<meta name="Description" content="Quotes an ODBC connection string value" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: odbc_connection_string_quote - Manual" />
<meta name="twitter:description" content="Quotes an ODBC connection string value" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: odbc_connection_string_quote - Manual" />
<meta itemprop="description" content="Quotes an ODBC connection string value" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Quotes an ODBC connection string value" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.odbc-connection-string-should-quote.php">
          odbc_connection_string_should_quote &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.odbc-connection-string-is-quoted.php">
          &laquo; odbc_connection_string_is_quoted        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-connection-string-quote.php' selected="selected">English</option>
            <option value='de/function.odbc-connection-string-quote.php'>German</option>
            <option value='es/function.odbc-connection-string-quote.php'>Spanish</option>
            <option value='fr/function.odbc-connection-string-quote.php'>French</option>
            <option value='it/function.odbc-connection-string-quote.php'>Italian</option>
            <option value='ja/function.odbc-connection-string-quote.php'>Japanese</option>
            <option value='pt_BR/function.odbc-connection-string-quote.php'>Brazilian Portuguese</option>
            <option value='ru/function.odbc-connection-string-quote.php'>Russian</option>
            <option value='tr/function.odbc-connection-string-quote.php'>Turkish</option>
            <option value='uk/function.odbc-connection-string-quote.php'>Ukrainian</option>
            <option value='zh/function.odbc-connection-string-quote.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.odbc-connection-string-quote" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.odbc-connection-string-quote-examples">
  ...
  <div class="example" id="odbc-connection-string-quote.example.basic">
   <p><strong>Example #1 <span class="function"><strong>odbc_connection_string_quote()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.odbc-connection-string-should-quote.php" class="function" rel="rdfs-seeAlso">odbc_connection_string_should_quote()</a> - Determines if an ODBC connection string value should be quoted</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-connection-string-quote.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-connection-string-quote%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-connection-string-quote&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-connection-string-quote.php">＋<small>add a note</small></a></span>
