...
<head>
  ...
  <title>PHP: Gmagick::equalizeimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.equalizeimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.equalizeimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.equalizeimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.enhanceimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.flipimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.equalizeimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.equalizeimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.equalizeimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.equalizeimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.equalizeimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.equalizeimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.equalizeimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.equalizeimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.equalizeimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.equalizeimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.equalizeimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::equalizeimage - Manual" />
<meta name="twitter:description" content="Equalizes the image histogram" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::equalizeimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.flipimage.php">
          Gmagick::flipimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.enhanceimage.php">
          &laquo; Gmagick::enhanceimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.equalizeimage.php' selected="selected">English</option>
            <option value='de/gmagick.equalizeimage.php'>German</option>
            <option value='es/gmagick.equalizeimage.php'>Spanish</option>
            <option value='fr/gmagick.equalizeimage.php'>French</option>
            <option value='it/gmagick.equalizeimage.php'>Italian</option>
            <option value='ja/gmagick.equalizeimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.equalizeimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.equalizeimage.php'>Russian</option>
            <option value='tr/gmagick.equalizeimage.php'>Turkish</option>
            <option value='uk/gmagick.equalizeimage.php'>Ukrainian</option>
            <option value='zh/gmagick.equalizeimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.equalizeimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::equalizeimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::equalizeimage</span> &mdash; <span class="dc-title">Equalizes the image histogram</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.equalizeimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::equalizeimage</strong></span>(): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.equalizeimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.equalizeimage-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   The equalized <span class="classname"><a href="class.gmagick.php" class="classname">Gmagick</a></span> object.
  </p>
 </div>


 <div class="refsect1 errors" id="refsect1-gmagick.equalizeimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/equalizeimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.equalizeimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.equalizeimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.equalizeimage.php">＋<small>add a note</small></a></span>
