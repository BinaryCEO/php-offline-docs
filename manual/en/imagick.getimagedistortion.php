...
<head>
  ...
  <title>PHP: Imagick::getImageDistortion - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimagedistortion.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimagedistortion.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagedistortion.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagedispose.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimageextrema.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimagedistortion.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimagedistortion.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimagedistortion.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimagedistortion.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimagedistortion.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimagedistortion.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimagedistortion.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimagedistortion.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimagedistortion.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimagedistortion.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimagedistortion.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Imagick::getImageDistortion - Manual" />
<meta name="twitter:description" content="Compares an image to a reconstructed image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageDistortion - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.getimageextrema.php">
          Imagick::getImageExtrema &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagedispose.php">
          &laquo; Imagick::getImageDispose        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimagedistortion.php' selected="selected">English</option>
            <option value='de/imagick.getimagedistortion.php'>German</option>
            <option value='es/imagick.getimagedistortion.php'>Spanish</option>
            <option value='fr/imagick.getimagedistortion.php'>French</option>
            <option value='it/imagick.getimagedistortion.php'>Italian</option>
            <option value='ja/imagick.getimagedistortion.php'>Japanese</option>
            <option value='pt_BR/imagick.getimagedistortion.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimagedistortion.php'>Russian</option>
            <option value='tr/imagick.getimagedistortion.php'>Turkish</option>
            <option value='uk/imagick.getimagedistortion.php'>Ukrainian</option>
            <option value='zh/imagick.getimagedistortion.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimagedistortion" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::getImageDistortion</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getImageDistortion</span> &mdash; <span class="dc-title">Compares an image to a reconstructed image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.getimagedistortion-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageDistortion</strong></span>(<span class="methodparam"><span class="type">MagickWand</span> <code class="parameter">$reference</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$metric</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimagedistortion-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.getimagedistortion-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.getimagedistortion-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimagedistortion.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimagedistortion%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimagedistortion&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimagedistortion.php">＋<small>add a note</small></a></span>
