...
<head>
  ...
  <title>PHP: DateTime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.datetime.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/datetime.examples-arithmetic.php">
 <link rel="next" href="https://www.php.net/manual/en/datetime.add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.datetime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.datetime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.datetime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.datetime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.datetime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.datetime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.datetime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.datetime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.datetime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.datetime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.datetime.php" hreflang="zh">
...
<meta name="Description" content="The DateTime class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: DateTime - Manual" />
<meta name="twitter:description" content="The DateTime class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: DateTime - Manual" />
<meta itemprop="description" content="The DateTime class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The DateTime class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="datetime.add.php">
          DateTime::add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="datetime.examples-arithmetic.php">
          &laquo; Date/Time Arithmetic        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.datetime.php' selected="selected">English</option>
            <option value='de/class.datetime.php'>German</option>
            <option value='es/class.datetime.php'>Spanish</option>
            <option value='fr/class.datetime.php'>French</option>
            <option value='it/class.datetime.php'>Italian</option>
            <option value='ja/class.datetime.php'>Japanese</option>
            <option value='pt_BR/class.datetime.php'>Brazilian Portuguese</option>
            <option value='ru/class.datetime.php'>Russian</option>
            <option value='tr/class.datetime.php'>Turkish</option>
            <option value='uk/class.datetime.php'>Ukrainian</option>
            <option value='zh/class.datetime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.datetime" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.2.0, PHP 7, PHP 8)</p>
  ...
  <div class="section" id="datetime.intro">
   ...
   <p class="para">
    This class behaves the same as <span class="classname"><a href="class.datetimeimmutable.php" class="classname">DateTimeImmutable</a></span>,
   ...
   <div class="warning"><strong class="warning">Warning</strong>
    <p class="para">
     Calling methods on objects of the class <span class="classname"><strong class="classname">DateTime</strong></span>
     will change the information encapsulated in these objects, if you want to
     prevent that you will have to use <code class="literal">clone</code> operator to
     create a new object. Use <span class="classname"><a href="class.datetimeimmutable.php" class="classname">DateTimeImmutable</a></span>
     instead of <span class="classname"><strong class="classname">DateTime</strong></span> to obtain this recommended
    ...
    <table class="doctable informaltable">
      ...
      <tbody class="tbody">
       ...
       <tr>
        <td>7.2.0</td>
        <td>
         The class constants of <span class="classname"><strong class="classname">DateTime</strong></span> are now defined
         on <span class="classname"><a href="class.datetimeinterface.php" class="classname">DateTimeInterface</a></span>.
        </td>
       </tr>
       ...
       <tr>
        <td>7.1.0</td>
        <td>
         The <span class="classname"><strong class="classname">DateTime</strong></span> constructor now includes the
   ...
   a DateTime object</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/datetime/datetime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.datetime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.datetime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.datetime.php">＋<small>add a note</small></a></span>
