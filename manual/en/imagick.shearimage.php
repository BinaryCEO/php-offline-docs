...
<head>
  ...
  <title>PHP: Imagick::shearImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.shearimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.shearimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.shearimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.shaveimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.sigmoidalcontrastimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.shearimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.shearimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.shearimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.shearimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.shearimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.shearimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.shearimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.shearimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.shearimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.shearimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.shearimage.php" hreflang="zh">
...
<meta name="Description" content="Creating a parallelogram" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::shearImage - Manual" />
<meta name="twitter:description" content="Creating a parallelogram" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::shearImage - Manual" />
<meta itemprop="description" content="Creating a parallelogram" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Creating a parallelogram" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.sigmoidalcontrastimage.php">
          Imagick::sigmoidalContrastImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.shaveimage.php">
          &laquo; Imagick::shaveImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.shearimage.php' selected="selected">English</option>
            <option value='de/imagick.shearimage.php'>German</option>
            <option value='es/imagick.shearimage.php'>Spanish</option>
            <option value='fr/imagick.shearimage.php'>French</option>
            <option value='it/imagick.shearimage.php'>Italian</option>
            <option value='ja/imagick.shearimage.php'>Japanese</option>
            <option value='pt_BR/imagick.shearimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.shearimage.php'>Russian</option>
            <option value='tr/imagick.shearimage.php'>Turkish</option>
            <option value='uk/imagick.shearimage.php'>Ukrainian</option>
            <option value='zh/imagick.shearimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.shearimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::shearImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::shearImage</span> &mdash; <span class="dc-title">Creating a parallelogram</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.shearimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::shearImage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$background</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$x_shear</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$y_shear</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.shearimage-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">x_shear</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">y_shear</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.shearimage-returnvalues">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.shearimage-changelog">
  ...
  <p class="para">
    <div class="example" id="example-3114">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/shearimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.shearimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.shearimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.shearimage.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92894">  <div class="votes">
    <div id="Vu92894">
    <a href="/manual/vote-note.php?id=92894&amp;page=imagick.shearimage&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92894">
    <a href="/manual/vote-note.php?id=92894&amp;page=imagick.shearimage&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92894" title="no votes...">
    0
    </div>
  </div>
  <a href="#92894" class="name">
  <strong class="user"><em>raja at tweetchennai dot com</em></strong></a><a class="genanchor" href="#92894"> &para;</a><div class="date" title="2009-08-13 05:42"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92894">
<div class="phpcode"><code><span class="html">Eg:
<br />
<br /><span class="default">&lt;?php
<br />$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">'pic.png'</span><span class="keyword">);
<br /></span><span class="default">$image </span><span class="keyword">-&gt;</span><span class="default">shearImage</span><span class="keyword">(</span><span class="string">'grey'</span><span class="keyword">, </span><span class="default">10 </span><span class="keyword">, </span><span class="default">5</span><span class="keyword">);
<br /></span><span class="default">$image </span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="string">'final.png'</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.shearimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.shearimage.php">＋<small>add a note</small></a></div>
