...
<head>
  ...
  <title>PHP: get_magic_quotes_runtime - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.get-magic-quotes-runtime.php">
 <link rel="shorturl" href="https://www.php.net/get-magic-quotes-runtime">
 <link rel="alternate" href="https://www.php.net/get-magic-quotes-runtime" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.info.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.get-magic-quotes-gpc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.get-required-files.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.get-magic-quotes-runtime.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.get-magic-quotes-runtime.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.get-magic-quotes-runtime.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.get-magic-quotes-runtime.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.get-magic-quotes-runtime.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.get-magic-quotes-runtime.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.get-magic-quotes-runtime.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.get-magic-quotes-runtime.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.get-magic-quotes-runtime.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.get-magic-quotes-runtime.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.get-magic-quotes-runtime.php" hreflang="zh">
...
<meta name="Description" content="Gets the current active configuration setting of magic_quotes_runtime" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: get_magic_quotes_runtime - Manual" />
<meta name="twitter:description" content="Gets the current active configuration setting of magic_quotes_runtime" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: get_magic_quotes_runtime - Manual" />
<meta itemprop="description" content="Gets the current active configuration setting of magic_quotes_runtime" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the current active configuration setting of magic_quotes_runtime" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.get-required-files.php">
          get_required_files &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.get-magic-quotes-gpc.php">
          &laquo; get_magic_quotes_gpc        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.get-magic-quotes-runtime.php' selected="selected">English</option>
            <option value='de/function.get-magic-quotes-runtime.php'>German</option>
            <option value='es/function.get-magic-quotes-runtime.php'>Spanish</option>
            <option value='fr/function.get-magic-quotes-runtime.php'>French</option>
            <option value='it/function.get-magic-quotes-runtime.php'>Italian</option>
            <option value='ja/function.get-magic-quotes-runtime.php'>Japanese</option>
            <option value='pt_BR/function.get-magic-quotes-runtime.php'>Brazilian Portuguese</option>
            <option value='ru/function.get-magic-quotes-runtime.php'>Russian</option>
            <option value='tr/function.get-magic-quotes-runtime.php'>Turkish</option>
            <option value='uk/function.get-magic-quotes-runtime.php'>Ukrainian</option>
            <option value='zh/function.get-magic-quotes-runtime.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.get-magic-quotes-runtime" class="refentry">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.get-magic-quotes-gpc.php" class="function" rel="rdfs-seeAlso">get_magic_quotes_gpc()</a> - Gets the current configuration setting of magic_quotes_gpc</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/info/functions/get-magic-quotes-runtime.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.get-magic-quotes-runtime%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.get-magic-quotes-runtime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-magic-quotes-runtime.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="93056">  <div class="votes">
    <div id="Vu93056">
    <a href="/manual/vote-note.php?id=93056&amp;page=function.get-magic-quotes-runtime&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd93056">
    <a href="/manual/vote-note.php?id=93056&amp;page=function.get-magic-quotes-runtime&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V93056" title="52% like this...">
    2
    </div>
  </div>
  <a href="#93056" class="name">
  <strong class="user"><em>dipshrestha AT mail</em></strong></a><a class="genanchor" href="#93056"> &para;</a><div class="date" title="2009-08-20 06:28"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom93056">
<div class="phpcode"><code><span class="html">To add to what "php at nospam-qualystem dot com" has mentioned.<br /><br />Some Japanese Encoding System (shift-jis) encode characters like 予 with ASCII pairs "975C". (5C is ASCII for backslash)<br /><br />Thus when reading those characters from files (saved as shift-jis) in system with magic_quotes_runtime enabled, the characeter is turned into 予\  (equivalent ASCII "975C5C")<br /><br />Similarly,<br />予定　is turned into 予\定</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.get-magic-quotes-runtime&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.get-magic-quotes-runtime.php">＋<small>add a note</small></a></div>
