...
<head>
  ...
  <title>PHP: SolrQuery::getTerms - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getterms.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getterms.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getterms.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getstatsfields.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.gettermsfield.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getterms.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getterms.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getterms.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getterms.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getterms.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getterms.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getterms.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getterms.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getterms.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getterms.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getterms.php" hreflang="zh">
...
<meta name="Description" content="Returns whether or not the TermsComponent is enabled" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getTerms - Manual" />
<meta name="twitter:description" content="Returns whether or not the TermsComponent is enabled" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getTerms - Manual" />
<meta itemprop="description" content="Returns whether or not the TermsComponent is enabled" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns whether or not the TermsComponent is enabled" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.gettermsfield.php">
          SolrQuery::getTermsField &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getstatsfields.php">
          &laquo; SolrQuery::getStatsFields        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getterms.php' selected="selected">English</option>
            <option value='de/solrquery.getterms.php'>German</option>
            <option value='es/solrquery.getterms.php'>Spanish</option>
            <option value='fr/solrquery.getterms.php'>French</option>
            <option value='it/solrquery.getterms.php'>Italian</option>
            <option value='ja/solrquery.getterms.php'>Japanese</option>
            <option value='pt_BR/solrquery.getterms.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getterms.php'>Russian</option>
            <option value='tr/solrquery.getterms.php'>Turkish</option>
            <option value='uk/solrquery.getterms.php'>Ukrainian</option>
            <option value='zh/solrquery.getterms.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getterms" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getTerms</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::getTerms</span> &mdash; <span class="dc-title">Returns whether or not the TermsComponent is enabled</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getterms-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getTerms</strong></span>(): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getterms-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getterms-returnvalues">
...
Returns a boolean on success and <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if not set.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getterms.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getterms%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getterms&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getterms.php">＋<small>add a note</small></a></span>
