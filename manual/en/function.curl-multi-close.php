...
<head>
  ...
  <title>PHP: curl_multi_close - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.curl-multi-close.php">
 <link rel="shorturl" href="https://www.php.net/curl-multi-close">
 <link rel="alternate" href="https://www.php.net/curl-multi-close" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.curl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.curl-multi-add-handle.php">
 <link rel="next" href="https://www.php.net/manual/en/function.curl-multi-errno.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.curl-multi-close.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.curl-multi-close.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.curl-multi-close.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.curl-multi-close.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.curl-multi-close.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.curl-multi-close.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.curl-multi-close.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.curl-multi-close.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.curl-multi-close.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.curl-multi-close.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.curl-multi-close.php" hreflang="zh">
...
<meta name="Description" content="Remove all cURL handles from a multi handle" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: curl_multi_close - Manual" />
<meta name="twitter:description" content="Remove all cURL handles from a multi handle" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: curl_multi_close - Manual" />
<meta itemprop="description" content="Remove all cURL handles from a multi handle" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Remove all cURL handles from a multi handle" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.curl-multi-errno.php">
          curl_multi_errno &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.curl-multi-add-handle.php">
          &laquo; curl_multi_add_handle        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.curl-multi-close.php' selected="selected">English</option>
            <option value='de/function.curl-multi-close.php'>German</option>
            <option value='es/function.curl-multi-close.php'>Spanish</option>
            <option value='fr/function.curl-multi-close.php'>French</option>
            <option value='it/function.curl-multi-close.php'>Italian</option>
            <option value='ja/function.curl-multi-close.php'>Japanese</option>
            <option value='pt_BR/function.curl-multi-close.php'>Brazilian Portuguese</option>
            <option value='ru/function.curl-multi-close.php'>Russian</option>
            <option value='tr/function.curl-multi-close.php'>Turkish</option>
            <option value='uk/function.curl-multi-close.php'>Ukrainian</option>
            <option value='zh/function.curl-multi-close.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.curl-multi-close" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">curl_multi_close</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">curl_multi_close</span> &mdash; <span class="dc-title">Remove all cURL handles from a multi handle</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.curl-multi-close-description">
  ...
  <p class="para rdfs-comment">
   Removes all <span class="classname"><a href="class.curlhandle.php" class="classname">CurlHandle</a></span>s attached to the <span class="classname"><a href="class.curlmultihandle.php" class="classname">CurlMultiHandle</a></span>,
   as if <span class="function"><a href="function.curl-multi-remove-handle.php" class="function">curl_multi_remove_handle()</a></span> was called for each of them.
  </p>
  <p class="para">
 ...
 <div class="refsect1 seealso" id="refsect1-function.curl-multi-close-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.curl-close.php" class="function" rel="rdfs-seeAlso">curl_close()</a> - Close a cURL session</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/curl/functions/curl-multi-close.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.curl-multi-close%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.curl-multi-close&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.curl-multi-close.php">＋<small>add a note</small></a></span>
