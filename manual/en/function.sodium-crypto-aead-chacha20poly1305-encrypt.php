...
<head>
  ...
  <title>PHP: sodium_crypto_aead_chacha20poly1305_encrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-encrypt.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-aead-chacha20poly1305-encrypt">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-aead-chacha20poly1305-encrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-decrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-ietf-decrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-aead-chacha20poly1305-encrypt.php" hreflang="zh">
...
<meta name="Description" content="Encrypt then authenticate with ChaCha20-Poly1305" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_aead_chacha20poly1305_encrypt - Manual" />
<meta name="twitter:description" content="Encrypt then authenticate with ChaCha20-Poly1305" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_aead_chacha20poly1305_encrypt - Manual" />
<meta itemprop="description" content="Encrypt then authenticate with ChaCha20-Poly1305" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Encrypt then authenticate with ChaCha20-Poly1305" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.sodium-crypto-aead-chacha20poly1305-ietf-decrypt.php">
          sodium_crypto_aead_chacha20poly1305_ietf_decrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-aead-chacha20poly1305-decrypt.php">
          &laquo; sodium_crypto_aead_chacha20poly1305_decrypt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-aead-chacha20poly1305-encrypt.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>German</option>
            <option value='es/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>French</option>
            <option value='it/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>Italian</option>
            <option value='ja/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>Russian</option>
            <option value='tr/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-aead-chacha20poly1305-encrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-aead-chacha20poly1305-encrypt" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.sodium-crypto-aead-chacha20poly1305-encrypt-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_aead_chacha20poly1305_encrypt</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$message</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$additional_data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nonce</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span><br>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-aead-chacha20poly1305-encrypt-returnvalues">
  ...
  <p class="para">
   Returns the ciphertext and tag on success,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-aead-chacha20poly1305-encrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-aead-chacha20poly1305-encrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-chacha20poly1305-encrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-encrypt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128306">  <div class="votes">
    <div id="Vu128306">
    <a href="/manual/vote-note.php?id=128306&amp;page=function.sodium-crypto-aead-chacha20poly1305-encrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128306">
    <a href="/manual/vote-note.php?id=128306&amp;page=function.sodium-crypto-aead-chacha20poly1305-encrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128306" title="66% like this...">
    1
    </div>
  </div>
  <a href="#128306" class="name">
  <strong class="user"><em>alain at fuz dot org</em></strong></a><a class="genanchor" href="#128306"> &para;</a><div class="date" title="2023-03-13 06:30"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128306">
<div class="phpcode"><code><span class="html">A flip/flop unit test to give you a sample:<br /><br /><span class="default">&lt;?php<br /><br /></span><span class="keyword">use </span><span class="default">PHPUnit\Framework\TestCase</span><span class="keyword">;<br /><br />class </span><span class="default">SodiumTest </span><span class="keyword">extends </span><span class="default">TestCase<br /></span><span class="keyword">{<br />    public function </span><span class="default">testSodium</span><span class="keyword">()<br />    {<br />        </span><span class="comment">// or 32 cryptographically secure bytes<br />        // store the key securely with other secrets in your app <br />       </span><span class="default">$key </span><span class="keyword">= </span><span class="default">sodium_crypto_aead_xchacha20poly1305_ietf_keygen</span><span class="keyword">();<br /><br />        </span><span class="comment">// 8-bytes nonce should be stored along with the ciphertext (will be needed for decryption)<br />        // It is not sensitive, you may just prepend it before the ciphertext.<br />        </span><span class="default">$nonce </span><span class="keyword">= </span><span class="default">random_bytes</span><span class="keyword">(</span><span class="default">SODIUM_CRYPTO_AEAD_CHACHA20POLY1305_NPUBBYTES</span><span class="keyword">);<br /><br />        </span><span class="default">$flip </span><span class="keyword">= </span><span class="string">'Hello, world!'</span><span class="keyword">;<br />        </span><span class="default">$ciphertext </span><span class="keyword">= </span><span class="default">sodium_crypto_aead_chacha20poly1305_encrypt</span><span class="keyword">(</span><span class="default">$flip</span><span class="keyword">, </span><span class="default">$nonce</span><span class="keyword">, </span><span class="default">$nonce</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">);<br />        </span><span class="default">$flop </span><span class="keyword">= </span><span class="default">sodium_crypto_aead_chacha20poly1305_decrypt</span><span class="keyword">(</span><span class="default">$ciphertext</span><span class="keyword">, </span><span class="default">$nonce</span><span class="keyword">, </span><span class="default">$nonce</span><span class="keyword">, </span><span class="default">$key</span><span class="keyword">);<br /><br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">assertEquals</span><span class="keyword">(</span><span class="default">$flip</span><span class="keyword">, </span><span class="default">$flop</span><span class="keyword">);<br />    }<br />}<br /><br /></span><span class="default">?&gt;<br /></span><br />Side note: the nonce is used twice in this test, but you can use a username, an identifier or whatever you like in `$additional_data`</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-chacha20poly1305-encrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-chacha20poly1305-encrypt.php">＋<small>add a note</small></a></div>
