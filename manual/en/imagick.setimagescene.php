...
<head>
  ...
  <title>PHP: Imagick::setImageScene - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagescene.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagescene.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagescene.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageresolution.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagetickspersecond.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagescene.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagescene.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagescene.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagescene.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagescene.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagescene.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagescene.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagescene.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagescene.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagescene.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagescene.php" hreflang="zh">
...
<meta name="Description" content="Sets the image scene" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageScene - Manual" />
<meta name="twitter:description" content="Sets the image scene" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageScene - Manual" />
<meta itemprop="description" content="Sets the image scene" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image scene" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimagetickspersecond.php">
          Imagick::setImageTicksPerSecond &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageresolution.php">
          &laquo; Imagick::setImageResolution        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagescene.php' selected="selected">English</option>
            <option value='de/imagick.setimagescene.php'>German</option>
            <option value='es/imagick.setimagescene.php'>Spanish</option>
            <option value='fr/imagick.setimagescene.php'>French</option>
            <option value='it/imagick.setimagescene.php'>Italian</option>
            <option value='ja/imagick.setimagescene.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagescene.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagescene.php'>Russian</option>
            <option value='tr/imagick.setimagescene.php'>Turkish</option>
            <option value='uk/imagick.setimagescene.php'>Ukrainian</option>
            <option value='zh/imagick.setimagescene.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagescene" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageScene</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageScene</span> &mdash; <span class="dc-title">Sets the image scene</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagescene-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageScene</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$scene</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagescene-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">scene</code></dt>
     <dd>
      <p class="para">
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagescene-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagescene-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagescene.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagescene%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagescene&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagescene.php">＋<small>add a note</small></a></span>
