...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-exec.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-escape-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-execute.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-exec.php' selected="selected">English</option>
            ...
            <option value='tr/function.db2-exec.php'>Turkish</option>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-prepare.php" class="function" rel="rdfs-seeAlso">db2_prepare()</a> - Prepares an SQL statement to be executed</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-exec.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-exec%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-exec&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-exec.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">If you need to "emulate" offset/limit (as PEAR::DB puts it) for db2 queries, you will definitely need to add array('cursor' =&gt; DB2_SCROLLABLE) to your db2_exec() call. Otherwise, you will get nothing useful from db2_fetch_{whatever}() when you try to (see following hack for example):
<br />
<br /><span class="default">&lt;?php
<br />$limit </span><span class="keyword">= </span><span class="default">10</span><span class="keyword">;
<br /></span><span class="default">$offset </span><span class="keyword">= </span><span class="default">20</span><span class="keyword">;
<br />
<br />for (</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$limit </span><span class="keyword">&amp;&amp; </span><span class="default">$row </span><span class="keyword">= </span><span class="default">db2_fetch_array</span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">, </span><span class="default">$offset </span><span class="keyword">+ </span><span class="default">$i</span><span class="keyword">); </span><span class="default">$i</span><span class="keyword">++) {
<br />    </span><span class="comment">// stuff goes here
<br /></span><span class="keyword">}
<br /></span><span class="default">?&gt;
<br /></span>
<br />You can accomplish the same time of thing using sub-selects, "with" statements and other things new to me in the world of DB2, but the more dynamically generated the queries, the more difficult it gets to implement limit/offset behavior on the fly.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.db2-exec&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-exec.php">＋<small>add a note</small></a></div>
