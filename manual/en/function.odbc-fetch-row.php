...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.odbc-fetch-row.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.odbc-fetch-object.php">
 <link rel="next" href="https://www.php.net/manual/en/function.odbc-field-len.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.odbc-fetch-row.php' selected="selected">English</option>
  ...
  instance now; previously, a <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> was expected.
     ...
     <tr>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/uodbc/functions/odbc-fetch-row.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.odbc-fetch-row%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.odbc-fetch-row&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.odbc-fetch-row.php">＋<small>add a note</small></a></span>
