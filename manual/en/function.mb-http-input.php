...
<head>
  ...
  <title>PHP: mb_http_input - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-http-input.php">
 <link rel="shorturl" href="https://www.php.net/mb-http-input">
 <link rel="alternate" href="https://www.php.net/mb-http-input" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-get-info.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-http-output.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-http-input.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-http-input.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-http-input.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-http-input.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-http-input.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-http-input.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-http-input.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-http-input.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-http-input.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-http-input.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-http-input.php" hreflang="zh">
...
<meta name="Description" content="Detect HTTP input character encoding" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_http_input - Manual" />
<meta name="twitter:description" content="Detect HTTP input character encoding" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_http_input - Manual" />
<meta itemprop="description" content="Detect HTTP input character encoding" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Detect HTTP input character encoding" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-http-input.php' selected="selected">English</option>
            <option value='de/function.mb-http-input.php'>German</option>
            <option value='es/function.mb-http-input.php'>Spanish</option>
            <option value='fr/function.mb-http-input.php'>French</option>
            <option value='it/function.mb-http-input.php'>Italian</option>
            <option value='ja/function.mb-http-input.php'>Japanese</option>
            <option value='pt_BR/function.mb-http-input.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-http-input.php'>Russian</option>
            <option value='tr/function.mb-http-input.php'>Turkish</option>
            <option value='uk/function.mb-http-input.php'>Ukrainian</option>
            <option value='zh/function.mb-http-input.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-http-input" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-detect-order.php" class="function" rel="rdfs-seeAlso">mb_detect_order()</a> - Set/Get character encoding detection order</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-http-input.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-http-input%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-http-input&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-http-input.php">＋<small>add a note</small></a></span>
