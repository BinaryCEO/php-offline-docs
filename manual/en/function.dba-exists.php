...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.dba-exists.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.dba-delete.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dba-fetch.php">
...
<meta name="Description" content="Check whether key exists" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: dba_exists - Manual" />
<meta name="twitter:description" content="Check whether key exists" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: dba_exists - Manual" />
<meta itemprop="description" content="Check whether key exists" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Check whether key exists" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.dba-exists.php' selected="selected">English</option>
            <option value='de/function.dba-exists.php'>German</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">dba_exists</span> &mdash; <span class="dc-title">Check whether key exists</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.dba-exists-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>dba_exists()</strong></span> checks whether the specified
   <code class="parameter">key</code> exists in the database.
  </p>
 </div>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.dba-exists-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if the key exists, <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> otherwise.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.dba-replace.php" class="function" rel="rdfs-seeAlso">dba_replace()</a> - Replace or insert entry</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/dba/functions/dba-exists.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.dba-exists%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.dba-exists&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dba-exists.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>frenzy dot ivan at gmail dot com</em></strong></a><a class="genanchor" href="#87264"> &para;</a><div class="date" title="2008-11-26 05:37"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom87264">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php
<br />
<br />$index </span><span class="keyword">= </span><span class="default">4</span><span class="keyword">;
<br /></span><span class="default">$id </span><span class="keyword">= </span><span class="default">dba_open</span><span class="keyword">(</span><span class="string">"frenzy.db"</span><span class="keyword">, </span><span class="string">"w"</span><span class="keyword">, </span><span class="string">"flatfile"</span><span class="keyword">);
<br />if(!</span><span class="default">$id</span><span class="keyword">) exit (</span><span class="string">"Some error..."</span><span class="keyword">);
<br />if(</span><span class="default">dba_exists</span><span class="keyword">(</span><span class="default">$index</span><span class="keyword">, </span><span class="default">$id</span><span class="keyword">)) exit (</span><span class="string">"This key is using"</span><span class="keyword">);
<br /></span><span class="default">dba_close</span><span class="keyword">(</span><span class="default">$id</span><span class="keyword">);
<br />
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.dba-exists&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.dba-exists.php">＋<small>add a note</small></a></div>
