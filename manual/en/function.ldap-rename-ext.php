...
<head>
  ...
  <title>PHP: ldap_rename_ext - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ldap-rename-ext.php">
 <link rel="shorturl" href="https://www.php.net/ldap-rename-ext">
 <link rel="alternate" href="https://www.php.net/ldap-rename-ext" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ldap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ldap-rename.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ldap-sasl-bind.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ldap-rename-ext.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ldap-rename-ext.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ldap-rename-ext.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ldap-rename-ext.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ldap-rename-ext.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ldap-rename-ext.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ldap-rename-ext.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ldap-rename-ext.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ldap-rename-ext.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ldap-rename-ext.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ldap-rename-ext.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: ldap_rename_ext - Manual" />
<meta name="twitter:description" content="Modify the name of an entry" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ldap_rename_ext - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ldap-rename-ext.php' selected="selected">English</option>
            <option value='de/function.ldap-rename-ext.php'>German</option>
            <option value='es/function.ldap-rename-ext.php'>Spanish</option>
            <option value='fr/function.ldap-rename-ext.php'>French</option>
            <option value='it/function.ldap-rename-ext.php'>Italian</option>
            <option value='ja/function.ldap-rename-ext.php'>Japanese</option>
            <option value='pt_BR/function.ldap-rename-ext.php'>Brazilian Portuguese</option>
            <option value='ru/function.ldap-rename-ext.php'>Russian</option>
            <option value='tr/function.ldap-rename-ext.php'>Turkish</option>
            <option value='uk/function.ldap-rename-ext.php'>Ukrainian</option>
            <option value='zh/function.ldap-rename-ext.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ldap-rename-ext" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ldap_rename_ext</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.3.0, PHP 8)</p><p class="refpurpose"><span class="refname">ldap_rename_ext</span> &mdash; <span class="dc-title">Modify the name of an entry</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ldap-rename-ext-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ldap_rename_ext</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="class.ldap-connection.php" class="type LDAP\Connection">LDAP\Connection</a></span> <code class="parameter">$ldap</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$dn</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$new_rdn</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$new_parent</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$delete_old_rdn</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.array.php" class="type array">array</a></span></span> <code class="parameter">$controls</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><span class="type"><a href="class.ldap-result.php" class="type LDAP\Result">LDAP\Result</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Does the same thing as <span class="function"><a href="function.ldap-rename.php" class="function">ldap_rename()</a></span> but returns
 ...
 <div class="refsect1 parameters" id="refsect1-function.ldap-rename-ext-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
    See <span class="function"><a href="function.ldap-rename.php" class="function">ldap_rename()</a></span>
  </p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.ldap-rename-ext-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns an <span class="classname"><a href="class.ldap-result.php" class="classname">LDAP\Result</a></span> instance, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.ldap-rename-ext-changelog">
 ...
 <div class="refsect1 seealso" id="refsect1-function.ldap-rename-ext-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ldap-parse-result.php" class="function" rel="rdfs-seeAlso">ldap_parse_result()</a> - Extract information from result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ldap/functions/ldap-rename-ext.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ldap-rename-ext%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ldap-rename-ext&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ldap-rename-ext.php">＋<small>add a note</small></a></span>
