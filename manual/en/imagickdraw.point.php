...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.point.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.point.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.point.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.pathstart.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.polygon.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.point.php' selected="selected">English</option>
            <option value='de/imagickdraw.point.php'>German</option>
 ...
 <div class="refsect1 examples" id="refsect1-imagickdraw.point-examples">
  ...
  <p class="para">
    <div class="example" id="example-3157">
      <p><strong>Example #1 <span class="function"><strong>ImagickDraw::point()</strong></span> example</strong></p>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/point.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.point%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.point&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.point.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>Brian</em></strong></a><a class="genanchor" href="#113534"> &para;</a><div class="date" title="2013-10-26 04:19"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113534">
<div class="phpcode"><code><span class="html">This no longer uses the fill color.  It now uses the stroke color, consistent with the documentation.</span></code></div>
  </div>
 </div>
...
<div class="phpcode"><code><span class="html">point($x, $y) uses the FillColor of ImagickDraw! This actually took quite a while, till I found out that it's falsely documented on these pages. So to draw single pixels, do it like this:
<br />
...
<br /></span><span class="default">$pixel </span><span class="keyword">= new </span><span class="default">ImagickPixel</span><span class="keyword">(</span><span class="string">'red'</span><span class="keyword">);
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">newImage</span><span class="keyword">(</span><span class="default">10</span><span class="keyword">, </span><span class="default">10</span><span class="keyword">, </span><span class="string">'transparent'</span><span class="keyword">, </span><span class="string">'gif'</span><span class="keyword">);
<br />
<br /></span><span class="comment">// Here comes the magick:
<br /></span><span class="default">$pixel</span><span class="keyword">-&gt;</span><span class="default">setColor</span><span class="keyword">(</span><span class="default">$_POST</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">.</span><span class="string">"x"</span><span class="keyword">.</span><span class="default">$j</span><span class="keyword">]);
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">setFillColor</span><span class="keyword">(</span><span class="default">$pixel</span><span class="keyword">);
<br /></span><span class="default">$draw</span><span class="keyword">-&gt;</span><span class="default">point</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">,</span><span class="default">$j</span><span class="keyword">);
<br />
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">drawImage</span><span class="keyword">(</span><span class="default">$draw</span><span class="keyword">);
<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);
<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagickdraw.point&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.point.php">＋<small>add a note</small></a></div>
