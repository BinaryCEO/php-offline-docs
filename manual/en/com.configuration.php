...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/com.configuration.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/com.configuration.php">
 <link rel="alternate" href="https://www.php.net/manual/en/com.configuration.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/com.setup.php">
 <link rel="prev" href="https://www.php.net/manual/en/com.installation.php">
 <link rel="next" href="https://www.php.net/manual/en/com.constants.php">

 <link rel="alternate" href="https://www.php.net/manual/en/com.configuration.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/com.configuration.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/com.configuration.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/com.configuration.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/com.configuration.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/com.configuration.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/com.configuration.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/com.configuration.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/com.configuration.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/com.configuration.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/com.configuration.php" hreflang="zh">
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="com.constants.php">
          Predefined Constants &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="com.installation.php">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/com.configuration.php' selected="selected">English</option>
            <option value='de/com.configuration.php'>German</option>
            <option value='es/com.configuration.php'>Spanish</option>
            <option value='fr/com.configuration.php'>French</option>
            <option value='it/com.configuration.php'>Italian</option>
            <option value='ja/com.configuration.php'>Japanese</option>
            <option value='pt_BR/com.configuration.php'>Brazilian Portuguese</option>
            <option value='ru/com.configuration.php'>Russian</option>
            <option value='tr/com.configuration.php'>Turkish</option>
            <option value='uk/com.configuration.php'>Ukrainian</option>
            <option value='zh/com.configuration.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="com.configuration" class="section">
    ...
    <p class="para">
     ...
     insensitively.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/com/ini.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fcom.configuration%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=com.configuration&amp;repo=en&amp;redirect=https://www.php.net/manual/en/com.configuration.php">＋<small>add a note</small></a></span>
