...
<head>
  ...
  <title>PHP: fbird_errmsg - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-errmsg.php">
 <link rel="shorturl" href="https://www.php.net/fbird-errmsg">
 <link rel="alternate" href="https://www.php.net/fbird-errmsg" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-errcode.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fbird-execute.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-errmsg.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-errmsg.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-errmsg.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-errmsg.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-errmsg.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-errmsg.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-errmsg.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-errmsg.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-errmsg.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-errmsg.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-errmsg.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_errmsg" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_errmsg - Manual" />
<meta name="twitter:description" content="Alias of ibase_errmsg" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_errmsg - Manual" />
<meta itemprop="description" content="Alias of ibase_errmsg" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_errmsg" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-errmsg.php' selected="selected">English</option>
            <option value='de/function.fbird-errmsg.php'>German</option>
            <option value='es/function.fbird-errmsg.php'>Spanish</option>
            <option value='fr/function.fbird-errmsg.php'>French</option>
            <option value='it/function.fbird-errmsg.php'>Italian</option>
            <option value='ja/function.fbird-errmsg.php'>Japanese</option>
            <option value='pt_BR/function.fbird-errmsg.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-errmsg.php'>Russian</option>
            <option value='tr/function.fbird-errmsg.php'>Turkish</option>
            <option value='uk/function.fbird-errmsg.php'>Ukrainian</option>
            <option value='zh/function.fbird-errmsg.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-errmsg" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_errmsg</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_errmsg</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-errmsg.php" class="function">ibase_errmsg()</a></span></span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.fbird-errmsg-description">
  <h3 class="title">Description</h3>
  <p class="simpara">
   This function is an alias of: 
   <span class="function"><a href="function.ibase-errmsg.php" class="function">ibase_errmsg()</a></span>.
  </p>
 </div>


 <div class="refsect1 seealso" id="refsect1-function.fbird-errmsg-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.fbird-errcode.php" class="function" rel="rdfs-seeAlso">fbird_errcode()</a> - Alias of ibase_errcode</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-errmsg.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-errmsg%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-errmsg&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-errmsg.php">＋<small>add a note</small></a></span>
