...
<head>
  ...
  <title>PHP: ImagickDraw::setClipUnits - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagickdraw.setclipunits.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagickdraw.setclipunits.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setclipunits.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagickdraw.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagickdraw.setcliprule.php">
 <link rel="next" href="https://www.php.net/manual/en/imagickdraw.setfillalpha.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagickdraw.setclipunits.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagickdraw.setclipunits.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagickdraw.setclipunits.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagickdraw.setclipunits.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagickdraw.setclipunits.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagickdraw.setclipunits.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagickdraw.setclipunits.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagickdraw.setclipunits.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagickdraw.setclipunits.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagickdraw.setclipunits.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagickdraw.setclipunits.php" hreflang="zh">
...
<meta name="Description" content="Sets the interpretation of clip path units" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ImagickDraw::setClipUnits - Manual" />
<meta name="twitter:description" content="Sets the interpretation of clip path units" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ImagickDraw::setClipUnits - Manual" />
<meta itemprop="description" content="Sets the interpretation of clip path units" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the interpretation of clip path units" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagickdraw.setfillalpha.php">
          ImagickDraw::setFillAlpha &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagickdraw.setcliprule.php">
          &laquo; ImagickDraw::setClipRule        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagickdraw.setclipunits.php' selected="selected">English</option>
            <option value='de/imagickdraw.setclipunits.php'>German</option>
            <option value='es/imagickdraw.setclipunits.php'>Spanish</option>
            <option value='fr/imagickdraw.setclipunits.php'>French</option>
            <option value='it/imagickdraw.setclipunits.php'>Italian</option>
            <option value='ja/imagickdraw.setclipunits.php'>Japanese</option>
            <option value='pt_BR/imagickdraw.setclipunits.php'>Brazilian Portuguese</option>
            <option value='ru/imagickdraw.setclipunits.php'>Russian</option>
            <option value='tr/imagickdraw.setclipunits.php'>Turkish</option>
            <option value='uk/imagickdraw.setclipunits.php'>Ukrainian</option>
            <option value='zh/imagickdraw.setclipunits.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagickdraw.setclipunits" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ImagickDraw::setClipUnits</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">ImagickDraw::setClipUnits</span> &mdash; <span class="dc-title">Sets the interpretation of clip path units</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagickdraw.setclipunits-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>ImagickDraw::setClipUnits</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$pathunits</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
currently not documented; only its argument list is available.
 ...
 <div class="refsect1 parameters" id="refsect1-imagickdraw.setclipunits-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">pathunits</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagickdraw.setclipunits-returnvalues">
  ...
  <p class="para">
    <div class="example" id="example-3169">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagickdraw/setclipunits.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagickdraw.setclipunits%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagickdraw.setclipunits&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagickdraw.setclipunits.php">＋<small>add a note</small></a></span>
