...
<head>
  ...
  <title>PHP: array_reverse - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.array-reverse.php">
 <link rel="shorturl" href="https://www.php.net/array-reverse">
 <link rel="alternate" href="https://www.php.net/array-reverse" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.array.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.array-replace-recursive.php">
 <link rel="next" href="https://www.php.net/manual/en/function.array-search.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.array-reverse.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.array-reverse.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.array-reverse.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.array-reverse.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.array-reverse.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.array-reverse.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.array-reverse.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.array-reverse.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.array-reverse.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.array-reverse.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.array-reverse.php" hreflang="zh">
...
<meta name="Description" content="Return an array with elements in reverse order" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: array_reverse - Manual" />
<meta name="twitter:description" content="Return an array with elements in reverse order" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: array_reverse - Manual" />
<meta itemprop="description" content="Return an array with elements in reverse order" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return an array with elements in reverse order" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.array-replace-recursive.php">
          &laquo; array_replace_recursive        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.array-reverse.php' selected="selected">English</option>
            <option value='de/function.array-reverse.php'>German</option>
            <option value='es/function.array-reverse.php'>Spanish</option>
            <option value='fr/function.array-reverse.php'>French</option>
            <option value='it/function.array-reverse.php'>Italian</option>
            <option value='ja/function.array-reverse.php'>Japanese</option>
            <option value='pt_BR/function.array-reverse.php'>Brazilian Portuguese</option>
            <option value='ru/function.array-reverse.php'>Russian</option>
            <option value='tr/function.array-reverse.php'>Turkish</option>
            <option value='uk/function.array-reverse.php'>Ukrainian</option>
            <option value='zh/function.array-reverse.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.array-reverse" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">array_reverse</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">array_reverse</span> &mdash; <span class="dc-title">Return an array with elements in reverse order</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.array-reverse-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>array_reverse</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$array</code></span>, <span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$preserve_keys</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span>): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>

  <p class="para rdfs-comment">
   Takes an input <code class="parameter">array</code> and returns a new array with
 ...
 <div class="refsect1 parameters" id="refsect1-function.array-reverse-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       If set to <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> numeric keys are preserved. 
...
(
 ...
 <div class="refsect1 seealso" id="refsect1-function.array-reverse-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.array-flip.php" class="function" rel="rdfs-seeAlso">array_flip()</a> - Exchanges all keys with their associated values in an array</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/array/functions/array-reverse.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.array-reverse%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.array-reverse&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.array-reverse.php">＋<small>add a note</small></a></span>
