...
<head>
  ...
  <title>PHP: wincache_ucache_info - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.wincache-ucache-info.php">
 <link rel="shorturl" href="https://www.php.net/wincache-ucache-info">
 <link rel="alternate" href="https://www.php.net/wincache-ucache-info" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.wincache.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.wincache-ucache-inc.php">
 <link rel="next" href="https://www.php.net/manual/en/function.wincache-ucache-meminfo.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.wincache-ucache-info.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.wincache-ucache-info.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.wincache-ucache-info.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.wincache-ucache-info.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.wincache-ucache-info.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.wincache-ucache-info.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.wincache-ucache-info.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.wincache-ucache-info.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.wincache-ucache-info.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.wincache-ucache-info.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.wincache-ucache-info.php" hreflang="zh">
...
<meta name="Description" content="Retrieves information about data stored in the user cache" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: wincache_ucache_info - Manual" />
<meta name="twitter:description" content="Retrieves information about data stored in the user cache" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: wincache_ucache_info - Manual" />
<meta itemprop="description" content="Retrieves information about data stored in the user cache" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Retrieves information about data stored in the user cache" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.wincache-ucache-meminfo.php">
          wincache_ucache_meminfo &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.wincache-ucache-inc.php">
          &laquo; wincache_ucache_inc        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.wincache-ucache-info.php' selected="selected">English</option>
            <option value='de/function.wincache-ucache-info.php'>German</option>
            <option value='es/function.wincache-ucache-info.php'>Spanish</option>
            <option value='fr/function.wincache-ucache-info.php'>French</option>
            <option value='it/function.wincache-ucache-info.php'>Italian</option>
            <option value='ja/function.wincache-ucache-info.php'>Japanese</option>
            <option value='pt_BR/function.wincache-ucache-info.php'>Brazilian Portuguese</option>
            <option value='ru/function.wincache-ucache-info.php'>Russian</option>
            <option value='tr/function.wincache-ucache-info.php'>Turkish</option>
            <option value='uk/function.wincache-ucache-info.php'>Ukrainian</option>
            <option value='zh/function.wincache-ucache-info.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.wincache-ucache-info" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.wincache-ucache-info-returnvalues">
  ...
  <p class="para">
   Array of meta data about user cache  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure
  </p>
    <p class="para">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.wincache-scache-meminfo.php" class="function" rel="rdfs-seeAlso">wincache_scache_meminfo()</a> - Retrieves information about session cache memory usage</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/wincache/functions/wincache-ucache-info.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.wincache-ucache-info%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.wincache-ucache-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-info.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="96575">  <div class="votes">
    <div id="Vu96575">
    <a href="/manual/vote-note.php?id=96575&amp;page=function.wincache-ucache-info&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd96575">
    <a href="/manual/vote-note.php?id=96575&amp;page=function.wincache-ucache-info&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V96575" title="100% like this...">
    1
    </div>
  </div>
  <a href="#96575" class="name">
  <strong class="user"><em>don dot raman at microsoft dot com</em></strong></a><a class="genanchor" href="#96575"> &para;</a><div class="date" title="2010-03-05 11:53"><strong>15 years ago</strong></div>
  <div class="text" id="Hcom96575">
<div class="phpcode"><code><span class="html">One thing to note is that 'is_local_cache' field returned as one of the metadata in the array for User Cache will always return boolean false as User Cache is always global and never local.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.wincache-ucache-info&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.wincache-ucache-info.php">＋<small>add a note</small></a></div>
