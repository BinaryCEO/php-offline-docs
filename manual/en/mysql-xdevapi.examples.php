...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysql-xdevapi.examples.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysql-xdevapi.examples.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi.examples.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.mysql-xdevapi.php">
 <link rel="prev" href="https://www.php.net/manual/en/changelog.mysql_xdevapi.php">
 <link rel="next" href="https://www.php.net/manual/en/ref.mysql-xdevapi.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysql-xdevapi.examples.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysql-xdevapi.examples.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysql-xdevapi.examples.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysql-xdevapi.examples.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysql-xdevapi.examples.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysql-xdevapi.examples.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysql-xdevapi.examples.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysql-xdevapi.examples.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysql-xdevapi.examples.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysql-xdevapi.examples.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysql-xdevapi.examples.php" hreflang="zh">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysql-xdevapi.examples.php' selected="selected">English</option>
            <option value='de/mysql-xdevapi.examples.php'>German</option>
            <option value='es/mysql-xdevapi.examples.php'>Spanish</option>
            <option value='fr/mysql-xdevapi.examples.php'>French</option>
            <option value='it/mysql-xdevapi.examples.php'>Italian</option>
            <option value='ja/mysql-xdevapi.examples.php'>Japanese</option>
            <option value='pt_BR/mysql-xdevapi.examples.php'>Brazilian Portuguese</option>
            <option value='ru/mysql-xdevapi.examples.php'>Russian</option>
            <option value='tr/mysql-xdevapi.examples.php'>Turkish</option>
            <option value='uk/mysql-xdevapi.examples.php'>Ukrainian</option>
            <option value='zh/mysql-xdevapi.examples.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysql-xdevapi.examples" class="chapter">
 ...
 <p class="para">
  ...
  <span class="classname"><a href="class.mysql-xdevapi-session.php" class="classname">mysql_xdevapi\Session</a></span> object.
 </p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br />$schema </span><span style="color: #007700">= </span><span style="color: #0000BB">$session</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">createSchema</span><span style="color: #007700">(</span><span style="color: #DD0000">"test"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">$collection </span><span style="color: #007700">= </span><span style="color: #0000BB">$schema</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">createCollection</span><span style="color: #007700">(</span><span style="color: #DD0000">"example"</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <p class="para">
  When storing data, typically <span class="function"><a href="function.json-encode.php" class="function">json_encode()</a></span> is used to encode
...
Mike is a Manager.
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysql_xdevapi/examples.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysql-xdevapi.examples%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysql-xdevapi.examples&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysql-xdevapi.examples.php">＋<small>add a note</small></a></span>
