...
<head>
  ...
  <title>PHP: parallel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.parallel.php">
 <link rel="shorturl" href="https://www.php.net/parallel">
 <link rel="alternate" href="https://www.php.net/parallel" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/refs.fileprocess.process.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.system.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.parallel.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.parallel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.parallel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.parallel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.parallel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.parallel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.parallel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.parallel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.parallel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.parallel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.parallel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.parallel.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: parallel - Manual" />
<meta name="twitter:description" content="parallel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: parallel - Manual" />
<meta itemprop="description" content="parallel" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.parallel.php' selected="selected">English</option>
            <option value='de/book.parallel.php'>German</option>
            <option value='es/book.parallel.php'>Spanish</option>
            <option value='fr/book.parallel.php'>French</option>
            <option value='it/book.parallel.php'>Italian</option>
            <option value='ja/book.parallel.php'>Japanese</option>
            <option value='pt_BR/book.parallel.php'>Brazilian Portuguese</option>
            <option value='ru/book.parallel.php'>Russian</option>
            <option value='tr/book.parallel.php'>Turkish</option>
            <option value='uk/book.parallel.php'>Ukrainian</option>
            <option value='zh/book.parallel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.parallel" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.parallel.php">Introduction</a></li><li><a href="parallel.setup.php">Installation</a></li><li><a href="philosophy.parallel.php">Philosophy</a></li><li><a href="functional.parallel.php">Functional API</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="parallel.bootstrap.php">parallel\bootstrap</a> — Bootstrapping</li><li><a href="parallel.run.php">parallel\run</a> — Execution</li></ul></li><li><a href="class.parallel-runtime.php">parallel\Runtime</a> — The parallel\Runtime class<ul class="chunklist chunklist_book chunklist_children"><li><a href="parallel-runtime.construct.php">parallel\Runtime::__construct</a> — Runtime Construction</li><li><a href="parallel-runtime.run.php">parallel\Runtime::run</a> — Execution</li><li><a href="parallel-runtime.close.php">parallel\Runtime::close</a> — Runtime Graceful Join</li><li><a href="parallel-runtime.kill.php">parallel\Runtime::kill</a> — Runtime Join</li></ul></li><li><a href="class.parallel-future.php">parallel\Future</a> — The parallel\Future class<ul class="chunklist chunklist_book chunklist_children"><li><a href="parallel-future.cancel.php">parallel\Future::cancel</a> — Cancellation</li><li><a href="parallel-future.cancelled.php">parallel\Future::cancelled</a> — State Detection</li><li><a href="parallel-future.done.php">parallel\Future::done</a> — State Detection</li><li><a href="parallel-future.value.php">parallel\Future::value</a> — Resolution</li></ul></li><li><a href="class.parallel-channel.php">parallel\Channel</a> — The parallel\Channel class<ul class="chunklist chunklist_book chunklist_children"><li><a href="parallel-channel.construct.php">parallel\Channel::__construct</a> — Channel Construction</li><li><a href="parallel-channel.make.php">parallel\Channel::make</a> — Access</li><li><a href="parallel-channel.open.php">parallel\Channel::open</a> — Access</li><li><a href="parallel-channel.recv.php">parallel\Channel::recv</a> — Sharing</li><li><a href="parallel-channel.send.php">parallel\Channel::send</a> — Sharing</li><li><a href="parallel-channel.close.php">parallel\Channel::close</a> — Closing</li></ul></li><li><a href="class.parallel-events.php">parallel\Events</a> — The parallel\Events class<ul class="chunklist chunklist_book chunklist_children"><li><a href="parallel-events.setblocking.php">parallel\Events::setBlocking</a> — Behaviour</li><li><a href="parallel-events.settimeout.php">parallel\Events::setTimeout</a> — Behaviour</li><li><a href="parallel-events.setinput.php">parallel\Events::setInput</a> — Input</li><li><a href="parallel-events.addchannel.php">parallel\Events::addChannel</a> — Targets</li><li><a href="parallel-events.addfuture.php">parallel\Events::addFuture</a> — Targets</li><li><a href="parallel-events.remove.php">parallel\Events::remove</a> — Targets</li><li><a href="parallel-events.poll.php">parallel\Events::poll</a> — Polling</li></ul></li><li><a href="class.parallel-events-input.php">parallel\Events\Input</a> — The parallel\Events\Input class<ul class="chunklist chunklist_book chunklist_children"><li><a href="parallel-events-input.add.php">parallel\Events\Input::add</a> — Inputs</li><li><a href="parallel-events-input.clear.php">parallel\Events\Input::clear</a> — Inputs</li><li><a href="parallel-events-input.remove.php">parallel\Events\Input::remove</a> — Inputs</li></ul></li><li><a href="class.parallel-events-event.php">parallel\Events\Event</a> — The parallel\Events\Event class</li><li><a href="class.parallel-events-event-type.php">parallel\Events\Event\Type</a> — The parallel\Events\Event\Type class</li><li><a href="class.parallel-sync.php">parallel\Sync</a> — The parallel\Sync class<ul class="chunklist chunklist_book chunklist_children"><li><a href="parallel-sync.construct.php">parallel\Sync::__construct</a> — Construction</li><li><a href="parallel-sync.get.php">parallel\Sync::get</a> — Access</li><li><a href="parallel-sync.set.php">parallel\Sync::set</a> — Access</li><li><a href="parallel-sync.wait.php">parallel\Sync::wait</a> — Synchronization</li><li><a href="parallel-sync.notify.php">parallel\Sync::notify</a> — Synchronization</li><li><a href="parallel-sync.invoke.php">parallel\Sync::__invoke</a> — Synchronization</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.parallel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.parallel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.parallel.php">＋<small>add a note</small></a></span>
