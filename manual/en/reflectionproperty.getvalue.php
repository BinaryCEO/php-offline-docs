...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.getvalue.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.getvalue.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.getvalue.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.gettype.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.hasdefaultvalue.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.getvalue.php' selected="selected">English</option>
            ...
            <option value='zh/reflectionproperty.getvalue.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-reflectionproperty.getvalue-examples">
  ...
  <p class="para">
   <div class="example" id="example-5606">
    <p><strong>Example #1 <span class="methodname"><strong>ReflectionProperty::getValue()</strong></span> example</strong></p>
 ...
 <div class="refsect1 seealso" id="refsect1-reflectionproperty.getvalue-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="reflectionclass.getdefaultproperties.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getDefaultProperties()</a> - Gets default properties</span></li>
    <li><span class="methodname"><a href="reflectionclass.getstaticpropertyvalue.php" class="methodname" rel="rdfs-seeAlso">ReflectionClass::getStaticPropertyValue()</a> - Gets static property value</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/getvalue.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.getvalue%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.getvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.getvalue.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">To allow protected and private properties to be accessed, you should use<br />ReflectionProperty::setAccessible(bool $accessible):<br /><br /><span class="default">&lt;?php<br /></span><span class="comment">/** Class Foo with protected and private members */<br /></span><span class="keyword">class </span><span class="default">Foo </span><span class="keyword">{<br />    protected </span><span class="default">$bar </span><span class="keyword">= </span><span class="string">'barrr!'</span><span class="keyword">;<br />    private </span><span class="default">$baz </span><span class="keyword">= </span><span class="string">'bazzz!'</span><span class="keyword">;<br />}<br /><br /></span><span class="default">$reflFoo </span><span class="keyword">= new </span><span class="default">ReflectionClass</span><span class="keyword">(</span><span class="string">'Foo'</span><span class="keyword">);<br /></span><span class="default">$reflBar </span><span class="keyword">= </span><span class="default">$reflFoo</span><span class="keyword">-&gt;</span><span class="default">getProperty</span><span class="keyword">(</span><span class="string">'bar'</span><span class="keyword">);<br /></span><span class="default">$reflBaz </span><span class="keyword">= </span><span class="default">$reflFoo</span><span class="keyword">-&gt;</span><span class="default">getProperty</span><span class="keyword">(</span><span class="string">'baz'</span><span class="keyword">);<br /><br /></span><span class="comment">// Set private and protected members accessible for getValue/setValue<br /></span><span class="default">$reflBar</span><span class="keyword">-&gt;</span><span class="default">setAccessible</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">);<br /></span><span class="default">$reflBaz</span><span class="keyword">-&gt;</span><span class="default">setAccessible</span><span class="keyword">(</span><span class="default">true</span><span class="keyword">);<br /><br /></span><span class="default">$foo </span><span class="keyword">= new </span><span class="default">Foo</span><span class="keyword">();<br />echo </span><span class="default">$reflBar</span><span class="keyword">-&gt;</span><span class="default">getValue</span><span class="keyword">(</span><span class="default">$foo</span><span class="keyword">); </span><span class="comment">// will output "barrr!"<br /></span><span class="keyword">echo </span><span class="default">$reflBaz</span><span class="keyword">-&gt;</span><span class="default">getValue</span><span class="keyword">(</span><span class="default">$foo</span><span class="keyword">); </span><span class="comment">// will output "bazzz!"<br /><br />// You can also setValue<br /></span><span class="default">$reflBar</span><span class="keyword">-&gt;</span><span class="default">setValue</span><span class="keyword">(</span><span class="default">$foo</span><span class="keyword">, </span><span class="string">"new value"</span><span class="keyword">);<br />echo </span><span class="default">$reflBar</span><span class="keyword">-&gt;</span><span class="default">getValue</span><span class="keyword">(</span><span class="default">$foo</span><span class="keyword">); </span><span class="comment">// will output "new value"<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionproperty.getvalue&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.getvalue.php">＋<small>add a note</small></a></div>
