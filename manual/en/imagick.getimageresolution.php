...
<head>
  ...
  <title>PHP: Imagick::getImageResolution - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getimageresolution.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getimageresolution.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageresolution.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getimagerenderingintent.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getimagesblob.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getimageresolution.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.getimageresolution.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.getimageresolution.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.getimageresolution.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.getimageresolution.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.getimageresolution.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.getimageresolution.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.getimageresolution.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.getimageresolution.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.getimageresolution.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.getimageresolution.php" hreflang="zh">
...
<meta name="Description" content="Gets the image X and Y resolution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getImageResolution - Manual" />
<meta name="twitter:description" content="Gets the image X and Y resolution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getImageResolution - Manual" />
<meta itemprop="description" content="Gets the image X and Y resolution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image X and Y resolution" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.getimagesblob.php">
          Imagick::getImagesBlob &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.getimagerenderingintent.php">
          &laquo; Imagick::getImageRenderingIntent        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getimageresolution.php' selected="selected">English</option>
            <option value='de/imagick.getimageresolution.php'>German</option>
            <option value='es/imagick.getimageresolution.php'>Spanish</option>
            <option value='fr/imagick.getimageresolution.php'>French</option>
            <option value='it/imagick.getimageresolution.php'>Italian</option>
            <option value='ja/imagick.getimageresolution.php'>Japanese</option>
            <option value='pt_BR/imagick.getimageresolution.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.getimageresolution.php'>Russian</option>
            <option value='tr/imagick.getimageresolution.php'>Turkish</option>
            <option value='uk/imagick.getimageresolution.php'>Ukrainian</option>
            <option value='zh/imagick.getimageresolution.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.getimageresolution" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-imagick.getimageresolution-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::getImageResolution</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.getimageresolution-parameters">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getimageresolution.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getimageresolution%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getimageresolution&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageresolution.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="114440">  <div class="votes">
    <div id="Vu114440">
    <a href="/manual/vote-note.php?id=114440&amp;page=imagick.getimageresolution&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd114440">
    <a href="/manual/vote-note.php?id=114440&amp;page=imagick.getimageresolution&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V114440" title="68% like this...">
    6
    </div>
  </div>
  <a href="#114440" class="name">
  <strong class="user"><em>christian at cvj dot se</em></strong></a><a class="genanchor" href="#114440"> &para;</a><div class="date" title="2014-02-20 11:48"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom114440">
<div class="phpcode"><code><span class="html">For me getImageResolution() always returns X and Y resolution in pixels per centimeter, no matter if I set it with setImageUnits() or not.<br /><br />So an easy way to convert the result from pixels per centimeter to pixels per inch is to do this:<br /><br /><span class="default">&lt;?php<br />$resource </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">);<br /></span><span class="default">$imageResolution </span><span class="keyword">= </span><span class="default">$resource</span><span class="keyword">-&gt;</span><span class="default">getImageResolution</span><span class="keyword">();<br /><br />if (!empty(</span><span class="default">$imageResolution</span><span class="keyword">[</span><span class="string">'y'</span><span class="keyword">])) { <br /></span><span class="default">$imageResolution</span><span class="keyword">[</span><span class="string">'y'</span><span class="keyword">] = <br />                            </span><span class="default">round</span><span class="keyword">(</span><span class="default">$imageResolution</span><span class="keyword">[</span><span class="string">'y'</span><span class="keyword">] * </span><span class="default">2.54</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);<br />}<br /><br />if (!empty(</span><span class="default">$imageResolution</span><span class="keyword">[</span><span class="string">'x'</span><span class="keyword">])) {<br /></span><span class="default">$imageResolution</span><span class="keyword">[</span><span class="string">'x'</span><span class="keyword">] = <br />                            </span><span class="default">round</span><span class="keyword">(</span><span class="default">$imageResolution</span><span class="keyword">[</span><span class="string">'x'</span><span class="keyword">] * </span><span class="default">2.54</span><span class="keyword">, </span><span class="default">2</span><span class="keyword">);<br />}<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="113279">  <div class="votes">
    <div id="Vu113279">
    <a href="/manual/vote-note.php?id=113279&amp;page=imagick.getimageresolution&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113279">
    <a href="/manual/vote-note.php?id=113279&amp;page=imagick.getimageresolution&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113279" title="66% like this...">
    3
    </div>
  </div>
  <a href="#113279" class="name">
  <strong class="user"><em>Simon Epskamp</em></strong></a><a class="genanchor" href="#113279"> &para;</a><div class="date" title="2013-09-20 08:30"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom113279">
<div class="phpcode"><code><span class="html">Please note that this method seems to return the image density, or DPI, not it's output resolution. If you want the output resolution, please refer to Imagick::getImageGeometry: <a href="http://www.php.net/manual/en/imagick.getimagegeometry.php" rel="nofollow" target="_blank">http://www.php.net/manual/en/imagick.getimagegeometry.php</a><br /><br />See <a href="http://www.imagemagick.org/Usage/basics/#density" rel="nofollow" target="_blank">http://www.imagemagick.org/Usage/basics/#density</a> for more infomation on the difference.</span></code></div>
  </div>
 </div>
  <div class="note" id="78271">  <div class="votes">
    <div id="Vu78271">
    <a href="/manual/vote-note.php?id=78271&amp;page=imagick.getimageresolution&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd78271">
    <a href="/manual/vote-note.php?id=78271&amp;page=imagick.getimageresolution&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V78271" title="66% like this...">
    1
    </div>
  </div>
  <a href="#78271" class="name">
  <strong class="user"><em>perching_eagle at yahoo dot com</em></strong></a><a class="genanchor" href="#78271"> &para;</a><div class="date" title="2007-10-04 06:14"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom78271">
<div class="phpcode"><code><span class="html">//location of image: c:/htdocs/rose.jpg<br />$path="c:/htdocs/";<br />$image=new Imagick($path."rose.jpg");<br />$array=$image-&gt;getImageResolution();<br />print_r($array);<br /><br />result:<br />Array<br />(<br />    [x]=&gt;75<br />    [y]=&gt;75<br />)</span></code></div>
  </div>
 </div>
  <div class="note" id="103531">  <div class="votes">
    <div id="Vu103531">
    <a href="/manual/vote-note.php?id=103531&amp;page=imagick.getimageresolution&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd103531">
    <a href="/manual/vote-note.php?id=103531&amp;page=imagick.getimageresolution&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V103531" title="50% like this...">
    0
    </div>
  </div>
  <a href="#103531" class="name">
  <strong class="user"><em>Shawn Pyle</em></strong></a><a class="genanchor" href="#103531"> &para;</a><div class="date" title="2011-04-18 12:53"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom103531">
<div class="phpcode"><code><span class="html">As of the following versions, the results of this function returns the x and y resolution as floats.<br /><br />desktop:~$ convert --version<br />Version: ImageMagick 6.6.9-1 2011-04-14 Q8 <a href="http://www.imagemagick.org" rel="nofollow" target="_blank">http://www.imagemagick.org</a><br />Copyright: Copyright (C) 1999-2011 ImageMagick Studio LLC<br />Features: OpenMP OpenCL <br /><br />desktop:~$ pecl list<br />Installed packages, channel pecl.php.net:<br />==========================<br />Package Version State<br />imagick 3.0.1   stable<br /><br />desktop:~$ php --version<br />PHP 5.3.5 (cli) (built: Mar  1 2011 12:57:53) <br />Copyright (c) 1997-2010 The PHP Group<br />Zend Engine v2.3.0, Copyright (c) 1998-2010 Zend Technologies<br />    with Xdebug v2.1.0, Copyright (c) 2002-2010, by Derick Rethans</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.getimageresolution&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getimageresolution.php">＋<small>add a note</small></a></div>
