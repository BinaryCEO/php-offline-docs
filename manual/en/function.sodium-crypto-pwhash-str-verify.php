...
<head>
  ...
  <title>PHP: sodium_crypto_pwhash_str_verify - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-pwhash-str-verify.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-pwhash-str-verify">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-pwhash-str-verify" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-pwhash-str-needs-rehash.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-scalarmult.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-pwhash-str-verify.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-pwhash-str-verify.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-pwhash-str-verify.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-pwhash-str-verify.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-pwhash-str-verify.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-pwhash-str-verify.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-pwhash-str-verify.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-pwhash-str-verify.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-pwhash-str-verify.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-pwhash-str-verify.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-pwhash-str-verify.php" hreflang="zh">
...
<meta name="Description" content="Verifies that a password matches a hash" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_pwhash_str_verify - Manual" />
<meta name="twitter:description" content="Verifies that a password matches a hash" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_pwhash_str_verify - Manual" />
<meta itemprop="description" content="Verifies that a password matches a hash" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verifies that a password matches a hash" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-scalarmult.php">
          sodium_crypto_scalarmult &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-pwhash-str-needs-rehash.php">
          &laquo; sodium_crypto_pwhash_str_needs_rehash        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-pwhash-str-verify.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-pwhash-str-verify.php'>German</option>
            <option value='es/function.sodium-crypto-pwhash-str-verify.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-pwhash-str-verify.php'>French</option>
            <option value='it/function.sodium-crypto-pwhash-str-verify.php'>Italian</option>
            <option value='ja/function.sodium-crypto-pwhash-str-verify.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-pwhash-str-verify.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-pwhash-str-verify.php'>Russian</option>
            <option value='tr/function.sodium-crypto-pwhash-str-verify.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-pwhash-str-verify.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-pwhash-str-verify.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-pwhash-str-verify" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.password-verify.php" class="function" rel="rdfs-seeAlso">password_verify()</a> - Verifies that a password matches a hash</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-pwhash-str-verify.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-pwhash-str-verify%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-pwhash-str-verify&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-pwhash-str-verify.php">＋<small>add a note</small></a></span>
