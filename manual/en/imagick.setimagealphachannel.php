...
<head>
  ...
  <title>PHP: Imagick::setImageAlphaChannel - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagealphachannel.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagealphachannel.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagealphachannel.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimageartifact.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagealphachannel.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagealphachannel.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagealphachannel.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagealphachannel.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagealphachannel.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagealphachannel.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagealphachannel.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagealphachannel.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagealphachannel.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagealphachannel.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagealphachannel.php" hreflang="zh">
...
<meta name="Description" content="Sets image alpha channel" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageAlphaChannel - Manual" />
<meta name="twitter:description" content="Sets image alpha channel" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageAlphaChannel - Manual" />
<meta itemprop="description" content="Sets image alpha channel" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets image alpha channel" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimageartifact.php">
          Imagick::setImageArtifact &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimage.php">
          &laquo; Imagick::setImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagealphachannel.php' selected="selected">English</option>
            <option value='de/imagick.setimagealphachannel.php'>German</option>
            <option value='es/imagick.setimagealphachannel.php'>Spanish</option>
            <option value='fr/imagick.setimagealphachannel.php'>French</option>
            <option value='it/imagick.setimagealphachannel.php'>Italian</option>
            <option value='ja/imagick.setimagealphachannel.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagealphachannel.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagealphachannel.php'>Russian</option>
            <option value='tr/imagick.setimagealphachannel.php'>Turkish</option>
            <option value='uk/imagick.setimagealphachannel.php'>Ukrainian</option>
            <option value='zh/imagick.setimagealphachannel.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagealphachannel" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageAlphaChannel</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.1.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageAlphaChannel</span> &mdash; <span class="dc-title">Sets image alpha channel</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagealphachannel-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageAlphaChannel</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Activate or deactivate image alpha channel. The <code class="parameter">mode</code> 
   is one of the <strong><code><a href="imagick.constants.php#imagick.constants.alphachannel-activate">Imagick::ALPHACHANNEL_<span class="replaceable">*</span></a></code></strong> constants.
   This method is available if Imagick has been compiled against ImageMagick version 6.3.8 or newer.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-imagick.setimagealphachannel-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       One of the <strong><code><a href="imagick.constants.php#imagick.constants.alphachannel-activate">Imagick::ALPHACHANNEL_<span class="replaceable">*</span></a></code></strong> constants
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagealphachannel-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagealphachannel-errors">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.setimagealphachannel-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.setimagematte.php" class="function" rel="rdfs-seeAlso">Imagick::setImageMatte()</a> - Sets the image matte channel</span></li>
    <li> <a href="imagick.constants.php#imagick.constants.alphachannel" class="link">Imagick Alpha Channel Constants</a></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagealphachannel.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagealphachannel%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagealphachannel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagealphachannel.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="124856">  <div class="votes">
    <div id="Vu124856">
    <a href="/manual/vote-note.php?id=124856&amp;page=imagick.setimagealphachannel&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd124856">
    <a href="/manual/vote-note.php?id=124856&amp;page=imagick.setimagealphachannel&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V124856" title="86% like this...">
    11
    </div>
  </div>
  <a href="#124856" class="name">
  <strong class="user"><em>simonjjarrett at gmail dot com</em></strong></a><a class="genanchor" href="#124856"> &para;</a><div class="date" title="2020-03-25 03:09"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom124856">
<div class="phpcode"><code><span class="html">If you're having trouble with white backgrounds turning black when converting PDFs to other formats, you need to use this function with Imagick::ALPHACHANNEL_REMOVE as the parameter (this is not currently on the constants page, but it exists in PHP 7.2) to remove the alpha channel.<br /><br /><span class="default">&lt;?php<br />$im</span><span class="keyword">-&gt;</span><span class="default">setImageAlphaChannel</span><span class="keyword">(</span><span class="default">Imagick</span><span class="keyword">::</span><span class="default">ALPHACHANNEL_REMOVE </span><span class="keyword">);<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagealphachannel&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagealphachannel.php">＋<small>add a note</small></a></div>
