...
<head>
  ...
  <title>PHP: closelog - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.closelog.php">
 <link rel="shorturl" href="https://www.php.net/closelog">
 <link rel="alternate" href="https://www.php.net/closelog" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.network.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.checkdnsrr.php">
 <link rel="next" href="https://www.php.net/manual/en/function.dns-check-record.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.closelog.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.closelog.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.closelog.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.closelog.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.closelog.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.closelog.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.closelog.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.closelog.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.closelog.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.closelog.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.closelog.php" hreflang="zh">
...
<meta name="Description" content="Close connection to system logger" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: closelog - Manual" />
<meta name="twitter:description" content="Close connection to system logger" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: closelog - Manual" />
<meta itemprop="description" content="Close connection to system logger" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Close connection to system logger" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.closelog.php' selected="selected">English</option>
            <option value='de/function.closelog.php'>German</option>
            <option value='es/function.closelog.php'>Spanish</option>
            <option value='fr/function.closelog.php'>French</option>
            <option value='it/function.closelog.php'>Italian</option>
            <option value='ja/function.closelog.php'>Japanese</option>
            <option value='pt_BR/function.closelog.php'>Brazilian Portuguese</option>
            <option value='ru/function.closelog.php'>Russian</option>
            <option value='tr/function.closelog.php'>Turkish</option>
            <option value='uk/function.closelog.php'>Ukrainian</option>
            <option value='zh/function.closelog.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.closelog" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">closelog</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">closelog</span> &mdash; <span class="dc-title">Close connection to system logger</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.closelog-description">
  ...
  <p class="para rdfs-comment">
   <span class="function"><strong>closelog()</strong></span> closes the descriptor being used to write to
   the system logger.  The use of <span class="function"><strong>closelog()</strong></span> is optional.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openlog.php" class="function" rel="rdfs-seeAlso">openlog()</a> - Open connection to system logger</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/network/functions/closelog.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.closelog%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.closelog&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.closelog.php">＋<small>add a note</small></a></span>
