...
<head>
  ...
  <title>PHP: Imagick::setImageBackgroundColor - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setimageattribute.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimagebias.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setimagebackgroundcolor.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setimagebackgroundcolor.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setimagebackgroundcolor.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setimagebackgroundcolor.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setimagebackgroundcolor.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setimagebackgroundcolor.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setimagebackgroundcolor.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setimagebackgroundcolor.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setimagebackgroundcolor.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setimagebackgroundcolor.php" hreflang="zh">
...
<meta name="Description" content="Sets the image background color" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setImageBackgroundColor - Manual" />
<meta name="twitter:description" content="Sets the image background color" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setImageBackgroundColor - Manual" />
<meta itemprop="description" content="Sets the image background color" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the image background color" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.setimagebias.php">
          Imagick::setImageBias &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setimageattribute.php">
          &laquo; Imagick::setImageAttribute        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setimagebackgroundcolor.php' selected="selected">English</option>
            <option value='de/imagick.setimagebackgroundcolor.php'>German</option>
            <option value='es/imagick.setimagebackgroundcolor.php'>Spanish</option>
            <option value='fr/imagick.setimagebackgroundcolor.php'>French</option>
            <option value='it/imagick.setimagebackgroundcolor.php'>Italian</option>
            <option value='ja/imagick.setimagebackgroundcolor.php'>Japanese</option>
            <option value='pt_BR/imagick.setimagebackgroundcolor.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setimagebackgroundcolor.php'>Russian</option>
            <option value='tr/imagick.setimagebackgroundcolor.php'>Turkish</option>
            <option value='uk/imagick.setimagebackgroundcolor.php'>Ukrainian</option>
            <option value='zh/imagick.setimagebackgroundcolor.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setimagebackgroundcolor" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setImageBackgroundColor</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setImageBackgroundColor</span> &mdash; <span class="dc-title">Sets the image background color</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setimagebackgroundcolor-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setImageBackgroundColor</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$background</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setimagebackgroundcolor-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setimagebackgroundcolor-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.setimagebackgroundcolor-errors">
 ...
 <div class="refsect1 changelog" id="refsect1-imagick.setimagebackgroundcolor-changelog">
   ...
   <table class="doctable informaltable">
     ...
     <tbody class="tbody">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setimagebackgroundcolor.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setimagebackgroundcolor%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setimagebackgroundcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="121447">  <div class="votes">
    <div id="Vu121447">
    <a href="/manual/vote-note.php?id=121447&amp;page=imagick.setimagebackgroundcolor&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd121447">
    <a href="/manual/vote-note.php?id=121447&amp;page=imagick.setimagebackgroundcolor&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V121447" title="44% like this...">
    -1
    </div>
  </div>
  <a href="#121447" class="name">
  <strong class="user"><em>mjunaidahmad at outlook dot com</em></strong></a><a class="genanchor" href="#121447"> &para;</a><div class="date" title="2017-07-28 06:02"><strong>8 years ago</strong></div>
  <div class="text" id="Hcom121447">
<div class="phpcode"><code><span class="html"><span class="default">&lt;?php<br /><br />  $im </span><span class="keyword">= new </span><span class="default">\Imagick</span><span class="keyword">();<br /><br />        </span><span class="comment">/* read image (914x784) */<br />   <br />     </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'DOCUMENT_ROOT'</span><span class="keyword">].</span><span class="string">"/path/toimage/"</span><span class="keyword">.</span><span class="default">$inputfront</span><span class="keyword">);<br />        <br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">setImageBackgroundColor</span><span class="keyword">(new </span><span class="default">\ImagickPixel</span><span class="keyword">(</span><span class="string">'transparent'</span><span class="keyword">)); </span><span class="comment">/* this is equal to -background none (in imagemagick command options ) */<br />  <br />        /*Control points for the distortion in order to check weather setImageBackgound is working properly*/<br /><br />        </span><span class="default">$controlPoints </span><span class="keyword">= array( </span><span class="default">0</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,<br />            </span><span class="default">280</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,<br /><br />            </span><span class="default">994</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,<br />            </span><span class="default">914</span><span class="keyword">,</span><span class="default">50</span><span class="keyword">,<br /><br />            </span><span class="default">994</span><span class="keyword">,</span><span class="default">862</span><span class="keyword">,<br />            </span><span class="default">784</span><span class="keyword">,</span><span class="default">842</span><span class="keyword">,<br /><br />            </span><span class="default">0</span><span class="keyword">,</span><span class="default">862</span><span class="keyword">,<br />            </span><span class="default">110</span><span class="keyword">,</span><span class="default">762</span><span class="keyword">);<br /><br />        </span><span class="comment">/* Perform the distortion */<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">distortImage</span><span class="keyword">(</span><span class="default">\Imagick</span><span class="keyword">::</span><span class="default">DISTORTION_PERSPECTIVE</span><span class="keyword">, </span><span class="default">$controlPoints</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">);<br /><br />        </span><span class="comment">/* Ouput the image */<br />        </span><span class="default">$output_front_distort</span><span class="keyword">=</span><span class="string">"Projects/path/where you want to store image/distorted_book.png"</span><span class="keyword">;<br />    <br />       </span><span class="default">header</span><span class="keyword">(</span><span class="string">"Content-Type: image/png"</span><span class="keyword">);<br />        </span><span class="default">$im</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'DOCUMENT_ROOT'</span><span class="keyword">].</span><span class="string">"/designerr/public/"</span><span class="keyword">.</span><span class="default">$output_front_distort</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setimagebackgroundcolor&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setimagebackgroundcolor.php">＋<small>add a note</small></a></div>
