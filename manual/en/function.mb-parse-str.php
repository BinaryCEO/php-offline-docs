...
<head>
  ...
  <title>PHP: mb_parse_str - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-parse-str.php">
 <link rel="shorturl" href="https://www.php.net/mb-parse-str">
 <link rel="alternate" href="https://www.php.net/mb-parse-str" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-output-handler.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-preferred-mime-name.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-parse-str.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-parse-str.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-parse-str.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-parse-str.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-parse-str.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-parse-str.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-parse-str.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-parse-str.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-parse-str.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-parse-str.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-parse-str.php" hreflang="zh">
...
<meta name="Description" content="Parse GET/POST/COOKIE data and set global variable" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mb_parse_str - Manual" />
<meta name="twitter:description" content="Parse GET/POST/COOKIE data and set global variable" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mb_parse_str - Manual" />
<meta itemprop="description" content="Parse GET/POST/COOKIE data and set global variable" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Parse GET/POST/COOKIE data and set global variable" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.mb-preferred-mime-name.php">
          mb_preferred_mime_name &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.mb-output-handler.php">
          &laquo; mb_output_handler        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-parse-str.php' selected="selected">English</option>
            <option value='de/function.mb-parse-str.php'>German</option>
            <option value='es/function.mb-parse-str.php'>Spanish</option>
            <option value='fr/function.mb-parse-str.php'>French</option>
            <option value='it/function.mb-parse-str.php'>Italian</option>
            <option value='ja/function.mb-parse-str.php'>Japanese</option>
            <option value='pt_BR/function.mb-parse-str.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-parse-str.php'>Russian</option>
            <option value='tr/function.mb-parse-str.php'>Turkish</option>
            <option value='uk/function.mb-parse-str.php'>Ukrainian</option>
            <option value='zh/function.mb-parse-str.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-parse-str" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mb_parse_str</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mb_parse_str</span> &mdash; <span class="dc-title">Parse GET/POST/COOKIE data and set global variable</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.mb-parse-str-description">
  ...
  <p class="para rdfs-comment">
   ...
   encoding and set values to the <code class="parameter">result</code> <span class="type"><a href="language.types.array.php" class="type array">array</a></span> or
   global variables.
  </p>
 </div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.mb-parse-str-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       An <span class="type"><a href="language.types.array.php" class="type array">array</a></span> containing decoded and character encoded converted values.
      </p>
     </dd>
 ...
 <div class="refsect1 changelog" id="refsect1-function.mb-parse-str-changelog">
  ...
  <table class="doctable informaltable">
    ...
    <tbody class="tbody">
     <tr>
      <td>8.0.0</td>
      <td>The second parameter was no longer optional.</td>
     </tr>

     <tr>
      <td>7.2.0</td>
      <td>Calling <span class="function"><strong>mb_parse_str()</strong></span> without the second parameter was deprecated.</td>
     </tr>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.mb-internal-encoding.php" class="function" rel="rdfs-seeAlso">mb_internal_encoding()</a> - Set/Get internal character encoding</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-parse-str.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-parse-str%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-parse-str&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-parse-str.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="118713">  <div class="votes">
    <div id="Vu118713">
    <a href="/manual/vote-note.php?id=118713&amp;page=function.mb-parse-str&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd118713">
    <a href="/manual/vote-note.php?id=118713&amp;page=function.mb-parse-str&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V118713" title="61% like this...">
    6
    </div>
  </div>
  <a href="#118713" class="name">
  <strong class="user"><em>kehaovista at qq dot com</em></strong></a><a class="genanchor" href="#118713"> &para;</a><div class="date" title="2016-01-23 12:55"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom118713">
<div class="phpcode"><code><span class="html">$str = 'email=kehaovista@qq.com&amp;city=shanghai&amp;job=Phper';<br />mb_parse_str($str, $result);<br />print_r($result);<br /><br />//结果<br />Array<br />(<br />    [email] =&gt; kehaovista@qq.com<br />    [city] =&gt; shanghai<br />    [job] =&gt; Phper<br />)</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.mb-parse-str&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-parse-str.php">＋<small>add a note</small></a></div>
