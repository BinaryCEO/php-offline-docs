...
<head>
  ...
  <title>PHP: mysqli::$warning_count - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli.warning-count.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli.warning-count.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.warning-count.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli.use-result.php">
 <link rel="next" href="https://www.php.net/manual/en/class.mysqli-stmt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli.warning-count.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli.warning-count.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli.warning-count.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli.warning-count.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli.warning-count.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli.warning-count.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli.warning-count.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli.warning-count.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli.warning-count.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli.warning-count.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli.warning-count.php" hreflang="zh">
...
<meta name="Description" content="Returns the number of warnings generated by the most recently executed query" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli::$warning_count - Manual" />
<meta name="twitter:description" content="Returns the number of warnings generated by the most recently executed query" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli::$warning_count - Manual" />
<meta itemprop="description" content="Returns the number of warnings generated by the most recently executed query" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns the number of warnings generated by the most recently executed query" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli.warning-count.php' selected="selected">English</option>
            <option value='de/mysqli.warning-count.php'>German</option>
            <option value='es/mysqli.warning-count.php'>Spanish</option>
            <option value='fr/mysqli.warning-count.php'>French</option>
            <option value='it/mysqli.warning-count.php'>Italian</option>
            <option value='ja/mysqli.warning-count.php'>Japanese</option>
            <option value='pt_BR/mysqli.warning-count.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli.warning-count.php'>Russian</option>
            <option value='tr/mysqli.warning-count.php'>Turkish</option>
            <option value='uk/mysqli.warning-count.php'>Ukrainian</option>
            <option value='zh/mysqli.warning-count.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli.warning-count" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">mysqli::$warning_count</h1>
  <h1 class="refname">mysqli_warning_count</h1>
  <p class="verinfo">(PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">mysqli::$warning_count</span> -- <span class="refname">mysqli_warning_count</span> &mdash; <span class="dc-title">Returns the number of warnings generated by the most recently executed query</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-mysqli.warning-count-description">
  <h3 class="title">Description</h3>
  <p class="para">Object-oriented style</p>
  <div class="fieldsynopsis"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <var class="varname"><a href="mysqli.warning-count.php">$mysqli-&gt;warning_count</a></var>;</div>

  <p class="para">Procedural style</p>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>mysqli_warning_count</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli.php" class="type mysqli">mysqli</a></span> <code class="parameter">$mysql</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-mysqli.warning-count-parameters">
...
returned by <span class="function"><a href="function.mysqli-connect.php" class="function">mysqli_connect()</a></span> or <span class="function"><a href="mysqli.init.php" class="function">mysqli_init()</a></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli.warning-count-returnvalues">
...
<div class="examplescode"><pre class="examplescode">Warning (1365): Division by 0</pre>
 ...
 <div class="refsect1 seealso" id="refsect1-mysqli.warning-count-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli.sqlstate.php" class="function" rel="rdfs-seeAlso">mysqli_sqlstate()</a> - Returns the SQLSTATE error from previous MySQL operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli/warning-count.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli.warning-count%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli.warning-count&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli.warning-count.php">＋<small>add a note</small></a></span>
