...
<head>
  ...
  <title>PHP: Fallback to global space - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/language.namespaces.fallback.php">
 <link rel="shorturl" href="https://www.php.net/namespaces.fallback">
 <link rel="alternate" href="https://www.php.net/namespaces.fallback" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/language.namespaces.php">
 <link rel="prev" href="https://www.php.net/manual/en/language.namespaces.global.php">
 <link rel="next" href="https://www.php.net/manual/en/language.namespaces.rules.php">

 <link rel="alternate" href="https://www.php.net/manual/en/language.namespaces.fallback.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/language.namespaces.fallback.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/language.namespaces.fallback.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/language.namespaces.fallback.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/language.namespaces.fallback.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/language.namespaces.fallback.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/language.namespaces.fallback.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/language.namespaces.fallback.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/language.namespaces.fallback.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/language.namespaces.fallback.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/language.namespaces.fallback.php" hreflang="zh">
...
<meta name="Description" content="Using namespaces: fallback to the global space for functions and constants" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Fallback to global space - Manual" />
<meta name="twitter:description" content="Using namespaces: fallback to the global space for functions and constants" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Fallback to global space - Manual" />
<meta itemprop="description" content="Using namespaces: fallback to the global space for functions and constants" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Using namespaces: fallback to the global space for functions and constants" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="language.namespaces.rules.php">
          Name resolution rules &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="language.namespaces.global.php">
          &laquo; Global space        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.namespaces.fallback.php' selected="selected">English</option>
            <option value='de/language.namespaces.fallback.php'>German</option>
            <option value='es/language.namespaces.fallback.php'>Spanish</option>
            <option value='fr/language.namespaces.fallback.php'>French</option>
            <option value='it/language.namespaces.fallback.php'>Italian</option>
            <option value='ja/language.namespaces.fallback.php'>Japanese</option>
            <option value='pt_BR/language.namespaces.fallback.php'>Brazilian Portuguese</option>
            <option value='ru/language.namespaces.fallback.php'>Russian</option>
            <option value='tr/language.namespaces.fallback.php'>Turkish</option>
            <option value='uk/language.namespaces.fallback.php'>Ukrainian</option>
            <option value='zh/language.namespaces.fallback.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="language.namespaces.fallback" class="sect1">
    ...
    <div class="example-contents">
     <div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">namespace </span><span style="color: #0000BB">A\B\C</span><span style="color: #007700">;<br /><br />const </span><span style="color: #0000BB">E_ERROR </span><span style="color: #007700">= </span><span style="color: #0000BB">45</span><span style="color: #007700">;<br />function </span><span style="color: #0000BB">strlen</span><span style="color: #007700">(</span><span style="color: #0000BB">$str</span><span style="color: #007700">)<br />{<br />    return </span><span style="color: #0000BB">\strlen</span><span style="color: #007700">(</span><span style="color: #0000BB">$str</span><span style="color: #007700">) - </span><span style="color: #0000BB">1</span><span style="color: #007700">;<br />}<br /><br />echo </span><span style="color: #0000BB">E_ERROR</span><span style="color: #007700">, </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">; </span><span style="color: #FF8000">// prints "45"<br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">INI_ALL</span><span style="color: #007700">, </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">; </span><span style="color: #FF8000">// prints "7" - falls back to global INI_ALL<br /><br /></span><span style="color: #007700">echo </span><span style="color: #0000BB">strlen</span><span style="color: #007700">(</span><span style="color: #DD0000">'hi'</span><span style="color: #007700">), </span><span style="color: #DD0000">"\n"</span><span style="color: #007700">; </span><span style="color: #FF8000">// prints "1"<br /></span><span style="color: #007700">if (</span><span style="color: #0000BB">is_array</span><span style="color: #007700">(</span><span style="color: #DD0000">'hi'</span><span style="color: #007700">)) { </span><span style="color: #FF8000">// prints "is not array"<br />    </span><span style="color: #007700">echo </span><span style="color: #DD0000">"is array\n"</span><span style="color: #007700">;<br />} else {<br />    echo </span><span style="color: #DD0000">"is not array\n"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.namespaces.fallback%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.namespaces.fallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.namespaces.fallback.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="116275">  <div class="votes">
    <div id="Vu116275">
    <a href="/manual/vote-note.php?id=116275&amp;page=language.namespaces.fallback&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd116275">
    <a href="/manual/vote-note.php?id=116275&amp;page=language.namespaces.fallback&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V116275" title="74% like this...">
    39
    </div>
  </div>
  <a href="#116275" class="name">
  <strong class="user"><em>markus at malkusch dot de</em></strong></a><a class="genanchor" href="#116275"> &para;</a><div class="date" title="2014-12-04 08:22"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom116275">
<div class="phpcode"><code><span class="html">You can use the fallback policy to provide mocks for built-in functions like time(). You therefore have to call those functions unqualified:<br /><br /><span class="default">&lt;?php<br /></span><span class="keyword">namespace </span><span class="default">foo</span><span class="keyword">;<br /><br />function </span><span class="default">time</span><span class="keyword">() {<br />    return </span><span class="default">1234</span><span class="keyword">;<br />}<br /><br /></span><span class="default">assert </span><span class="keyword">(</span><span class="default">1234 </span><span class="keyword">== </span><span class="default">time</span><span class="keyword">());<br /></span><span class="default">?&gt;<br /></span><br />However there's a restriction that you have to define the mock function before the first usage in the tested class method. This is documented in Bug #68541.<br /><br />You can find the mock library php-mock at GitHub.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=language.namespaces.fallback&amp;repo=en&amp;redirect=https://www.php.net/manual/en/language.namespaces.fallback.php">＋<small>add a note</small></a></div>
