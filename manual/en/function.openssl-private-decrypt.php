...
<head>
  ...
  <title>PHP: openssl_private_decrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-private-decrypt.php">
 <link rel="shorturl" href="https://www.php.net/openssl-private-decrypt">
 <link rel="alternate" href="https://www.php.net/openssl-private-decrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-pkey-new.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-private-encrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-private-decrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-private-decrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-private-decrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-private-decrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-private-decrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-private-decrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-private-decrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-private-decrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-private-decrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-private-decrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-private-decrypt.php" hreflang="zh">
...
<meta name="Description" content="Decrypts data with private key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_private_decrypt - Manual" />
<meta name="twitter:description" content="Decrypts data with private key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_private_decrypt - Manual" />
<meta itemprop="description" content="Decrypts data with private key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decrypts data with private key" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-private-encrypt.php">
          openssl_private_encrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-pkey-new.php">
          &laquo; openssl_pkey_new        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-private-decrypt.php' selected="selected">English</option>
            <option value='de/function.openssl-private-decrypt.php'>German</option>
            <option value='es/function.openssl-private-decrypt.php'>Spanish</option>
            <option value='fr/function.openssl-private-decrypt.php'>French</option>
            <option value='it/function.openssl-private-decrypt.php'>Italian</option>
            <option value='ja/function.openssl-private-decrypt.php'>Japanese</option>
            <option value='pt_BR/function.openssl-private-decrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-private-decrypt.php'>Russian</option>
            <option value='tr/function.openssl-private-decrypt.php'>Turkish</option>
            <option value='uk/function.openssl-private-decrypt.php'>Ukrainian</option>
            <option value='zh/function.openssl-private-decrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-private-decrypt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">openssl_private_decrypt</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.6, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">openssl_private_decrypt</span> &mdash; <span class="dc-title">Decrypts data with private key</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.openssl-private-decrypt-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>openssl_private_decrypt</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter reference">&$decrypted_data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><span class="type"><a href="class.opensslasymmetrickey.php" class="type OpenSSLAsymmetricKey">OpenSSLAsymmetricKey</a></span>|<span class="type"><a href="class.opensslcertificate.php" class="type OpenSSLCertificate">OpenSSLCertificate</a></span>|<span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$private_key</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$padding</code><span class="initializer"> = <strong><code><a href="openssl.padding.php#constant.openssl-pkcs1-padding">OPENSSL_PKCS1_PADDING</a></code></strong></span></span><br>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>openssl_private_decrypt()</strong></span> decrypts
   <code class="parameter">data</code> that was previously encrypted via
   <span class="function"><a href="function.openssl-public-encrypt.php" class="function">openssl_public_encrypt()</a></span> and stores the result into
