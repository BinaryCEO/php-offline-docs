...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.radius-demangle.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.radius-cvt-string.php">
 <link rel="next" href="https://www.php.net/manual/en/function.radius-demangle-mppe-key.php">
...
<meta name="Description" content="Demangles data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: radius_demangle - Manual" />
<meta name="twitter:description" content="Demangles data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: radius_demangle - Manual" />
<meta itemprop="description" content="Demangles data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Demangles data" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.radius-demangle.php' selected="selected">English</option>
            <option value='de/function.radius-demangle.php'>German</option>
            <option value='es/function.radius-demangle.php'>Spanish</option>
            <option value='fr/function.radius-demangle.php'>French</option>
  ...
  <p class="para">
   Returns the demangled string, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/radius/functions/radius-demangle.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.radius-demangle%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.radius-demangle&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.radius-demangle.php">＋<small>add a note</small></a></span>
