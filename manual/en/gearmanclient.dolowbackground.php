...
<head>
  ...
  <title>PHP: GearmanClient::doLowBackground - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gearmanclient.dolowbackground.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gearmanclient.dolowbackground.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dolowbackground.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gearmanclient.php">
 <link rel="prev" href="https://www.php.net/manual/en/gearmanclient.dolow.php">
 <link rel="next" href="https://www.php.net/manual/en/gearmanclient.donormal.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gearmanclient.dolowbackground.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gearmanclient.dolowbackground.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gearmanclient.dolowbackground.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gearmanclient.dolowbackground.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gearmanclient.dolowbackground.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gearmanclient.dolowbackground.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gearmanclient.dolowbackground.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gearmanclient.dolowbackground.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gearmanclient.dolowbackground.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gearmanclient.dolowbackground.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gearmanclient.dolowbackground.php" hreflang="zh">
...
<meta name="Description" content="Run a low priority task in the background" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GearmanClient::doLowBackground - Manual" />
<meta name="twitter:description" content="Run a low priority task in the background" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GearmanClient::doLowBackground - Manual" />
<meta itemprop="description" content="Run a low priority task in the background" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Run a low priority task in the background" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gearmanclient.donormal.php">
          GearmanClient::doNormal &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gearmanclient.dolow.php">
          &laquo; GearmanClient::doLow        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gearmanclient.dolowbackground.php' selected="selected">English</option>
            <option value='de/gearmanclient.dolowbackground.php'>German</option>
            <option value='es/gearmanclient.dolowbackground.php'>Spanish</option>
            <option value='fr/gearmanclient.dolowbackground.php'>French</option>
            <option value='it/gearmanclient.dolowbackground.php'>Italian</option>
            <option value='ja/gearmanclient.dolowbackground.php'>Japanese</option>
            <option value='pt_BR/gearmanclient.dolowbackground.php'>Brazilian Portuguese</option>
            <option value='ru/gearmanclient.dolowbackground.php'>Russian</option>
            <option value='tr/gearmanclient.dolowbackground.php'>Turkish</option>
            <option value='uk/gearmanclient.dolowbackground.php'>Ukrainian</option>
            <option value='zh/gearmanclient.dolowbackground.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gearmanclient.dolowbackground" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">GearmanClient::doLowBackground</h1>
  <p class="verinfo">(PECL gearman &gt;= 0.5.0)</p><p class="refpurpose"><span class="refname">GearmanClient::doLowBackground</span> &mdash; <span class="dc-title">Run a low priority task in the background</span></p>
 ...
 <div class="refsect1 description" id="refsect1-gearmanclient.dolowbackground-description">
  ...
  <p class="para rdfs-comment">
   ...
   to get the status of the running task.  Normal and high priority tasks take precedence over
   ...
   <ul class="simplelist">
    ...
    <li><span class="methodname"><a href="gearmanclient.dohighbackground.php" class="methodname" rel="rdfs-seeAlso">GearmanClient::doHighBackground()</a> - Run a high priority task in the background</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gearman/gearmanclient/dolowbackground.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgearmanclient.dolowbackground%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gearmanclient.dolowbackground&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gearmanclient.dolowbackground.php">＋<small>add a note</small></a></span>
