...
<head>
  ...
  <title>PHP: SolrQuery::getGroupFunctions - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.getgroupfunctions.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.getgroupfunctions.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupfunctions.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.getgroupformat.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.getgrouplimit.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.getgroupfunctions.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.getgroupfunctions.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.getgroupfunctions.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.getgroupfunctions.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.getgroupfunctions.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.getgroupfunctions.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.getgroupfunctions.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.getgroupfunctions.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.getgroupfunctions.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.getgroupfunctions.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.getgroupfunctions.php" hreflang="zh">
...
<meta name="Description" content="Returns group functions (group.func parameter values)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::getGroupFunctions - Manual" />
<meta name="twitter:description" content="Returns group functions (group.func parameter values)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::getGroupFunctions - Manual" />
<meta itemprop="description" content="Returns group functions (group.func parameter values)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns group functions (group.func parameter values)" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="solrquery.getgrouplimit.php">
          SolrQuery::getGroupLimit &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.getgroupformat.php">
          &laquo; SolrQuery::getGroupFormat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.getgroupfunctions.php' selected="selected">English</option>
            <option value='de/solrquery.getgroupfunctions.php'>German</option>
            <option value='es/solrquery.getgroupfunctions.php'>Spanish</option>
            <option value='fr/solrquery.getgroupfunctions.php'>French</option>
            <option value='it/solrquery.getgroupfunctions.php'>Italian</option>
            <option value='ja/solrquery.getgroupfunctions.php'>Japanese</option>
            <option value='pt_BR/solrquery.getgroupfunctions.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.getgroupfunctions.php'>Russian</option>
            <option value='tr/solrquery.getgroupfunctions.php'>Turkish</option>
            <option value='uk/solrquery.getgroupfunctions.php'>Ukrainian</option>
            <option value='zh/solrquery.getgroupfunctions.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.getgroupfunctions" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::getGroupFunctions</h1>
  <p class="verinfo">(PECL solr &gt;= 2.2.0)</p><p class="refpurpose"><span class="refname">SolrQuery::getGroupFunctions</span> &mdash; <span class="dc-title">Returns group functions (group.func parameter values)</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.getgroupfunctions-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::getGroupFunctions</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.getgroupfunctions-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-solrquery.getgroupfunctions-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-solrquery.getgroupfunctions-seealso">
  ...
  <ul class="simplelist">
   <li><span class="methodname"><a href="solrquery.addgroupfunction.php" class="methodname" rel="rdfs-seeAlso">SolrQuery::addGroupFunction()</a> - Allows grouping results based on the unique values of a function query (group.func parameter)</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/getgroupfunctions.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.getgroupfunctions%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.getgroupfunctions&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.getgroupfunctions.php">＋<small>add a note</small></a></span>
