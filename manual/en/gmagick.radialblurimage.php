...
<head>
  ...
  <title>PHP: Gmagick::radialblurimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.radialblurimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.radialblurimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.radialblurimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.queryformats.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.raiseimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.radialblurimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.radialblurimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.radialblurimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.radialblurimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.radialblurimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.radialblurimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.radialblurimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.radialblurimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.radialblurimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.radialblurimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.radialblurimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::radialblurimage - Manual" />
<meta name="twitter:description" content="Radial blurs an image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::radialblurimage - Manual" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.raiseimage.php">
          Gmagick::raiseimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.queryformats.php">
          &laquo; Gmagick::queryformats        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.radialblurimage.php' selected="selected">English</option>
            <option value='de/gmagick.radialblurimage.php'>German</option>
            <option value='es/gmagick.radialblurimage.php'>Spanish</option>
            <option value='fr/gmagick.radialblurimage.php'>French</option>
            <option value='it/gmagick.radialblurimage.php'>Italian</option>
            <option value='ja/gmagick.radialblurimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.radialblurimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.radialblurimage.php'>Russian</option>
            <option value='tr/gmagick.radialblurimage.php'>Turkish</option>
            <option value='uk/gmagick.radialblurimage.php'>Ukrainian</option>
            <option value='zh/gmagick.radialblurimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.radialblurimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::radialblurimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::radialblurimage</span> &mdash; <span class="dc-title">Radial blurs an image</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.radialblurimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::radialblurimage</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$angle</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$channel</code><span class="initializer"> = Gmagick::CHANNEL_DEFAULT</span></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.radialblurimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.radialblurimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.radialblurimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/radialblurimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.radialblurimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.radialblurimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.radialblurimage.php">＋<small>add a note</small></a></span>
