...
<head>
  ...
  <title>PHP: db2_commit - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-commit.php">
 <link rel="shorturl" href="https://www.php.net/db2-commit">
 <link rel="alternate" href="https://www.php.net/db2-commit" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-columns.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-conn-error.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-commit.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-commit.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-commit.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-commit.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-commit.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-commit.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-commit.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-commit.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-commit.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-commit.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-commit.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: db2_commit - Manual" />
<meta name="twitter:description" content="Commits a transaction" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_commit - Manual" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-commit.php' selected="selected">English</option>
            <option value='de/function.db2-commit.php'>German</option>
            <option value='es/function.db2-commit.php'>Spanish</option>
            <option value='fr/function.db2-commit.php'>French</option>
            <option value='it/function.db2-commit.php'>Italian</option>
            <option value='ja/function.db2-commit.php'>Japanese</option>
            <option value='pt_BR/function.db2-commit.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-commit.php'>Russian</option>
            <option value='tr/function.db2-commit.php'>Turkish</option>
            <option value='uk/function.db2-commit.php'>Ukrainian</option>
            <option value='zh/function.db2-commit.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-commit" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_commit</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_commit</span> &mdash; <span class="dc-title">
   Commits a transaction
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.db2-commit-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_commit</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para rdfs-comment">
   ...
   mode, so <span class="function"><strong>db2_commit()</strong></span> is not necessary unless AUTOCOMMIT
   has been turned off for the connection resource.
  </p>

 </div>

 <div class="refsect1 parameters" id="refsect1-function.db2-commit-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-commit-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-commit-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.db2-autocommit.php" class="function" rel="rdfs-seeAlso">db2_autocommit()</a> - Returns or sets the AUTOCOMMIT state for a database connection</span></li>
    <li><span class="function"><a href="function.db2-rollback.php" class="function" rel="rdfs-seeAlso">db2_rollback()</a> - Rolls back a transaction</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-commit.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-commit%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-commit&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-commit.php">＋<small>add a note</small></a></span>
