...
<head>
  ...
  <title>PHP: Imagick::adaptiveSharpenImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.adaptivesharpenimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.adaptivesharpenimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.adaptivesharpenimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.adaptiveresizeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.adaptivethresholdimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.adaptivesharpenimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.adaptivesharpenimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.adaptivesharpenimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.adaptivesharpenimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.adaptivesharpenimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.adaptivesharpenimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.adaptivesharpenimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.adaptivesharpenimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.adaptivesharpenimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.adaptivesharpenimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.adaptivesharpenimage.php" hreflang="zh">
...
<meta name="Description" content="Adaptively sharpen the image" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::adaptiveSharpenImage - Manual" />
<meta name="twitter:description" content="Adaptively sharpen the image" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::adaptiveSharpenImage - Manual" />
<meta itemprop="description" content="Adaptively sharpen the image" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Adaptively sharpen the image" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.adaptivethresholdimage.php">
          Imagick::adaptiveThresholdImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.adaptiveresizeimage.php">
          &laquo; Imagick::adaptiveResizeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.adaptivesharpenimage.php' selected="selected">English</option>
            <option value='de/imagick.adaptivesharpenimage.php'>German</option>
            <option value='es/imagick.adaptivesharpenimage.php'>Spanish</option>
            <option value='fr/imagick.adaptivesharpenimage.php'>French</option>
            <option value='it/imagick.adaptivesharpenimage.php'>Italian</option>
            <option value='ja/imagick.adaptivesharpenimage.php'>Japanese</option>
            <option value='pt_BR/imagick.adaptivesharpenimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.adaptivesharpenimage.php'>Russian</option>
            <option value='tr/imagick.adaptivesharpenimage.php'>Turkish</option>
            <option value='uk/imagick.adaptivesharpenimage.php'>Ukrainian</option>
            <option value='zh/imagick.adaptivesharpenimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.adaptivesharpenimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::adaptiveSharpenImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::adaptiveSharpenImage</span> &mdash; <span class="dc-title">Adaptively sharpen the image</span></p>
 ...
 <div class="refsect1 examples" id="refsect1-imagick.adaptivesharpenimage-examples">
  ...
  <p class="para">
   <div class="example" id="example-2964">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">try {<br />    </span><span style="color: #0000BB">$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #DD0000">'image.png'</span><span style="color: #007700">);<br />    </span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">adaptiveSharpenImage</span><span style="color: #007700">(</span><span style="color: #0000BB">2</span><span style="color: #007700">,</span><span style="color: #0000BB">1</span><span style="color: #007700">);<br />} catch(</span><span style="color: #0000BB">ImagickException $e</span><span style="color: #007700">) {<br />    echo </span><span style="color: #DD0000">'Error: ' </span><span style="color: #007700">, </span><span style="color: #0000BB">$e</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">getMessage</span><span style="color: #007700">();<br />    die();<br />}<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-type: image/png'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.adaptivesharpenimage-seealso">
  ...
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.sharpenimage.php" class="function" rel="rdfs-seeAlso">Imagick::sharpenImage()</a> - Sharpens an image</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/adaptivesharpenimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.adaptivesharpenimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.adaptivesharpenimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.adaptivesharpenimage.php">＋<small>add a note</small></a></span>
