...
<head>
  ...
  <title>PHP: imap_base64 - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.imap-base64.php">
 <link rel="shorturl" href="https://www.php.net/imap-base64">
 <link rel="alternate" href="https://www.php.net/imap-base64" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.imap.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.imap-append.php">
 <link rel="next" href="https://www.php.net/manual/en/function.imap-binary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.imap-base64.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.imap-base64.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.imap-base64.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.imap-base64.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.imap-base64.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.imap-base64.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.imap-base64.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.imap-base64.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.imap-base64.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.imap-base64.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.imap-base64.php" hreflang="zh">
...
<meta name="Description" content="Decode BASE64 encoded text" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: imap_base64 - Manual" />
<meta name="twitter:description" content="Decode BASE64 encoded text" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: imap_base64 - Manual" />
<meta itemprop="description" content="Decode BASE64 encoded text" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Decode BASE64 encoded text" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.imap-binary.php">
          imap_binary &raquo;
              ...
              <div class="prev">
        <a href="function.imap-append.php">
          &laquo; imap_append        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.imap-base64.php' selected="selected">English</option>
            <option value='de/function.imap-base64.php'>German</option>
            <option value='es/function.imap-base64.php'>Spanish</option>
            <option value='fr/function.imap-base64.php'>French</option>
            <option value='it/function.imap-base64.php'>Italian</option>
            <option value='ja/function.imap-base64.php'>Japanese</option>
            <option value='pt_BR/function.imap-base64.php'>Brazilian Portuguese</option>
            <option value='ru/function.imap-base64.php'>Russian</option>
            <option value='tr/function.imap-base64.php'>Turkish</option>
            <option value='uk/function.imap-base64.php'>Ukrainian</option>
            <option value='zh/function.imap-base64.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.imap-base64" class="refentry">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.imap-base64-returnvalues">
  ...
  <p class="para">
   Returns the decoded message as a string,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
   ...
   <ul class="simplelist">
    ...
    <li><a href="https://datatracker.ietf.org/doc/html/rfc2045" class="link external">&raquo;&nbsp;RFC2045</a>, Section 6.8</li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imap/functions/imap-base64.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.imap-base64%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.imap-base64&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-base64.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="102766">  <div class="votes">
    <div id="Vu102766">
    <a href="/manual/vote-note.php?id=102766&amp;page=function.imap-base64&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd102766">
    <a href="/manual/vote-note.php?id=102766&amp;page=function.imap-base64&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V102766" title="54% like this...">
    5
    </div>
  </div>
  <a href="#102766" class="name">
  <strong class="user"><em>chris at deliens dot be</em></strong></a><a class="genanchor" href="#102766"> &para;</a><div class="date" title="2011-03-04 07:45"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom102766">
<div class="phpcode"><code><span class="html">Looks like this function has exactly the same behavior as base64_decode($test, true) -&gt; it returns FALSE if $text contains characters outside the Base64 alphabet, although this isn't documented here.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.imap-base64&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.imap-base64.php">＋<small>add a note</small></a></div>
