...
<head>
  ...
  <title>PHP: openssl_error_string - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-error-string.php">
 <link rel="shorturl" href="https://www.php.net/openssl-error-string">
 <link rel="alternate" href="https://www.php.net/openssl-error-string" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-encrypt.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-free-key.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-error-string.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-error-string.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-error-string.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-error-string.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-error-string.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-error-string.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-error-string.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-error-string.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-error-string.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-error-string.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-error-string.php" hreflang="zh">
...
<meta name="Description" content="Return openSSL error message" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_error_string - Manual" />
<meta name="twitter:description" content="Return openSSL error message" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_error_string - Manual" />
<meta itemprop="description" content="Return openSSL error message" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Return openSSL error message" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.openssl-free-key.php">
          openssl_free_key &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-encrypt.php">
          &laquo; openssl_encrypt        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-error-string.php' selected="selected">English</option>
            <option value='de/function.openssl-error-string.php'>German</option>
            <option value='es/function.openssl-error-string.php'>Spanish</option>
            <option value='fr/function.openssl-error-string.php'>French</option>
            <option value='it/function.openssl-error-string.php'>Italian</option>
            <option value='ja/function.openssl-error-string.php'>Japanese</option>
            <option value='pt_BR/function.openssl-error-string.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-error-string.php'>Russian</option>
            <option value='tr/function.openssl-error-string.php'>Turkish</option>
            <option value='uk/function.openssl-error-string.php'>Ukrainian</option>
            <option value='zh/function.openssl-error-string.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-error-string" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-error-string-examples">
  ...
  <p class="para">
   <div class="example" id="example-1024">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// lets assume you just called an openssl function that failed<br /></span><span style="color: #007700">while (</span><span style="color: #0000BB">$msg </span><span style="color: #007700">= </span><span style="color: #0000BB">openssl_error_string</span><span style="color: #007700">())<br />    echo </span><span style="color: #0000BB">$msg </span><span style="color: #007700">. </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-error-string.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-error-string%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-error-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-error-string.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="119878">  <div class="votes">
    <div id="Vu119878">
    <a href="/manual/vote-note.php?id=119878&amp;page=function.openssl-error-string&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd119878">
    <a href="/manual/vote-note.php?id=119878&amp;page=function.openssl-error-string&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V119878" title="57% like this...">
    2
    </div>
  </div>
  <a href="#119878" class="name">
  <strong class="user"><em>Joey</em></strong></a><a class="genanchor" href="#119878"> &para;</a><div class="date" title="2016-09-12 03:33"><strong>9 years ago</strong></div>
  <div class="text" id="Hcom119878">
<div class="phpcode"><code><span class="html">You need to do something like this to clear it:<br /><br />while(openssl_error_string() !== false);<br /><br />Some openssl functions will add errors to the list even if they succeed.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.openssl-error-string&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-error-string.php">＋<small>add a note</small></a></div>
