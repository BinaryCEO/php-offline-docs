...
<head>
  ...
  <title>PHP: rnp_ffi_set_pass_provider - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.rnp-ffi-set-pass-provider.php">
 <link rel="shorturl" href="https://www.php.net/rnp-ffi-set-pass-provider">
 <link rel="alternate" href="https://www.php.net/rnp-ffi-set-pass-provider" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.rnp.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.rnp-ffi-destroy.php">
 <link rel="next" href="https://www.php.net/manual/en/function.rnp-import-keys.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.rnp-ffi-set-pass-provider.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.rnp-ffi-set-pass-provider.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.rnp-ffi-set-pass-provider.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.rnp-ffi-set-pass-provider.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.rnp-ffi-set-pass-provider.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.rnp-ffi-set-pass-provider.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.rnp-ffi-set-pass-provider.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.rnp-ffi-set-pass-provider.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.rnp-ffi-set-pass-provider.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.rnp-ffi-set-pass-provider.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.rnp-ffi-set-pass-provider.php" hreflang="zh">
...
<meta name="Description" content="Set password provider callback function" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: rnp_ffi_set_pass_provider - Manual" />
<meta name="twitter:description" content="Set password provider callback function" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: rnp_ffi_set_pass_provider - Manual" />
<meta itemprop="description" content="Set password provider callback function" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set password provider callback function" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.rnp-import-keys.php">
          rnp_import_keys &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.rnp-ffi-destroy.php">
          &laquo; rnp_ffi_destroy        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.rnp-ffi-set-pass-provider.php' selected="selected">English</option>
            <option value='de/function.rnp-ffi-set-pass-provider.php'>German</option>
            <option value='es/function.rnp-ffi-set-pass-provider.php'>Spanish</option>
            <option value='fr/function.rnp-ffi-set-pass-provider.php'>French</option>
            <option value='it/function.rnp-ffi-set-pass-provider.php'>Italian</option>
            <option value='ja/function.rnp-ffi-set-pass-provider.php'>Japanese</option>
            <option value='pt_BR/function.rnp-ffi-set-pass-provider.php'>Brazilian Portuguese</option>
            <option value='ru/function.rnp-ffi-set-pass-provider.php'>Russian</option>
            <option value='tr/function.rnp-ffi-set-pass-provider.php'>Turkish</option>
            <option value='uk/function.rnp-ffi-set-pass-provider.php'>Ukrainian</option>
            <option value='zh/function.rnp-ffi-set-pass-provider.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.rnp-ffi-set-pass-provider" class="refentry">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      ...
      Callback function should return <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> if password was successfully set or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
     </p>
    </dd>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">function </span><span style="color: #0000BB">password_callback</span><span style="color: #007700">(</span><span style="color: #0000BB">string $key_fp</span><span style="color: #007700">, </span><span style="color: #0000BB">string $pgp_context</span><span style="color: #007700">, </span><span style="color: #0000BB">string </span><span style="color: #007700">&amp;</span><span style="color: #0000BB">$password</span><span style="color: #007700">)<br />{<br />    </span><span style="color: #0000BB">$password </span><span style="color: #007700">= </span><span style="color: #DD0000">"password"</span><span style="color: #007700">;<br /><br />    return </span><span style="color: #0000BB">true</span><span style="color: #007700">;<br />}<br /><br /></span><span style="color: #0000BB">$ffi </span><span style="color: #007700">= </span><span style="color: #0000BB">rnp_ffi_create</span><span style="color: #007700">(</span><span style="color: #DD0000">'GPG'</span><span style="color: #007700">, </span><span style="color: #DD0000">'GPG'</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">rnp_ffi_set_pass_provider</span><span style="color: #007700">(</span><span style="color: #0000BB">$ffi</span><span style="color: #007700">, </span><span style="color: #DD0000">'password_callback'</span><span style="color: #007700">);</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/rnp/functions/rnp-ffi-set-pass-provider.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.rnp-ffi-set-pass-provider%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.rnp-ffi-set-pass-provider&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.rnp-ffi-set-pass-provider.php">＋<small>add a note</small></a></span>
