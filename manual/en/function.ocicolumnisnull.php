...
<head>
  ...
  <title>PHP: ocicolumnisnull - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ocicolumnisnull.php">
 <link rel="shorturl" href="https://www.php.net/ocicolumnisnull">
 <link rel="alternate" href="https://www.php.net/ocicolumnisnull" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/oldaliases.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ocicolltrim.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ocicolumnname.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ocicolumnisnull.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ocicolumnisnull.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ocicolumnisnull.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ocicolumnisnull.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ocicolumnisnull.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ocicolumnisnull.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ocicolumnisnull.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ocicolumnisnull.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ocicolumnisnull.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ocicolumnisnull.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ocicolumnisnull.php" hreflang="zh">
...
<meta name="Description" content="Alias of oci_field_is_null" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ocicolumnisnull - Manual" />
<meta name="twitter:description" content="Alias of oci_field_is_null" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ocicolumnisnull - Manual" />
<meta itemprop="description" content="Alias of oci_field_is_null" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of oci_field_is_null" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ocicolumnname.php">
          ocicolumnname &raquo;
              ...
              <div class="prev">
        <a href="function.ocicolltrim.php">
          &laquo; ocicolltrim        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ocicolumnisnull.php' selected="selected">English</option>
            <option value='de/function.ocicolumnisnull.php'>German</option>
            <option value='es/function.ocicolumnisnull.php'>Spanish</option>
            <option value='fr/function.ocicolumnisnull.php'>French</option>
            <option value='it/function.ocicolumnisnull.php'>Italian</option>
            <option value='ja/function.ocicolumnisnull.php'>Japanese</option>
            <option value='pt_BR/function.ocicolumnisnull.php'>Brazilian Portuguese</option>
            <option value='ru/function.ocicolumnisnull.php'>Russian</option>
            <option value='tr/function.ocicolumnisnull.php'>Turkish</option>
            <option value='uk/function.ocicolumnisnull.php'>Ukrainian</option>
            <option value='zh/function.ocicolumnisnull.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ocicolumnisnull" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ocicolumnisnull</h1>
  <p class="verinfo">(PHP 4, PHP 5, PHP 7, PHP 8, PECL OCI8 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">ocicolumnisnull</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.oci-field-is-null.php" class="function">oci_field_is_null()</a></span></span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.ocicolumnisnull-description">
  <h3 class="title">Description</h3>
  <p class="para">Alias of <span class="function"><a href="function.oci-field-is-null.php" class="function">oci_field_is_null()</a></span></p>
...
on this alias is highly discouraged.</p></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/oldaliases/ocicolumnisnull.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ocicolumnisnull%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ocicolumnisnull&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ocicolumnisnull.php">＋<small>add a note</small></a></span>
