...
<head>
  ...
  <title>PHP: Gmagick::setimagedepth - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.setimagedepth.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.setimagedepth.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagedepth.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.setimagedelay.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.setimagedispose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.setimagedepth.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.setimagedepth.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.setimagedepth.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.setimagedepth.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.setimagedepth.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.setimagedepth.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.setimagedepth.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.setimagedepth.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.setimagedepth.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.setimagedepth.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.setimagedepth.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::setimagedepth - Manual" />
<meta name="twitter:description" content="Sets the image depth" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::setimagedepth - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.setimagedispose.php">
          Gmagick::setimagedispose &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.setimagedelay.php">
          &laquo; Gmagick::setimagedelay        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.setimagedepth.php' selected="selected">English</option>
            <option value='de/gmagick.setimagedepth.php'>German</option>
            <option value='es/gmagick.setimagedepth.php'>Spanish</option>
            <option value='fr/gmagick.setimagedepth.php'>French</option>
            <option value='it/gmagick.setimagedepth.php'>Italian</option>
            <option value='ja/gmagick.setimagedepth.php'>Japanese</option>
            <option value='pt_BR/gmagick.setimagedepth.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.setimagedepth.php'>Russian</option>
            <option value='tr/gmagick.setimagedepth.php'>Turkish</option>
            <option value='uk/gmagick.setimagedepth.php'>Ukrainian</option>
            <option value='zh/gmagick.setimagedepth.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.setimagedepth" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::setimagedepth</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::setimagedepth</span> &mdash; <span class="dc-title">Sets the image depth</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.setimagedepth-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::setimagedepth</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$depth</code></span>): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.setimagedepth-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.setimagedepth-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.setimagedepth-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/setimagedepth.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.setimagedepth%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.setimagedepth&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.setimagedepth.php">＋<small>add a note</small></a></span>
