...
<head>
  ...
  <title>PHP: mb_lcfirst - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.mb-lcfirst.php">
 <link rel="shorturl" href="https://www.php.net/mb-lcfirst">
 <link rel="alternate" href="https://www.php.net/mb-lcfirst" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.mbstring.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.mb-language.php">
 <link rel="next" href="https://www.php.net/manual/en/function.mb-list-encodings.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.mb-lcfirst.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.mb-lcfirst.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.mb-lcfirst.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.mb-lcfirst.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.mb-lcfirst.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.mb-lcfirst.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.mb-lcfirst.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.mb-lcfirst.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.mb-lcfirst.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.mb-lcfirst.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.mb-lcfirst.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.mb-lcfirst.php' selected="selected">English</option>
            <option value='de/function.mb-lcfirst.php'>German</option>
            <option value='es/function.mb-lcfirst.php'>Spanish</option>
            <option value='fr/function.mb-lcfirst.php'>French</option>
            <option value='it/function.mb-lcfirst.php'>Italian</option>
            <option value='ja/function.mb-lcfirst.php'>Japanese</option>
            <option value='pt_BR/function.mb-lcfirst.php'>Brazilian Portuguese</option>
            <option value='ru/function.mb-lcfirst.php'>Russian</option>
            <option value='tr/function.mb-lcfirst.php'>Turkish</option>
            <option value='uk/function.mb-lcfirst.php'>Ukrainian</option>
            <option value='zh/function.mb-lcfirst.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.mb-lcfirst" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="function"><a href="function.lcfirst.php" class="function" rel="rdfs-seeAlso">lcfirst()</a> - Make a string's first character lowercase</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mbstring/functions/mb-lcfirst.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.mb-lcfirst%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.mb-lcfirst&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.mb-lcfirst.php">＋<small>add a note</small></a></span>
