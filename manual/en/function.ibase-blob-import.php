...
<head>
  ...
  <title>PHP: ibase_blob_import - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-blob-import.php">
 <link rel="shorturl" href="https://www.php.net/ibase-blob-import">
 <link rel="alternate" href="https://www.php.net/ibase-blob-import" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-blob-get.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-info.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-blob-import.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-blob-import.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-blob-import.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-blob-import.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-blob-import.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-blob-import.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-blob-import.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-blob-import.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-blob-import.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-blob-import.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-blob-import.php" hreflang="zh">
...
<meta name="Description" content="Create blob, copy file in it, and close it" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_blob_import - Manual" />
<meta name="twitter:description" content="Create blob, copy file in it, and close it" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_blob_import - Manual" />
<meta itemprop="description" content="Create blob, copy file in it, and close it" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Create blob, copy file in it, and close it" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.ibase-blob-info.php">
          ibase_blob_info &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-blob-get.php">
          &laquo; ibase_blob_get        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-blob-import.php' selected="selected">English</option>
            <option value='de/function.ibase-blob-import.php'>German</option>
            <option value='es/function.ibase-blob-import.php'>Spanish</option>
            <option value='fr/function.ibase-blob-import.php'>French</option>
            <option value='it/function.ibase-blob-import.php'>Italian</option>
            <option value='ja/function.ibase-blob-import.php'>Japanese</option>
            <option value='pt_BR/function.ibase-blob-import.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-blob-import.php'>Russian</option>
            <option value='tr/function.ibase-blob-import.php'>Turkish</option>
            <option value='uk/function.ibase-blob-import.php'>Ukrainian</option>
            <option value='zh/function.ibase-blob-import.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-blob-import" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.ibase-blob-import-examples">
  ...
  <p class="para">
   <div class="example" id="example-1324">
    <p><strong>Example #1 <span class="function"><strong>ibase_blob_import()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.ibase-blob-create.php" class="function" rel="rdfs-seeAlso">ibase_blob_create()</a> - Create a new blob for adding data</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-blob-import.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-blob-import%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-blob-import&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-blob-import.php">＋<small>add a note</small></a></span>
