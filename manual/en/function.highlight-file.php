...
<head>
  ...
  <title>PHP: highlight_file - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.highlight-file.php">
 <link rel="shorturl" href="https://www.php.net/highlight-file">
 <link rel="alternate" href="https://www.php.net/highlight-file" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.misc.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.halt-compiler.php">
 <link rel="next" href="https://www.php.net/manual/en/function.highlight-string.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.highlight-file.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.highlight-file.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.highlight-file.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.highlight-file.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.highlight-file.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.highlight-file.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.highlight-file.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.highlight-file.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.highlight-file.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.highlight-file.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.highlight-file.php" hreflang="zh">
...
<meta name="Description" content="Syntax highlighting of a file" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: highlight_file - Manual" />
<meta name="twitter:description" content="Syntax highlighting of a file" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: highlight_file - Manual" />
<meta itemprop="description" content="Syntax highlighting of a file" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Syntax highlighting of a file" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.highlight-string.php">
          highlight_string &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.halt-compiler.php">
          &laquo; __halt_compiler        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.highlight-file.php' selected="selected">English</option>
            <option value='de/function.highlight-file.php'>German</option>
            <option value='es/function.highlight-file.php'>Spanish</option>
            <option value='fr/function.highlight-file.php'>French</option>
            <option value='it/function.highlight-file.php'>Italian</option>
            <option value='ja/function.highlight-file.php'>Japanese</option>
            <option value='pt_BR/function.highlight-file.php'>Brazilian Portuguese</option>
            <option value='ru/function.highlight-file.php'>Russian</option>
            <option value='tr/function.highlight-file.php'>Turkish</option>
            <option value='uk/function.highlight-file.php'>Ukrainian</option>
            <option value='zh/function.highlight-file.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.highlight-file" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><a href="misc.configuration.php#ini.syntax-highlighting" class="link">Highlighting INI directives</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/misc/functions/highlight-file.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.highlight-file%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.highlight-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.highlight-file.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="44699">  <div class="votes">
    <div id="Vu44699">
    <a href="/manual/vote-note.php?id=44699&amp;page=function.highlight-file&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd44699">
    <a href="/manual/vote-note.php?id=44699&amp;page=function.highlight-file&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V44699" title="50% like this...">
    0
    </div>
  </div>
  <a href="#44699" class="name">
  <strong class="user"><em>csst0266 at cs dot uoi dot gr</em></strong></a><a class="genanchor" href="#44699"> &para;</a><div class="date" title="2004-08-13 09:42"><strong>21 years ago</strong></div>
  <div class="text" id="Hcom44699">
<div class="phpcode"><code><span class="html">Here is a simple, yet useful, tip... Issuing the following command under a Unix-like OS:<br /><br />ln -s your_script.php your_script.phps<br /><br />Will result in the creation of a symbolic link (called your_script.phps) to the source code (your_script.php). This way you have (apart from the source code .php) the highlighted version of your script (.phps) accessible via your web browser.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.highlight-file&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.highlight-file.php">＋<small>add a note</small></a></div>
