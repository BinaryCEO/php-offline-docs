...
<head>
  ...
  <title>PHP: Imagick::animateImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.animateimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.animateimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.animateimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.affinetransformimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.annotateimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.animateimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.animateimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.animateimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.animateimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.animateimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.animateimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.animateimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.animateimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.animateimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.animateimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.animateimages.php" hreflang="zh">
...
<meta name="Description" content="Animates an image or images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::animateImages - Manual" />
<meta name="twitter:description" content="Animates an image or images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::animateImages - Manual" />
<meta itemprop="description" content="Animates an image or images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Animates an image or images" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.annotateimage.php">
          Imagick::annotateImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.affinetransformimage.php">
          &laquo; Imagick::affineTransformImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.animateimages.php' selected="selected">English</option>
            <option value='de/imagick.animateimages.php'>German</option>
            <option value='es/imagick.animateimages.php'>Spanish</option>
            <option value='fr/imagick.animateimages.php'>French</option>
            <option value='it/imagick.animateimages.php'>Italian</option>
            <option value='ja/imagick.animateimages.php'>Japanese</option>
            <option value='pt_BR/imagick.animateimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.animateimages.php'>Russian</option>
            <option value='tr/imagick.animateimages.php'>Turkish</option>
            <option value='uk/imagick.animateimages.php'>Ukrainian</option>
            <option value='zh/imagick.animateimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.animateimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::animateImages</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.3.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::animateImages</span> &mdash; <span class="dc-title">Animates an image or images</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.animateimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::animateImages</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$x_server</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.animateimages-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">x_server</code></dt>
     <dd>
      <p class="para">
       X server address
      </p>
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.animateimages-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-imagick.animateimages-seealso">
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="imagick.displayimage.php" class="function" rel="rdfs-seeAlso">Imagick::displayImage()</a> - Displays an image</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/animateimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.animateimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.animateimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.animateimages.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="92912">  <div class="votes">
    <div id="Vu92912">
    <a href="/manual/vote-note.php?id=92912&amp;page=imagick.animateimages&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd92912">
    <a href="/manual/vote-note.php?id=92912&amp;page=imagick.animateimages&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V92912" title="50% like this...">
    0
    </div>
  </div>
  <a href="#92912" class="name">
  <strong class="user"><em>gomadurai at gmail dot com</em></strong></a><a class="genanchor" href="#92912"> &para;</a><div class="date" title="2009-08-14 03:31"><strong>16 years ago</strong></div>
  <div class="text" id="Hcom92912">
<div class="phpcode"><code><span class="html">Below eg shows how to create animated gif<br /><span class="default">&lt;?php<br /><br />$multiTIFF </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /><br /></span><span class="default">$mytifspath </span><span class="keyword">= </span><span class="string">"./man"</span><span class="keyword">; </span><span class="comment">// your image directory<br /><br /></span><span class="default">$files </span><span class="keyword">= </span><span class="default">scandir</span><span class="keyword">(</span><span class="default">$mytifspath</span><span class="keyword">);<br /><br /></span><span class="comment">//print_r($files);<br />   <br />/*foreach( $files as $f )<br />{*/<br /><br /></span><span class="keyword">for(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">2</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">&lt;</span><span class="default">6</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">++)<br />{<br />    echo </span><span class="default">$files</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">];<br />    <br />    echo </span><span class="string">"&lt;br&gt;"</span><span class="keyword">;<br />    </span><span class="default">$auxIMG </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br />    </span><span class="default">$auxIMG</span><span class="keyword">-&gt;</span><span class="default">readImage</span><span class="keyword">(</span><span class="default">$mytifspath</span><span class="keyword">.</span><span class="string">"/"</span><span class="keyword">.</span><span class="default">$files</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]);<br />   <br />    </span><span class="default">$multiTIFF</span><span class="keyword">-&gt;</span><span class="default">addImage</span><span class="keyword">(</span><span class="default">$auxIMG</span><span class="keyword">);<br />}<br /><br /></span><span class="comment">//file multi.TIF<br /></span><span class="default">$multiTIFF</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="string">'multi423432.gif'</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">); </span><span class="comment">// combine all image into one single image<br /><br />//files multi-0.TIF, multi-1.TIF, ...<br /></span><span class="default">$multiTIFF</span><span class="keyword">-&gt;</span><span class="default">writeImages</span><span class="keyword">(</span><span class="string">'multi.gif'</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">);<br /><br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.animateimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.animateimages.php">＋<small>add a note</small></a></div>
