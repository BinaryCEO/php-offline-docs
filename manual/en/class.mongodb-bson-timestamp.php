...
<head>
  ...
  <title>PHP: MongoDB\BSON\Timestamp - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.mongodb-bson-timestamp.php">
 <link rel="shorturl" href="https://www.php.net/mongodb-bson-timestamp">
 <link rel="alternate" href="https://www.php.net/mongodb-bson-timestamp" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/mongodb.bson.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-regex.tostring.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-timestamp.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.mongodb-bson-timestamp.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.mongodb-bson-timestamp.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.mongodb-bson-timestamp.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.mongodb-bson-timestamp.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.mongodb-bson-timestamp.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.mongodb-bson-timestamp.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.mongodb-bson-timestamp.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.mongodb-bson-timestamp.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.mongodb-bson-timestamp.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.mongodb-bson-timestamp.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.mongodb-bson-timestamp.php" hreflang="zh">
...
<meta name="Description" content="The MongoDB\BSON\Timestamp class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Timestamp - Manual" />
<meta name="twitter:description" content="The MongoDB\BSON\Timestamp class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Timestamp - Manual" />
<meta itemprop="description" content="The MongoDB\BSON\Timestamp class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The MongoDB\BSON\Timestamp class" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mongodb-bson-timestamp.construct.php">
          MongoDB\BSON\Timestamp::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mongodb-bson-regex.tostring.php">
          &laquo; MongoDB\BSON\Regex::__toString        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.mongodb-bson-timestamp.php' selected="selected">English</option>
            <option value='de/class.mongodb-bson-timestamp.php'>German</option>
            <option value='es/class.mongodb-bson-timestamp.php'>Spanish</option>
            <option value='fr/class.mongodb-bson-timestamp.php'>French</option>
            <option value='it/class.mongodb-bson-timestamp.php'>Italian</option>
            <option value='ja/class.mongodb-bson-timestamp.php'>Japanese</option>
            <option value='pt_BR/class.mongodb-bson-timestamp.php'>Brazilian Portuguese</option>
            <option value='ru/class.mongodb-bson-timestamp.php'>Russian</option>
            <option value='tr/class.mongodb-bson-timestamp.php'>Turkish</option>
            <option value='uk/class.mongodb-bson-timestamp.php'>Ukrainian</option>
            <option value='zh/class.mongodb-bson-timestamp.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.mongodb-bson-timestamp" class="reference">
 ...
 <div class="partintro"><p class="verinfo">(mongodb &gt;=1.0.0)</p>
  ...
  <div class="section" id="mongodb-bson-timestamp.intro">
   ...
   <p class="para">
    Represents a
    <a href="https://www.mongodb.com/docs/manual/reference/bson-types/#timestamps" class="link external">&raquo;&nbsp;BSON timestamp</a>,
   ...
   <blockquote class="note"><p><strong class="note">Note</strong>: 
    <span class="simpara">
     ...
     (<span class="classname"><a href="class.mongodb-bson-utcdatetime.php" class="classname">MongoDB\BSON\UTCDateTime</a></span> should be used instead).
    </span>
   </p></blockquote>
  </div>
    ...
    <table class="doctable informaltable">
      ...
      <tbody class="tbody">
       ...
       <tr>
        ...
        <td>
         Implements <span class="interfacename"><a href="class.mongodb-bson-timestampinterface.php" class="interfacename">MongoDB\BSON\TimestampInterface</a></span>.
        </td>
       </tr>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="mongodb-bson-timestamp.construct.php">MongoDB\BSON\Timestamp::__construct</a> — Construct a new Timestamp</li><li><a href="mongodb-bson-timestamp.getincrement.php">MongoDB\BSON\Timestamp::getIncrement</a> — Returns the increment component of this Timestamp</li><li><a href="mongodb-bson-timestamp.gettimestamp.php">MongoDB\BSON\Timestamp::getTimestamp</a> — Returns the timestamp component of this Timestamp</li><li><a href="mongodb-bson-timestamp.jsonserialize.php">MongoDB\BSON\Timestamp::jsonSerialize</a> — Returns a representation that can be converted to JSON</li><li><a href="mongodb-bson-timestamp.tostring.php">MongoDB\BSON\Timestamp::__toString</a> — Returns the string representation of this Timestamp</li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/timestamp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.mongodb-bson-timestamp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.mongodb-bson-timestamp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.mongodb-bson-timestamp.php">＋<small>add a note</small></a></span>
