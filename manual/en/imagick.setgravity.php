...
<head>
  ...
  <title>PHP: Imagick::setGravity - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.setgravity.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.setgravity.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setgravity.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.setformat.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.setimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.setgravity.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.setgravity.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.setgravity.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.setgravity.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.setgravity.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.setgravity.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.setgravity.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.setgravity.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.setgravity.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.setgravity.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.setgravity.php" hreflang="zh">
...
<meta name="Description" content="Sets the gravity" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::setGravity - Manual" />
<meta name="twitter:description" content="Sets the gravity" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::setGravity - Manual" />
<meta itemprop="description" content="Sets the gravity" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the gravity" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.setimage.php">
          Imagick::setImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.setformat.php">
          &laquo; Imagick::setFormat        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.setgravity.php' selected="selected">English</option>
            <option value='de/imagick.setgravity.php'>German</option>
            <option value='es/imagick.setgravity.php'>Spanish</option>
            <option value='fr/imagick.setgravity.php'>French</option>
            <option value='it/imagick.setgravity.php'>Italian</option>
            <option value='ja/imagick.setgravity.php'>Japanese</option>
            <option value='pt_BR/imagick.setgravity.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.setgravity.php'>Russian</option>
            <option value='tr/imagick.setgravity.php'>Turkish</option>
            <option value='uk/imagick.setgravity.php'>Ukrainian</option>
            <option value='zh/imagick.setgravity.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.setgravity" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::setGravity</h1>
  <p class="verinfo">(PECL imagick 2 &gt;= 2.2.0, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::setGravity</span> &mdash; <span class="dc-title">Sets the gravity</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.setgravity-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::setGravity</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$gravity</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.setgravity-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.setgravity-returnvalues">
  ...
  <p class="para">
   No value is returned.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/setgravity.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.setgravity%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.setgravity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setgravity.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="128472">  <div class="votes">
    <div id="Vu128472">
    <a href="/manual/vote-note.php?id=128472&amp;page=imagick.setgravity&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd128472">
    <a href="/manual/vote-note.php?id=128472&amp;page=imagick.setgravity&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V128472" title="no votes...">
    0
    </div>
  </div>
  <a href="#128472" class="name">
  <strong class="user"><em>Ahmad</em></strong></a><a class="genanchor" href="#128472"> &para;</a><div class="date" title="2023-05-10 10:51"><strong>2 years ago</strong></div>
  <div class="text" id="Hcom128472">
<div class="phpcode"><code><span class="html">GRAVITY_NORTHWEST: 1<br />GRAVITY_NORTH: 2<br />GRAVITY_NORTHEAST: 3<br />GRAVITY_WEST: 4<br />GRAVITY_CENTER: 5<br />GRAVITY_EAST: 6<br />GRAVITY_SOUTHWEST: 7<br />GRAVITY_SOUTH: 8<br />GRAVITY_SOUTHEAST: 9<br /><br />Default is: 0</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.setgravity&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.setgravity.php">＋<small>add a note</small></a></div>
