...
<head>
  ...
  <title>PHP: Imagick::__construct - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.construct.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.construct.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.construct.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.compositeimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.contrastimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.construct.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.construct.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.construct.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.construct.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.construct.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.construct.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.construct.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.construct.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.construct.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.construct.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.construct.php" hreflang="zh">
...
<meta name="Description" content="The Imagick constructor" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::__construct - Manual" />
<meta name="twitter:description" content="The Imagick constructor" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::__construct - Manual" />
<meta itemprop="description" content="The Imagick constructor" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The Imagick constructor" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.contrastimage.php">
          Imagick::contrastImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.compositeimage.php">
          &laquo; Imagick::compositeImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.construct.php' selected="selected">English</option>
            <option value='de/imagick.construct.php'>German</option>
            <option value='es/imagick.construct.php'>Spanish</option>
            <option value='fr/imagick.construct.php'>French</option>
            <option value='it/imagick.construct.php'>Italian</option>
            <option value='ja/imagick.construct.php'>Japanese</option>
            <option value='pt_BR/imagick.construct.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.construct.php'>Russian</option>
            <option value='tr/imagick.construct.php'>Turkish</option>
            <option value='uk/imagick.construct.php'>Ukrainian</option>
            <option value='zh/imagick.construct.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.construct" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::__construct</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::__construct</span> &mdash; <span class="dc-title">The Imagick constructor</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.construct-description">
  <h3 class="title">Description</h3>
  <div class="constructorsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::__construct</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span> <code class="parameter">$files</code><span class="initializer"> = ?</span></span>)</div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.construct-parameters">
 ...
 <div class="refsect1 errors" id="refsect1-imagick.construct-errors">
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/construct.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.construct%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.construct.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="108764">  <div class="votes">
    <div id="Vu108764">
    <a href="/manual/vote-note.php?id=108764&amp;page=imagick.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd108764">
    <a href="/manual/vote-note.php?id=108764&amp;page=imagick.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V108764" title="71% like this...">
    9
    </div>
  </div>
  <a href="#108764" class="name">
  <strong class="user"><em>martin at lks dot com</em></strong></a><a class="genanchor" href="#108764"> &para;</a><div class="date" title="2012-05-23 04:29"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom108764">
<div class="phpcode"><code><span class="html">If you are using windows imagemagick, at leat in my case, you have to include the full path of the file, including the 'c:' at the beginning. If you don't know for sure the way that the filename is going to come, you can use realpath() function to normalize it:<br /><br /><span class="default">&lt;?php<br />    $incoming_file </span><span class="keyword">= </span><span class="string">'/Users/John/Desktop/file_loco.jpg'</span><span class="keyword">;<br />    </span><span class="default">$img </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">realpath</span><span class="keyword">(</span><span class="default">$incoming_file</span><span class="keyword">));<br />    </span><span class="comment">// realpath() will convert '/Users/John/Desktop/file_loco.jpg' to 'C:\Users\John\Desktop\file_loco.jpg'<br />    // and ImageMagick will have no trouble when loading<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="111656">  <div class="votes">
    <div id="Vu111656">
    <a href="/manual/vote-note.php?id=111656&amp;page=imagick.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd111656">
    <a href="/manual/vote-note.php?id=111656&amp;page=imagick.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V111656" title="76% like this...">
    7
    </div>
  </div>
  <a href="#111656" class="name">
  <strong class="user"><em>andyearnshaw at do-not-spam-mygmail dot com</em></strong></a><a class="genanchor" href="#111656"> &para;</a><div class="date" title="2013-03-13 10:13"><strong>12 years ago</strong></div>
  <div class="text" id="Hcom111656">
<div class="phpcode"><code><span class="html">If you try and load an ICO file whose extension isn't .ico, you'll get an error going along the lines of no delegate existing for the supplied image's format.  The can occur, for example, if you're using a temporary file.<br /><br /><span class="default">&lt;?php<br />$tmp </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="string">'cache/images'</span><span class="keyword">, </span><span class="string">'ico_'</span><span class="keyword">);<br /><br />if (</span><span class="default">copy</span><span class="keyword">(</span><span class="string">'<a href="http://remote.url/favicon.ico" rel="nofollow" target="_blank">http://remote.url/favicon.ico</a>'</span><span class="keyword">, </span><span class="default">$tmp</span><span class="keyword">)) {<br />    </span><span class="default">$ico </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">$tmp</span><span class="keyword">);  </span><span class="comment">// &lt;-- ERROR!<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;<br /></span><br />Your first thought might be to rename your temporary file's extension to .ico, but I decided to try something that works on the command line―prefix the file name with 'ico:'<br /><br /><span class="default">&lt;?php<br />$tmp </span><span class="keyword">= </span><span class="default">tempnam</span><span class="keyword">(</span><span class="string">'cache/images'</span><span class="keyword">, </span><span class="string">'ico_'</span><span class="keyword">);<br /><br />if (</span><span class="default">copy</span><span class="keyword">(</span><span class="string">'<a href="http://remote.url/favicon.ico" rel="nofollow" target="_blank">http://remote.url/favicon.ico</a>'</span><span class="keyword">, </span><span class="default">$tmp</span><span class="keyword">)) {<br />    </span><span class="default">$ico </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="string">"ico:</span><span class="default">$tmp</span><span class="string">"</span><span class="keyword">);  </span><span class="comment">// &lt;-- Works great!<br /></span><span class="keyword">}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="123791">  <div class="votes">
    <div id="Vu123791">
    <a href="/manual/vote-note.php?id=123791&amp;page=imagick.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123791">
    <a href="/manual/vote-note.php?id=123791&amp;page=imagick.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123791" title="63% like this...">
    3
    </div>
  </div>
  <a href="#123791" class="name">
  <strong class="user"><em>divinity76 at gmail dot com</em></strong></a><a class="genanchor" href="#123791"> &para;</a><div class="date" title="2019-04-22 07:55"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123791">
<div class="phpcode"><code><span class="html">if you need to create an image from a string containing the image binary, use readImageBlob, eg<br /><br /><span class="default">&lt;?php<br />$imagick </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">();<br /></span><span class="default">$imagick</span><span class="keyword">-&gt;</span><span class="default">readImageBlob</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />likewise if you need to create an image from a file handle (without having the filepath), use readImageFile()</span></code></div>
  </div>
 </div>
  <div class="note" id="113801">  <div class="votes">
    <div id="Vu113801">
    <a href="/manual/vote-note.php?id=113801&amp;page=imagick.construct&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd113801">
    <a href="/manual/vote-note.php?id=113801&amp;page=imagick.construct&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V113801" title="52% like this...">
    1
    </div>
  </div>
  <a href="#113801" class="name">
  <strong class="user"><em>Jerome</em></strong></a><a class="genanchor" href="#113801"> &para;</a><div class="date" title="2013-12-04 11:05"><strong>11 years ago</strong></div>
  <div class="text" id="Hcom113801">
<div class="phpcode"><code><span class="html">you can use PDF page as image. To do that, install ghostscript libraries.<br />IMagick use ghostscript to read PDF page.<br /><br /><span class="default">&lt;?php<br />$myurl </span><span class="keyword">= </span><span class="string">'/pdf/mypdf.pdf'</span><span class="keyword">;<br /></span><span class="default">$image </span><span class="keyword">= new </span><span class="default">Imagick</span><span class="keyword">(</span><span class="default">realpath</span><span class="keyword">(</span><span class="default">$myurl</span><span class="keyword">).</span><span class="string">'[0]'</span><span class="keyword">); </span><span class="comment">//[0] indicate the number of the wanted page<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setResolution</span><span class="keyword">( </span><span class="default">300</span><span class="keyword">, </span><span class="default">300 </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">setImageFormat</span><span class="keyword">( </span><span class="string">"png" </span><span class="keyword">);<br /></span><span class="default">$image</span><span class="keyword">-&gt;</span><span class="default">writeImage</span><span class="keyword">(</span><span class="default">realpath</span><span class="keyword">(</span><span class="string">'./mypdf.png'</span><span class="keyword">));<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=imagick.construct&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.construct.php">＋<small>add a note</small></a></div>
