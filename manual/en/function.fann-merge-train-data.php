...
<head>
  ...
  <title>PHP: fann_merge_train_data - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fann-merge-train-data.php">
 <link rel="shorturl" href="https://www.php.net/fann-merge-train-data">
 <link rel="alternate" href="https://www.php.net/fann-merge-train-data" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.fann.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fann-length-train-data.php">
 <link rel="next" href="https://www.php.net/manual/en/function.fann-num-input-train-data.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fann-merge-train-data.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fann-merge-train-data.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fann-merge-train-data.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fann-merge-train-data.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fann-merge-train-data.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fann-merge-train-data.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fann-merge-train-data.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fann-merge-train-data.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fann-merge-train-data.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fann-merge-train-data.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fann-merge-train-data.php" hreflang="zh">
...
<meta name="Description" content="Merges the train data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fann_merge_train_data - Manual" />
<meta name="twitter:description" content="Merges the train data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fann_merge_train_data - Manual" />
<meta itemprop="description" content="Merges the train data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Merges the train data" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.fann-num-input-train-data.php">
          fann_num_input_train_data &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.fann-length-train-data.php">
          &laquo; fann_length_train_data        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fann-merge-train-data.php' selected="selected">English</option>
            <option value='de/function.fann-merge-train-data.php'>German</option>
            <option value='es/function.fann-merge-train-data.php'>Spanish</option>
            <option value='fr/function.fann-merge-train-data.php'>French</option>
            <option value='it/function.fann-merge-train-data.php'>Italian</option>
            <option value='ja/function.fann-merge-train-data.php'>Japanese</option>
            <option value='pt_BR/function.fann-merge-train-data.php'>Brazilian Portuguese</option>
            <option value='ru/function.fann-merge-train-data.php'>Russian</option>
            <option value='tr/function.fann-merge-train-data.php'>Turkish</option>
            <option value='uk/function.fann-merge-train-data.php'>Ukrainian</option>
            <option value='zh/function.fann-merge-train-data.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fann-merge-train-data" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fann_merge_train_data</h1>
  <p class="verinfo">(PECL fann &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">fann_merge_train_data</span> &mdash; <span class="dc-title">Merges the train data</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.fann-merge-train-data-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>fann_merge_train_data</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$data1</code></span>, <span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$data2</code></span>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>

  <p class="para rdfs-comment">
   Merges the data from data1 and data2 into a new train data <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>.
  </p>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.fann-merge-train-data-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">data1</code></dt>
    <dd>
     <p class="para">Neural network training data <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>.</p>
    </dd>
   
   
    <dt><code class="parameter">data2</code></dt>
    <dd>
     <p class="para">Neural network training data <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>.</p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.fann-merge-train-data-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   New merged train data <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span>, or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on error.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/fann/functions/fann-merge-train-data.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fann-merge-train-data%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fann-merge-train-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-merge-train-data.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="123272">  <div class="votes">
    <div id="Vu123272">
    <a href="/manual/vote-note.php?id=123272&amp;page=function.fann-merge-train-data&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd123272">
    <a href="/manual/vote-note.php?id=123272&amp;page=function.fann-merge-train-data&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V123272" title="66% like this...">
    1
    </div>
  </div>
  <a href="#123272" class="name">
  <strong class="user"><em>geekgirljoy at gmail dot com</em></strong></a><a class="genanchor" href="#123272"> &para;</a><div class="date" title="2018-10-29 07:19"><strong>6 years ago</strong></div>
  <div class="text" id="Hcom123272">
<div class="phpcode"><code><span class="html">There will be times when you need to merge separate data sets into a new single set. <br /><br />This code demonstrates how to merge the XOR dataset from two separate files into a single training file.<br /><br />File (xor_part_1.data):<br />1 2 1<br />-1 -1<br />-1<br /><br />File (xor_part_2.data):<br />3 2 1<br />-1 1<br />1<br />1 -1<br />1<br />1 1<br />-1<br /><br />Resulting File (xor_complete.data):<br />4 2 1<br />-1 -1 <br />-1 <br />-1 1 <br />1 <br />1 -1 <br />1 <br />1 1 <br />-1 <br /><br /><span class="default">&lt;?php<br /></span><span class="comment">// Create partial data resources<br /></span><span class="default">$train_data_1 </span><span class="keyword">= </span><span class="default">fann_read_train_from_file</span><span class="keyword">(</span><span class="string">"xor_part_1.data"</span><span class="keyword">);<br /></span><span class="default">$train_data_2 </span><span class="keyword">= </span><span class="default">fann_read_train_from_file</span><span class="keyword">(</span><span class="string">"xor_part_2.data"</span><span class="keyword">);<br /><br /></span><span class="comment">// Merge into new data resource<br /></span><span class="default">$train_data </span><span class="keyword">= </span><span class="default">fann_merge_train_data </span><span class="keyword">(</span><span class="default">$train_data_1</span><span class="keyword">, </span><span class="default">$train_data_2</span><span class="keyword">);<br /><br /></span><span class="comment">// Remove the partial data resources from memory <br /></span><span class="default">fann_destroy_train </span><span class="keyword">( </span><span class="default">$train_data_1 </span><span class="keyword">);<br /></span><span class="default">fann_destroy_train </span><span class="keyword">( </span><span class="default">$train_data_2 </span><span class="keyword">);<br /><br /></span><span class="comment">// Save the new complete Data file<br /></span><span class="default">fann_save_train </span><span class="keyword">( </span><span class="default">$train_data </span><span class="keyword">, </span><span class="string">"xor_complete.data"</span><span class="keyword">);<br /><br /></span><span class="comment">// Remove the complete data resources from memory <br /></span><span class="default">fann_destroy_train </span><span class="keyword">( </span><span class="default">$train_data </span><span class="keyword">);<br /><br />echo </span><span class="string">'All Done!' </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.fann-merge-train-data&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fann-merge-train-data.php">＋<small>add a note</small></a></div>
