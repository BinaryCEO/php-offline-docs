...
<head>
  ...
  <title>PHP: oci_set_action - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.oci-set-action.php">
 <link rel="shorturl" href="https://www.php.net/oci-set-action">
 <link rel="alternate" href="https://www.php.net/oci-set-action" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.oci8.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.oci-server-version.php">
 <link rel="next" href="https://www.php.net/manual/en/function.oci-set-call-timout.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.oci-set-action.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.oci-set-action.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.oci-set-action.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.oci-set-action.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.oci-set-action.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.oci-set-action.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.oci-set-action.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.oci-set-action.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.oci-set-action.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.oci-set-action.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.oci-set-action.php" hreflang="zh">
...
<meta name="Description" content="Sets the action name" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: oci_set_action - Manual" />
<meta name="twitter:description" content="Sets the action name" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: oci_set_action - Manual" />
<meta itemprop="description" content="Sets the action name" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sets the action name" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.oci-set-call-timout.php">
          oci_set_call_timeout &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.oci-server-version.php">
          &laquo; oci_server_version        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.oci-set-action.php' selected="selected">English</option>
            <option value='de/function.oci-set-action.php'>German</option>
            <option value='es/function.oci-set-action.php'>Spanish</option>
            <option value='fr/function.oci-set-action.php'>French</option>
            <option value='it/function.oci-set-action.php'>Italian</option>
            <option value='ja/function.oci-set-action.php'>Japanese</option>
            <option value='pt_BR/function.oci-set-action.php'>Brazilian Portuguese</option>
            <option value='ru/function.oci-set-action.php'>Russian</option>
            <option value='tr/function.oci-set-action.php'>Turkish</option>
            <option value='uk/function.oci-set-action.php'>Ukrainian</option>
            <option value='zh/function.oci-set-action.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.oci-set-action" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-function.oci-set-action-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>oci_set_action</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$action</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
...
using <span class="function"><a href="function.oci-set-client-info.php" class="function">oci_set_client_info()</a></span>.</p></div>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.oci-set-db-operation.php" class="function" rel="rdfs-seeAlso">oci_set_db_operation()</a> - Sets the database operation</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/oci8/functions/oci-set-action.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.oci-set-action%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.oci-set-action&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.oci-set-action.php">＋<small>add a note</small></a></span>
