...
<head>
  ...
  <title>PHP: pg_affected_rows - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-affected-rows.php">
 <link rel="shorturl" href="https://www.php.net/pg-affected-rows">
 <link rel="alternate" href="https://www.php.net/pg-affected-rows" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-cancel-query.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-affected-rows.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-affected-rows.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-affected-rows.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-affected-rows.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-affected-rows.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-affected-rows.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-affected-rows.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-affected-rows.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-affected-rows.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-affected-rows.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-affected-rows.php" hreflang="zh">
...
<meta name="Description" content="Returns number of affected records (tuples)" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_affected_rows - Manual" />
<meta name="twitter:description" content="Returns number of affected records (tuples)" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_affected_rows - Manual" />
<meta itemprop="description" content="Returns number of affected records (tuples)" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns number of affected records (tuples)" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.pg-cancel-query.php">
          pg_cancel_query &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="ref.pgsql.php">
          &laquo; PostgreSQL Functions        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-affected-rows.php' selected="selected">English</option>
            <option value='de/function.pg-affected-rows.php'>German</option>
            <option value='es/function.pg-affected-rows.php'>Spanish</option>
            <option value='fr/function.pg-affected-rows.php'>French</option>
            <option value='it/function.pg-affected-rows.php'>Italian</option>
            <option value='ja/function.pg-affected-rows.php'>Japanese</option>
            <option value='pt_BR/function.pg-affected-rows.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-affected-rows.php'>Russian</option>
            <option value='tr/function.pg-affected-rows.php'>Turkish</option>
            <option value='uk/function.pg-affected-rows.php'>Ukrainian</option>
            <option value='zh/function.pg-affected-rows.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-affected-rows" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-affected-rows-examples">
  ...
  <p class="para">
   <div class="example" id="example-2038">
    <p><strong>Example #1 <span class="function"><strong>pg_affected_rows()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.pg-num-rows.php" class="function" rel="rdfs-seeAlso">pg_num_rows()</a> - Returns the number of rows in a result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-affected-rows.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-affected-rows%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-affected-rows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-affected-rows.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">4 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="79179">  <div class="votes">
    <div id="Vu79179">
    <a href="/manual/vote-note.php?id=79179&amp;page=function.pg-affected-rows&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79179">
    <a href="/manual/vote-note.php?id=79179&amp;page=function.pg-affected-rows&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79179" title="81% like this...">
    10
    </div>
  </div>
  <a href="#79179" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#79179"> &para;</a><div class="date" title="2007-11-14 07:45"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79179">
<div class="phpcode"><code><span class="html">pg-affected-rows () only runs on the LAST SQL STATEMENT executed.  If you compound several statements together then pg_affected_rows might not return what you expect.  <br /><br />For example:<br /><br /><span class="default">&lt;?php<br /><br />$result </span><span class="keyword">= </span><span class="default">pg_query </span><span class="keyword">(</span><span class="string">'BEGIN; INSERT INTO foo (bar) VALUES (\'baz\'; COMMIT'</span><span class="keyword">);<br /><br />echo (</span><span class="default">pg_affected_rows </span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">));<br /><br /></span><span class="default">?&gt;<br /></span><br />will cause 0 to be printed, because the last statement executed by Postgres was COMMIT, which doesn't affect any rows.  <br /><br />I haven't tried this so am not certain it works, but you SHOULD be able to get the row counts you want if you split your queries up.  <br /><br />For example: <br /><br /><span class="default">&lt;?php<br /><br />$result </span><span class="keyword">= </span><span class="default">pg_query </span><span class="keyword">(</span><span class="string">'BEGIN; INSERT INTO foo (bar) VALUES (\'baz\';'</span><span class="keyword">);<br /><br />echo (</span><span class="default">pg_affected_rows </span><span class="keyword">(</span><span class="default">$result</span><span class="keyword">));<br /><br /></span><span class="default">pg_query </span><span class="keyword">(</span><span class="string">'COMMIT;'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span><br />should allow you to get the number of rows affected by the previous query.  I haven't tried this yet though, so don't count on it.</span></code></div>
  </div>
 </div>
  <div class="note" id="54239">  <div class="votes">
    <div id="Vu54239">
    <a href="/manual/vote-note.php?id=54239&amp;page=function.pg-affected-rows&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd54239">
    <a href="/manual/vote-note.php?id=54239&amp;page=function.pg-affected-rows&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V54239" title="46% like this...">
    -1
    </div>
  </div>
  <a href="#54239" class="name">
  <strong class="user"><em>Bruno Baguette</em></strong></a><a class="genanchor" href="#54239"> &para;</a><div class="date" title="2005-06-28 01:45"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom54239">
<div class="phpcode"><code><span class="html">Note that when you submit several SQL queries, within one BEGIN;COMMIT; like this one :<br /><br />$SQLQuery = 'BEGIN;';<br />$SQLQuery.= 'INSERT INTO a (a,b) VALUES (1,2);';<br />$SQLQuery.= 'INSERT INTO b (ref_b,c) VALUES (2,5);';<br />$SQLQuery.= 'COMMIT;';<br /><br />$HandleResults = pg_query($SQLQuery);<br />echo(pg_affected_rows($HandleResults));<br /><br />pg_affected_rows() will return 0</span></code></div>
  </div>
 </div>
  <div class="note" id="79937">  <div class="votes">
    <div id="Vu79937">
    <a href="/manual/vote-note.php?id=79937&amp;page=function.pg-affected-rows&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd79937">
    <a href="/manual/vote-note.php?id=79937&amp;page=function.pg-affected-rows&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V79937" title="33% like this...">
    -2
    </div>
  </div>
  <a href="#79937" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#79937"> &para;</a><div class="date" title="2007-12-20 03:02"><strong>17 years ago</strong></div>
  <div class="text" id="Hcom79937">
<div class="phpcode"><code><span class="html">There is something called auto-commit, when you supply more than one query delimited by ; semicolon all-or-none is done if one fails. No need for BEGIN;COMMIT;ROLLBACK when doing one query. its logic to mee pg_affected_rows() returns affected rows and if you want to do 2 queries apart from each other.. do a BEGIN and then 1 and get pg_affected_rows() then do 2 and get pg_affected_rows() and then finally do COMMIT;</span></code></div>
  </div>
 </div>
  <div class="note" id="55508">  <div class="votes">
    <div id="Vu55508">
    <a href="/manual/vote-note.php?id=55508&amp;page=function.pg-affected-rows&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd55508">
    <a href="/manual/vote-note.php?id=55508&amp;page=function.pg-affected-rows&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V55508" title="33% like this...">
    -3
    </div>
  </div>
  <a href="#55508" class="name"><strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#55508"> &para;</a><div class="date" title="2005-08-05 03:31"><strong>20 years ago</strong></div>
  <div class="text" id="Hcom55508">
<div class="phpcode"><code><span class="html">That's not quite true, I've been able to execute multiple queries in a single call just fine. In stead, it has to do with the fact this function returns the affected rows for the last executed query, not the last set of queries specified to a single call to pg_query.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.pg-affected-rows&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-affected-rows.php">＋<small>add a note</small></a></div>
