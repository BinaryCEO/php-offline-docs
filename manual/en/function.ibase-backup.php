...
<head>
  ...
  <title>PHP: ibase_backup - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.ibase-backup.php">
 <link rel="shorturl" href="https://www.php.net/ibase-backup">
 <link rel="alternate" href="https://www.php.net/ibase-backup" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.ibase-affected-rows.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-blob-add.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.ibase-backup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.ibase-backup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.ibase-backup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.ibase-backup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.ibase-backup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.ibase-backup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.ibase-backup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.ibase-backup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.ibase-backup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.ibase-backup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.ibase-backup.php" hreflang="zh">
...
<meta name="Description" content="Initiates a backup task in the service manager and returns immediately" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ibase_backup - Manual" />
<meta name="twitter:description" content="Initiates a backup task in the service manager and returns immediately" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ibase_backup - Manual" />
<meta itemprop="description" content="Initiates a backup task in the service manager and returns immediately" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Initiates a backup task in the service manager and returns immediately" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-blob-add.php">
          ibase_blob_add &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.ibase-affected-rows.php">
          &laquo; ibase_affected_rows        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.ibase-backup.php' selected="selected">English</option>
            <option value='de/function.ibase-backup.php'>German</option>
            <option value='es/function.ibase-backup.php'>Spanish</option>
            <option value='fr/function.ibase-backup.php'>French</option>
            <option value='it/function.ibase-backup.php'>Italian</option>
            <option value='ja/function.ibase-backup.php'>Japanese</option>
            <option value='pt_BR/function.ibase-backup.php'>Brazilian Portuguese</option>
            <option value='ru/function.ibase-backup.php'>Russian</option>
            <option value='tr/function.ibase-backup.php'>Turkish</option>
            <option value='uk/function.ibase-backup.php'>Ukrainian</option>
            <option value='zh/function.ibase-backup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.ibase-backup" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">ibase_backup</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">ibase_backup</span> &mdash; <span class="dc-title">Initiates a backup task in the service manager and returns immediately</span></p>

 </div>
 
 <div class="refsect1 description" id="refsect1-function.ibase-backup-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>ibase_backup</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$service_handle</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$source_db</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$dest_file</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$options</code><span class="initializer"> = 0</span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span> <code class="parameter">$verbose</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong></span></span><br>): <span class="type"><a href="language.types.mixed.php" class="type mixed">mixed</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.ibase-backup-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dt><code class="parameter">source_db</code></dt>
     <dd>
      <p class="para">
     ...
     <dt><code class="parameter">dest_file</code></dt>
     <dd>
      <p class="para">
     ...
     <dd>
      <p class="para">
       ...
       The <code class="parameter">options</code> parameter can be a combination 
       ...
       <strong><code><a href="ibase.constants.php#constant.ibase-bkp-non-transportable">IBASE_BKP_NON_TRANSPORTABLE</a></code></strong> or
       <strong><code><a href="ibase.constants.php#constant.ibase-bkp-convert">IBASE_BKP_CONVERT</a></code></strong>.
       Read the section about <a href="ibase.constants.php" class="xref">Predefined Constants</a> for further information.
      </p>
     </dd>
    
    
     <dt><code class="parameter">verbose</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.ibase-backup-returnvalues">
  ...
  <p class="para">
   ...
   While the arguments are legal, you won&#039;t get <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong>.
  </p>
 </div>


 <div class="refsect1 examples" id="refsect1-function.ibase-backup-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-1321">
    <p><strong>Example #1 <span class="function"><strong>ibase_backup()</strong></span> example</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Attach to database server by ip address and port<br /></span><span style="color: #0000BB">$service </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_service_attach </span><span style="color: #007700">(</span><span style="color: #DD0000">'10.1.11.200/3050'</span><span style="color: #007700">, </span><span style="color: #DD0000">'sysdba'</span><span style="color: #007700">, </span><span style="color: #DD0000">'masterkey'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Start the backup process on database server<br />// Backup employee database using full path to /srv/backup/employees.fbk<br />// Don't use any special arguments<br /></span><span style="color: #0000BB">ibase_backup</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #DD0000">'/srv/firebird/employees.fdb'</span><span style="color: #007700">, </span><span style="color: #DD0000">'/srv/backup/employees.fbk'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Free the attached connection<br /></span><span style="color: #0000BB">ibase_service_detach </span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
  ...
  <p class="para">
   <div class="example" id="example-1322">
    <p><strong>Example #2 <span class="function"><strong>ibase_backup()</strong></span> example with arguments</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br /></span><span style="color: #FF8000">// Attach to database server by name and default port<br /></span><span style="color: #0000BB">$service </span><span style="color: #007700">= </span><span style="color: #0000BB">ibase_service_attach </span><span style="color: #007700">(</span><span style="color: #DD0000">'fb-server.contoso.local'</span><span style="color: #007700">, </span><span style="color: #DD0000">'sysdba'</span><span style="color: #007700">, </span><span style="color: #DD0000">'masterkey'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Start the backup process on database server<br />// Backup employee database using alias to /srv/backup/employees.fbk.<br />// Backup only the metadata. Don't create a transportable backup.<br /></span><span style="color: #0000BB">ibase_backup</span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">, </span><span style="color: #DD0000">'employees.fdb'</span><span style="color: #007700">, </span><span style="color: #DD0000">'/srv/backup/employees.fbk'</span><span style="color: #007700">, </span><span style="color: #0000BB">IBASE_BKP_METADATA_ONLY </span><span style="color: #007700">| </span><span style="color: #0000BB">IBASE_BKP_NON_TRANSPORTABLE</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">// Free the attached connection<br /></span><span style="color: #0000BB">ibase_service_detach </span><span style="color: #007700">(</span><span style="color: #0000BB">$service</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    </div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.ibase-backup-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.ibase-restore.php" class="function" rel="rdfs-seeAlso">ibase_restore()</a> - Initiates a restore task in the service manager and returns immediately</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/ibase-backup.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.ibase-backup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.ibase-backup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.ibase-backup.php">＋<small>add a note</small></a></span>
