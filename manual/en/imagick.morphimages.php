...
<head>
  ...
  <title>PHP: Imagick::morphImages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.morphimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.morphimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.morphimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.montageimage.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.morphology.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.morphimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.morphimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.morphimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.morphimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.morphimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.morphimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.morphimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.morphimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.morphimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.morphimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.morphimages.php" hreflang="zh">
...
<meta name="Description" content="Method morphs a set of images" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::morphImages - Manual" />
<meta name="twitter:description" content="Method morphs a set of images" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::morphImages - Manual" />
<meta itemprop="description" content="Method morphs a set of images" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Method morphs a set of images" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.morphology.php">
          Imagick::morphology &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.montageimage.php">
          &laquo; Imagick::montageImage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.morphimages.php' selected="selected">English</option>
            <option value='de/imagick.morphimages.php'>German</option>
            <option value='es/imagick.morphimages.php'>Spanish</option>
            <option value='fr/imagick.morphimages.php'>French</option>
            <option value='it/imagick.morphimages.php'>Italian</option>
            <option value='ja/imagick.morphimages.php'>Japanese</option>
            <option value='pt_BR/imagick.morphimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.morphimages.php'>Russian</option>
            <option value='tr/imagick.morphimages.php'>Turkish</option>
            <option value='uk/imagick.morphimages.php'>Ukrainian</option>
            <option value='zh/imagick.morphimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.morphimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::morphImages</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::morphImages</span> &mdash; <span class="dc-title">Method morphs a set of images</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.morphimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::morphImages</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$number_frames</code></span>): <span class="type"><a href="class.imagick.php" class="type Imagick">Imagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.morphimages-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">
   <dl>
    
     <dt><code class="parameter">number_frames</code></dt>
     <dd>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.morphimages-returnvalues">
...
<span class="classname"><strong class="classname">ImagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/morphimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.morphimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.morphimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.morphimages.php">＋<small>add a note</small></a></span>
