...
<head>
  ...
  <title>PHP: ArrayObject::uasort - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/arrayobject.uasort.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/arrayobject.uasort.php">
 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.uasort.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.arrayobject.php">
 <link rel="prev" href="https://www.php.net/manual/en/arrayobject.setiteratorclass.php">
 <link rel="next" href="https://www.php.net/manual/en/arrayobject.uksort.php">

 <link rel="alternate" href="https://www.php.net/manual/en/arrayobject.uasort.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/arrayobject.uasort.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/arrayobject.uasort.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/arrayobject.uasort.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/arrayobject.uasort.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/arrayobject.uasort.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/arrayobject.uasort.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/arrayobject.uasort.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/arrayobject.uasort.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/arrayobject.uasort.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/arrayobject.uasort.php" hreflang="zh">
...
<meta name="Description" content="Sort the entries with a user-defined comparison function and maintain key association" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ArrayObject::uasort - Manual" />
<meta name="twitter:description" content="Sort the entries with a user-defined comparison function and maintain key association" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ArrayObject::uasort - Manual" />
<meta itemprop="description" content="Sort the entries with a user-defined comparison function and maintain key association" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sort the entries with a user-defined comparison function and maintain key association" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="arrayobject.uksort.php">
          ArrayObject::uksort &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="arrayobject.setiteratorclass.php">
          &laquo; ArrayObject::setIteratorClass        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/arrayobject.uasort.php' selected="selected">English</option>
            <option value='de/arrayobject.uasort.php'>German</option>
            <option value='es/arrayobject.uasort.php'>Spanish</option>
            <option value='fr/arrayobject.uasort.php'>French</option>
            <option value='it/arrayobject.uasort.php'>Italian</option>
            <option value='ja/arrayobject.uasort.php'>Japanese</option>
            <option value='pt_BR/arrayobject.uasort.php'>Brazilian Portuguese</option>
            <option value='ru/arrayobject.uasort.php'>Russian</option>
            <option value='tr/arrayobject.uasort.php'>Turkish</option>
            <option value='uk/arrayobject.uasort.php'>Ukrainian</option>
            <option value='zh/arrayobject.uasort.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="arrayobject.uasort" class="refentry">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.uasort.php" class="function" rel="rdfs-seeAlso">uasort()</a> - Sort an array with a user-defined comparison function and maintain index association</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/arrayobject/uasort.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Farrayobject.uasort%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=arrayobject.uasort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/arrayobject.uasort.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="105628">  <div class="votes">
    <div id="Vu105628">
    <a href="/manual/vote-note.php?id=105628&amp;page=arrayobject.uasort&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd105628">
    <a href="/manual/vote-note.php?id=105628&amp;page=arrayobject.uasort&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V105628" title="100% like this...">
    2
    </div>
  </div>
  <a href="#105628" class="name">
  <strong class="user"><em>poxetinho at gmail dot com</em></strong></a><a class="genanchor" href="#105628"> &para;</a><div class="date" title="2011-09-01 12:38"><strong>14 years ago</strong></div>
  <div class="text" id="Hcom105628">
<div class="phpcode"><code><span class="html">Note that return values between (-1, 1) are being considered as 0.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=arrayobject.uasort&amp;repo=en&amp;redirect=https://www.php.net/manual/en/arrayobject.uasort.php">＋<small>add a note</small></a></div>
