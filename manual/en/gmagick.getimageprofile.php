...
<head>
  ...
  <title>PHP: Gmagick::getimageprofile - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageprofile.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageprofile.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageprofile.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagemattecolor.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimageredprimary.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageprofile.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageprofile.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageprofile.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageprofile.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageprofile.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageprofile.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageprofile.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageprofile.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageprofile.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageprofile.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageprofile.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageprofile - Manual" />
<meta name="twitter:description" content="Returns the named image profile" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageprofile - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimageredprimary.php">
          Gmagick::getimageredprimary &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagemattecolor.php">
          &laquo; Gmagick::getimagemattecolor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageprofile.php' selected="selected">English</option>
            <option value='de/gmagick.getimageprofile.php'>German</option>
            <option value='es/gmagick.getimageprofile.php'>Spanish</option>
            <option value='fr/gmagick.getimageprofile.php'>French</option>
            <option value='it/gmagick.getimageprofile.php'>Italian</option>
            <option value='ja/gmagick.getimageprofile.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageprofile.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageprofile.php'>Russian</option>
            <option value='tr/gmagick.getimageprofile.php'>Turkish</option>
            <option value='uk/gmagick.getimageprofile.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageprofile.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageprofile" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageprofile</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageprofile</span> &mdash; <span class="dc-title">Returns the named image profile</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageprofile-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageprofile</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$name</code></span>): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimageprofile-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageprofile-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageprofile-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageprofile.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageprofile%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageprofile&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageprofile.php">＋<small>add a note</small></a></span>
