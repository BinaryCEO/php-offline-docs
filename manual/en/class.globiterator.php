...
<head>
  ...
  <title>PHP: GlobIterator - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.globiterator.php">
 <link rel="shorturl" href="https://www.php.net/globiterator">
 <link rel="alternate" href="https://www.php.net/globiterator" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/spl.iterators.php">
 <link rel="prev" href="https://www.php.net/manual/en/filteriterator.valid.php">
 <link rel="next" href="https://www.php.net/manual/en/globiterator.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.globiterator.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.globiterator.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.globiterator.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.globiterator.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.globiterator.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.globiterator.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.globiterator.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.globiterator.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.globiterator.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.globiterator.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.globiterator.php" hreflang="zh">
...
<meta name="Description" content="The GlobIterator class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: GlobIterator - Manual" />
<meta name="twitter:description" content="The GlobIterator class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: GlobIterator - Manual" />
<meta itemprop="description" content="The GlobIterator class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The GlobIterator class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="globiterator.construct.php">
          GlobIterator::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="filteriterator.valid.php">
          &laquo; FilterIterator::valid        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.globiterator.php' selected="selected">English</option>
            <option value='de/class.globiterator.php'>German</option>
            <option value='es/class.globiterator.php'>Spanish</option>
            <option value='fr/class.globiterator.php'>French</option>
            <option value='it/class.globiterator.php'>Italian</option>
            <option value='ja/class.globiterator.php'>Japanese</option>
            <option value='pt_BR/class.globiterator.php'>Brazilian Portuguese</option>
            <option value='ru/class.globiterator.php'>Russian</option>
            <option value='tr/class.globiterator.php'>Turkish</option>
            <option value='uk/class.globiterator.php'>Ukrainian</option>
            <option value='zh/class.globiterator.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.globiterator" class="reference">

 <h1 class="title">The GlobIterator class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p>


  <div class="section" id="globiterator.intro">
  ...
  <div class="section" id="globiterator.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="classname">GlobIterator</strong></strong>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
   ...
   <span class="modifier">public</span> <span class="methodname"><a href="globiterator.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$pattern</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$flags</code><span class="initializer"> = FilesystemIterator::KEY_AS_PATHNAME | FilesystemIterator::CURRENT_AS_FILEINFO</span></span>)</div>

    <div class="methodsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="globiterator.count.php" class="methodname">count</a></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="globiterator.construct.php">GlobIterator::__construct</a> — Construct a directory using glob</li><li><a href="globiterator.count.php">GlobIterator::count</a> — Get the number of directories and files</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/spl/globiterator.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.globiterator%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.globiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.globiterator.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">2 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125220">  <div class="votes">
    <div id="Vu125220">
    <a href="/manual/vote-note.php?id=125220&amp;page=class.globiterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125220">
    <a href="/manual/vote-note.php?id=125220&amp;page=class.globiterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125220" title="62% like this...">
    2
    </div>
  </div>
  <a href="#125220" class="name">
  <strong class="user"><em>info at ensostudio dot ru</em></strong></a><a class="genanchor" href="#125220"> &para;</a><div class="date" title="2020-07-28 12:10"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125220">
<div class="phpcode"><code><span class="html">Fix problem with braces in template:<br /><span class="default">&lt;?php<br /></span><span class="keyword">class </span><span class="default">GlobStreamWrapper<br /></span><span class="keyword">{<br />    private </span><span class="default">$generator</span><span class="keyword">;<br /><br />    protected function </span><span class="default">createGenerator</span><span class="keyword">(array </span><span class="default">$paths</span><span class="keyword">): </span><span class="default">Generator<br />    </span><span class="keyword">{<br />        return yield from </span><span class="default">$paths</span><span class="keyword">;<br />    }<br /><br />    public function </span><span class="default">dir_opendir</span><span class="keyword">(</span><span class="default">string $pattern</span><span class="keyword">, </span><span class="default">int $options </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">): </span><span class="default">bool<br />    </span><span class="keyword">{<br />        </span><span class="default">$pattern </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$pattern</span><span class="keyword">, </span><span class="default">7</span><span class="keyword">); </span><span class="comment">// crop 'glob://' prefix<br />        </span><span class="default">$pattern </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">([</span><span class="string">'\\'</span><span class="keyword">, </span><span class="string">'/'</span><span class="keyword">], </span><span class="default">DIRECTORY_SEPARATOR</span><span class="keyword">, </span><span class="default">$pattern</span><span class="keyword">);<br />        </span><span class="default">$paths </span><span class="keyword">= (array) </span><span class="default">glob</span><span class="keyword">(</span><span class="default">$pattern</span><span class="keyword">, </span><span class="default">GLOB_BRACE </span><span class="keyword">| </span><span class="default">GLOB_NOSORT</span><span class="keyword">);<br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">generator </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">createGenerator</span><span class="keyword">(</span><span class="default">$paths</span><span class="keyword">);<br />        return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">generator</span><span class="keyword">-&gt;</span><span class="default">valid</span><span class="keyword">();<br />    }<br /><br />    public function </span><span class="default">dir_readdir</span><span class="keyword">(): </span><span class="default">string<br />    </span><span class="keyword">{<br />        </span><span class="default">$path </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">generator</span><span class="keyword">-&gt;</span><span class="default">current</span><span class="keyword">() ?: </span><span class="string">''</span><span class="keyword">;<br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">generator</span><span class="keyword">-&gt;</span><span class="default">next</span><span class="keyword">();<br />        return </span><span class="default">$path</span><span class="keyword">;<br />    }<br /><br />    public function </span><span class="default">dir_rewinddir</span><span class="keyword">(): </span><span class="default">bool<br />    </span><span class="keyword">{<br />       </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">generator</span><span class="keyword">-&gt;</span><span class="default">rewind</span><span class="keyword">();<br />        return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">generator</span><span class="keyword">-&gt;</span><span class="default">valid</span><span class="keyword">();<br />    }<br /><br />    public function </span><span class="default">dir_closedir</span><span class="keyword">(): </span><span class="default">bool<br />    </span><span class="keyword">{<br />        </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">generator </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">;<br />        return </span><span class="default">true</span><span class="keyword">;<br />    }<br />}<br /></span><span class="default">?&gt;<br /></span>Replace glob wrapper:<br /><span class="default">&lt;?php<br />stream_wrapper_unregister</span><span class="keyword">(</span><span class="string">'glob'</span><span class="keyword">);<br /></span><span class="default">stream_wrapper_register</span><span class="keyword">(</span><span class="string">'glob'</span><span class="keyword">, </span><span class="string">'GlobStreamWrapper'</span><span class="keyword">);<br /></span><span class="default">?&gt;<br /></span>Example:<br /><span class="default">&lt;?php<br />$iterator </span><span class="keyword">= new </span><span class="default">GlobIterator</span><span class="keyword">(</span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/{application,system}/src/*.php'</span><span class="keyword">);<br />while (</span><span class="default">$iterator</span><span class="keyword">-&gt;</span><span class="default">valid</span><span class="keyword">()) {<br />    echo </span><span class="default">$iterator</span><span class="keyword">-&gt;</span><span class="default">current</span><span class="keyword">()-&gt;</span><span class="default">getFilename</span><span class="keyword">() . </span><span class="string">'&lt;/br&gt;'</span><span class="keyword">;<br />    </span><span class="default">$iterator</span><span class="keyword">-&gt;</span><span class="default">next</span><span class="keyword">();<br />}<br /></span><span class="default">?&gt;</span></span></code></div>
  </div>
 </div>
  <div class="note" id="125800">  <div class="votes">
    <div id="Vu125800">
    <a href="/manual/vote-note.php?id=125800&amp;page=class.globiterator&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125800">
    <a href="/manual/vote-note.php?id=125800&amp;page=class.globiterator&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125800" title="66% like this...">
    1
    </div>
  </div>
  <a href="#125800" class="name">
  <strong class="user"><em>info at ensostudio dot ru</em></strong></a><a class="genanchor" href="#125800"> &para;</a><div class="date" title="2021-02-09 08:48"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125800">
<div class="phpcode"><code><span class="html">NOTE: "similar fashion to glob()" GlobIterator use  stream wrapper "glob://" = use glob()</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=class.globiterator&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.globiterator.php">＋<small>add a note</small></a></div>
