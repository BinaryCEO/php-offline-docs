...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/book.sync.php">
 <link rel="shorturl" href="https://www.php.net/sync">
 <link rel="alternate" href="https://www.php.net/sync" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/refs.fileprocess.process.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.shmop.php">
 <link rel="next" href="https://www.php.net/manual/en/intro.sync.php">

 <link rel="alternate" href="https://www.php.net/manual/en/book.sync.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/book.sync.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/book.sync.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/book.sync.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/book.sync.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/book.sync.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/book.sync.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/book.sync.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/book.sync.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/book.sync.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/book.sync.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Sync - Manual" />
<meta name="twitter:description" content="Sync" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Sync - Manual" />
<meta itemprop="description" content="Sync" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Sync" />
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/book.sync.php' selected="selected">English</option>
            <option value='de/book.sync.php'>German</option>
            <option value='es/book.sync.php'>Spanish</option>
            <option value='fr/book.sync.php'>French</option>
            <option value='it/book.sync.php'>Italian</option>
            <option value='ja/book.sync.php'>Japanese</option>
            <option value='pt_BR/book.sync.php'>Brazilian Portuguese</option>
            <option value='ru/book.sync.php'>Russian</option>
            <option value='tr/book.sync.php'>Turkish</option>
            <option value='uk/book.sync.php'>Ukrainian</option>
            <option value='zh/book.sync.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="book.sync" class="book">
...
<ul class="chunklist chunklist_book"><li><a href="intro.sync.php">Introduction</a></li><li><a href="sync.setup.php">Installing/Configuring</a><ul class="chunklist chunklist_book chunklist_children"><li><a href="sync.requirements.php">Requirements</a></li><li><a href="sync.installation.php">Installation</a></li></ul></li><li><a href="class.syncmutex.php">SyncMutex</a> — The SyncMutex class<ul class="chunklist chunklist_book chunklist_children"><li><a href="syncmutex.construct.php">SyncMutex::__construct</a> — Constructs a new SyncMutex object</li><li><a href="syncmutex.lock.php">SyncMutex::lock</a> — Waits for an exclusive lock</li><li><a href="syncmutex.unlock.php">SyncMutex::unlock</a> — Unlocks the mutex</li></ul></li><li><a href="class.syncsemaphore.php">SyncSemaphore</a> — The SyncSemaphore class<ul class="chunklist chunklist_book chunklist_children"><li><a href="syncsemaphore.construct.php">SyncSemaphore::__construct</a> — Constructs a new SyncSemaphore object</li><li><a href="syncsemaphore.lock.php">SyncSemaphore::lock</a> — Decreases the count of the semaphore or waits</li><li><a href="syncsemaphore.unlock.php">SyncSemaphore::unlock</a> — Increases the count of the semaphore</li></ul></li><li><a href="class.syncevent.php">SyncEvent</a> — The SyncEvent class<ul class="chunklist chunklist_book chunklist_children"><li><a href="syncevent.construct.php">SyncEvent::__construct</a> — Constructs a new SyncEvent object</li><li><a href="syncevent.fire.php">SyncEvent::fire</a> — Fires/sets the event</li><li><a href="syncevent.reset.php">SyncEvent::reset</a> — Resets a manual event</li><li><a href="syncevent.wait.php">SyncEvent::wait</a> — Waits for the event to be fired/set</li></ul></li><li><a href="class.syncreaderwriter.php">SyncReaderWriter</a> — The SyncReaderWriter class<ul class="chunklist chunklist_book chunklist_children"><li><a href="syncreaderwriter.construct.php">SyncReaderWriter::__construct</a> — Constructs a new SyncReaderWriter object</li><li><a href="syncreaderwriter.readlock.php">SyncReaderWriter::readlock</a> — Waits for a read lock</li><li><a href="syncreaderwriter.readunlock.php">SyncReaderWriter::readunlock</a> — Releases a read lock</li><li><a href="syncreaderwriter.writelock.php">SyncReaderWriter::writelock</a> — Waits for an exclusive write lock</li><li><a href="syncreaderwriter.writeunlock.php">SyncReaderWriter::writeunlock</a> — Releases a write lock</li></ul></li><li><a href="class.syncsharedmemory.php">SyncSharedMemory</a> — The SyncSharedMemory class<ul class="chunklist chunklist_book chunklist_children"><li><a href="syncsharedmemory.construct.php">SyncSharedMemory::__construct</a> — Constructs a new SyncSharedMemory object</li><li><a href="syncsharedmemory.first.php">SyncSharedMemory::first</a> — Check to see if the object is the first instance system-wide of named shared memory</li><li><a href="syncsharedmemory.read.php">SyncSharedMemory::read</a> — Copy data from named shared memory</li><li><a href="syncsharedmemory.size.php">SyncSharedMemory::size</a> — Returns the size of the named shared memory</li><li><a href="syncsharedmemory.write.php">SyncSharedMemory::write</a> — Copy data to named shared memory</li></ul></li></ul></div>    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sync/book.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fbook.sync%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=book.sync&amp;repo=en&amp;redirect=https://www.php.net/manual/en/book.sync.php">＋<small>add a note</small></a></span>
