...
<head>
  ...
  <title>PHP: Gmagick::getimagesignature - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagesignature.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagesignature.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagesignature.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagescene.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagetype.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagesignature.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagesignature.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagesignature.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagesignature.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagesignature.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagesignature.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagesignature.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagesignature.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagesignature.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagesignature.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagesignature.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimagesignature - Manual" />
<meta name="twitter:description" content="Generates an SHA-256 message digest" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagesignature - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagetype.php">
          Gmagick::getimagetype &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagescene.php">
          &laquo; Gmagick::getimagescene        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagesignature.php' selected="selected">English</option>
            <option value='de/gmagick.getimagesignature.php'>German</option>
            <option value='es/gmagick.getimagesignature.php'>Spanish</option>
            <option value='fr/gmagick.getimagesignature.php'>French</option>
            <option value='it/gmagick.getimagesignature.php'>Italian</option>
            <option value='ja/gmagick.getimagesignature.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagesignature.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagesignature.php'>Russian</option>
            <option value='tr/gmagick.getimagesignature.php'>Turkish</option>
            <option value='uk/gmagick.getimagesignature.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagesignature.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagesignature" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagesignature</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagesignature</span> &mdash; <span class="dc-title">Generates an SHA-256 message digest</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagesignature-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagesignature</strong></span>(): <span class="type"><a href="language.types.string.php" class="type string">string</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagesignature-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagesignature-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagesignature-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagesignature.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagesignature%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagesignature&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagesignature.php">＋<small>add a note</small></a></span>
