...
<head>
  ...
  <title>PHP: openssl_spki_export - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.openssl-spki-export.php">
 <link rel="shorturl" href="https://www.php.net/openssl-spki-export">
 <link rel="alternate" href="https://www.php.net/openssl-spki-export" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.openssl.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.openssl-sign.php">
 <link rel="next" href="https://www.php.net/manual/en/function.openssl-spki-export-challenge.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.openssl-spki-export.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.openssl-spki-export.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.openssl-spki-export.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.openssl-spki-export.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.openssl-spki-export.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.openssl-spki-export.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.openssl-spki-export.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.openssl-spki-export.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.openssl-spki-export.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.openssl-spki-export.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.openssl-spki-export.php" hreflang="zh">
...
<meta name="Description" content="Exports a valid PEM formatted public key signed public key and challenge" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: openssl_spki_export - Manual" />
<meta name="twitter:description" content="Exports a valid PEM formatted public key signed public key and challenge" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: openssl_spki_export - Manual" />
<meta itemprop="description" content="Exports a valid PEM formatted public key signed public key and challenge" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Exports a valid PEM formatted public key signed public key and challenge" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.openssl-spki-export-challenge.php">
          openssl_spki_export_challenge &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.openssl-sign.php">
          &laquo; openssl_sign        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.openssl-spki-export.php' selected="selected">English</option>
            <option value='de/function.openssl-spki-export.php'>German</option>
            <option value='es/function.openssl-spki-export.php'>Spanish</option>
            <option value='fr/function.openssl-spki-export.php'>French</option>
            <option value='it/function.openssl-spki-export.php'>Italian</option>
            <option value='ja/function.openssl-spki-export.php'>Japanese</option>
            <option value='pt_BR/function.openssl-spki-export.php'>Brazilian Portuguese</option>
            <option value='ru/function.openssl-spki-export.php'>Russian</option>
            <option value='tr/function.openssl-spki-export.php'>Turkish</option>
            <option value='uk/function.openssl-spki-export.php'>Ukrainian</option>
            <option value='zh/function.openssl-spki-export.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.openssl-spki-export" class="refentry">
 ...
 <div class="refsect1 examples" id="refsect1-function.openssl-spki-export-examples">
  ...
  <div class="example" id="openssl_spki_export.example.basic">
   <p><strong>Example #1 <span class="function"><strong>openssl_spki_export()</strong></span> example</strong></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.openssl-csr-sign.php" class="function" rel="rdfs-seeAlso">openssl_csr_sign()</a> - Sign a CSR with another certificate (or itself) and generate a certificate</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/openssl/functions/openssl-spki-export.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.openssl-spki-export%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.openssl-spki-export&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.openssl-spki-export.php">＋<small>add a note</small></a></span>
