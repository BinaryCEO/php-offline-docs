...
<head>
  ...
  <title>PHP: db2_column_privileges - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.db2-column-privileges.php">
 <link rel="shorturl" href="https://www.php.net/db2-column-privileges">
 <link rel="alternate" href="https://www.php.net/db2-column-privileges" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibm-db2.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.db2-close.php">
 <link rel="next" href="https://www.php.net/manual/en/function.db2-columns.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.db2-column-privileges.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.db2-column-privileges.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.db2-column-privileges.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.db2-column-privileges.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.db2-column-privileges.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.db2-column-privileges.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.db2-column-privileges.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.db2-column-privileges.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.db2-column-privileges.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.db2-column-privileges.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.db2-column-privileges.php" hreflang="zh">
...
<meta name="Description" content="Returns a result set listing the columns and associated privileges for a table" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: db2_column_privileges - Manual" />
<meta name="twitter:description" content="Returns a result set listing the columns and associated privileges for a table" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: db2_column_privileges - Manual" />
<meta itemprop="description" content="Returns a result set listing the columns and associated privileges for a table" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a result set listing the columns and associated privileges for a table" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.db2-columns.php">
          db2_columns &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.db2-close.php">
          &laquo; db2_close        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.db2-column-privileges.php' selected="selected">English</option>
            <option value='de/function.db2-column-privileges.php'>German</option>
            <option value='es/function.db2-column-privileges.php'>Spanish</option>
            <option value='fr/function.db2-column-privileges.php'>French</option>
            <option value='it/function.db2-column-privileges.php'>Italian</option>
            <option value='ja/function.db2-column-privileges.php'>Japanese</option>
            <option value='pt_BR/function.db2-column-privileges.php'>Brazilian Portuguese</option>
            <option value='ru/function.db2-column-privileges.php'>Russian</option>
            <option value='tr/function.db2-column-privileges.php'>Turkish</option>
            <option value='uk/function.db2-column-privileges.php'>Ukrainian</option>
            <option value='zh/function.db2-column-privileges.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.db2-column-privileges" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">db2_column_privileges</h1>
  <p class="verinfo">(PECL ibm_db2 &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">db2_column_privileges</span> &mdash; <span class="dc-title">
   Returns a result set listing the columns and associated privileges for a table
  </span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.db2-column-privileges-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>db2_column_privileges</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span> <code class="parameter">$connection</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$qualifier</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$schema</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$table_name</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><span class="type"><a href="language.types.null.php" class="type null">?</a></span><span class="type"><a href="language.types.string.php" class="type string">string</a></span></span> <code class="parameter">$column_name</code><span class="initializer"> = <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong></span></span><br>): <span class="type"><a href="language.types.resource.php" class="type resource">resource</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.db2-column-privileges-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       The schema which contains the tables. To match all schemas, pass <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong>
       or an empty string.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.db2-column-privileges-returnvalues">
 ...
 <div class="refsect1 seealso" id="refsect1-function.db2-column-privileges-seealso">
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.db2-tables.php" class="function" rel="rdfs-seeAlso">db2_tables()</a> - Returns a result set listing the tables and associated metadata in a database</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibm_db2/functions/db2-column-privileges.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.db2-column-privileges%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.db2-column-privileges&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.db2-column-privileges.php">＋<small>add a note</small></a></span>
