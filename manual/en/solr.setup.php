...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solr.setup.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solr.setup.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solr.setup.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.solr.php">
 <link rel="prev" href="https://www.php.net/manual/en/intro.solr.php">
 <link rel="next" href="https://www.php.net/manual/en/solr.requirements.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solr.setup.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solr.setup.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solr.setup.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solr.setup.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solr.setup.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solr.setup.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solr.setup.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solr.setup.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solr.setup.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solr.setup.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solr.setup.php" hreflang="zh">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solr.setup.php' selected="selected">English</option>
            <option value='de/solr.setup.php'>German</option>
            <option value='es/solr.setup.php'>Spanish</option>
            <option value='fr/solr.setup.php'>French</option>
            <option value='it/solr.setup.php'>Italian</option>
            <option value='ja/solr.setup.php'>Japanese</option>
            <option value='pt_BR/solr.setup.php'>Brazilian Portuguese</option>
            <option value='ru/solr.setup.php'>Russian</option>
            <option value='tr/solr.setup.php'>Turkish</option>
            <option value='uk/solr.setup.php'>Ukrainian</option>
            <option value='zh/solr.setup.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solr.setup" class="chapter">
 <h1 class="title">Installing/Configuring</h1>
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="solr.requirements.php">Requirements</a></li><li><a href="solr.installation.php">Installation</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolr.setup%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solr.setup&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solr.setup.php">＋<small>add a note</small></a></span>
