...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.getoption.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.getoption.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.getoption.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.getnumberimages.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.getpackagename.php">
...
<meta name="Description" content="Returns a value associated with the specified key" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::getOption - Manual" />
<meta name="twitter:description" content="Returns a value associated with the specified key" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::getOption - Manual" />
<meta itemprop="description" content="Returns a value associated with the specified key" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Returns a value associated with the specified key" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.getoption.php' selected="selected">English</option>
            ...
            <option value='ru/imagick.getoption.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::getOption</span> &mdash; <span class="dc-title">Returns a value associated with the specified key</span></p>
  ...
  <p class="para">
   Throws ImagickException on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/getoption.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.getoption%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.getoption&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.getoption.php">＋<small>add a note</small></a></span>
