...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mongodb-bson-document.fromphp.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mongodb-bson-document.fromphp.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mongodb-bson-document.fromphp.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mongodb-bson-document.php">
 <link rel="prev" href="https://www.php.net/manual/en/mongodb-bson-document.fromjson.php">
 <link rel="next" href="https://www.php.net/manual/en/mongodb-bson-document.get.php">
...
<meta name="Description" content="Construct a new document instance from PHP data" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: MongoDB\BSON\Document::fromPHP - Manual" />
<meta name="twitter:description" content="Construct a new document instance from PHP data" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: MongoDB\BSON\Document::fromPHP - Manual" />
<meta itemprop="description" content="Construct a new document instance from PHP data" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Construct a new document instance from PHP data" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mongodb-bson-document.fromphp.php' selected="selected">English</option>
            ...
            <option value='ru/mongodb-bson-document.fromphp.php'>Russian</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(mongodb &gt;=1.16.0)</p><p class="refpurpose"><span class="refname">MongoDB\BSON\Document::fromPHP</span> &mdash; <span class="dc-title">Construct a new document instance from PHP data</span></p>
  ...
  <ul class="simplelist">
   ...
   <li><a href="https://www.mongodb.com/docs/manual/reference/bson-types/" class="link external">&raquo;&nbsp;BSON Types</a></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mongodb/bson/document/fromphp.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmongodb-bson-document.fromphp%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mongodb-bson-document.fromphp&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mongodb-bson-document.fromphp.php">＋<small>add a note</small></a></span>
