...
<head>
  ...
  <title>PHP: IntlCalendar::add - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/intlcalendar.add.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/intlcalendar.add.php">
 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.add.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.intlcalendar.php">
 <link rel="next" href="https://www.php.net/manual/en/intlcalendar.after.php">

 <link rel="alternate" href="https://www.php.net/manual/en/intlcalendar.add.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/intlcalendar.add.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/intlcalendar.add.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/intlcalendar.add.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/intlcalendar.add.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/intlcalendar.add.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/intlcalendar.add.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/intlcalendar.add.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/intlcalendar.add.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/intlcalendar.add.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/intlcalendar.add.php" hreflang="zh">
...
<meta name="Description" content="Add a (signed) amount of time to a field" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: IntlCalendar::add - Manual" />
<meta name="twitter:description" content="Add a (signed) amount of time to a field" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: IntlCalendar::add - Manual" />
<meta itemprop="description" content="Add a (signed) amount of time to a field" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Add a (signed) amount of time to a field" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="intlcalendar.after.php">
          IntlCalendar::after &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.intlcalendar.php">
          &laquo; IntlCalendar        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/intlcalendar.add.php' selected="selected">English</option>
            <option value='de/intlcalendar.add.php'>German</option>
            <option value='es/intlcalendar.add.php'>Spanish</option>
            <option value='fr/intlcalendar.add.php'>French</option>
            <option value='it/intlcalendar.add.php'>Italian</option>
            <option value='ja/intlcalendar.add.php'>Japanese</option>
            <option value='pt_BR/intlcalendar.add.php'>Brazilian Portuguese</option>
            <option value='ru/intlcalendar.add.php'>Russian</option>
            <option value='tr/intlcalendar.add.php'>Turkish</option>
            <option value='uk/intlcalendar.add.php'>Ukrainian</option>
            <option value='zh/intlcalendar.add.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="intlcalendar.add" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">IntlCalendar::add</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.5.0, PHP 7, PHP 8, PECL &gt;= 3.0.0a1)</p><p class="refpurpose"><span class="refname">IntlCalendar::add</span> &mdash; <span class="dc-title">Add a (signed) amount of time to a field</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-intlcalendar.add-description">
  <h3 class="title">Description</h3>
  <p class="para">
   Object-oriented style
  </p>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>IntlCalendar::add</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>

  <p class="para rdfs-comment">
   Procedural style
  </p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>intlcal_add</strong></span>(<span class="methodparam"><span class="type"><a href="class.intlcalendar.php" class="type IntlCalendar">IntlCalendar</a></span> <code class="parameter">$calendar</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$field</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$value</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
  ...
  <p class="para">
   ...
   <span class="function"><a href="intlcalendar.roll.php" class="function">IntlCalendar::roll()</a></span>, when a value wraps around, more
 ...
 <div class="refsect1 parameters" id="refsect1-intlcalendar.add-parameters">
...
<p class="para">
 ...
 <strong><code>IntlCalendar::FIELD_COUNT</code></strong>.
    ...
    <dd>
     <p class="para">
      ...
      hours for <strong><code><a href="class.intlcalendar.php#intlcalendar.constants.field-hour-of-day">IntlCalendar::FIELD_HOUR_OF_DAY</a></code></strong>.
     </p>
    </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-intlcalendar.add-returnvalues">
...
1 mars 2012 00:00:00</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/intl/intlcalendar/add.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fintlcalendar.add%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=intlcalendar.add&amp;repo=en&amp;redirect=https://www.php.net/manual/en/intlcalendar.add.php">＋<small>add a note</small></a></span>
