...
<head>
  ...
  <title>PHP: Imagick::readimages - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.readimages.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.readimages.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.readimages.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.readimagefile.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.recolorimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.readimages.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.readimages.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.readimages.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.readimages.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.readimages.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.readimages.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.readimages.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.readimages.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.readimages.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.readimages.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.readimages.php" hreflang="zh">
...
<meta name="Description" content="Reads image from an array of filenames" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::readimages - Manual" />
<meta name="twitter:description" content="Reads image from an array of filenames" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::readimages - Manual" />
<meta itemprop="description" content="Reads image from an array of filenames" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Reads image from an array of filenames" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="imagick.recolorimage.php">
          Imagick::recolorImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.readimagefile.php">
          &laquo; Imagick::readImageFile        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.readimages.php' selected="selected">English</option>
            <option value='de/imagick.readimages.php'>German</option>
            <option value='es/imagick.readimages.php'>Spanish</option>
            <option value='fr/imagick.readimages.php'>French</option>
            <option value='it/imagick.readimages.php'>Italian</option>
            <option value='ja/imagick.readimages.php'>Japanese</option>
            <option value='pt_BR/imagick.readimages.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.readimages.php'>Russian</option>
            <option value='tr/imagick.readimages.php'>Turkish</option>
            <option value='uk/imagick.readimages.php'>Ukrainian</option>
            <option value='zh/imagick.readimages.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.readimages" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::readimages</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::readimages</span> &mdash; <span class="dc-title">Reads image from an array of filenames</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.readimages-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::readImages</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.array.php" class="type array">array</a></span> <code class="parameter">$filenames</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.readimages-parameters">
  <h3 class="title">Parameters</h3>
  <dl>
   
    <dt><code class="parameter">filenames</code></dt>
    <dd>
     <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.readimages-returnvalues">
  ...
  <p class="para">
   Returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong> on success.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/readimages.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.readimages%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.readimages&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.readimages.php">＋<small>add a note</small></a></span>
