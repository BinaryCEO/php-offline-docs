...
<head>
  ...
  <title>PHP: stream_socket_shutdown - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-socket-shutdown.php">
 <link rel="shorturl" href="https://www.php.net/stream-socket-shutdown">
 <link rel="alternate" href="https://www.php.net/stream-socket-shutdown" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stream.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-socket-server.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-supports-lock.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stream-socket-shutdown.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stream-socket-shutdown.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stream-socket-shutdown.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stream-socket-shutdown.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stream-socket-shutdown.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stream-socket-shutdown.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stream-socket-shutdown.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stream-socket-shutdown.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stream-socket-shutdown.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stream-socket-shutdown.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stream-socket-shutdown.php" hreflang="zh">
...
<meta name="Description" content="Shutdown a full-duplex connection" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_socket_shutdown - Manual" />
<meta name="twitter:description" content="Shutdown a full-duplex connection" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_socket_shutdown - Manual" />
<meta itemprop="description" content="Shutdown a full-duplex connection" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Shutdown a full-duplex connection" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stream-supports-lock.php">
          stream_supports_lock &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stream-socket-server.php">
          &laquo; stream_socket_server        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-socket-shutdown.php' selected="selected">English</option>
            <option value='de/function.stream-socket-shutdown.php'>German</option>
            <option value='es/function.stream-socket-shutdown.php'>Spanish</option>
            <option value='fr/function.stream-socket-shutdown.php'>French</option>
            <option value='it/function.stream-socket-shutdown.php'>Italian</option>
            <option value='ja/function.stream-socket-shutdown.php'>Japanese</option>
            <option value='pt_BR/function.stream-socket-shutdown.php'>Brazilian Portuguese</option>
            <option value='ru/function.stream-socket-shutdown.php'>Russian</option>
            <option value='tr/function.stream-socket-shutdown.php'>Turkish</option>
            <option value='uk/function.stream-socket-shutdown.php'>Ukrainian</option>
            <option value='zh/function.stream-socket-shutdown.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stream-socket-shutdown" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stream_socket_shutdown</h1>
  <p class="verinfo">(PHP 5 &gt;= 5.2.1, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_socket_shutdown</span> &mdash; <span class="dc-title">Shutdown a full-duplex connection</span></p>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stream-socket-shutdown-parameters">
  ...
  <p class="para">
   <dl>
     ...
     <dd>
      <p class="para">
       An open stream (opened with <span class="function"><a href="function.stream-socket-client.php" class="function">stream_socket_client()</a></span>,
       for example)
      </p>
     </dd>
     ...
     <dd>
      <p class="para">
       One of the following constants: <strong><code><a href="stream.constants.php#constant.stream-shut-rd">STREAM_SHUT_RD</a></code></strong>
       (disable further receptions), <strong><code><a href="stream.constants.php#constant.stream-shut-wr">STREAM_SHUT_WR</a></code></strong>
       (disable further transmissions) or
       <strong><code><a href="stream.constants.php#constant.stream-shut-rdwr">STREAM_SHUT_RDWR</a></code></strong> (disable further receptions and
       transmissions).
      </p>
     </dd>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.fclose.php" class="function" rel="rdfs-seeAlso">fclose()</a> - Closes an open file pointer</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-socket-shutdown.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-socket-shutdown%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-socket-shutdown&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-shutdown.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">3 notes</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125659">  <div class="votes">
    <div id="Vu125659">
    <a href="/manual/vote-note.php?id=125659&amp;page=function.stream-socket-shutdown&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125659">
    <a href="/manual/vote-note.php?id=125659&amp;page=function.stream-socket-shutdown&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125659" title="100% like this...">
    5
    </div>
  </div>
  <a href="#125659" class="name">
  <strong class="user"><em>Daniel J</em></strong></a><a class="genanchor" href="#125659"> &para;</a><div class="date" title="2021-01-06 07:59"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom125659">
<div class="phpcode"><code><span class="html">Be wary of using stream_socket_shutdown with a TLS socket. The socket is closed without sending the "close_notify" message required by TLS protocol.<br /><br />To correctly close a TLS socket, use fclose() instead, which internally calls OpenSSL's SSL_shutdown() function.</span></code></div>
  </div>
 </div>
  <div class="note" id="126303">  <div class="votes">
    <div id="Vu126303">
    <a href="/manual/vote-note.php?id=126303&amp;page=function.stream-socket-shutdown&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd126303">
    <a href="/manual/vote-note.php?id=126303&amp;page=function.stream-socket-shutdown&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V126303" title="66% like this...">
    1
    </div>
  </div>
  <a href="#126303" class="name">
  <strong class="user"><em>Anonymous</em></strong></a><a class="genanchor" href="#126303"> &para;</a><div class="date" title="2021-08-02 01:22"><strong>4 years ago</strong></div>
  <div class="text" id="Hcom126303">
<div class="phpcode"><code><span class="html">As Daniel J has pointed out, stream_socket_shutdown doesn't send the TLS close_notify message. In some instances, it's a preferred function over fclose (to trigger stream_select, for example).<br /><br />To use this function correctly with TLS, use stream_socket_enable_crypto($fp, false); before shutting down the socket.</span></code></div>
  </div>
 </div>
  <div class="note" id="109982">  <div class="votes">
    <div id="Vu109982">
    <a href="/manual/vote-note.php?id=109982&amp;page=function.stream-socket-shutdown&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd109982">
    <a href="/manual/vote-note.php?id=109982&amp;page=function.stream-socket-shutdown&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V109982" title="50% like this...">
    0
    </div>
  </div>
  <a href="#109982" class="name">
  <strong class="user"><em>jgotti</em></strong></a><a class="genanchor" href="#109982"> &para;</a><div class="date" title="2012-09-07 06:22"><strong>13 years ago</strong></div>
  <div class="text" id="Hcom109982">
<div class="phpcode"><code><span class="html">Just a note to say that if you encounter problem closing some sockets using fclose in a multi client server, you should really  give this one a try.<br /><br />Spent a full day trying to resolve this issue using stream_socket_shutdown($clientStream,STREAM_SHUT_RDWR);<br />finally do the trick.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-socket-shutdown&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-socket-shutdown.php">＋<small>add a note</small></a></div>
