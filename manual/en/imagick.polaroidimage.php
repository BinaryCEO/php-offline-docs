...
<head>
  ...
  <title>PHP: Imagick::polaroidImage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/imagick.polaroidimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/imagick.polaroidimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/imagick.polaroidimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.imagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/imagick.pingimagefile.php">
 <link rel="next" href="https://www.php.net/manual/en/imagick.posterizeimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/imagick.polaroidimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/imagick.polaroidimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/imagick.polaroidimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/imagick.polaroidimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/imagick.polaroidimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/imagick.polaroidimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/imagick.polaroidimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/imagick.polaroidimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/imagick.polaroidimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/imagick.polaroidimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/imagick.polaroidimage.php" hreflang="zh">
...
<meta name="Description" content="Simulates a Polaroid picture" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Imagick::polaroidImage - Manual" />
<meta name="twitter:description" content="Simulates a Polaroid picture" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Imagick::polaroidImage - Manual" />
<meta itemprop="description" content="Simulates a Polaroid picture" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Simulates a Polaroid picture" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="imagick.posterizeimage.php">
          Imagick::posterizeImage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="imagick.pingimagefile.php">
          &laquo; Imagick::pingImageFile        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/imagick.polaroidimage.php' selected="selected">English</option>
            <option value='de/imagick.polaroidimage.php'>German</option>
            <option value='es/imagick.polaroidimage.php'>Spanish</option>
            <option value='fr/imagick.polaroidimage.php'>French</option>
            <option value='it/imagick.polaroidimage.php'>Italian</option>
            <option value='ja/imagick.polaroidimage.php'>Japanese</option>
            <option value='pt_BR/imagick.polaroidimage.php'>Brazilian Portuguese</option>
            <option value='ru/imagick.polaroidimage.php'>Russian</option>
            <option value='tr/imagick.polaroidimage.php'>Turkish</option>
            <option value='uk/imagick.polaroidimage.php'>Ukrainian</option>
            <option value='zh/imagick.polaroidimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="imagick.polaroidimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Imagick::polaroidImage</h1>
  <p class="verinfo">(PECL imagick 2, PECL imagick 3)</p><p class="refpurpose"><span class="refname">Imagick::polaroidImage</span> &mdash; <span class="dc-title">Simulates a Polaroid picture</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-imagick.polaroidimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Imagick::polaroidImage</strong></span>(<span class="methodparam"><span class="type"><a href="class.imagickdraw.php" class="type ImagickDraw">ImagickDraw</a></span> <code class="parameter">$properties</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$angle</code></span>): <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-imagick.polaroidimage-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-imagick.polaroidimage-returnvalues">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/* Create the object */<br /></span><span style="color: #0000BB">$image </span><span style="color: #007700">= new </span><span style="color: #0000BB">Imagick</span><span style="color: #007700">(</span><span style="color: #DD0000">'source.png'</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* Set the opacity */<br /></span><span style="color: #0000BB">$image</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">polaroidImage</span><span style="color: #007700">(new </span><span style="color: #0000BB">ImagickDraw</span><span style="color: #007700">(), </span><span style="color: #0000BB">25</span><span style="color: #007700">);<br /><br /></span><span style="color: #FF8000">/* output the image */<br /></span><span style="color: #0000BB">header</span><span style="color: #007700">(</span><span style="color: #DD0000">'Content-type: image/png'</span><span style="color: #007700">);<br />echo </span><span style="color: #0000BB">$image</span><span style="color: #007700">;<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/imagick/imagick/polaroidimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fimagick.polaroidimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=imagick.polaroidimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/imagick.polaroidimage.php">＋<small>add a note</small></a></span>
