...
<head>
  ...
  <title>PHP: pg_set_client_encoding - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.pg-set-client-encoding.php">
 <link rel="shorturl" href="https://www.php.net/pg-set-client-encoding">
 <link rel="alternate" href="https://www.php.net/pg-set-client-encoding" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.pgsql.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.pg-set-chunked-rows-size.php">
 <link rel="next" href="https://www.php.net/manual/en/function.pg-set-error-context-visibility.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.pg-set-client-encoding.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.pg-set-client-encoding.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.pg-set-client-encoding.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.pg-set-client-encoding.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.pg-set-client-encoding.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.pg-set-client-encoding.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.pg-set-client-encoding.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.pg-set-client-encoding.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.pg-set-client-encoding.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.pg-set-client-encoding.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.pg-set-client-encoding.php" hreflang="zh">
...
<meta name="Description" content="Set the client encoding" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: pg_set_client_encoding - Manual" />
<meta name="twitter:description" content="Set the client encoding" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: pg_set_client_encoding - Manual" />
<meta itemprop="description" content="Set the client encoding" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Set the client encoding" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.pg-set-error-context-visibility.php">
          pg_set_error_context_visibility &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.pg-set-chunked-rows-size.php">
          &laquo; pg_set_chunked_rows_size        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.pg-set-client-encoding.php' selected="selected">English</option>
            <option value='de/function.pg-set-client-encoding.php'>German</option>
            <option value='es/function.pg-set-client-encoding.php'>Spanish</option>
            <option value='fr/function.pg-set-client-encoding.php'>French</option>
            <option value='it/function.pg-set-client-encoding.php'>Italian</option>
            <option value='ja/function.pg-set-client-encoding.php'>Japanese</option>
            <option value='pt_BR/function.pg-set-client-encoding.php'>Brazilian Portuguese</option>
            <option value='ru/function.pg-set-client-encoding.php'>Russian</option>
            <option value='tr/function.pg-set-client-encoding.php'>Turkish</option>
            <option value='uk/function.pg-set-client-encoding.php'>Ukrainian</option>
            <option value='zh/function.pg-set-client-encoding.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.pg-set-client-encoding" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">pg_set_client_encoding</h1>
  <p class="verinfo">(PHP 4 &gt;= 4.0.3, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">pg_set_client_encoding</span> &mdash; <span class="dc-title">
   Set the client encoding
  </span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.pg-set-client-encoding-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>pg_set_client_encoding</strong></span>(<span class="methodparam"><span class="type"><a href="class.pgsql-connection.php" class="type PgSql\Connection">PgSql\Connection</a></span> <code class="parameter">$connection</code><span class="initializer"> = ?</span></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$encoding</code></span>): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>

  <p class="para rdfs-comment">
   <span class="function"><strong>pg_set_client_encoding()</strong></span> sets the client
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    <span class="function"><strong>pg_setclientencoding()</strong></span>.
   </p>
  </p></blockquote>
 </div>


 <div class="refsect1 parameters" id="refsect1-function.pg-set-client-encoding-parameters">
...
<div class="warning"><strong class="warning">Warning</strong><p class="simpara">As of PHP 8.1.0, using the default connection is deprecated.</p></div></p>
     ...
     <dd>
      <p class="para">
       The required client encoding.  One of <code class="literal">SQL_ASCII</code>, <code class="literal">EUC_JP</code>, 
       <code class="literal">EUC_CN</code>, <code class="literal">EUC_KR</code>, <code class="literal">EUC_TW</code>, 
       <code class="literal">UNICODE</code>, <code class="literal">MULE_INTERNAL</code>, <code class="literal">LATINX</code> (X=1...9), 
       <code class="literal">KOI8</code>, <code class="literal">WIN</code>, <code class="literal">ALT</code>, <code class="literal">SJIS</code>, 
       <code class="literal">BIG5</code> or <code class="literal">WIN1250</code>.
      </p>
      <p class="para">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.pg-set-client-encoding-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns <code class="literal">0</code> on success or <code class="literal">-1</code> on error.
  </p>
 </div>


 <div class="refsect1 changelog" id="refsect1-function.pg-set-client-encoding-changelog">
 ...
 <div class="refsect1 examples" id="refsect1-function.pg-set-client-encoding-examples">
  <h3 class="title">Examples</h3>
  <p class="para">
   <div class="example" id="example-2117">
    <p><strong>Example #1 <span class="function"><strong>pg_set_client_encoding()</strong></span> example</strong></p>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$conn </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_pconnect</span><span style="color: #007700">(</span><span style="color: #DD0000">"dbname=publisher"</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$conn</span><span style="color: #007700">) {<br />  echo </span><span style="color: #DD0000">"An error occurred.\n"</span><span style="color: #007700">;<br />  exit;<br />}<br /><br /></span><span style="color: #FF8000">// Set the client encoding to UNICODE.  Data will be automatically<br />// converted from the backend encoding to the frontend.<br /></span><span style="color: #0000BB">pg_set_client_encoding</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"UNICODE"</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">$result </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_query</span><span style="color: #007700">(</span><span style="color: #0000BB">$conn</span><span style="color: #007700">, </span><span style="color: #DD0000">"SELECT author, email FROM authors"</span><span style="color: #007700">);<br />if (!</span><span style="color: #0000BB">$result</span><span style="color: #007700">) {<br />  echo </span><span style="color: #DD0000">"An error occurred.\n"</span><span style="color: #007700">;<br />  exit;<br />}<br /><br /></span><span style="color: #FF8000">// Write out UTF-8 data<br /></span><span style="color: #007700">while (</span><span style="color: #0000BB">$row </span><span style="color: #007700">= </span><span style="color: #0000BB">pg_fetch_row</span><span style="color: #007700">(</span><span style="color: #0000BB">$result</span><span style="color: #007700">)) {<br />  echo </span><span style="color: #DD0000">"Author: </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">0</span><span style="color: #007700">]</span><span style="color: #DD0000">  E-mail: </span><span style="color: #0000BB">$row</span><span style="color: #007700">[</span><span style="color: #0000BB">1</span><span style="color: #007700">]</span><span style="color: #DD0000">"</span><span style="color: #007700">;<br />  echo </span><span style="color: #DD0000">"&lt;br /&gt;\n"</span><span style="color: #007700">;<br />}<br /> <br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
 ...
 <div class="refsect1 seealso" id="refsect1-function.pg-set-client-encoding-seealso">
  <h3 class="title">See Also</h3>
  <p class="para">
   <ul class="simplelist">
    <li><span class="function"><a href="function.pg-client-encoding.php" class="function" rel="rdfs-seeAlso">pg_client_encoding()</a> - Gets the client encoding</span></li>
   </ul>
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/pgsql/functions/pg-set-client-encoding.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.pg-set-client-encoding%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.pg-set-client-encoding&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.pg-set-client-encoding.php">＋<small>add a note</small></a></span>
