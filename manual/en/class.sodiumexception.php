...
<head>
  ...
  <title>PHP: SodiumException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.sodiumexception.php">
 <link rel="shorturl" href="https://www.php.net/sodiumexception">
 <link rel="alternate" href="https://www.php.net/sodiumexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-unpad.php">
 <link rel="next" href="https://www.php.net/manual/en/book.xpass.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.sodiumexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.sodiumexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.sodiumexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.sodiumexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.sodiumexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.sodiumexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.sodiumexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.sodiumexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.sodiumexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.sodiumexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.sodiumexception.php" hreflang="zh">
...
<meta name="Description" content="The SodiumException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SodiumException - Manual" />
<meta name="twitter:description" content="The SodiumException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SodiumException - Manual" />
<meta itemprop="description" content="The SodiumException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The SodiumException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="book.xpass.php">
          Xpass &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-unpad.php">
          &laquo; sodium_unpad        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.sodiumexception.php' selected="selected">English</option>
            <option value='de/class.sodiumexception.php'>German</option>
            <option value='es/class.sodiumexception.php'>Spanish</option>
            <option value='fr/class.sodiumexception.php'>French</option>
            <option value='it/class.sodiumexception.php'>Italian</option>
            <option value='ja/class.sodiumexception.php'>Japanese</option>
            <option value='pt_BR/class.sodiumexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.sodiumexception.php'>Russian</option>
            <option value='tr/class.sodiumexception.php'>Turkish</option>
            <option value='uk/class.sodiumexception.php'>Ukrainian</option>
            <option value='zh/class.sodiumexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.sodiumexception" class="reference">

 <h1 class="title">The SodiumException class</h1>
 

 <div class="partintro"><p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p>


  <div class="section" id="sodiumexception.intro">
  ...
  <div class="section" id="sodiumexception.synopsis">
   <h2 class="title">Class synopsis</h2>


   <div class="classsynopsis"><div class="classsynopsisinfo">
    
     <span class="modifier">class</span> <strong class="classname"><strong class="exceptionname">SodiumException</strong></strong>
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/sodiumexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.sodiumexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.sodiumexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.sodiumexception.php">＋<small>add a note</small></a></span>
