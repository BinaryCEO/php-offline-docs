...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/memcache.examples-overview.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/memcache.examples-overview.php">
 <link rel="alternate" href="https://www.php.net/manual/en/memcache.examples-overview.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/memcache.examples.php">
 <link rel="prev" href="https://www.php.net/manual/en/memcache.examples.php">
 <link rel="next" href="https://www.php.net/manual/en/class.memcache.php">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="memcache.examples.php">
          ...
          <ul>
            <li><a href='index.php'>PHP Manual</a></li>      <li><a href='funcref.php'>Function Reference</a></li>      <li><a href='refs.remote.other.php'>Other Services</a></li>      <li><a href='book.memcache.php'>Memcache</a></li>      <li><a href='memcache.examples.php'>Examples</a></li>      </ul>
    </div>
  </div>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/memcache.examples-overview.php' selected="selected">English</option>
            ...
            <option value='ja/memcache.examples-overview.php'>Japanese</option>
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /><br />$session_save_path </span><span style="color: #007700">= </span><span style="color: #DD0000">"tcp://</span><span style="color: #0000BB">$host</span><span style="color: #DD0000">:</span><span style="color: #0000BB">$port</span><span style="color: #DD0000">?persistent=1&amp;weight=2&amp;timeout=2&amp;retry_interval=10,  ,tcp://</span><span style="color: #0000BB">$host</span><span style="color: #DD0000">:</span><span style="color: #0000BB">$port</span><span style="color: #DD0000">  "</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">ini_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'session.save_handler'</span><span style="color: #007700">, </span><span style="color: #DD0000">'memcache'</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">ini_set</span><span style="color: #007700">(</span><span style="color: #DD0000">'session.save_path'</span><span style="color: #007700">, </span><span style="color: #0000BB">$session_save_path</span><span style="color: #007700">);<br /><br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmemcache.examples-overview%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=memcache.examples-overview&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcache.examples-overview.php">＋<small>add a note</small></a></span>
...
<div class="phpcode"><code><span class="html">moderator please merge these posts<br /><br />an errata to my comment done on 2020-07-28 01:05 about tmpfs session dir...<br /><br />the tmpfs directory i used to install session files is "/run" not "/tmp"...  as /tmp is auto (or manual) deleted sometimes</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=memcache.examples-overview&amp;repo=en&amp;redirect=https://www.php.net/manual/en/memcache.examples-overview.php">＋<small>add a note</small></a></div>
</section>    </section><!-- layout-content -->
        <aside class='layout-menu'>

        <ul class='parent-menu-list'>
                                    <li>
                <a href="memcache.examples.php">Examples</a>

                                    <ul class='child-menu-list'>

                                                <li class="current">
                            <a href="memcache.examples-overview.php" title="Basic usage">Basic usage</a>
                        </li>
