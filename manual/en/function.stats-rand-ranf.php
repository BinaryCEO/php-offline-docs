...
<head>
  ...
  <title>PHP: stats_rand_ranf - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-ranf.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-ranf">
 <link rel="alternate" href="https://www.php.net/stats-rand-ranf" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-phrase-to-seeds.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-setall.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-ranf.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-ranf.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-ranf.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-ranf.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-ranf.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-ranf.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-ranf.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-ranf.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-ranf.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-ranf.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-ranf.php" hreflang="zh">
...
<meta name="Description" content="Generates a random floating point number between 0 and 1" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_ranf - Manual" />
<meta name="twitter:description" content="Generates a random floating point number between 0 and 1" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_ranf - Manual" />
<meta itemprop="description" content="Generates a random floating point number between 0 and 1" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates a random floating point number between 0 and 1" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-rand-setall.php">
          stats_rand_setall &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-phrase-to-seeds.php">
          &laquo; stats_rand_phrase_to_seeds        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-ranf.php' selected="selected">English</option>
            <option value='de/function.stats-rand-ranf.php'>German</option>
            <option value='es/function.stats-rand-ranf.php'>Spanish</option>
            <option value='fr/function.stats-rand-ranf.php'>French</option>
            <option value='it/function.stats-rand-ranf.php'>Italian</option>
            <option value='ja/function.stats-rand-ranf.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-ranf.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-ranf.php'>Russian</option>
            <option value='tr/function.stats-rand-ranf.php'>Turkish</option>
            <option value='uk/function.stats-rand-ranf.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-ranf.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-ranf" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_rand_ranf</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_rand_ranf</span> &mdash; <span class="dc-title">Generates a random floating point number between 0 and 1</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-rand-ranf-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_rand_ranf</strong></span>(): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-rand-ranf-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-function.stats-rand-ranf-returnvalues">
  ...
  <p class="para">
   A random floating point number
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-ranf.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-ranf%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-ranf&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-ranf.php">＋<small>add a note</small></a></span>
