...
<head>
  ...
  <title>PHP: ReflectionProperty::getType - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/reflectionproperty.gettype.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/reflectionproperty.gettype.php">
 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.gettype.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.reflectionproperty.php">
 <link rel="prev" href="https://www.php.net/manual/en/reflectionproperty.getsettabletype.php">
 <link rel="next" href="https://www.php.net/manual/en/reflectionproperty.getvalue.php">

 <link rel="alternate" href="https://www.php.net/manual/en/reflectionproperty.gettype.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/reflectionproperty.gettype.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/reflectionproperty.gettype.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/reflectionproperty.gettype.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/reflectionproperty.gettype.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/reflectionproperty.gettype.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/reflectionproperty.gettype.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/reflectionproperty.gettype.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/reflectionproperty.gettype.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/reflectionproperty.gettype.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/reflectionproperty.gettype.php" hreflang="zh">
...
<meta name="Description" content="Gets a property's type" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ReflectionProperty::getType - Manual" />
<meta name="twitter:description" content="Gets a property's type" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ReflectionProperty::getType - Manual" />
<meta itemprop="description" content="Gets a property's type" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets a property's type" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="reflectionproperty.getvalue.php">
          ReflectionProperty::getValue &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="reflectionproperty.getsettabletype.php">
          &laquo; ReflectionProperty::getSettableType        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/reflectionproperty.gettype.php' selected="selected">English</option>
            <option value='de/reflectionproperty.gettype.php'>German</option>
            <option value='es/reflectionproperty.gettype.php'>Spanish</option>
            <option value='fr/reflectionproperty.gettype.php'>French</option>
            <option value='it/reflectionproperty.gettype.php'>Italian</option>
            <option value='ja/reflectionproperty.gettype.php'>Japanese</option>
            <option value='pt_BR/reflectionproperty.gettype.php'>Brazilian Portuguese</option>
            <option value='ru/reflectionproperty.gettype.php'>Russian</option>
            <option value='tr/reflectionproperty.gettype.php'>Turkish</option>
            <option value='uk/reflectionproperty.gettype.php'>Ukrainian</option>
            <option value='zh/reflectionproperty.gettype.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="reflectionproperty.gettype" class="refentry">
  ...
  <ul class="simplelist">
   ...
   <li><span class="methodname"><a href="reflectionproperty.isinitialized.php" class="methodname" rel="rdfs-seeAlso">ReflectionProperty::isInitialized()</a> - Checks whether a property is initialized</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/reflection/reflectionproperty/gettype.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Freflectionproperty.gettype%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=reflectionproperty.gettype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.gettype.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="125075">  <div class="votes">
    <div id="Vu125075">
    <a href="/manual/vote-note.php?id=125075&amp;page=reflectionproperty.gettype&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd125075">
    <a href="/manual/vote-note.php?id=125075&amp;page=reflectionproperty.gettype&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V125075" title="80% like this...">
    6
    </div>
  </div>
  <a href="#125075" class="name">
  <strong class="user"><em>email at dronov dot vg</em></strong></a><a class="genanchor" href="#125075"> &para;</a><div class="date" title="2020-06-03 02:46"><strong>5 years ago</strong></div>
  <div class="text" id="Hcom125075">
<div class="phpcode"><code><span class="html">class User<br />{<br />    /**<br />     * @var string<br />     */<br />    public $name;<br />}<br /><br />function getTypeNameFromAnnotation(string $className, string $propertyName): ?string<br />{<br />    $rp = new \ReflectionProperty($className, $propertyName);<br />    if (preg_match('/@var\s+([^\s]+)/', $rp-&gt;getDocComment(), $matches)) {<br />        return $matches[1];<br />    }<br />    <br />    return null;<br />}<br />    <br />echo getTypeNameFromAnnotation('User', 'name');<br /><br />// string</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=reflectionproperty.gettype&amp;repo=en&amp;redirect=https://www.php.net/manual/en/reflectionproperty.gettype.php">＋<small>add a note</small></a></div>
