...
<head>
  ...
  <title>PHP: SolrQuery::setEchoParams - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/solrquery.setechoparams.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/solrquery.setechoparams.php">
 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setechoparams.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.solrquery.php">
 <link rel="prev" href="https://www.php.net/manual/en/solrquery.setechohandler.php">
 <link rel="next" href="https://www.php.net/manual/en/solrquery.setexpand.php">

 <link rel="alternate" href="https://www.php.net/manual/en/solrquery.setechoparams.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/solrquery.setechoparams.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/solrquery.setechoparams.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/solrquery.setechoparams.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/solrquery.setechoparams.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/solrquery.setechoparams.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/solrquery.setechoparams.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/solrquery.setechoparams.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/solrquery.setechoparams.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/solrquery.setechoparams.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/solrquery.setechoparams.php" hreflang="zh">
...
<meta name="Description" content="Determines what kind of parameters to include in the response" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: SolrQuery::setEchoParams - Manual" />
<meta name="twitter:description" content="Determines what kind of parameters to include in the response" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: SolrQuery::setEchoParams - Manual" />
<meta itemprop="description" content="Determines what kind of parameters to include in the response" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Determines what kind of parameters to include in the response" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="solrquery.setexpand.php">
          SolrQuery::setExpand &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="solrquery.setechohandler.php">
          &laquo; SolrQuery::setEchoHandler        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/solrquery.setechoparams.php' selected="selected">English</option>
            <option value='de/solrquery.setechoparams.php'>German</option>
            <option value='es/solrquery.setechoparams.php'>Spanish</option>
            <option value='fr/solrquery.setechoparams.php'>French</option>
            <option value='it/solrquery.setechoparams.php'>Italian</option>
            <option value='ja/solrquery.setechoparams.php'>Japanese</option>
            <option value='pt_BR/solrquery.setechoparams.php'>Brazilian Portuguese</option>
            <option value='ru/solrquery.setechoparams.php'>Russian</option>
            <option value='tr/solrquery.setechoparams.php'>Turkish</option>
            <option value='uk/solrquery.setechoparams.php'>Ukrainian</option>
            <option value='zh/solrquery.setechoparams.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="solrquery.setechoparams" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">SolrQuery::setEchoParams</h1>
  <p class="verinfo">(PECL solr &gt;= 0.9.2)</p><p class="refpurpose"><span class="refname">SolrQuery::setEchoParams</span> &mdash; <span class="dc-title">Determines what kind of parameters to include in the response</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-solrquery.setechoparams-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>SolrQuery::setEchoParams</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$type</code></span>): <span class="type"><a href="class.solrquery.php" class="type SolrQuery">SolrQuery</a></span></div>
...
<p class="para">
 <div class="descriptioncode"><pre class="descriptioncode">- none - don&#039;t include any request parameters for debugging
- explicit - include the parameters explicitly specified by the client in the request
- all - include all parameters involved in this request, either specified explicitly by the client, or implicit because of the request handler configuration.</pre>
</div>
 ...
 <div class="refsect1 parameters" id="refsect1-solrquery.setechoparams-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-solrquery.setechoparams-returnvalues">
  ...
  <p class="para">
   Returns the current SolrQuery object, if the return value is used.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/solr/solrquery/setechoparams.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fsolrquery.setechoparams%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=solrquery.setechoparams&amp;repo=en&amp;redirect=https://www.php.net/manual/en/solrquery.setechoparams.php">＋<small>add a note</small></a></span>
