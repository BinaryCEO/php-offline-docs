...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.gmp-fact.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.gmp-export.php">
 <link rel="next" href="https://www.php.net/manual/en/function.gmp-gcd.php">
...
<meta name="twitter:description" content="Factorial" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: gmp_fact - Manual" />
<meta itemprop="description" content="Factorial" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Factorial" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.gmp-fact.php' selected="selected">English</option>
            ...
            <option value='pt_BR/function.gmp-fact.php'>Brazilian Portuguese</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 4 &gt;= 4.0.4, PHP 5, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">gmp_fact</span> &mdash; <span class="dc-title">Factorial</span></p>
 ...
 <div class="refsect1 description" id="refsect1-function.gmp-fact-description">
  ...
  <p class="para rdfs-comment">
   Calculates factorial (<code class="literal">num!</code>) of <code class="parameter">num</code>.
  </p>
 </div>
 ...
 <div class="refsect1 examples" id="refsect1-function.gmp-fact-examples">
  ...
  <p class="para">
   <div class="example" id="example-3323">
    <p><strong>Example #1 <span class="function"><strong>gmp_fact()</strong></span> example</strong></p>
...
30414093201713378043612608166064768844377641568960512000000000000</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmp/functions/gmp-fact.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.gmp-fact%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.gmp-fact&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.gmp-fact.php">＋<small>add a note</small></a></span>
