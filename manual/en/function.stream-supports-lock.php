...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stream-supports-lock.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.stream-socket-shutdown.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stream-wrapper-register.php">
...
<meta name="Description" content="Tells whether the stream supports locking" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stream_supports_lock - Manual" />
<meta name="twitter:description" content="Tells whether the stream supports locking" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stream_supports_lock - Manual" />
<meta itemprop="description" content="Tells whether the stream supports locking" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Tells whether the stream supports locking" />
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stream-supports-lock.php' selected="selected">English</option>
            ...
            <option value='fr/function.stream-supports-lock.php'>French</option>
 ...
 <div class="refnamediv">
  ...
  <p class="verinfo">(PHP 5 &gt;= 5.3.0, PHP 7, PHP 8)</p><p class="refpurpose"><span class="refname">stream_supports_lock</span> &mdash; <span class="dc-title">Tells whether the stream supports locking</span></p>
   ...
   <ul class="simplelist">
    <li><span class="function"><a href="function.flock.php" class="function" rel="rdfs-seeAlso">flock()</a> - Portable advisory file locking</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stream/functions/stream-supports-lock.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stream-supports-lock%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stream-supports-lock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-supports-lock.php">＋<small>add a note</small></a></span>
  ...
  <strong class="user"><em>romain dot ardiet at gmail dot com</em></strong></a><a class="genanchor" href="#115992"> &para;</a><div class="date" title="2014-10-23 08:54"><strong>10 years ago</strong></div>
  <div class="text" id="Hcom115992">
<div class="phpcode"><code><span class="html">This method returns TRUE on custom wrappers by default if you don't implement the stream_lock() method inside the wrapper : <a href="http://php.net/manual/en/streamwrapper.stream-lock.php" rel="nofollow" target="_blank">http://php.net/manual/en/streamwrapper.stream-lock.php</a></span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.stream-supports-lock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stream-supports-lock.php">＋<small>add a note</small></a></div>
