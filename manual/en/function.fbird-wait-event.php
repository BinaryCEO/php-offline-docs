...
<head>
  ...
  <title>PHP: fbird_wait_event - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.fbird-wait-event.php">
 <link rel="shorturl" href="https://www.php.net/fbird-wait-event">
 <link rel="alternate" href="https://www.php.net/fbird-wait-event" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.ibase.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.fbird-trans.php">
 <link rel="next" href="https://www.php.net/manual/en/function.ibase-add-user.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.fbird-wait-event.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.fbird-wait-event.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.fbird-wait-event.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.fbird-wait-event.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.fbird-wait-event.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.fbird-wait-event.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.fbird-wait-event.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.fbird-wait-event.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.fbird-wait-event.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.fbird-wait-event.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.fbird-wait-event.php" hreflang="zh">
...
<meta name="Description" content="Alias of ibase_wait_event" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: fbird_wait_event - Manual" />
<meta name="twitter:description" content="Alias of ibase_wait_event" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: fbird_wait_event - Manual" />
<meta itemprop="description" content="Alias of ibase_wait_event" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Alias of ibase_wait_event" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="function.ibase-add-user.php">
          ibase_add_user &raquo;
        </a>
      </div>
              <div class="prev">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.fbird-wait-event.php' selected="selected">English</option>
            <option value='de/function.fbird-wait-event.php'>German</option>
            <option value='es/function.fbird-wait-event.php'>Spanish</option>
            <option value='fr/function.fbird-wait-event.php'>French</option>
            <option value='it/function.fbird-wait-event.php'>Italian</option>
            <option value='ja/function.fbird-wait-event.php'>Japanese</option>
            <option value='pt_BR/function.fbird-wait-event.php'>Brazilian Portuguese</option>
            <option value='ru/function.fbird-wait-event.php'>Russian</option>
            <option value='tr/function.fbird-wait-event.php'>Turkish</option>
            <option value='uk/function.fbird-wait-event.php'>Ukrainian</option>
            <option value='zh/function.fbird-wait-event.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.fbird-wait-event" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">fbird_wait_event</h1>
  <p class="verinfo">(PHP 5, PHP 7 &lt; 7.4.0)</p><p class="refpurpose"><span class="refname">fbird_wait_event</span> &mdash; <span class="dc-title">Alias of <span class="function"><a href="function.ibase-wait-event.php" class="function">ibase_wait_event()</a></span></span></p>
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="function.fbird-free-event-handler.php" class="function" rel="rdfs-seeAlso">fbird_free_event_handler()</a> - Alias of ibase_free_event_handler</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ibase/functions/fbird-wait-event.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.fbird-wait-event%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.fbird-wait-event&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.fbird-wait-event.php">＋<small>add a note</small></a></span>
