...
<head>
  ...
  <title>PHP: CommonMark\Node\CodeBlock - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.commonmark-node-codeblock.php">
 <link rel="shorturl" href="https://www.php.net/commonmark-node-codeblock">
 <link rel="alternate" href="https://www.php.net/commonmark-node-codeblock" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.cmark.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.commonmark-node-code.php">
 <link rel="next" href="https://www.php.net/manual/en/commonmark-node-codeblock.construct.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.commonmark-node-codeblock.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.commonmark-node-codeblock.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.commonmark-node-codeblock.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.commonmark-node-codeblock.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.commonmark-node-codeblock.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.commonmark-node-codeblock.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.commonmark-node-codeblock.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.commonmark-node-codeblock.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.commonmark-node-codeblock.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.commonmark-node-codeblock.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.commonmark-node-codeblock.php" hreflang="zh">
...
<meta name="Description" content="CodeBlock concrete CommonMark\Node" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: CommonMark\Node\CodeBlock - Manual" />
<meta name="twitter:description" content="CodeBlock concrete CommonMark\Node" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: CommonMark\Node\CodeBlock - Manual" />
<meta itemprop="description" content="CodeBlock concrete CommonMark\Node" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="CodeBlock concrete CommonMark\Node" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="commonmark-node-codeblock.construct.php">
          CommonMark\Node\CodeBlock::__construct &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.commonmark-node-code.php">
          &laquo; CommonMark\Node\Code        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.commonmark-node-codeblock.php' selected="selected">English</option>
            <option value='de/class.commonmark-node-codeblock.php'>German</option>
            <option value='es/class.commonmark-node-codeblock.php'>Spanish</option>
            <option value='fr/class.commonmark-node-codeblock.php'>French</option>
            <option value='it/class.commonmark-node-codeblock.php'>Italian</option>
            <option value='ja/class.commonmark-node-codeblock.php'>Japanese</option>
            <option value='pt_BR/class.commonmark-node-codeblock.php'>Brazilian Portuguese</option>
            <option value='ru/class.commonmark-node-codeblock.php'>Russian</option>
            <option value='tr/class.commonmark-node-codeblock.php'>Turkish</option>
            <option value='uk/class.commonmark-node-codeblock.php'>Ukrainian</option>
            <option value='zh/class.commonmark-node-codeblock.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.commonmark-node-codeblock" class="reference">

 <h1 class="title">CodeBlock concrete CommonMark\Node</h1>
 

 <div class="partintro"><p class="verinfo">(cmark &gt;= 1.0.0)</p>

  <div class="section" id="commonmark-node-codeblock.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      ...
      <span class="modifier">class</span> <strong class="classname">CommonMark\Node\CodeBlock</strong>
     </span>
...
<div class="fieldsynopsis"><span class="modifier">public</span>
    ...
    <div class="fieldsynopsis"><span class="modifier">public</span>
     <span class="type">?</span><span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span><span class="type"></span></span>
      <var class="varname">$<var class="varname">fence</var></var>;</div>
...
<div class="constructorsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node-text.construct.php" class="methodname">CommonMark\Node\Text::__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$literal</code></span>)</div>
    ...
    <div class="constructorsynopsis dc-description"><span class="modifier">public</span> <span class="methodname"><a href="commonmark-node-codeblock.construct.php" class="methodname">__construct</a></span>(<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$fence</code></span>, <span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$literal</code></span>)</div>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_reference"><li><a href="commonmark-node-codeblock.construct.php">CommonMark\Node\CodeBlock::__construct</a> — CodeBlock Construction</li></ul>
</div>
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/cmark/commonmark.node.codeblock.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.commonmark-node-codeblock%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.commonmark-node-codeblock&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.commonmark-node-codeblock.php">＋<small>add a note</small></a></span>
