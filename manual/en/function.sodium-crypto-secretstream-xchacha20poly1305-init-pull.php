...
<head>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-secretstream-xchacha20poly1305-init-pull.php">
 ...
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-secretbox-open.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-secretstream-xchacha20poly1305-init-push.php">
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-secretstream-xchacha20poly1305-init-pull.php' selected="selected">English</option>
            ...
            <option value='zh/function.sodium-crypto-secretstream-xchacha20poly1305-init-pull.php'>Chinese (Simplified)</option>
 ...
 <div class="refsect1 examples" id="refsect1-function.sodium-crypto-secretstream-xchacha20poly1305-init-pull-examples">
  ...
  <div class="example" id="sodium-crypto-secretstream-xchacha20poly1305-init-pull.example.basic">
   <p><strong>Example #1 <span class="function"><strong>sodium_crypto_secretstream_xchacha20poly1305_init_pull()</strong></span> example</strong></p>
...
<div class="examplescode"><pre class="examplescode">string(12) &quot;Hello world!&quot;</pre>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-secretstream-xchacha20poly1305-init-pull.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-secretstream-xchacha20poly1305-init-pull%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-secretstream-xchacha20poly1305-init-pull&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-secretstream-xchacha20poly1305-init-pull.php">＋<small>add a note</small></a></span>
