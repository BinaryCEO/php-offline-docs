...
<head>
  ...
  <title>PHP: Gmagick::stripimage - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.stripimage.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.stripimage.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.stripimage.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.spreadimage.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.swirlimage.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.stripimage.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.stripimage.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.stripimage.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.stripimage.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.stripimage.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.stripimage.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.stripimage.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.stripimage.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.stripimage.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.stripimage.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.stripimage.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::stripimage - Manual" />
<meta name="twitter:description" content="Strips an image of all profiles and comments" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::stripimage - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.swirlimage.php">
          Gmagick::swirlimage &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.spreadimage.php">
          &laquo; Gmagick::spreadimage        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.stripimage.php' selected="selected">English</option>
            <option value='de/gmagick.stripimage.php'>German</option>
            <option value='es/gmagick.stripimage.php'>Spanish</option>
            <option value='fr/gmagick.stripimage.php'>French</option>
            <option value='it/gmagick.stripimage.php'>Italian</option>
            <option value='ja/gmagick.stripimage.php'>Japanese</option>
            <option value='pt_BR/gmagick.stripimage.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.stripimage.php'>Russian</option>
            <option value='tr/gmagick.stripimage.php'>Turkish</option>
            <option value='uk/gmagick.stripimage.php'>Ukrainian</option>
            <option value='zh/gmagick.stripimage.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.stripimage" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::stripimage</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::stripimage</span> &mdash; <span class="dc-title">Strips an image of all profiles and comments</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.stripimage-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::stripimage</strong></span>(): <span class="type"><a href="class.gmagick.php" class="type Gmagick">Gmagick</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.stripimage-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.stripimage-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.stripimage-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/stripimage.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.stripimage%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.stripimage&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.stripimage.php">＋<small>add a note</small></a></span>
