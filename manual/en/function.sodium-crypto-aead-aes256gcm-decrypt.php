...
<head>
  ...
  <title>PHP: sodium_crypto_aead_aes256gcm_decrypt - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-decrypt.php">
 <link rel="shorturl" href="https://www.php.net/sodium-crypto-aead-aes256gcm-decrypt">
 <link rel="alternate" href="https://www.php.net/sodium-crypto-aead-aes256gcm-decrypt" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.sodium.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aegis256-keygen.php">
 <link rel="next" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-encrypt.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.sodium-crypto-aead-aes256gcm-decrypt.php" hreflang="zh">
...
<meta name="Description" content="Verify then decrypt a message with AES-256-GCM" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: sodium_crypto_aead_aes256gcm_decrypt - Manual" />
<meta name="twitter:description" content="Verify then decrypt a message with AES-256-GCM" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: sodium_crypto_aead_aes256gcm_decrypt - Manual" />
<meta itemprop="description" content="Verify then decrypt a message with AES-256-GCM" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Verify then decrypt a message with AES-256-GCM" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.sodium-crypto-aead-aes256gcm-encrypt.php">
          sodium_crypto_aead_aes256gcm_encrypt &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.sodium-crypto-aead-aegis256-keygen.php">
          &laquo; sodium_crypto_aead_aegis256_keygen        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.sodium-crypto-aead-aes256gcm-decrypt.php' selected="selected">English</option>
            <option value='de/function.sodium-crypto-aead-aes256gcm-decrypt.php'>German</option>
            <option value='es/function.sodium-crypto-aead-aes256gcm-decrypt.php'>Spanish</option>
            <option value='fr/function.sodium-crypto-aead-aes256gcm-decrypt.php'>French</option>
            <option value='it/function.sodium-crypto-aead-aes256gcm-decrypt.php'>Italian</option>
            <option value='ja/function.sodium-crypto-aead-aes256gcm-decrypt.php'>Japanese</option>
            <option value='pt_BR/function.sodium-crypto-aead-aes256gcm-decrypt.php'>Brazilian Portuguese</option>
            <option value='ru/function.sodium-crypto-aead-aes256gcm-decrypt.php'>Russian</option>
            <option value='tr/function.sodium-crypto-aead-aes256gcm-decrypt.php'>Turkish</option>
            <option value='uk/function.sodium-crypto-aead-aes256gcm-decrypt.php'>Ukrainian</option>
            <option value='zh/function.sodium-crypto-aead-aes256gcm-decrypt.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.sodium-crypto-aead-aes256gcm-decrypt" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">sodium_crypto_aead_aes256gcm_decrypt</h1>
  <p class="verinfo">(PHP 7 &gt;= 7.2.0, PHP 8)</p><p class="refpurpose"><span class="refname">sodium_crypto_aead_aes256gcm_decrypt</span> &mdash; <span class="dc-title">Verify then decrypt a message with AES-256-GCM</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-function.sodium-crypto-aead-aes256gcm-decrypt-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>sodium_crypto_aead_aes256gcm_decrypt</strong></span>(<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$ciphertext</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$additional_data</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$nonce</code></span>,<br>&nbsp;&nbsp;&nbsp;&nbsp;<span class="methodparam"><span class="attribute"><a href="class.sensitiveparameter.php">#[\SensitiveParameter]</a> </span><span class="type"><a href="language.types.string.php" class="type string">string</a></span> <code class="parameter">$key</code></span><br>): <span class="type"><span class="type"><a href="language.types.string.php" class="type string">string</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">
   Verify then decrypt with AES-256-GCM.
   Only available if <span class="function"><a href="function.sodium-crypto-aead-aes256gcm-is-available.php" class="function">sodium_crypto_aead_aes256gcm_is_available()</a></span> returns <strong><code><a href="reserved.constants.php#constant.true">true</a></code></strong>.
  </p>

 </div>


 <div class="refsect1 parameters" id="refsect1-function.sodium-crypto-aead-aes256gcm-decrypt-parameters">
  ...
  <dl>
    ...
    <dd>
     <p class="para">
      Must be in the format provided by <span class="function"><a href="function.sodium-crypto-aead-aes256gcm-encrypt.php" class="function">sodium_crypto_aead_aes256gcm_encrypt()</a></span>
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.sodium-crypto-aead-aes256gcm-decrypt-returnvalues">
  <h3 class="title">Return Values</h3>
  <p class="para">
   Returns the plaintext on success,  or <strong><code><a href="reserved.constants.php#constant.false">false</a></code></strong> on failure.
  </p>
 </div>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/sodium/functions/sodium-crypto-aead-aes256gcm-decrypt.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.sodium-crypto-aead-aes256gcm-decrypt%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-aes256gcm-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-decrypt.php">＋<small>add a note</small></a></span>
  <h3 class="title">User Contributed Notes <span class="count">1 note</span></h3>
 </div><div id="allnotes">
  <div class="note" id="129332">  <div class="votes">
    <div id="Vu129332">
    <a href="/manual/vote-note.php?id=129332&amp;page=function.sodium-crypto-aead-aes256gcm-decrypt&amp;vote=up" title="Vote up!" class="usernotes-voteu">up</a>
    </div>
    <div id="Vd129332">
    <a href="/manual/vote-note.php?id=129332&amp;page=function.sodium-crypto-aead-aes256gcm-decrypt&amp;vote=down" title="Vote down!" class="usernotes-voted">down</a>
    </div>
    <div class="tally" id="V129332" title="66% like this...">
    1
    </div>
  </div>
  <a href="#129332" class="name">
  <strong class="user"><em>zjp115566 at gmail dot com</em></strong></a><a class="genanchor" href="#129332"> &para;</a><div class="date" title="2024-03-14 06:11"><strong>1 year ago</strong></div>
  <div class="text" id="Hcom129332">
<div class="phpcode"><code><span class="html">Title: Resolving Sodium Compatibility Issues when Migrating from Intel to ARM Architecture<br /><br />Introduction:<br />During the process of migrating a PHP application from an Intel-based server to an ARM-based server, a compatibility issue arose with the Sodium extension. The specific error encountered was "Call to undefined function sodium_crypto_aead_aes256gcm_decrypt()". <br />This document outlines the discovery of the issue and presents a solution using the OpenSSL extension as an alternative.<br /><br />Problem Discovery:<br />Upon investigating the issue, it was found that the sodium_crypto_aead_aes256gcm_is_available() function returned false on the ARM-based server, indicating that AES-256-GCM encryption and decryption were not supported in the current environment. <br />This compatibility problem was attributed to the ARM architecture of the M1 chip, as the Sodium extension may not have been optimized or compiled for this specific architecture.<br /><br />Solution:<br />To overcome the compatibility issue and ensure the functionality of encryption and decryption operations, the OpenSSL extension was employed as an alternative. <br />The original Sodium-based code was modified to utilize OpenSSL functions for AES-256-GCM encryption and decryption.<br /><br />The following code snippet demonstrates the updated aes256gcm_decrypt() function using OpenSSL:<br /><br />function aes256gcm_decrypt($secretData, string $keygen, string $nonce)<br />{<br />    $secretData = preg_replace('/[\r\n\s]/', '', $secretData);<br />    $keygen = preg_replace('/[\r\n\s]/', '', $keygen);<br />    $nonce = preg_replace('/[\r\n\s]/', '', $nonce);<br /><br />    $key = hex2bin($keygen);<br />    $tag = substr($secretData, -32);<br />    $ciphertext = substr($secretData, 0, -32);<br /><br />    try {<br />        $plaintext = openssl_decrypt(<br />            hex2bin($ciphertext),<br />            'aes-256-gcm',<br />            $key,<br />            OPENSSL_RAW_DATA,<br />            hex2bin($nonce),<br />            hex2bin($tag)<br />        );<br /><br />        if ($plaintext === false) {<br />            throw new Exception('Decryption failed.');<br />        }<br /><br />        return $plaintext;<br />    } catch (Exception $e) {<br />        return $e-&gt;getMessage();<br />    }<br />}<br /><br />Key points of the solution:<br /><br />The input data ($secretData, $keygen, and $nonce) is cleaned by removing newline characters and whitespace using preg_replace().<br />The $keygen is converted from a hexadecimal string to binary format using hex2bin().<br />The authentication tag ($tag) and ciphertext ($ciphertext) are extracted from $secretData.<br />The openssl_decrypt() function is used for decryption, with the necessary parameters such as the ciphertext, encryption algorithm, key, nonce, and tag.<br />Error handling is implemented using a try-catch block to catch and return any exceptions that may occur during the decryption process.<br />Conclusion:<br />By utilizing the OpenSSL extension and modifying the code accordingly, the compatibility issue encountered when migrating from an Intel-based server to an ARM-based server was successfully resolved. <br />The provided solution ensures that AES-256-GCM encryption and decryption operations can be performed seamlessly on the ARM architecture.</span></code></div>
  </div>
 </div></div>
<div class="foot"><a href="/manual/add-note.php?sect=function.sodium-crypto-aead-aes256gcm-decrypt&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.sodium-crypto-aead-aes256gcm-decrypt.php">＋<small>add a note</small></a></div>
