...
<head>
  ...
  <title>PHP: Gmagick::getimageblueprimary - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimageblueprimary.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimageblueprimary.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageblueprimary.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagebackgroundcolor.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagebordercolor.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimageblueprimary.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimageblueprimary.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimageblueprimary.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimageblueprimary.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimageblueprimary.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimageblueprimary.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimageblueprimary.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimageblueprimary.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimageblueprimary.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimageblueprimary.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimageblueprimary.php" hreflang="zh">
...
<meta name="twitter:title" content="PHP: Gmagick::getimageblueprimary - Manual" />
<meta name="twitter:description" content="Returns the chromaticy blue primary point" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimageblueprimary - Manual" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="gmagick.getimagebordercolor.php">
          Gmagick::getimagebordercolor &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagebackgroundcolor.php">
          &laquo; Gmagick::getimagebackgroundcolor        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimageblueprimary.php' selected="selected">English</option>
            <option value='de/gmagick.getimageblueprimary.php'>German</option>
            <option value='es/gmagick.getimageblueprimary.php'>Spanish</option>
            <option value='fr/gmagick.getimageblueprimary.php'>French</option>
            <option value='it/gmagick.getimageblueprimary.php'>Italian</option>
            <option value='ja/gmagick.getimageblueprimary.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimageblueprimary.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimageblueprimary.php'>Russian</option>
            <option value='tr/gmagick.getimageblueprimary.php'>Turkish</option>
            <option value='uk/gmagick.getimageblueprimary.php'>Ukrainian</option>
            <option value='zh/gmagick.getimageblueprimary.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimageblueprimary" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimageblueprimary</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimageblueprimary</span> &mdash; <span class="dc-title">Returns the chromaticy blue primary point</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimageblueprimary-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimageblueprimary</strong></span>(): <span class="type"><a href="language.types.array.php" class="type array">array</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimageblueprimary-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimageblueprimary-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimageblueprimary-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimageblueprimary.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimageblueprimary%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimageblueprimary&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimageblueprimary.php">＋<small>add a note</small></a></span>
