...
<head>
  ...
  <title>PHP: stats_rand_gen_f - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/function.stats-rand-gen-f.php">
 <link rel="shorturl" href="https://www.php.net/stats-rand-gen-f">
 <link rel="alternate" href="https://www.php.net/stats-rand-gen-f" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/ref.stats.php">
 <link rel="prev" href="https://www.php.net/manual/en/function.stats-rand-gen-exponential.php">
 <link rel="next" href="https://www.php.net/manual/en/function.stats-rand-gen-funiform.php">

 <link rel="alternate" href="https://www.php.net/manual/en/function.stats-rand-gen-f.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/function.stats-rand-gen-f.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/function.stats-rand-gen-f.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/function.stats-rand-gen-f.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/function.stats-rand-gen-f.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/function.stats-rand-gen-f.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/function.stats-rand-gen-f.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/function.stats-rand-gen-f.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/function.stats-rand-gen-f.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/function.stats-rand-gen-f.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/function.stats-rand-gen-f.php" hreflang="zh">
...
<meta name="Description" content="Generates a random deviate from the F distribution" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: stats_rand_gen_f - Manual" />
<meta name="twitter:description" content="Generates a random deviate from the F distribution" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: stats_rand_gen_f - Manual" />
<meta itemprop="description" content="Generates a random deviate from the F distribution" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Generates a random deviate from the F distribution" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="function.stats-rand-gen-funiform.php">
          stats_rand_gen_funiform &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="function.stats-rand-gen-exponential.php">
          &laquo; stats_rand_gen_exponential        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/function.stats-rand-gen-f.php' selected="selected">English</option>
            <option value='de/function.stats-rand-gen-f.php'>German</option>
            <option value='es/function.stats-rand-gen-f.php'>Spanish</option>
            <option value='fr/function.stats-rand-gen-f.php'>French</option>
            <option value='it/function.stats-rand-gen-f.php'>Italian</option>
            <option value='ja/function.stats-rand-gen-f.php'>Japanese</option>
            <option value='pt_BR/function.stats-rand-gen-f.php'>Brazilian Portuguese</option>
            <option value='ru/function.stats-rand-gen-f.php'>Russian</option>
            <option value='tr/function.stats-rand-gen-f.php'>Turkish</option>
            <option value='uk/function.stats-rand-gen-f.php'>Ukrainian</option>
            <option value='zh/function.stats-rand-gen-f.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="function.stats-rand-gen-f" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">stats_rand_gen_f</h1>
  <p class="verinfo">(PECL stats &gt;= 1.0.0)</p><p class="refpurpose"><span class="refname">stats_rand_gen_f</span> &mdash; <span class="dc-title">Generates a random deviate from the F distribution</span></p>

 </div>
 <div class="refsect1 description" id="refsect1-function.stats-rand-gen-f-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="methodname"><strong>stats_rand_gen_f</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$dfn</code></span>, <span class="methodparam"><span class="type"><a href="language.types.float.php" class="type float">float</a></span> <code class="parameter">$dfd</code></span>): <span class="type"><a href="language.types.float.php" class="type float">float</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-function.stats-rand-gen-f-parameters">
 ...
 <div class="refsect1 returnvalues" id="refsect1-function.stats-rand-gen-f-returnvalues">
  ...
  <p class="para">
   A random deviate
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/stats/functions/stats-rand-gen-f.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Ffunction.stats-rand-gen-f%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.stats-rand-gen-f&amp;repo=en&amp;redirect=https://www.php.net/manual/en/function.stats-rand-gen-f.php">＋<small>add a note</small></a></span>
