...
<head>
  ...
  <title>PHP: Gmagick::getimagecolorspace - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/gmagick.getimagecolorspace.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/gmagick.getimagecolorspace.php">
 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagecolorspace.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.gmagick.php">
 <link rel="prev" href="https://www.php.net/manual/en/gmagick.getimagecolors.php">
 <link rel="next" href="https://www.php.net/manual/en/gmagick.getimagecompose.php">

 <link rel="alternate" href="https://www.php.net/manual/en/gmagick.getimagecolorspace.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/gmagick.getimagecolorspace.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/gmagick.getimagecolorspace.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/gmagick.getimagecolorspace.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/gmagick.getimagecolorspace.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/gmagick.getimagecolorspace.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/gmagick.getimagecolorspace.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/gmagick.getimagecolorspace.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/gmagick.getimagecolorspace.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/gmagick.getimagecolorspace.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/gmagick.getimagecolorspace.php" hreflang="zh">
...
<meta name="Description" content="Gets the image colorspace" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Gmagick::getimagecolorspace - Manual" />
<meta name="twitter:description" content="Gets the image colorspace" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Gmagick::getimagecolorspace - Manual" />
<meta itemprop="description" content="Gets the image colorspace" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Gets the image colorspace" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="gmagick.getimagecompose.php">
          Gmagick::getimagecompose &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="gmagick.getimagecolors.php">
          &laquo; Gmagick::getimagecolors        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/gmagick.getimagecolorspace.php' selected="selected">English</option>
            <option value='de/gmagick.getimagecolorspace.php'>German</option>
            <option value='es/gmagick.getimagecolorspace.php'>Spanish</option>
            <option value='fr/gmagick.getimagecolorspace.php'>French</option>
            <option value='it/gmagick.getimagecolorspace.php'>Italian</option>
            <option value='ja/gmagick.getimagecolorspace.php'>Japanese</option>
            <option value='pt_BR/gmagick.getimagecolorspace.php'>Brazilian Portuguese</option>
            <option value='ru/gmagick.getimagecolorspace.php'>Russian</option>
            <option value='tr/gmagick.getimagecolorspace.php'>Turkish</option>
            <option value='uk/gmagick.getimagecolorspace.php'>Ukrainian</option>
            <option value='zh/gmagick.getimagecolorspace.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="gmagick.getimagecolorspace" class="refentry">
 <div class="refnamediv">
  <h1 class="refname">Gmagick::getimagecolorspace</h1>
  <p class="verinfo">(PECL gmagick &gt;= Unknown)</p><p class="refpurpose"><span class="refname">Gmagick::getimagecolorspace</span> &mdash; <span class="dc-title">Gets the image colorspace</span></p>

 </div>

 <div class="refsect1 description" id="refsect1-gmagick.getimagecolorspace-description">
  <h3 class="title">Description</h3>
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>Gmagick::getimagecolorspace</strong></span>(): <span class="type"><a href="language.types.integer.php" class="type int">int</a></span></div>
 ...
 <div class="refsect1 parameters" id="refsect1-gmagick.getimagecolorspace-parameters">
  <h3 class="title">Parameters</h3>
  <p class="para">This function has no parameters.</p>
 </div>


 <div class="refsect1 returnvalues" id="refsect1-gmagick.getimagecolorspace-returnvalues">
 ...
 <div class="refsect1 errors" id="refsect1-gmagick.getimagecolorspace-errors">
...
<span class="classname"><strong class="classname">GmagickException</strong></span> on error.
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/gmagick/gmagick/getimagecolorspace.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fgmagick.getimagecolorspace%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=gmagick.getimagecolorspace&amp;repo=en&amp;redirect=https://www.php.net/manual/en/gmagick.getimagecolorspace.php">＋<small>add a note</small></a></span>
