...
<head>
  ...
  <title>PHP: mysqli_result::fetch_array - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/mysqli-result.fetch-array.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/mysqli-result.fetch-array.php">
 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.fetch-array.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/class.mysqli-result.php">
 <link rel="prev" href="https://www.php.net/manual/en/mysqli-result.fetch-all.php">
 <link rel="next" href="https://www.php.net/manual/en/mysqli-result.fetch-assoc.php">

 <link rel="alternate" href="https://www.php.net/manual/en/mysqli-result.fetch-array.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/mysqli-result.fetch-array.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/mysqli-result.fetch-array.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/mysqli-result.fetch-array.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/mysqli-result.fetch-array.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/mysqli-result.fetch-array.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/mysqli-result.fetch-array.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/mysqli-result.fetch-array.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/mysqli-result.fetch-array.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/mysqli-result.fetch-array.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/mysqli-result.fetch-array.php" hreflang="zh">
...
<meta name="Description" content="Fetch the next row of a result set as an associative, a numeric array, or both" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: mysqli_result::fetch_array - Manual" />
<meta name="twitter:description" content="Fetch the next row of a result set as an associative, a numeric array, or both" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: mysqli_result::fetch_array - Manual" />
<meta itemprop="description" content="Fetch the next row of a result set as an associative, a numeric array, or both" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Fetch the next row of a result set as an associative, a numeric array, or both" />
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
        ...
        <a href="mysqli-result.fetch-assoc.php">
          mysqli_result::fetch_assoc &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="mysqli-result.fetch-all.php">
          &laquo; mysqli_result::fetch_all        </a>
      </div>
          <ul>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/mysqli-result.fetch-array.php' selected="selected">English</option>
            <option value='de/mysqli-result.fetch-array.php'>German</option>
            <option value='es/mysqli-result.fetch-array.php'>Spanish</option>
            <option value='fr/mysqli-result.fetch-array.php'>French</option>
            <option value='it/mysqli-result.fetch-array.php'>Italian</option>
            <option value='ja/mysqli-result.fetch-array.php'>Japanese</option>
            <option value='pt_BR/mysqli-result.fetch-array.php'>Brazilian Portuguese</option>
            <option value='ru/mysqli-result.fetch-array.php'>Russian</option>
            <option value='tr/mysqli-result.fetch-array.php'>Turkish</option>
            <option value='uk/mysqli-result.fetch-array.php'>Ukrainian</option>
            <option value='zh/mysqli-result.fetch-array.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="mysqli-result.fetch-array" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-mysqli-result.fetch-array-description">
  ...
  <div class="methodsynopsis dc-description">
   <span class="modifier">public</span> <span class="methodname"><strong>mysqli_result::fetch_array</strong></span>(<span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code><span class="initializer"> = <strong><code><a href="mysqli.constants.php#constant.mysqli-both">MYSQLI_BOTH</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>

  <p class="para rdfs-comment">Procedural style</p>
  <div class="methodsynopsis dc-description"><span class="methodname"><strong>mysqli_fetch_array</strong></span>(<span class="methodparam"><span class="type"><a href="class.mysqli-result.php" class="type mysqli_result">mysqli_result</a></span> <code class="parameter">$result</code></span>, <span class="methodparam"><span class="type"><a href="language.types.integer.php" class="type int">int</a></span> <code class="parameter">$mode</code><span class="initializer"> = <strong><code><a href="mysqli.constants.php#constant.mysqli-both">MYSQLI_BOTH</a></code></strong></span></span>): <span class="type"><span class="type"><a href="language.types.array.php" class="type array">array</a></span>|<span class="type"><a href="language.types.null.php" class="type null">null</a></span>|<span class="type"><a href="language.types.singleton.php" class="type false">false</a></span></span></div>
...
<span class="function"><a href="mysqli.use-result.php" class="function">mysqli_use_result()</a></span> or <span class="function"><a href="mysqli-stmt.get-result.php" class="function">mysqli_stmt_get_result()</a></span>.</p></dd>
     ...
     <dd>
      ...
      <p class="para">
       By using the <strong><code><a href="mysqli.constants.php#constant.mysqli-assoc">MYSQLI_ASSOC</a></code></strong> constant this function
       will behave identically to the <span class="function"><a href="mysqli-result.fetch-assoc.php" class="function">mysqli_fetch_assoc()</a></span>,
       while <strong><code><a href="mysqli.constants.php#constant.mysqli-num">MYSQLI_NUM</a></code></strong> will behave identically to the
       <span class="function"><a href="mysqli-result.fetch-row.php" class="function">mysqli_fetch_row()</a></span> function. The final option 
       <strong><code><a href="mysqli.constants.php#constant.mysqli-both">MYSQLI_BOTH</a></code></strong> will create a single array with the
       attributes of both.
      </p>
     </dd>
 ...
 <div class="refsect1 returnvalues" id="refsect1-mysqli-result.fetch-array-returnvalues">
  ...
  <p class="para">
   Returns an array representing the fetched row, <strong><code><a href="reserved.constants.php#constant.null">null</a></code></strong> if there
   ...
   <ul class="simplelist">
    ...
    <li><span class="function"><a href="mysqli-result.data-seek.php" class="function" rel="rdfs-seeAlso">mysqli_data_seek()</a> - Adjusts the result pointer to an arbitrary row in the result</span></li>
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/mysqli/mysqli_result/fetch-array.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fmysqli-result.fetch-array%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=mysqli-result.fetch-array&amp;repo=en&amp;redirect=https://www.php.net/manual/en/mysqli-result.fetch-array.php">＋<small>add a note</small></a></span>
