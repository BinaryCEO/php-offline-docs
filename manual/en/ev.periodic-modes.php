...
<head>
  ...
  <title>PHP: Periodic watcher operation modes - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/ev.periodic-modes.php">
 <link rel="shorturl" href="https://www.php.net/manual/en/ev.periodic-modes.php">
 <link rel="alternate" href="https://www.php.net/manual/en/ev.periodic-modes.php" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.ev.php">
 <link rel="prev" href="https://www.php.net/manual/en/ev.watcher-callbacks.php">
 <link rel="next" href="https://www.php.net/manual/en/class.ev.php">

 <link rel="alternate" href="https://www.php.net/manual/en/ev.periodic-modes.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/ev.periodic-modes.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/ev.periodic-modes.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/ev.periodic-modes.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/ev.periodic-modes.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/ev.periodic-modes.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/ev.periodic-modes.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/ev.periodic-modes.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/ev.periodic-modes.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/ev.periodic-modes.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/ev.periodic-modes.php" hreflang="zh">
...
<meta name="Description" content="Periodic watcher operation modes" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: Periodic watcher operation modes - Manual" />
<meta name="twitter:description" content="Periodic watcher operation modes" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: Periodic watcher operation modes - Manual" />
<meta itemprop="description" content="Periodic watcher operation modes" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="Periodic watcher operation modes" />
    ...
    <div id="breadcrumbs-inner">
        ...
        <a href="class.ev.php">
          Ev &raquo;
              ...
              <div class="prev">
        <a href="ev.watcher-callbacks.php">
          &laquo; Watcher callbacks        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/ev.periodic-modes.php' selected="selected">English</option>
            <option value='de/ev.periodic-modes.php'>German</option>
            <option value='es/ev.periodic-modes.php'>Spanish</option>
            <option value='fr/ev.periodic-modes.php'>French</option>
            <option value='it/ev.periodic-modes.php'>Italian</option>
            <option value='ja/ev.periodic-modes.php'>Japanese</option>
            <option value='pt_BR/ev.periodic-modes.php'>Brazilian Portuguese</option>
            <option value='ru/ev.periodic-modes.php'>Russian</option>
            <option value='tr/ev.periodic-modes.php'>Turkish</option>
            <option value='uk/ev.periodic-modes.php'>Ukrainian</option>
            <option value='zh/ev.periodic-modes.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="ev.periodic-modes" class="chapter">
...
<div class="phpcode"><code><span style="color: #000000"><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">// Tick each 10.5 seconds<br /><br /></span><span style="color: #007700">function </span><span style="color: #0000BB">reschedule_cb </span><span style="color: #007700">(</span><span style="color: #0000BB">$watcher</span><span style="color: #007700">, </span><span style="color: #0000BB">$now</span><span style="color: #007700">) {<br />   return </span><span style="color: #0000BB">$now </span><span style="color: #007700">+ (</span><span style="color: #0000BB">10.5</span><span style="color: #007700">. - </span><span style="color: #0000BB">fmod</span><span style="color: #007700">(</span><span style="color: #0000BB">$now</span><span style="color: #007700">, </span><span style="color: #0000BB">10.5</span><span style="color: #007700">));<br />}<br /><br /></span><span style="color: #0000BB">$w </span><span style="color: #007700">= new </span><span style="color: #0000BB">EvPeriodic</span><span style="color: #007700">(</span><span style="color: #0000BB">0.</span><span style="color: #007700">, </span><span style="color: #0000BB">0.</span><span style="color: #007700">, </span><span style="color: #DD0000">"reschedule_cb"</span><span style="color: #007700">, function (</span><span style="color: #0000BB">$w</span><span style="color: #007700">, </span><span style="color: #0000BB">$revents</span><span style="color: #007700">) {<br />   echo </span><span style="color: #0000BB">time</span><span style="color: #007700">(), </span><span style="color: #0000BB">PHP_EOL</span><span style="color: #007700">;<br />});<br /><br /></span><span style="color: #0000BB">Ev</span><span style="color: #007700">::</span><span style="color: #0000BB">run</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span></span></code></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/ev/periodic-modes.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fev.periodic-modes%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=ev.periodic-modes&amp;repo=en&amp;redirect=https://www.php.net/manual/en/ev.periodic-modes.php">＋<small>add a note</small></a></span>
