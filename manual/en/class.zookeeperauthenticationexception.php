...
<head>
  ...
  <title>PHP: ZookeeperAuthenticationException - Manual</title>
 ...
 <link rel="canonical" href="https://www.php.net/manual/en/class.zookeeperauthenticationexception.php">
 <link rel="shorturl" href="https://www.php.net/zookeeperauthenticationexception">
 <link rel="alternate" href="https://www.php.net/zookeeperauthenticationexception" hreflang="x-default">

 <link rel="contents" href="https://www.php.net/manual/en/index.php">
 <link rel="index" href="https://www.php.net/manual/en/book.zookeeper.php">
 <link rel="prev" href="https://www.php.net/manual/en/class.zookeeperexception.php">
 <link rel="next" href="https://www.php.net/manual/en/class.zookeeperconnectionexception.php">

 <link rel="alternate" href="https://www.php.net/manual/en/class.zookeeperauthenticationexception.php" hreflang="en">
 <link rel="alternate" href="https://www.php.net/manual/de/class.zookeeperauthenticationexception.php" hreflang="de">
 <link rel="alternate" href="https://www.php.net/manual/es/class.zookeeperauthenticationexception.php" hreflang="es">
 <link rel="alternate" href="https://www.php.net/manual/fr/class.zookeeperauthenticationexception.php" hreflang="fr">
 <link rel="alternate" href="https://www.php.net/manual/it/class.zookeeperauthenticationexception.php" hreflang="it">
 <link rel="alternate" href="https://www.php.net/manual/ja/class.zookeeperauthenticationexception.php" hreflang="ja">
 <link rel="alternate" href="https://www.php.net/manual/pt_BR/class.zookeeperauthenticationexception.php" hreflang="pt_BR">
 <link rel="alternate" href="https://www.php.net/manual/ru/class.zookeeperauthenticationexception.php" hreflang="ru">
 <link rel="alternate" href="https://www.php.net/manual/tr/class.zookeeperauthenticationexception.php" hreflang="tr">
 <link rel="alternate" href="https://www.php.net/manual/uk/class.zookeeperauthenticationexception.php" hreflang="uk">
 <link rel="alternate" href="https://www.php.net/manual/zh/class.zookeeperauthenticationexception.php" hreflang="zh">
...
<meta name="Description" content="The ZookeeperAuthenticationException class" />

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:site" content="@official_php" />
<meta name="twitter:title" content="PHP: ZookeeperAuthenticationException - Manual" />
<meta name="twitter:description" content="The ZookeeperAuthenticationException class" />
<meta name="twitter:creator" content="@official_php" />
<meta name="twitter:image:src" content="https://www.php.net/images/meta-image.png" />

<meta itemprop="name" content="PHP: ZookeeperAuthenticationException - Manual" />
<meta itemprop="description" content="The ZookeeperAuthenticationException class" />
<meta itemprop="image" content="https://www.php.net/images/meta-image.png" />

<meta property="og:image" content="https://www.php.net/images/meta-image.png" />
<meta property="og:description" content="The ZookeeperAuthenticationException class" />
...
<div id="goto">
  ...
  <div id="breadcrumbs" class="clearfix">
    <div id="breadcrumbs-inner">
          <div class="next">
        <a href="class.zookeeperconnectionexception.php">
          ZookeeperConnectionException &raquo;
        </a>
      </div>
              <div class="prev">
        <a href="class.zookeeperexception.php">
          &laquo; ZookeeperException        </a>
      </div>
          <ul>
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/class.zookeeperauthenticationexception.php' selected="selected">English</option>
            <option value='de/class.zookeeperauthenticationexception.php'>German</option>
            <option value='es/class.zookeeperauthenticationexception.php'>Spanish</option>
            <option value='fr/class.zookeeperauthenticationexception.php'>French</option>
            <option value='it/class.zookeeperauthenticationexception.php'>Italian</option>
            <option value='ja/class.zookeeperauthenticationexception.php'>Japanese</option>
            <option value='pt_BR/class.zookeeperauthenticationexception.php'>Brazilian Portuguese</option>
            <option value='ru/class.zookeeperauthenticationexception.php'>Russian</option>
            <option value='tr/class.zookeeperauthenticationexception.php'>Turkish</option>
            <option value='uk/class.zookeeperauthenticationexception.php'>Ukrainian</option>
            <option value='zh/class.zookeeperauthenticationexception.php'>Chinese (Simplified)</option>
            <option value='help-translate.php'>Other</option>
          </select>
        </fieldset>
      </form>
    </div>
  </div><div id="class.zookeeperauthenticationexception" class="reference">
 <h1 class="title">The ZookeeperAuthenticationException class</h1>
 
 
 <div class="partintro"><p class="verinfo">(PECL zookeeper &gt;= 0.3.0)</p>
 

  <div class="section" id="zookeeperauthenticationexception.intro">
  ...
  <div class="section" id="zookeeperauthenticationexception.synopsis">
   ...
   <div class="classsynopsis">
    ...
    <div class="classsynopsisinfo">
     <span class="ooclass">
      <span class="modifier">class</span> <strong class="classname">ZookeeperAuthenticationException</strong>
     </span>
     <span class="ooclass">
...
<div class="methodsynopsis dc-description"><span class="modifier">private</span> <span class="methodname"><a href="exception.clone.php" class="methodname">Exception::__clone</a></span>(): <span class="type"><a href="language.types.void.php" class="type void">void</a></span></div>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-en/blob/master/reference/zookeeper/zookeeperauthenticationexception.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-en/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Fclass.zookeeperauthenticationexception%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=class.zookeeperauthenticationexception&amp;repo=en&amp;redirect=https://www.php.net/manual/en/class.zookeeperauthenticationexception.php">＋<small>add a note</small></a></span>
